...
void EnMThunder_Draw(Actor* thisx, PlayState* play2) {
    ...
    switch (this->unk_1C6) {
        case 0:
            if (CVarGetInteger(COSMETIC_CVAR("SpinAttack_Level2Primary.Changed"), 0)) {
                Color_RGB8 color = CVarGetColor24(COSMETIC_CVAR("SpinAttack_Level2Primary.Value"), (Color_RGB8){255, 255, 170});
            ...
            break;
        case 1:
             if (CVarGetInteger(COSMETIC_CVAR("SpinAttack_Level1Primary.Changed"), 0)) {
                Color_RGB8 color = CVarGetColor24(COSMETIC_CVAR("SpinAttack_Level1Primary.Value"), (Color_RGB8){170, 255, 255});
                gDPSetPrimColor(POLY_XLU_DISP++, 0, 0x80, color.r, color.g, color.b, (u8)(this->unk_1B0 * 255));
            } else {
    ...
    if (this->unk_1B8 >= 0.85f) {
        ...
        if (CVarGetInteger(COSMETIC_CVAR("SpinAttack_Level2Secondary.Changed"), 0)) {
            Color_RGB8 color = CVarGetColor24(COSMETIC_CVAR("SpinAttack_Level2Secondary.Value"), (Color_RGB8){255, 100, 0});
        ...
        if (CVarGetInteger(COSMETIC_CVAR("SpinAttack_Level1Secondary.Changed"), 0)) {
            Color_RGB8 color = CVarGetColor24(COSMETIC_CVAR("SpinAttack_Level1Secondary.Value"), (Color_RGB8){0, 100, 255});
            gDPSetEnvColor(POLY_XLU_DISP++, color.r, color.g, color.b, 128);
        } else {
