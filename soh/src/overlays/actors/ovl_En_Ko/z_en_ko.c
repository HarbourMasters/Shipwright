...
void EnKo_Draw(Actor* thisx, PlayState* play) {
    ...
    if (CVarGetInteger(COSMETIC_CVAR("NPC_Kokiri.Changed"), 0)) {
        tunicColor = CVarGetColor(COSMETIC_CVAR("NPC_Kokiri.Value"), sModelInfo[ENKO_TYPE].tunicColor);
        bootsColor = CVarGetColor(COSMETIC_CVAR("NPC_Kokiri.Value"), sModelInfo[ENKO_TYPE].bootsColor);
    }
