...
void EnBomChu_Draw(Actor* thisx, PlayState* play) {
    ...
    if (CVarGetInteger(COSMETIC_CVAR("Equipment_ChuBody.Changed"), 0)) {
        Color_RGB8 color = CVarGetColor24(COSMETIC_CVAR("Equipment_ChuBody.Value"), (Color_RGB8){ 209.0f, 34.0f, -35.0f });
