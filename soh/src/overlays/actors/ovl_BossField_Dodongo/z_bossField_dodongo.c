...
void BossFieldDodongo_Init(Actor* thisx, PlayState* play);
void BossFieldDodongo_Destroy(Actor* thisx, PlayState* play);
void BossFieldDodongo_Update(Actor* thisx, PlayState* play);
void BossFieldDodongo_Draw(Actor* thisx, PlayState* play);

void BossFieldDodongo_SetupIntroCutscene(BossDodongo* this, PlayState* play);
void BossFieldDodongo_IntroCutscene(BossDodongo* this, PlayState* play);
void BossFieldDodongo_Walk(BossDodongo* this, PlayState* play);
void BossFieldDodongo_Inhale(BossDodongo* this, PlayState* play);
void BossFieldDodongo_BlowFire(BossDodongo* this, PlayState* play);
void BossFieldDodongo_Roll(BossDodongo* this, PlayState* play);
void BossFieldDodongo_SpawnFire(BossDodongo* this, PlayState* play, s16 arg2);
void BossFieldDodongo_Explode(BossDodongo* this, PlayState* play);
void BossFieldDodongo_LayDown(BossDodongo* this, PlayState* play);
void BossFieldDodongo_Vulnerable(BossDodongo* this, PlayState* play);
void BossFieldDodongo_GetUp(BossDodongo* this, PlayState* play);
void BossFieldDodongo_SetupWalk(BossDodongo* this);
void BossFieldDodongo_DeathCutscene(BossDodongo* this, PlayState* play);
void BossFieldDodongo_SetupDeathCutscene(BossDodongo* this);
void BossFieldDodongo_Damaged(BossDodongo* this, PlayState* play);
void BossFieldDodongo_UpdateDamage(BossDodongo* this, PlayState* play);
void BossFieldDodongo_PlayerPosCheck(BossDodongo* this, PlayState* play);
void BossFieldDodongo_PlayerYawCheck(BossDodongo* this, PlayState* play);
f32 funcField_808C4F6C(BossDodongo* this, PlayState* play);
f32 funcField_808C50A8(BossDodongo* this, PlayState* play);
void BossFieldDodongo_DrawEffects(PlayState* play);
void BossFieldDodongo_UpdateEffects(PlayState* play);

const ActorInit BossField_Dodongo_InitVars = {
    ACTOR_BOSS_DODONGO,
    ACTORCAT_BOSS,
    FLAGS,
    OBJECT_KINGDODONGO,
...
#include "z_bossField_dodongo_data.c"
...
void funcField_808C12C4(u8* arg1, s16 arg2) {
    if (arg2[arg1] != 0) {
...
void funcField_808C1554(void* arg0, void* floorTex, s32 arg2, f32 arg3) {
...
void funcField_808C17C8(PlayState* play, Vec3f* arg1, Vec3f* arg2, Vec3f* arg3, f32 arg4, s16 arg5) {
    s16 i;
...
s32 BossFieldDodongo_AteExplosive(BossDodongo* this, PlayState* play) {
    f32 dx;
    f32 dy;
    f32 dz;
...
void BossFieldDodongo_Init(Actor* thisx, PlayState* play) {
    ...
    u16* temp_s2;
    u32 temp_v0;
    this->timeBeforeRollForward = 100;
    ...
    this->unk_1F8 = 1.0f;
    //BossFieldDodongo_SetupIntroCutscene(this, play);
    BossFieldDodongo_Walk(this, play);
    this->health = 12;
...
void BossFieldDodongo_SetupIntroCutscene(BossDodongo* this, PlayState* play) {
    ...
    this->actionFunc = BossFieldDodongo_IntroCutscene;
    this->csState = 0;
    this->unk_1BC = 1;
}
...
void BossFieldDodongo_IntroCutscene(BossDodongo* this, PlayState* play) {
    ...
    switch (this->csState) {
        ...
        case 4:
            ...
            if (this->unk_198 == 0) {
                BossFieldDodongo_SetupWalk(this);
                this->unk_1DA = 50;
                this->unk_1BC = 0;
...
void BossFieldDodongo_SetupDamaged(BossDodongo* this) {
    if (this->actionFunc != BossFieldDodongo_Damaged) {
        ...
        this->actionFunc = BossFieldDodongo_Damaged;
    }
    this->unk_1DA = 100;
}

void BossFieldDodongo_SetupExplode(BossDodongo* this) {
    ...
    this->actionFunc = BossFieldDodongo_Explode;
    this->unk_1B0 = 10;
    this->unk_1C0 = 2;
    this->unk_1DA = 35;
    this->unk_1FC = 50.0f;
...
void BossFieldDodongo_SetupWalk(BossDodongo* this) {
    ...
    this->unk_1AA = 0;
    this->actionFunc = BossFieldDodongo_Walk;
    this->unk_1DA = 0;
    this->actor.flags |= ACTOR_FLAG_TARGETABLE;
    this->unk_1E4 = 0.0f;
}

void BossFieldDodongo_SetupRoll(BossDodongo* this) {
    Animation_Change(&this->skelAnime, &object_kingdodongo_Anim_00DF38, 1.0f, 0.0f, 59.0f, ANIMMODE_ONCE, -5.0f);
    this->actionFunc = BossFieldDodongo_Roll;
    this->numWallCollisions = 0;
    this->unk_1DA = 27;
}

void BossFieldDodongo_SetupBlowFire(BossDodongo* this) {
    ...
    this->actionFunc = BossFieldDodongo_BlowFire;
    this->unk_1DA = 50;
    this->unk_1AE = 0;
}

void BossFieldDodongo_SetupInhale(BossDodongo* this) {
    this->actor.speedXZ = 0.0f;
    Animation_Change(&this->skelAnime, &object_kingdodongo_Anim_008EEC, 1.0f, 0.0f,
                     Animation_GetLastFrame(&object_kingdodongo_Anim_008EEC), ANIMMODE_ONCE, -5.0f);
    this->actionFunc = BossFieldDodongo_Inhale;
    this->unk_1DA = 100;
    this->unk_1AC = 0;
    this->unk_1E2 = 1;
}
...
void BossFieldDodongo_Damaged(BossDodongo* this, PlayState* play) {
    ...
    if (Animation_OnFrame(&this->skelAnime, Animation_GetLastFrame(&object_kingdodongo_Anim_001074))) {
        BossFieldDodongo_SetupRoll(this);
    }
}
...
void BossFieldDodongo_Explode(BossDodongo* this, PlayState* play) {
    ...
    if (this->unk_1DA == 0) {
        ...
        this->actionFunc = BossFieldDodongo_LayDown;
...
void BossFieldDodongo_LayDown(BossDodongo* this, PlayState* play) {
    ...
    if (Animation_OnFrame(&this->skelAnime, Animation_GetLastFrame(&object_kingdodongo_Anim_004E0C))) {
        ...
        this->actionFunc = BossFieldDodongo_Vulnerable;
        this->unk_1DA = 100;
    }
}
...
void BossFieldDodongo_Vulnerable(BossDodongo* this, PlayState* play) {
    ...
    if (this->unk_1DA == 0) {
        ...
        this->actionFunc = BossFieldDodongo_GetUp;
    }
}
...
void BossFieldDodongo_BlowFire(BossDodongo* this, PlayState* play) {
    ...
    if ((this->skelAnime.curFrame > 17.0f) && (this->skelAnime.curFrame < 35.0f)) {
        BossFieldDodongo_SpawnFire(this, play, this->unk_1AE);
        this->unk_1AE++;
...
void BossFieldDodongo_Inhale(BossDodongo* this, PlayState* PlayState) {
    this->unk_1E2 = 1;
    ...
    if (this->unk_1DA == 0) {
        BossFieldDodongo_SetupBlowFire(this);
    } else {
        this->unk_1AC++;

        if ((this->unk_1AC > 20) && (this->unk_1AC < 82) && BossFieldDodongo_AteExplosive(this, PlayState)) {
            Audio_PlayActorSound2(&this->actor, NA_SE_EN_DODO_K_DRINK);
            BossFieldDodongo_SetupExplode(this);
        }
    }
}
...
void BossFieldDodongo_Walk(BossDodongo* this, PlayState* play) {
    ...
    Math_SmoothStepToF(&this->actor.world.pos.x, player->actor.world.pos.x, 0.3f, this->unk_1E4, 0.0f);
    Math_SmoothStepToF(&this->actor.world.pos.z, player->actor.world.pos.z, 0.3f, this->unk_1E4, 0.0f);
    ...
    Math_SmoothStepToS(&this->actor.world.rot.y, Actor_WorldYawTowardActor(&this->actor, player), 5,
    ...
    if ((this->unk_1DA == 0) && (this->unk_1BC == 0)) {
        if ((this->actor.xzDistToPlayer < 500.0f) && (this->unk_1A4 != 0) && !this->playerPosInRange) {
            BossFieldDodongo_SetupInhale(this);
            BossFieldDodongo_SpawnFire(this, play, -1);
        }
...
void BossFieldDodongo_Roll(BossDodongo* this, PlayState* play) {
    ...
    SkelAnime_Update(&this->skelAnime);
    Vec3f storedPosition = this->actor.world.pos;
    ...
    this->unk_1EC = 3.0f;
    if (this->timeBeforeRollForward != 0) {
        this->timeBeforeRollForward--;
        Math_SmoothStepToS(&this->actor.world.rot.y, Actor_WorldYawTowardActor(&this->actor, player), 5,
                           this->unk_1EC * this->unk_1E8, 0);
        this->actor.shape.rot.y = this->actor.world.rot.y;
    }
    else this->actor.speedXZ = 25.0f;
    if (this->unk_1DA == 0) {
    ...
    //For now this is a hardcoded value. The point of this is to not let
    //Dodongo travel further than 120 units before stopping. OR if he actually
    //does hit a wall it update accordingly.
    Vec3f SPHResult; //Unused vars just for BGChekc func
    CollisionPoly SPHPoly;
    if (Actor_WorldDistXZToPoint(&this->actor, &storedPosition) >= 60.0f || 
       BgCheck_EntitySphVsWall1(&play->colCtx, &SPHResult, &this->actor.world.pos,
       &this->actor.prevPos, 35, &SPHPoly, 0.0f, 0) == true) {

        this->numWallCollisions++;
        storedPosition = this->actor.world.pos;
...
void BossFieldDodongo_Update(Actor* thisx, PlayState* play2) {
    ...
    if (this->collider.base.atFlags & AT_HIT) {
        f32 xzVel = 6.0f;
        s16 knockbackYaw = this->actor.shape.rot.y;
        f32 yVel = 9.0f;
        this->collider.base.atFlags &= ~AT_HIT;
        func_8002F71C(play, &this->actor, xzVel, knockbackYaw, yVel);
    }
    //Bunch of unknown var, squish together to reduce lines
    this->unk_1E2 = 0;
    this->unk_19E++;
    if (this->unk_1DA != 0) this->unk_1DA--;
    if (this->unk_1DC != 0)this->unk_1DC--;
    if (this->unk_1DE != 0) this->unk_1DE--;
    if (this->unk_1C0 != 0) this->unk_1C0--;
    if (this->unk_1C8 != 0) this->unk_1C8--;
    temp_f0 = funcField_808C4F6C(this, play);
    if (temp_f0 > 0.0f) this->unk_1A4 = temp_f0; else this->unk_1A4 = 0;
    temp_f0 = funcField_808C50A8(this, play);
    if (temp_f0 > 0.0f) this->unk_1A6 = temp_f0; else this->unk_1A6 = 0;

    BossFieldDodongo_PlayerYawCheck(this, play);
    BossFieldDodongo_PlayerPosCheck(this, play);
    ...
    BossFieldDodongo_UpdateDamage(this, play);
    ...
    if (player->actor.world.pos.y < -1000.0f) {
        ...
        if ((this->unk_19E & sp90) == 0) {
            ...
            sp54.y = this->actor.world.pos.y; //??? why was it at -1500 smth
            ...
            for (i = 0; i < 4; i++) {
                ...
                sp54.x = sinf(sp4C) * sp50 + (-890.0f);
                sp54.y = this->actor.world.pos.y; //Same as above
                sp54.z = cosf(sp4C) * sp50 + (-3304.0f);
                funcField_808C17C8(play, &sp54, &sp6C, &sp60, ((s16)Rand_ZeroFloat(2.0f)) + 6, 0x50);
            }
        }

        // TODO The lave floor bubbles with an effect that modifies the texture. This needs to be recreated shader-side.
        //funcField_808C1554(gDodongosCavernBossLavaFloorTex, sLavaFloorLavaTex, this->unk_19E, this->unk_224);
    }
    ...
    if (this->unk_1BC == 0) {
        if (this->actionFunc != BossFieldDodongo_DeathCutscene) {
            CollisionCheck_SetAC(play, &play->colChkCtx, &this->collider.base);
        }

        CollisionCheck_SetOC(play, &play->colChkCtx, &this->collider.base);

        if (this->actionFunc == BossFieldDodongo_Roll) {
            CollisionCheck_SetAT(play, &play->colChkCtx, &this->collider.base);
        }
    }

    this->collider.elements[0].dim.scale = (this->actionFunc == BossFieldDodongo_Inhale) ? 0.0f : 1.0f;

    for (i = 6; i < 19; i++) {
        if (i != 12) {
            this->collider.elements[i].dim.scale = (this->actionFunc == BossFieldDodongo_Roll) ? 0.0f : 1.0f;
        }
    }
    ...
    BossFieldDodongo_UpdateEffects(play);
}

s32 BossFieldDodongo_OverrideLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot,
                                 void* thisx) {
    f32 mtxScaleY;
    f32 mtxScaleZ;
    BossDodongo* this = (BossDodongo*)thisx;
...
void BossFieldDodongo_PostLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3s* rot, void* thisx) {
...
void BossFieldDodongo_Draw(Actor* thisx, PlayState* play) {
    ...
    SkelAnime_DrawSkeletonOpa(play, &this->skelAnime, BossFieldDodongo_OverrideLimbDraw, BossFieldDodongo_PostLimbDraw, this);

    POLY_OPA_DISP = Play_SetFog(play, POLY_OPA_DISP);

    CLOSE_DISPS(play->state.gfxCtx);

    BossFieldDodongo_DrawEffects(play);
}
...
void BossFieldDodongo_SpawnFire(BossDodongo* this, PlayState* play, s16 params) {
...
void BossFieldDodongo_UpdateDamage(BossDodongo* this, PlayState* play) {
    ...
    if ((this->health <= 0) && (this->actionFunc != BossFieldDodongo_DeathCutscene)) {
        BossFieldDodongo_SetupDeathCutscene(this);
        Enemy_StartFinishingBlow(play, &this->actor);
        return;
    }

    if (this->unk_1C0 == 0) {
        if (this->actionFunc == BossFieldDodongo_Inhale) {
            for (i = 0; i < 19; i++) {
        ...
        if (this->collider.elements->info.bumperFlags & 2) {
            ...
            if ((this->actionFunc == BossFieldDodongo_Vulnerable) || (this->actionFunc == BossFieldDodongo_LayDown)) {
                swordDamage = damage = CollisionCheck_GetSwordDamage(item1->toucher.dmgFlags, play);

                if (damage != 0) {
                    Audio_PlayActorSound2(&this->actor, NA_SE_EN_DODO_K_DAMAGE);
                    BossFieldDodongo_SetupDamaged(this);
                    this->unk_1C0 = 5;
...
void BossFieldDodongo_SetupDeathCutscene(BossDodongo* this) {
    ...
    this->actionFunc = BossFieldDodongo_DeathCutscene;
    ...
    switch (this->csState) {
        ...
        case 7:
            ...
            if (this->unk_1DA == 1) {
                ...
                Math_SmoothStepToF(&this->actor.world.pos.x, this->actor.home.pos.x, 1.0f, this->unk_1E4, 0.0f);
                Math_SmoothStepToF(&this->actor.world.pos.z, this->actor.home.pos.z, 1.0f, this->unk_1E4, 0.0f);
                Audio_PlayActorSound2(&this->actor, NA_SE_EN_DODO_K_ROLL - SFX_FLAG);
                if (!(this->unk_19E & 1)) {
                    Actor_SpawnFloorDustRing(play, &this->actor, &this->actor.world.pos, 40.0f, 3, 8.0f, 500, 10,
                                             false);
                ...
                /*Math_SmoothStepToS(&this->actor.world.rot.y, (Math_FAtan2F(tempSin, tempCos) * (0x8000 / M_PI)), 5,
                                   (this->unk_1EC * this->unk_1E8), 0);*/
                //Just not dealing with these vars -_-
        ...
        case 9:
            ...
            if (this->unk_1DA < 854) {
                for (i = 0; i < 2; i++) {
                    funcField_808C12C4(D_808C7000, this->unk_1CC);
        ...
        case 100:
            if ((this->unk_1DA < 0x2C6) && (Rand_ZeroOne() < 0.5f)) {
                ...
                sp68.y = (Rand_ZeroOne() * 50.0f) + this->actor.home.pos.y;
