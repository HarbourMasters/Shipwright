/*
 * File: z_bg_fieldsst_floor.c
 * Overlay: ovl_Bg_Sst_Floor
 * Description: Bongo Bongo's drum
 */

#include "z_bg_fieldsst_floor.h"
#include "objects/object_sst/object_sst.h"

#define FLAGS (ACTOR_FLAG_UPDATE_WHILE_CULLED | ACTOR_FLAG_DRAW_WHILE_CULLED)

void BgFieldSstFloor_Init(BgSstFloor* this, PlayState* play);
void BgFieldSstFloor_Destroy(BgSstFloor* this, PlayState* play);
void BgFieldSstFloor_Update(BgSstFloor* this, PlayState* play);
void BgFieldSstFloor_Draw(BgSstFloor* this, PlayState* play);

static s32 sUnkValues[] = { 0, 0, 0 }; // Unused, probably a zero vector

const ActorInit Bg_FieldSst_Floor_InitVars = {
    ACTOR_BG_SST_FLOOR,
    ACTORCAT_BG,
    FLAGS,
    OBJECT_SST,
    sizeof(BgSstFloor),
    (ActorFunc)BgFieldSstFloor_Init,
    (ActorFunc)BgFieldSstFloor_Destroy,
    (ActorFunc)BgFieldSstFloor_Update,
    (ActorFunc)BgFieldSstFloor_Draw,
    NULL,
};
...
void BgFieldSstFloor_Init(BgSstFloor* thisx, PlayState* play) {
    s32 pad;
...
void BgFieldSstFloor_Destroy(BgSstFloor* thisx, PlayState* play) {
    s32 pad;
    BgSstFloor* this = (BgSstFloor*)thisx;
...
void BgFieldSstFloor_Update(BgSstFloor* thisx, PlayState* play) {
    s32 pad;
    BgSstFloor* this = (BgSstFloor*)thisx;
...
void BgFieldSstFloor_Draw(BgSstFloor* thisx, PlayState* play) {
    BgSstFloor* this = (BgSstFloor*)thisx;
