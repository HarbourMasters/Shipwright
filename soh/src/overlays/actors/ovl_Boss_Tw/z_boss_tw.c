    ...
    if (this->actor.params == TW_KOTAKE) {
        ...
        if (Flags_GetClear(play, play->roomCtx.curRoom.num)) {
            ...
            if (GameInteractor_Should(VB_SPAWN_HEART_CONTAINER, true)) {
                Actor_Spawn(&play->actorCtx, play, ACTOR_ITEM_B_HEART, -600.0f, 230.0f, 0.0f, 0, 0, 0, 0, false);
            }
        } else {
            sKotakePtr =
    ...
    switch (this->csState2) {
        ...
        case 3:
            ...
            if (this->work[CS_TIMER_2] >= 1020) {
                ...
                if (GameInteractor_Should(VB_SPAWN_HEART_CONTAINER, true)) {
                    Actor_Spawn(&play->actorCtx, play, ACTOR_ITEM_B_HEART, -600.0f, 230.f, 0.0f, 0, 0, 0, 0, false);
                }
