...
void EnGs_Draw(Actor* thisx, PlayState* play) {
    ...
    if (!(this->unk_19E & 8)) {
        ...
        if (this->unk_19E & 4) {
            ...
            if (CVarGetInteger(COSMETIC_CVAR("World_GossipStone.Changed"), 0)) {
                Color_RGB8 color = CVarGetColor24(COSMETIC_CVAR("World_GossipStone.Value"), (Color_RGB8){255, 255, 255});
