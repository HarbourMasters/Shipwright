...
void KaleidoScope_UpdateItemEquip(PlayState* play) {
    ...
    //DPadItems
    if (CVarGetInteger("gDPadPosType", 0) != ANCHOR_NONE) {
    ...
    //C button Left
    if (CVarGetInteger("gCBtnLPosType", 0) != ANCHOR_NONE) {
    ...
    //C Button down
    if (CVarGetInteger("gCBtnDPosType", 0) != ANCHOR_NONE) {
    ...
    //C button Right
    if (CVarGetInteger("gCBtnRPosType", 0) != ANCHOR_NONE) {
