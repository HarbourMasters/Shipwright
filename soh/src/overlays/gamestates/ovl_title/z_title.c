...
void Title_Draw(TitleContext* this) {
    ...
    if (CVarGetInteger(COSMETIC_CVAR("Title_NintendoLogo.Changed"), 0)) {
        Color_RGB8 nintendoLogoColor = CVarGetColor24(COSMETIC_CVAR("Title_NintendoLogo.Value"), (Color_RGB8){0, 0, 255});
    ...
    sTitleRotY += (300 * CVarGetFloat(COSMETIC_CVAR("N64Logo_SpinSpeed"), 1.0f));
