...
void Select_PrintMenu(SelectContext* this, GfxPrint* printer) {
    ...
    for (i = 0; i < 20; i++) {
        ...
        if (CVarGetInteger(CVAR_DEVELOPER_TOOLS_DEBUG_WARP_SCREEN_TRANSLATION, 1)) {
    ...
    if (CVarGetInteger(CVAR_DEVELOPER_TOOLS_DEBUG_WARP_SCREEN_TRANSLATION, 1) && gSaveContext.language == LANGUAGE_GER) {
...
void Select_PrintCutsceneSetting(SelectContext* this, GfxPrint* printer, u16 csIndex) {
    ...
    char* label;
    int lang = CVarGetInteger(CVAR_DEVELOPER_TOOLS_DEBUG_WARP_SCREEN_TRANSLATION, 1) ? gSaveContext.language + 1 : 0;
...
void Select_Main(GameState* thisx) {
    ...
    if (this->isBetterWarp != CVarGetInteger(CVAR_DEVELOPER_TOOLS_BETTER_DEBUG_WARP_SCREEN, 0)) {
...
void Select_Init(GameState* thisx) {
    ...
    Select_SwitchBetterWarpMode(this, CVarGetInteger(CVAR_DEVELOPER_TOOLS_BETTER_DEBUG_WARP_SCREEN, 0));
}
