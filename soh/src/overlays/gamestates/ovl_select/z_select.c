...
static SceneSelectEntry sScenes[] = {
    ...
    { "23:" GFXP_KATAKANA "ﾊｲﾗﾙ" GFXP_HIRAGANA "ﾆﾜ" GFXP_KATAKANA "ｹﾞｰﾑ", "23:Castle Courtyard Game",
      "23:Burghof - Wachen", "23:Cour du Chateau (Infilration)", Select_LoadGame, 0x007A },
    ...
    { "34:" GFXP_KATAKANA "ﾛﾝﾛﾝ" GFXP_HIRAGANA "ﾎﾞｸｼﾞｮｳ ｿｳｺ 1", "34:Lon Lon Ranch House", "34:Lon Lon-Farm Haus",
      "34:Maison du Ranch Lon Lon", Select_LoadGame, 0x004F },
    { "35:" GFXP_KATAKANA "ﾛﾝﾛﾝ" GFXP_HIRAGANA "ﾎﾞｸｼﾞｮｳ ｿｳｺ 2", "35:Lon Lon Ranch Silo", "35:Lon Lon-Farm Silo",
      "35:Silo du Ranch Lon Lon", Select_LoadGame, 0x05D0 },
    ...
    { "38:" GFXP_HIRAGANA "ﾀｶﾗﾊﾞｺﾔ", "38:Treasure Chest Game", "38:Trhenlotterie", "38:Chasse aux Tresors",
      Select_LoadGame, 0x0063 },
    { "39:" GFXP_HIRAGANA "ｷﾝ " GFXP_KATAKANA "ｽﾀﾙﾁｭﾗ ﾊｳｽ", "39:House Of Skulltula", "39:Skulltulas Haus",
      "39:Maison des Skulltulas", Select_LoadGame, 0x0550 },
    { "40:" GFXP_HIRAGANA "ｼﾞｮｳｶﾏﾁ ｲﾘｸﾞﾁ", "40:Entrance to Market", "40:Eingang zum Marktplatz",
      "40:Entree de la Place du Marche", Select_LoadGame, 0x0033 },
    ...
    { "43:" GFXP_HIRAGANA "ﾄｷﾉｼﾝﾃﾞﾝ ﾏｴ", "43:Temple of Time Exterior", "43:Vor der Zitadelle der Zeit",
      "43:Exterieur du Temple du Temps", Select_LoadGame, 0x0171 },
    ...
    { "45:" GFXP_KATAKANA "ｶｶﾘｺ" GFXP_HIRAGANA "ﾑﾗﾉﾅｶﾞﾔ", "45:Kakariko House 1", "45:Kakariko Haus 1",
      "45:Maison du Village Cocorico 1", Select_LoadGame, 0x02FD },
    ...
    { "47:" GFXP_HIRAGANA "ｺｷﾘﾉﾑﾗ ﾓﾉｼﾘｷｮｳﾀﾞｲﾉｲｴ", "47:House of the Know-it-All Brothers",
      "47:Haus der Allwissenden Brueder", "47:Cabane des Freres Je-Sais-Tout", Select_LoadGame, 0x00C9 },
    ...
    { "61:" GFXP_KATAKANA "ｶｶﾘｺ" GFXP_HIRAGANA "ﾑﾗ  ｸｽﾘﾔ", "61:Closed Shop", "61:Geschlossener Laden",
      "61:Boutique Fermee", Select_LoadGame, 0x0384 },
    ...
    { "78:" GFXP_HIRAGANA "ﾋﾉｼﾝﾃﾞﾝ " GFXP_KATAKANA "ﾎﾞｽ", "78:Volvagia's Lair", "78:Volvagias Verlies",
      "78:Repaire de Volcania", Select_LoadGame, 0x0305 },
    ...
    { "115:" GFXP_KATAKANA "ﾊｲﾗﾙ ﾃﾞﾓ", "115:Goddess Cutscene Environment", "115:Goettinnen Cutscene Umgebung",
      "115:Carte de la scene des Deesses", Select_LoadGame, 0x00A0 },
    ...
    { "120:" GFXP_HIRAGANA "ﾁｭｳ" GFXP_KATAKANA "ｽﾀﾛﾌｫｽ" GFXP_HIRAGANA "ﾍﾞﾔ", "120:Stalfos Miniboss Room",
      "120:Stalfos-Ritter Miniboss Raum", "120:Salle de Miniboss Stalfos", Select_LoadGame, 0x001C },
    { "121:" GFXP_KATAKANA "ﾎﾞｽｽﾀﾛﾌｫｽ" GFXP_HIRAGANA "ﾍﾞﾔ", "121:Stalfos Boss Room", "121:Stalfos-Ritter Boss Raum",
      "121:Salle de Boss Stalfos", Select_LoadGame, 0x0020 },
    ...
    { "125:" GFXP_KATAKANA "ﾊｲﾗﾙ" GFXP_HIRAGANA "ﾆﾜ" GFXP_KATAKANA "ｹﾞｰﾑ2", "125:Hyrule Garden Game (Broken)",
      "125:Burghof - Wachen-Minispiel (Kaputt)", "125:Cour du Chateau (Non fonctionnel)", Select_LoadGame, 0x0076 },
...
static BetterSceneSelectEntry sBetterScenes[] = {
    ...
    { " 2:Kokiri Forest",
      ...
      9,
      {
          ...
          { "From Know-It-All Brothers House", "Vom Haus der Allwissenden Brueder",
            "Depuis la Cabane des Freres Je-Sais-Tout", 0x026A, 0 },
    ...
    { " 6:Castle Town Entrance",
      " 6:Eingang zum Marktplatz",
      " 6:Entree du Bourg d'Hyrule",
      Select_LoadGame,
      3,
      {
    ...
    { " 9:Castle Town Buildings",
      " 9:Marktplatz Gebaeude",
      " 9:Batiments du Bourg d'Hyrule",
      Select_LoadGame,
      10,
      {
    ...
    { "10:Temple of Time",
      "10:Zitadelle der Zeit",
      "10:Temple du Temps",
      Select_LoadGame,
      5,
      {
          { "From Outside", "Von draussen", "Depuis l'Entree", 0x053, 0 },
          { "From Master Sword Pedestal", "Vom Master-Schwert Podest", "Depuis le Piedestal de l'Epee de Legende",
            0x02CA, 0 },
          { "Prelude of Light Warp", "Kantate des Lichts Teleport", "Teleporteur du Prelude de la Lumiere", 0x05F4, 0 },
          { "Outside Temple of Time - From Market", "Vor der Zitadelle der Zeit - Vom Marktplatz",
            "Exterieur du Temple - Depuis la Place du Marche", 0x0171, 0 },
          { "Outside Temple of Time - From Temple of Time", "Vor der Zitadelle der Zeit - Von der Zitadelle der Zeit",
            "Exterieur du Temple - Depuis le Temple", 0x0472, 0 },
      } },
    { "11:Hyrule Castle",
      "11:Schloss Hyrule",
      "11:Chateau d'Hyrule",
    ...
    { "14:Lon Lon Ranch Buildings",
      "14:Lon Lon-Farm Gebaeude",
      "14:Batiments du Ranch Lon Lon",
      Select_LoadGame,
      3,
      {
    ...
    { "15:Kakariko Village",
      ...
      15,
      {
          ...
          { "From Potion Shop (Back Entrance)", "Vom Magie-Laden (Hintereingang)",
            "Depuis l'Apothicaire (Entree Arriere)", 0x04FF, 0 },
          ...
          { "Owl Drop Spot from Death Mountain", "Eulen-Absetzpunkt vom Todesberg",
            "Point de chute du Hibou depuis le Mont du Peril", 0x0554, 0 },
      } },
    { "16:Kakariko Buildings",
      "16:Kakariko Gebaeude",
      "16:Batiments du Village Cocorico",
      Select_LoadGame,
      9,
      {
    ...
    { "18:Graves",
      ...
      5,
      {
          ...
          { "Royal Familys Tomb, Suns Song Cutscene", "Koenigsgrab, Hymne der Sonne Cutscene",
            "Tombe Royale, Cinematique du Chant du Soleil", 0x0574, 0 },
          { "Treasure Chest Grave", "Schatzkisten Grab", "Tombe au Coffre", 0x004B, 0 },
          { "ReDead Grave", "Zombie Grab", "Tombe au Effrois", 0x031C, 0 },
      } },
    { "19:Death Mountain Trail",
      "19:Gebirgspfad",
      "19:Mont du Peril",
      Select_LoadGame,
      6,
    ...
    { "26:Lake Hylia Buildings",
      "26:Hylia-See Gebaeude",
      "26:Batiments du Lac Hylia",
      Select_LoadGame,
      2,
      {
    ...
    { "27:Gerudo Valley",
      ...
      5,
      {
          ...
          { "Carpenter's Tent/ Running Man Minigame", "Zelt der Zimmerleute/ Rennlaeufer Minispiel",
            "Tente du Charpentier/ Marathonien", 0x03A0, 0 },
          { "Thrown out of Fortress", "Aus der Festung geworfen", "Expulse de la Forteresse", 0x01A5, 0 },
      } },
    { "28:Gerudo Fortress",
      "28:Gerudo-Festung",
      "28:Forteresse Gerudo",
      Select_LoadGame,
      18,
      {
    ...
    { "31:Desert Colossus",
      ...
      7,
      {
          ...
          { "From Spirit Temple (Left Hand)", "Vom Geistertempel (Linke Hand)",
            "Depuis le Temple de l'Esprit (Main Gauche)", 0x01E5, 0 },
          { "From Spirit Temple (Right Hand)", "Vom Geistertempel (Rechte Hand)",
            "Depuis le Temple de l'Esprit (Main Droite)", 0x01E9, 0 },
    ...
    { "40:Ganons Castle",
      ...
      9,
      {
          ...
          { "Stairs to Lair - From Castle", "Stufen zum Verlies - Vom Schloss",
            "Escaliers vers Repaire - Depuis le Chateau", 0x041B, 0 },
          { "Stairs to Lair - From Ganondorf's Lair", "Stufen zum Verlies - Von Ganondorfs Verlies",
            "Escaliers vers Repaire - Depuis le Repaire de Ganondorf", 0x0427, 0 },
    ...
    { "41:Bottom of the Well",
      "41:Grund des Brunnens",
      "41:Puits",
      Select_LoadGame,
      1,
      {
    ...
    { "47:Chest Grottos",
      "47:Truhen Grotten",
      "47:Grottes a Coffres",
      Select_Grotto_LoadGame,
      11,
      {
          { "Kokiri Forest (Song of Storms)", "Kokiri-Wald (Hymne des Sturms)", "Foret Kokiri (Chant des Tempetes)",
            0x00, 0 },
          { "Lost Woods", "Verlorene Waelder", "Bois Perdus", 0x01, 0 },
          { "Sacred Forest Meadow", "Waldlichtung", "Bosquet Sacre", 0x02, 0 },
          { "Hyrule Field (Near Market)", "Hylianische Steppe (Nahe Marktplatz)",
            "Plaine d'Hyrule (Pres de la Place du Marche)", 0x03, 0 },
          { "Hyrule Field (Open Near Lake)", "Hylianische Steppe (Offen, beim Hylia-See)",
            "Plaine d'Hyrule (Deja ouverte pres du Lac)", 0x04, 0 },
          { "Hyrule Field (SE Boulder)", "Hylianische Steppe (Felsen, S-O)", "Plaine d'Hyrule (Rocher a Gantelets)",
            0x05, 0 },
          ...
          { "Death Mountain Trail (Song of Storms)", "Gebirgspfad (Hymne des Sturms)",
            "Mont du Peril (Chant des Tempetes)", 0x08, 0 },
    ...
    { "48:Scrub Grottos",
      "48:Laubkerl Grotten",
      "48:Grottes des Pestes Marchandes",
      Select_Grotto_LoadGame,
      10,
      {
          ...
          { "Zora River (Song of Storms)", "Zora-Fluss (Hymne des Sturms)", "Rivere Zora (Chant des Tempetes)", 0x11,
            0 },
          { "Sacred Forest Meadow (Song of Storms)", "Waldlichtung (Hymne des Sturms)",
            "Bosquet Scare (Chant des Tempetes)", 0x12, 0 },
          { "Gerudo Valley (Song of Storms)", "Gerudotal (Hymne des Sturms)", "Vallee Gerudo (Chant des Tempetes)",
            0x13, 0 },
    ...
    { "49:Other Grottos",
      ...
      7,
      {
          ...
          { "Spider Grotto (Hyrule Field)", "Spinnen-Grotte (Hylianische Steppe)", "Spider Araignee (Plaine d'Hyrule)",
            0x16, 0 },
          { "Spider Grotto (Hyrule Castle)", "Spinnen-Grotte (Schloss Hyrule)", "Grotte Araignee (Chateau d'Hyrule)",
            0x17, 0 },
          ...
          { "Cow Grotto (Death Mountain Trail)", "Kuh-Grotte (Gebirgspfad)", "Grotte a Vache (Chemin du Peril)", 0x19,
            0 },
          { "Flooded Grotto (Gerudo Valley)", "Geflutete Grotte (Gerudotal)", "Grotte Inondee (Vallee Gerudo)", 0x1A,
            0 },
          { "Flooded Grotto (Hyrule Field)", "Geflutete Grotte (Hylianische Steppe)",
            "Grotte Inondee (Plaine d'Hyrule)", 0x1B, 0 },
      } },
    { "50:Debug (Use with caution)",
      "50:Debug (Mit Vorsicht benutzen)",
      "50:Debug (A utiliser avec prudence)",
      Select_LoadGame,
      10,
      {
          ...
          { "Hyrule Garden Game (Broken)", "Burghof - Wachen-Minispiel (Kaputt)", "Cour du chateau (Non Fonctionnel)",
            0x0076, 0 },
      } },
};
    ...
    if (this->verticalInputAccumulator == 0) {
        ...
        if (CHECK_BTN_ALL(input->press.button, BTN_L)) {
            ...
            if (ResourceMgr_GameHasMasterQuest() && ResourceMgr_GameHasOriginal() &&
                ...
                if (this->opt) {
                    Audio_PlaySoundGeneral(NA_SE_IT_SWORD_PICKOUT, &D_801333D4, 4, &D_801333E0, &D_801333E0,
                                           &D_801333E8);
                } else {
