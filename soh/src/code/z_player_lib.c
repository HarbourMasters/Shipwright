...
void Player_DrawGetItemIceTrap(PlayState* play) {
    OPEN_DISPS(play->state.gfxCtx);
    ...
    gSPSegment(POLY_XLU_DISP++, 0x08,
               Gfx_TwoTexScrollEnvColor(play->state.gfxCtx, 0, 0, (0 - play->gameplayFrames) % 128, 32, 32, 1, 0,
                                        (play->gameplayFrames * -2) % 128, 32, 32, 0, 50, 100, 255));
