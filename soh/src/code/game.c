...
void func_800C4344(GameState* gameState) {
    ...
    if (CVarGetInteger(CVAR_DEVELOPER_TOOLS_REGEDIT_ENABLED, 0) || gIsCtrlr2Valid) {
...
void GameState_Draw(GameState* gameState, GraphicsContext* gfxCtx) {
    ...
    if (R_DISABLE_INPUT_DISPLAY == 0 && CVarGetInteger(CVAR_DEVELOPER_TOOLS_DEBUG_ENABLED, 0)) {
