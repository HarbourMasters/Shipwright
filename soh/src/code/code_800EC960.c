...
void func_800ED458(s32 arg0) {
    ...
    if ((D_8016BA10 == 0) ||
        ...
        if (D_8016BA18 & sOcarinaD4BtnMap && (!gSaveContext.n64ddFlag || Flags_GetRandomizerInf(RAND_INF_HAS_OCARINA_A))) {
            osSyncPrintf("Presss NA_KEY_D4 %08x\n", sOcarinaD4BtnMap);
            sCurOcarinaBtnVal = 2;
            sCurOcarinaBtnIdx = 0;
        } else if (D_8016BA18 & sOcarinaF4BtnMap && (!gSaveContext.n64ddFlag || Flags_GetRandomizerInf(RAND_INF_HAS_OCARINA_C_DOWN))) {
            osSyncPrintf("Presss NA_KEY_F4 %08x\n", sOcarinaF4BtnMap);
            sCurOcarinaBtnVal = 5;
            sCurOcarinaBtnIdx = 1;
        } else if (D_8016BA18 & sOcarinaA4BtnMap && (!gSaveContext.n64ddFlag || Flags_GetRandomizerInf(RAND_INF_HAS_OCARINA_C_RIGHT))) {
            osSyncPrintf("Presss NA_KEY_A4 %08x\n", sOcarinaA4BtnMap);
            sCurOcarinaBtnVal = 9;
            sCurOcarinaBtnIdx = 2;
        } else if (D_8016BA18 & sOcarinaB4BtnMap && (!gSaveContext.n64ddFlag || Flags_GetRandomizerInf(RAND_INF_HAS_OCARINA_C_LEFT))) {
            osSyncPrintf("Presss NA_KEY_B4 %08x\n", sOcarinaA4BtnMap);
            sCurOcarinaBtnVal = 0xB;
            sCurOcarinaBtnIdx = 3;
        } else if (D_8016BA18 & sOcarinaD5BtnMap && (!gSaveContext.n64ddFlag || Flags_GetRandomizerInf(RAND_INF_HAS_OCARINA_C_UP))) {
