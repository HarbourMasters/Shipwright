...
s32 OnePointCutscene_SetInfo(PlayState* play, s16 camIdx, s16 csId, Actor* actor, s16 timer) {
    ...
    switch (csId) {
        ...
        case 5010:
            ...
            Gameplay_CameraSetAtEye(play, camIdx, &mainCam->at, &mainCam->eye);
            csCam->roll = 0;
            break;
        case 9500:
        ...
        case 4500:
            ...
            Gameplay_CameraChangeSetting(play, camIdx, CAM_SET_FREE2);
            Gameplay_CameraSetAtEye(play, camIdx, &spC0, &spB4);
            func_8002DF54(play, NULL, 8);
            csCam->roll = 0;
            csCam->fov = 50.0f;
        ...
        case 1010:
            Gameplay_CameraChangeSetting(play, camIdx, CAM_SET_FREE2);
            Gameplay_CameraSetAtEye(play, camIdx, &childCam->at, &childCam->eye);
            Gameplay_CameraSetFov(play, camIdx, childCam->fov);
            Gameplay_SetCameraRoll(play, camIdx, childCam->roll);
            break;
        case 9601:
            Gameplay_CameraChangeSetting(play, camIdx, CAM_SET_CS_3);
            Gameplay_CameraChangeSetting(play, MAIN_CAM, mainCam->prevSetting);
        ...
        case 3170:
            ...
            Gameplay_CameraChangeSetting(play, camIdx, CAM_SET_FREE2);
            Gameplay_CameraSetAtEye(play, camIdx, &spC0, &spB4);
            Gameplay_CopyCamera(play, MAIN_CAM, camIdx);
            csCam->roll = -1;
            csCam->fov = 55.0f;
        ...
        case 3180:
            ...
            break;
        case 3190:
            Gameplay_CameraChangeSetting(play, camIdx, CAM_SET_FOREST_DEFEAT_POE);
        ...
        case 3230:
            ...
            spD0.r = 120.0f;
            OnePointCutscene_AddVecSphToVec3f(&spB4, &spC0, &spD0);
            Gameplay_CameraSetAtEye(play, MAIN_CAM, &spC0, &spB4);
        ...
        case 3390:
            ...
            break;
        case 3310:
            Gameplay_CameraChangeSetting(play, camIdx, CAM_SET_FIRE_STAIRCASE);
            func_8002DF54(play, NULL, 8);
            Gameplay_CopyCamera(play, camIdx, MAIN_CAM);
...
s16 OnePointCutscene_Init(PlayState* play, s16 csId, s16 timer, Actor* actor, s16 parentCamIdx) {
    ...
    csCamIdx = Gameplay_CreateSubCamera(play);
    ...
    if (parentCamIdx == MAIN_CAM) {
        Gameplay_ChangeCameraStatus(play, parentCamIdx, CAM_STAT_UNK3);
    } else {
        Gameplay_ChangeCameraStatus(play, parentCamIdx, CAM_STAT_WAIT);
    }
    OnePointCutscene_SetInfo(play, csCamIdx, csId, actor, timer);
    Gameplay_ChangeCameraStatus(play, csCamIdx, vCsStatus);
        ...
        if ((nextCsId / 100) < (thisCsId / 100)) {
            ...
            if (play->cameraPtrs[vNextCamIdx]->csId != 5010) {
                if ((vNextCamIdx = OnePointCutscene_RemoveCamera(play, vNextCamIdx)) != SUBCAM_NONE) {
                    Gameplay_ChangeCameraStatus(play, vNextCamIdx, CAM_STAT_ACTIVE);
                }
            } else {
