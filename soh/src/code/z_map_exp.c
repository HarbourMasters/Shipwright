        ...
        case SCENE_OUTSIDE_GANONS_CASTLE:
            ...
            if (play->sceneNum == SCENE_GRAVEYARD) {
                ...
                if ((LINK_AGE_IN_YEARS == YEARS_ADULT) &&
                    ((!IS_RANDO(gSaveContext) && !CHECK_QUEST_ITEM(QUEST_MEDALLION_WATER)) ||
                     (IS_RANDO(gSaveContext) && !Flags_GetRandomizerInf(RAND_INF_DUNGEONS_DONE_WATER_TEMPLE)))) {
                ...
                if ((!IS_RANDO(gSaveContext) && GET_EVENTCHKINF_CARPENTERS_FREE_ALL()) ||
                    (IS_RANDO(gSaveContext) && CHECK_QUEST_ITEM(QUEST_GERUDO_CARD))) {
