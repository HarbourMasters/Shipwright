    ...
    if (play->interfaceCtx.minimapAlpha >= 0xAA) {
        ...
        if (CVarGetInteger("gMinimapPosType", 0) != 0) {
            if (CVarGetInteger("gMinimapPosType", 0) == 1) { // Anchor Left
                ...
                Matrix_Translate(OTRGetDimensionFromRightEdge((tempXOffset + (X_Margins_Minimap * 10) + tempX +
                                                               (CVarGetInteger("gMinimapPosX", 0) * 10)) /
                                                              10.0f),
                                 (R_COMPASS_OFFSET_Y + ((Y_Margins_Minimap * 10) * -1) - tempZ +
                                  ((CVarGetInteger("gMinimapPosY", 0) * 10) * -1)) /
        ...
        if (CVarGetInteger("gMinimapPosType", 0) != 0) {
            if (CVarGetInteger("gMinimapPosType", 0) == 1) { // Anchor Left
                ...
                Matrix_Translate((tempXOffset + tempX + (CVarGetInteger("gMinimapPosX", 0) * 10) / 10.0f),
                                 (R_COMPASS_OFFSET_Y - tempZ + ((CVarGetInteger("gMinimapPosY", 0) * 10) * -1)) / 10.0f,
                                 0.0f, MTXMODE_NEW);
            }
        } else {
            Matrix_Translate(OTRGetDimensionFromRightEdge((tempXOffset + (X_Margins_Minimap * 10) + tempX) / 10.0f),
        ...
        Matrix_RotateY((sPlayerInitialDirection * (CVarGetInteger("gMirroredWorld", 0) ? -1 : 1)) / 10.0f,
                       MTXMODE_APPLY);
        gSPMatrix(OVERLAY_DISP++, MATRIX_NEWMTX(play->state.gfxCtx), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
                        ...
                        if (CVarGetInteger("gMinimapPosType", 0) != 0) {
                            ...
                            if (CVarGetInteger("gMinimapPosType", 0) == 1) { // Anchor Left
                                ...
                                dgnMiniMapX = OTRGetDimensionFromLeftEdge(
                                    R_DGN_MINIMAP_X + CVarGetInteger("gMinimapPosX", 0) + X_Margins_Minimap);
                            } else if (CVarGetInteger("gMinimapPosType", 0) == 2) { // Anchor Right
                                if (CVarGetInteger("gMinimapUseMargins", 0) != 0) {
                                    X_Margins_Minimap = Right_MM_Margin;
                                };
                ...
                if (!R_MINIMAP_DISABLED && CVarGetInteger("gMinimapPosType", 0) != 4) { // Not Hidden
                    ...
                    if (CVarGetInteger("gMinimapPosType", 0) != 0) {
                        ...
                        if (CVarGetInteger("gMinimapPosType", 0) == 1) { // Anchor Left
                            ...
                            oWMiniMapX = OTRGetDimensionFromLeftEdge(
                                R_OW_MINIMAP_X + CVarGetInteger("gMinimapPosX", 0) + X_Margins_Minimap);
                        } else if (CVarGetInteger("gMinimapPosType", 0) == 2) { // Anchor Right
                            if (CVarGetInteger("gMinimapUseMargins", 0) != 0) {
                                X_Margins_Minimap = Right_MM_Margin;
                            };
                    ...
                    if (((play->sceneNum != SCENE_KAKARIKO_VILLAGE) && (play->sceneNum != SCENE_KOKIRI_FOREST) &&
                        ...
                        if (CVarGetInteger("gMinimapPosType", 0) != 0) {
                            ...
                            if (CVarGetInteger("gMinimapPosType", 0) == 1) { // Anchor Left
                                ...
                                entranceX = OTRGetRectDimensionFromLeftEdge(newX + X_Margins_Minimap +
                                                                            CVarGetInteger("gMinimapPosX", 0));
                            } else if (CVarGetInteger("gMinimapPosType", 0) == 2) { // Anchor Right
                                if (CVarGetInteger("gMinimapUseMargins", 0) != 0) {
                                    X_Margins_Minimap = Right_MM_Margin;
                                };
                                entranceX = OTRGetRectDimensionFromRightEdge(newX + X_Margins_Minimap +
                                                                             CVarGetInteger("gMinimapPosX", 0));
                            } else if (CVarGetInteger("gMinimapPosType", 0) == 3) { // Anchor None
                        ...
                        if (gMapData->owEntranceIconPosY[sEntranceIconMapIndex] == 0) {
                            entranceY = 0;
                            entranceX = CVarGetInteger("gFixDungeonMinimapIcon", 0)
                                            ? -9999
                    ...
                    if (CVarGetInteger("gMinimapPosType", 0) != 0) {
                        ...
                        if (CVarGetInteger("gMinimapPosType", 0) == 1) { // Anchor Left
                            ...
                            entranceX = OTRGetRectDimensionFromLeftEdge(origX + X_Margins_Minimap +
                                                                        CVarGetInteger("gMinimapPosX", 0));
                        } else if (CVarGetInteger("gMinimapPosType", 0) == 2) { // Anchor Right
                            if (CVarGetInteger("gMinimapUseMargins", 0) != 0) {
                                X_Margins_Minimap = Right_MM_Margin;
                            };
                            entranceX = OTRGetRectDimensionFromRightEdge(origX + X_Margins_Minimap +
                                                                         CVarGetInteger("gMinimapPosX", 0));
                        } else if (CVarGetInteger("gMinimapPosType", 0) == 3) { // Anchor None
