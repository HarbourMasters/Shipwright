...
void Message_ResetOcarinaNoteState(void) {
    ...
    if (CVarGetInteger(COSMETIC_CVAR("Hud_ButtonA.Changed"), 0)) {
        sOcarinaNoteABtnPrim = CVarGetColor24(COSMETIC_CVAR("Hud_ButtonA.Value"), sOcarinaNoteABtnPrim);
    } else if (CVarGetInteger(COSMETIC_CVAR("DefaultColorScheme"), COLORSCHEME_N64) == COLORSCHEME_GAMECUBE) {
        sOcarinaNoteABtnPrim = (Color_RGB8){ 80, 255, 150 };
    }
    if (CVarGetInteger(COSMETIC_CVAR("Hud_CButtons.Changed"), 0)) {
        sOcarinaNoteCBtnPrim = CVarGetColor24(COSMETIC_CVAR("Hud_CButtons.Value"), sOcarinaNoteCBtnPrim);
    }
    ...
    if (CVarGetInteger(COSMETIC_CVAR("Hud_ButtonCUp.Changed"), 0)) {
        sOcarinaNoteCUpBtnPrim = CVarGetColor24(COSMETIC_CVAR("Hud_ButtonCUp.Value"), sOcarinaNoteCUpBtnPrim);
    }
    if (CVarGetInteger(COSMETIC_CVAR("Hud_ButtonCDown.Changed"), 0)) {
        sOcarinaNoteCDownBtnPrim = CVarGetColor24(COSMETIC_CVAR("Hud_ButtonCDown.Value"), sOcarinaNoteCDownBtnPrim);
    }
    if (CVarGetInteger(COSMETIC_CVAR("Hud_ButtonCLeft.Changed"), 0)) {
        sOcarinaNoteCLeftBtnPrim = CVarGetColor24(COSMETIC_CVAR("Hud_ButtonCLeft.Value"), sOcarinaNoteCLeftBtnPrim);
    }
    if (CVarGetInteger(COSMETIC_CVAR("Hud_ButtonCRight.Changed"), 0)) {
        sOcarinaNoteCRightBtnPrim = CVarGetColor24(COSMETIC_CVAR("Hud_ButtonCRight.Value"), sOcarinaNoteCRightBtnPrim);
    }
}
...
void Message_DrawTextboxIcon(PlayState* play, Gfx** p, s16 x, s16 y) {
    ...
    if (CVarGetInteger(COSMETIC_CVAR("Hud_ButtonA.Changed"), 0)) {
        Color_RGB8 color = CVarGetColor24(COSMETIC_CVAR("Hud_ButtonA.Value"), (Color_RGB8){ 50, 130, 255 });
...
void Message_DrawMain(PlayState* play, Gfx** p) {
    ...
    if (CVarGetInteger(COSMETIC_CVAR("Hud_ButtonA.Changed"), 0)) {
        Color_RGB8 color = CVarGetColor24(COSMETIC_CVAR("Hud_ButtonA.Value"), (Color_RGB8){ 100, 200, 255 });
    ...
    if (CVarGetInteger(COSMETIC_CVAR("Hud_CButtons.Changed"), 0)) {
        Color_RGB8 color = CVarGetColor24(COSMETIC_CVAR("Hud_CButtons.Value"), (Color_RGB8){ 100, 200, 255 });
    ...
    if (CVarGetInteger(COSMETIC_CVAR("Hud_ButtonCUp.Changed"), 0)) {
        Color_RGB8 color = CVarGetColor24(COSMETIC_CVAR("Hud_ButtonCUp.Value"), (Color_RGB8){ 100, 200, 255 });
    ...
    if (CVarGetInteger(COSMETIC_CVAR("Hud_ButtonCDown.Changed"), 0)) {
        Color_RGB8 color = CVarGetColor24(COSMETIC_CVAR("Hud_ButtonCDown.Value"), (Color_RGB8){ 100, 200, 255 });
    ...
    if (CVarGetInteger(COSMETIC_CVAR("Hud_ButtonCLeft.Changed"), 0)) {
        Color_RGB8 color = CVarGetColor24(COSMETIC_CVAR("Hud_ButtonCLeft.Value"), (Color_RGB8){ 100, 200, 255 });
    ...
    if (CVarGetInteger(COSMETIC_CVAR("Hud_ButtonCRight.Changed"), 0)) {
        Color_RGB8 color = CVarGetColor24(COSMETIC_CVAR("Hud_ButtonCRight.Value"), (Color_RGB8){ 100, 200, 255 });
