...
static inline uint32_t read_CMD_BBBB(std::shared_ptr<ShipDK::BinaryReader> reader) {
    uint32_t v;
...
static inline uint32_t read_CMD_BBH(std::shared_ptr<ShipDK::BinaryReader> reader) {
    uint32_t v;
    reader->Read((char*)&v, sizeof(uint32_t));

    // swap the half word to match endianness
    if (reader->GetEndianness() != ShipDK::Endianness::Native) {
        uint8_t* b = (uint8_t*)&v;
        uint8_t tmp = b[2];
        b[2] = b[3];
        b[3] = tmp;
...
static inline uint32_t read_CMD_HBB(std::shared_ptr<ShipDK::BinaryReader> reader) {
    uint32_t v;
    reader->Read((char*)&v, sizeof(uint32_t));
...
static inline uint32_t read_CMD_HH(std::shared_ptr<ShipDK::BinaryReader> reader) {
    uint32_t v;
    reader->Read((char*)&v, sizeof(uint32_t));
...
namespace SOH {
std::shared_ptr<ShipDK::IResource> ResourceFactoryBinaryCutsceneV0::ReadResource(std::shared_ptr<ShipDK::File> file) {
