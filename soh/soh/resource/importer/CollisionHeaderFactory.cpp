...
namespace SOH {
std::shared_ptr<ShipDK::IResource> ResourceFactoryBinaryCollisionHeaderV0::ReadResource(std::shared_ptr<ShipDK::File> file) {
...
std::shared_ptr<ShipDK::IResource> ResourceFactoryXMLCollisionHeaderV0::ReadResource(std::shared_ptr<ShipDK::File> file) {
    if (!FileHasValidFormatAndReader(file)) {
        return nullptr;
    }
