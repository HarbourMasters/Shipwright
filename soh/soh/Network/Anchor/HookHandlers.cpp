...
void Anchor::RegisterHooks() {
    ...
    COND_ID_HOOK(OnActorUpdate, ACTOR_EN_ITEM00, isConnected, [](IEvent* event) {
        OnActorUpdate* ev = reinterpret_cast<OnActorUpdate*>(event);
        EnItem00* actor = static_cast<EnItem00*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_BG_BOMBWALL, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        BgBombwall* actor = static_cast<BgBombwall*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_BG_BREAKWALL, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        BgBreakwall* actor = static_cast<BgBreakwall*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_BG_HAKA_ZOU, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        BgHakaZou* actor = static_cast<BgHakaZou*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_BG_HIDAN_HAMSTEP, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        BgHidanHamstep* actor = static_cast<BgHidanHamstep*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_BG_HIDAN_HROCK, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        BgHidanHrock* actor = static_cast<BgHidanHrock*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_BG_ICE_SHELTER, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        BgIceShelter* actor = static_cast<BgIceShelter*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_BG_JYA_BOMBCHUIWA, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        BgJyaBombchuiwa* actor = static_cast<BgJyaBombchuiwa*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_BG_JYA_BOMBIWA, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        BgJyaBombiwa* actor = static_cast<BgJyaBombiwa*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_BG_MIZU_BWALL, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        BgMizuBwall* actor = static_cast<BgMizuBwall*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_BG_SPOT08_BAKUDANKABE, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        BgSpot08Bakudankabe* actor = static_cast<BgSpot08Bakudankabe*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_BG_SPOT11_BAKUDANKABE, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        BgSpot11Bakudankabe* actor = static_cast<BgSpot11Bakudankabe*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_BG_SPOT17_BAKUDANKABE, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        BgSpot17Bakudankabe* actor = static_cast<BgSpot17Bakudankabe*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_BG_YDAN_MARUTA, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        BgYdanMaruta* actor = static_cast<BgYdanMaruta*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_BG_YDAN_SP, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        BgYdanSp* actor = static_cast<BgYdanSp*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_DOOR_SHUTTER, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        DoorShutter* actor = static_cast<DoorShutter*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_EN_DOOR, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        EnDoor* actor = static_cast<EnDoor*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_EN_SI, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        EnSi* actor = static_cast<EnSi*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_EN_SW, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        EnSw* actor = static_cast<EnSw*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_ITEM_B_HEART, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        ItemBHeart* actor = static_cast<ItemBHeart*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_OBJ_BOMBIWA, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        ObjBombiwa* actor = static_cast<ObjBombiwa*>(ev->actor);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_OBJ_HAMISHI, isConnected, [](IEvent* event) {
        ShouldActorUpdate* ev = reinterpret_cast<ShouldActorUpdate*>(event);
        ObjHamishi* actor = static_cast<ObjHamishi*>(ev->actor);
