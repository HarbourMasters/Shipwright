...
void SohMenu::AddMenuEnhancements() {
    ...
    AddWidget(path, "Unequip Items on Re-press", WIDGET_CVAR_CHECKBOX)
        .CVar(CVAR_ENHANCEMENT("ItemUnequip"))
        .Options(CheckboxOptions().Tooltip(
            "Allows unequipping items by hovering over an equipped item and pressing the button it's equipped to."));
