...
#define CVAR_RANDOMIZER_ENHANCEMENT_RELEVANT_NAVI CVAR_RANDOMIZER_ENHANCEMENT("RandoRelevantNavi")
#define CVAR_RANDOMIZER_ENHANCEMENT_RUPEE_NAMES CVAR_RANDOMIZER_ENHANCEMENT("RandomizeRupeeNames")
#define CVAR_RANDOMIZER_ENHANCEMENT_MATCH_KEY_COLORS CVAR_RANDOMIZER_ENHANCEMENT("MatchKeyColors")
#define CVAR_RANDOMIZER_ENHANCEMENT_QUEST_ITEM_FANFARES CVAR_RANDOMIZER_ENHANCEMENT("QuestItemFanfares")
