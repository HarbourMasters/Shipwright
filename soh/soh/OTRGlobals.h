...
bool Randomizer_CheckAPLocationCheckedFromActor(s16 actorId, s16 sceneNum, s16 actorParams);
bool Randomizer_CheckAPLocationChecked(RandomizerCheck check);
void Randomizer_SendAPItemFromActor(s16 actorId, s16 sceneNum, s16 actorParams);
...
void Randomizer_SendAPItemFromKnownCheck(RandomizerCheck check);
