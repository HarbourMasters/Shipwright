...
#define CVAR_DEVELOPER_TOOLS_DEBUG_ENABLED CVAR_DEVELOPER_TOOLS("DebugEnabled")
#define CVAR_DEVELOPER_TOOLS_DEBUG_ENABLED_SKULLTULA CVAR_DEVELOPER_TOOLS("SkulltulaDebugEnabled")
#define CVAR_DEVELOPER_TOOLS_DEBUG_SAVE_FILE_MODE CVAR_DEVELOPER_TOOLS("DebugSaveFileMode")
#define CVAR_DEVELOPER_TOOLS_DEBUG_WARP_SCREEN_TRANSLATION CVAR_DEVELOPER_TOOLS("DebugWarpScreenTranslation")
#define CVAR_DEVELOPER_TOOLS_BETTER_DEBUG_WARP_SCREEN CVAR_DEVELOPER_TOOLS("BetterDebugWarpScreen")
#define CVAR_DEVELOPER_TOOLS_REGEDIT_ENABLED CVAR_DEVELOPER_TOOLS("RegEditEnabled")
#define CVAR_DEVELOPER_TOOLS_RESOURCE_LOGGING CVAR_DEVELOPER_TOOLS("ResourceLogging")
#define CVAR_DEVELOPER_TOOLS_SAVE_FILE_ID CVAR_DEVELOPER_TOOLS("SaveFileID")
#define CVAR_DEVELOPER_TOOLS_SKIP_LOGO_TITLE CVAR_DEVELOPER_TOOLS("SkipLogoTitle")
