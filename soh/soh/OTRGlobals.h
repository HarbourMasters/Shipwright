...
#define CVAR_RANDOMIZER_ENHANCEMENT(var) CVAR_BLOCK_RANDOMIZER_ENHANCEMENT "." var
#define CVAR_RANDOMIZER_SETTING(var) CVAR_BLOCK_RANDOMIZER_SETTING "." var
#define CVAR_COSMETIC(var) CVAR_BLOCK_COSMETIC "." var
#define CVAR_AUDIO(var) CVAR_BLOCK_AUDIO "." var
#define CVAR_CHEAT(var) CVAR_BLOCK_CHEAT "." var
#define CVAR_ENHANCEMENT(var) CVAR_BLOCK_ENHANCEMENT "." var
#define CVAR_SETTING(var) CVAR_BLOCK_SETTING "." var
#define CVAR_WINDOW(var) CVAR_BLOCK_WINDOW "." var
#define CVAR_TRACKER(var) CVAR_BLOCK_TRACKER "." var
...
#define CVAR_DEVELOPER_TOOLS(var) CVAR_BLOCK_DEVELOPER_TOOLS "." var
#define CVAR_GENERAL(var) CVAR_BLOCK_GENERAL "." var
#define CVAR_REMOTE(var) CVAR_BLOCK_REMOTE "." var
