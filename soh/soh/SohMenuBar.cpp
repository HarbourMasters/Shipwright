    ...
    if (ImGui::BeginMenu("Enhancements"))
    {
        ...
        if (ImGui::BeginMenu("Gameplay"))
        {
            if (ImGui::BeginMenu("Time Savers"))
            {
                ...
                UIWidgets::PaddedEnhancementCheckbox("Bridge Open At Night", CVAR_ENHANCEMENT("BridgeOpenAtNight"), true, false);
                UIWidgets::Tooltip("Makes the bridge to Hyrule Market stay open at night.");
                const bool bBridgeOpenAtNightEnabled = CVarGetInteger(CVAR_ENHANCEMENT("BridgeOpenAtNight"), 0);
