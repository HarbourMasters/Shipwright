    ...
    if (ImGui::BeginMenu("Enhancements"))
    {
        ...
        if (ImGui::BeginMenu("Gameplay"))
        {
            ...
            if (ImGui::BeginMenu("Items"))
            {
                ...
                UIWidgets::PaddedEnhancementCheckbox("Keep Bunny Hood through time", "gKeepBunnyHoodThroughTime", true, false, !CVarGetInteger("gAdultBunnyHood", 0), "Only available with \"Bunny Hood Equippable as Adult\"", UIWidgets::CheckboxGraphics::Cross, false);
                ...
                UIWidgets::PaddedEnhancementCheckbox("Keep mask on death", "gKeepMasksOnDeath", true, false);
