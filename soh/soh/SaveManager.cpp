...
void SaveManager::LoadRandomizer() {
    ...
    SaveManager::Instance->LoadData("bombchuUpgradeLevel",
...
void SaveManager::SaveRandomizer(SaveContext* saveContext, int sectionID, bool fullSave) {
    ...
    SaveManager::Instance->SaveData("bombchuUpgradeLevel",
                                    saveContext->ship.quest.data.randomizer.bombchuUpgradeLevel);
