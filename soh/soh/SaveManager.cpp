...
std::filesystem::path SaveManager::GetFileName(int fileNum) {
    const std::filesystem::path sSavePath(ShipDK::Context::GetPathRelativeToAppDirectory("Save"));
...
void SaveManager::Init() {
    ...
    auto sOldSavePath = ShipDK::Context::GetPathRelativeToAppDirectory("oot_save.sav");
    auto sOldBackupSavePath = ShipDK::Context::GetPathRelativeToAppDirectory("oot_save.bak");
...
void SaveManager::LoadFile(int fileNum) {
    ...
    try {
        ...
        input.close();
        std::filesystem::path newFile(ShipDK::Context::GetPathRelativeToAppDirectory("Save") + ("/file" + std::to_string(fileNum + 1) + "-" + std::to_string(GetUnixTimestamp()) + ".bak"));
#if defined(__SWITCH__) || defined(__WIIU__)
