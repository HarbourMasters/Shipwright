...
static std::unordered_map<u16, u16> uniqueEnemyIdToStatCount = {
    ...
    //{ ACTOR_EN_BB,         COUNT_ENEMIES_DEFEATED_BUBBLE_GREEN },
    //{ ACTOR_EN_BB,         COUNT_ENEMIES_DEFEATED_BUBBLE_BLUE },
    //{ ACTOR_EN_BB,         COUNT_ENEMIES_DEFEATED_BUBBLE_WHITE },
    //{ ACTOR_EN_BB,         COUNT_ENEMIES_DEFEATED_BUBBLE_RED },
    ...
    //{ ACTOR_EN_DEKUBABA,   COUNT_ENEMIES_DEFEATED_DEKU_BABA },
    //{ ACTOR_EN_DEKUBABA,   COUNT_ENEMIES_DEFEATED_DEKU_BABA_BIG },
    { ACTOR_EN_HINTNUTS,   COUNT_ENEMIES_DEFEATED_DEKU_SCRUB },
    //{ ACTOR_EN_ZF,         COUNT_ENEMIES_DEFEATED_DINOLFOS },
    ...
    //{ ACTOR_EN_RD,         COUNT_ENEMIES_DEFEATED_GIBDO },
    { ACTOR_EN_GOMA,       COUNT_ENEMIES_DEFEATED_GOHMA_LARVA },
    { ACTOR_EN_CROW,       COUNT_ENEMIES_DEFEATED_GUAY },
    //{ ACTOR_EN_IK,         COUNT_ENEMIES_DEFEATED_IRON_KNUCKLE },
    //{ ACTOR_EN_IK,         COUNT_ENEMIES_DEFEATED_IRON_KNUCKLE_NABOORU },
    //{ ACTOR_EN_FIREFLY,    COUNT_ENEMIES_DEFEATED_KEESE },
    //{ ACTOR_EN_FIREFLY,    COUNT_ENEMIES_DEFEATED_KEESE_FIRE },
    //{ ACTOR_EN_FIREFLY,    COUNT_ENEMIES_DEFEATED_KEESE_ICE },
    //{ ACTOR_EN_REEBA,      COUNT_ENEMIES_DEFEATED_LEEVER },
    //{ ACTOR_EN_REEBA,      COUNT_ENEMIES_DEFEATED_LEEVER_BIG },
    { ACTOR_EN_RR,         COUNT_ENEMIES_DEFEATED_LIKE_LIKE },
    //{ ACTOR_EN_ZF,         COUNT_ENEMIES_DEFEATED_LIZALFOS },
    { ACTOR_EN_DEKUNUTS,   COUNT_ENEMIES_DEFEATED_MAD_SCRUB },
    //{ ACTOR_EN_MB,         COUNT_ENEMIES_DEFEATED_MOBLIN },
    //{ ACTOR_EN_MB,         COUNT_ENEMIES_DEFEATED_MOBLIN_CLUB },
    { ACTOR_EN_OKUTA,      COUNT_ENEMIES_DEFEATED_OCTOROK },
    { ACTOR_EN_BA,         COUNT_ENEMIES_DEFEATED_PARASITIC_TENTACLE },
    //{ ACTOR_EN_PEEHAT,     COUNT_ENEMIES_DEFEATED_PEAHAT },
    //{ ACTOR_EN_PEEHAT,     COUNT_ENEMIES_DEFEATED_PEAHAT_LARVA },
    //{ ACTOR_EN_POH,        COUNT_ENEMIES_DEFEATED_POE },
    //{ ACTOR_EN_PO_FIELD,   COUNT_ENEMIES_DEFEATED_POE_BIG },
    //{ ACTOR_EN_POH,        COUNT_ENEMIES_DEFEATED_POE_COMPOSER },
    { ACTOR_EN_PO_SISTERS, COUNT_ENEMIES_DEFEATED_POE_SISTERS },
    //{ ACTOR_EN_RD,         COUNT_ENEMIES_DEFEATED_REDEAD },
    { ACTOR_EN_BUBBLE,     COUNT_ENEMIES_DEFEATED_SHABOM },
    { ACTOR_EN_SB,         COUNT_ENEMIES_DEFEATED_SHELLBLADE },
    //{ ACTOR_EN_ST,         COUNT_ENEMIES_DEFEATED_SKULLTULA },
    //{ ACTOR_EN_ST,         COUNT_ENEMIES_DEFEATED_SKULLTULA_BIG },
    //{ ACTOR_EN_SW,         COUNT_ENEMIES_DEFEATED_SKULLTULA_GOLD },
    //{ ACTOR_EN_SW,         COUNT_ENEMIES_DEFEATED_SKULLWALLTULA },
    ...
    //{ ACTOR_EN_TP,         COUNT_ENEMIES_DEFEATED_TAILPASARAN },
    //{ ACTOR_EN_TITE,       COUNT_ENEMIES_DEFEATED_TEKTITE_BLUE },
    //{ ACTOR_EN_TITE,       COUNT_ENEMIES_DEFEATED_TEKTITE_RED },
    ...
    //{ ACTOR_EN_WF,         COUNT_ENEMIES_DEFEATED_WOLFOS },
    //{ ACTOR_EN_WF,         COUNT_ENEMIES_DEFEATED_WOLFOS_WHITE },
};
