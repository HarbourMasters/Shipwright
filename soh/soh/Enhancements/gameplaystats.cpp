...
void SetupDisplayNames() {
    ...
    // Rando items
    strcpy(itemTimestampDisplayName[TIMESTAMP_FOUND_GOHMA_SOUL],                       "Gohma Soul:         ");
    strcpy(itemTimestampDisplayName[TIMESTAMP_FOUND_KING_DODONGO_SOUL],                "Dodongo Soul:       ");
    strcpy(itemTimestampDisplayName[TIMESTAMP_FOUND_BARINADE_SOUL],                    "Barinade Soul:      ");
    strcpy(itemTimestampDisplayName[TIMESTAMP_FOUND_PHANTOM_GANON_SOUL],               "Phantom Ganon Soul: ");
    strcpy(itemTimestampDisplayName[TIMESTAMP_FOUND_VOLVAGIA_SOUL],                    "Volvagia Soul:      ");
    strcpy(itemTimestampDisplayName[TIMESTAMP_FOUND_MORPHA_SOUL],                      "Morpha Soul:        ");
    strcpy(itemTimestampDisplayName[TIMESTAMP_FOUND_BONGO_BONGO_SOUL],                 "Bongo Bongo Soul:   ");
    strcpy(itemTimestampDisplayName[TIMESTAMP_FOUND_TWINROVA_SOUL],                    "Twinrova Soul:      ");
    strcpy(itemTimestampDisplayName[TIMESTAMP_FOUND_GANON_SOUL],                       "Ganon Soul:         ");
    strcpy(itemTimestampDisplayName[TIMESTAMP_FOUND_OCARINA_A_BUTTON],                 "Ocarina A Button:   ");
    strcpy(itemTimestampDisplayName[TIMESTAMP_FOUND_OCARINA_C_UP_BUTTON],              "Ocarina C-Up:       ");
    strcpy(itemTimestampDisplayName[TIMESTAMP_FOUND_OCARINA_C_DOWN_BUTTON],            "Ocarina C-Down:     ");
    strcpy(itemTimestampDisplayName[TIMESTAMP_FOUND_OCARINA_C_LEFT_BUTTON],            "Ocarina C-Left:     ");
    strcpy(itemTimestampDisplayName[TIMESTAMP_FOUND_OCARINA_C_RIGHT_BUTTON],           "Ocarina C-Right:    ");
    ...
    strcpy(itemTimestampDisplayName[TIMESTAMP_FOUND_CHILD_WALLET],                     "Child Wallet:       ");
