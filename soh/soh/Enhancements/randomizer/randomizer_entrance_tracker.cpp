...
void DrawEntranceTracker(bool& open) {
    ...
    for (size_t i = 0; i < groupCount; i++) {
        ...
        for (size_t entranceIdx = 0; entranceIdx < entranceCount; entranceIdx++) {
            ...
            bool showOriginal = CVar_GetS32("gEntranceTrackerShowTo", 0) || isDiscovered;
            bool showOverride = CVar_GetS32("gEntranceTrackerShowFrom", 0) || isDiscovered;
            ...
            if (locationSearch.PassFilter(origSrcName) || locationSearch.PassFilter(origDstName) ||
                locationSearch.PassFilter(rplcSrcName) || locationSearch.PassFilter(rplcDstName)) {
