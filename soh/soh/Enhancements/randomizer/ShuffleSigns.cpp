...
locationTable[RC_LH_WARP_WATER_SWITCH_RECTANGLE_SIGN]                   = Location::Sign(RC_LH_WARP_WATER_SWITCH_RECTANGLE_SIGN,                    RCQUEST_BOTH,       RCAREA_LAKE_HYLIA,              SCENE_LAKE_HYLIA,               TWO_ACTOR_PARAMS(-970, 6954),       "Warp Water Switch Rectangle Sign",                 RHT_SIGN_LAKE_HYLIA,            ACTOR_EN_KANBAN,            SpoilerCollectionCheck::RandomizerInf(RAND_INF_LH_WARP_WATER_SWITCH_RECTANGLE_SIGN));
locationTable[RC_LH_FISHING_WATER_SWITCH_RECTANGLE_SIGN]                = Location::Sign(RC_LH_FISHING_WATER_SWITCH_RECTANGLE_SIGN,                 RCQUEST_BOTH,       RCAREA_LAKE_HYLIA,              SCENE_LAKE_HYLIA,               TWO_ACTOR_PARAMS(1320, 3951),       "Fishing Water Switch Rectangle Sign",              RHT_SIGN_LAKE_HYLIA,            ACTOR_EN_KANBAN,            SpoilerCollectionCheck::RandomizerInf(RAND_INF_LH_FISHING_WATER_SWITCH_RECTANGLE_SIGN));
