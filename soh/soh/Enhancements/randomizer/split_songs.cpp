...
static constexpr uint32_t kSplitSongPart2Flags[SPLIT_SONG_MAX] = {
    RAND_INF_SPLIT_ZL_PART2,      RAND_INF_SPLIT_EPONA_PART2,    RAND_INF_SPLIT_SARIA_PART2,
    RAND_INF_SPLIT_SUN_PART2,     RAND_INF_SPLIT_TIME_PART2,     RAND_INF_SPLIT_STORMS_PART2,
    RAND_INF_SPLIT_MINUET_PART2,  RAND_INF_SPLIT_BOLERO_PART2,   RAND_INF_SPLIT_SERENADE_PART2,
    RAND_INF_SPLIT_REQUIEM_PART2, RAND_INF_SPLIT_NOCTURNE_PART2, RAND_INF_SPLIT_PRELUDE_PART2,
};
