...
std::unordered_map<RandomizerGet, SongData> StaticData::songData = {
    { RG_PROGRESSIVE_ZELDAS_LULLABY,
      { RG_ZELDAS_LULLABY, RG_PART_OF_ZELDAS_LULLABY, RAND_INF_SPLIT_ZL_PART, QUEST_SONG_LULLABY } },
    { RG_PROGRESSIVE_EPONAS_SONG,
      { RG_EPONAS_SONG, RG_PART_OF_EPONAS_SONG, RAND_INF_SPLIT_EPONA_PART, QUEST_SONG_EPONA } },
    { RG_PROGRESSIVE_SARIAS_SONG,
      { RG_SARIAS_SONG, RG_PART_OF_SARIAS_SONG, RAND_INF_SPLIT_SARIA_PART, QUEST_SONG_SARIA } },
    { RG_PROGRESSIVE_SUNS_SONG, { RG_SUNS_SONG, RG_PART_OF_SUNS_SONG, RAND_INF_SPLIT_SUN_PART, QUEST_SONG_SUN } },
    { RG_PROGRESSIVE_SONG_OF_TIME,
      { RG_SONG_OF_TIME, RG_PART_OF_SONG_OF_TIME, RAND_INF_SPLIT_TIME_PART, QUEST_SONG_TIME } },
    { RG_PROGRESSIVE_SONG_OF_STORMS,
      { RG_SONG_OF_STORMS, RG_PART_OF_SONG_OF_STORMS, RAND_INF_SPLIT_STORMS_PART, QUEST_SONG_STORMS } },
    { RG_PROGRESSIVE_MINUET_OF_FOREST,
      { RG_MINUET_OF_FOREST, RG_PART_OF_MINUET_OF_FOREST, RAND_INF_SPLIT_MINUET_PART, QUEST_SONG_MINUET } },
    { RG_PROGRESSIVE_BOLERO_OF_FIRE,
      { RG_BOLERO_OF_FIRE, RG_PART_OF_BOLERO_OF_FIRE, RAND_INF_SPLIT_BOLERO_PART, QUEST_SONG_BOLERO } },
    { RG_PROGRESSIVE_SERENADE_OF_WATER,
      { RG_SERENADE_OF_WATER, RG_PART_OF_SERENADE_OF_WATER, RAND_INF_SPLIT_SERENADE_PART, QUEST_SONG_SERENADE } },
    { RG_PROGRESSIVE_REQUIEM_OF_SPIRIT,
      { RG_REQUIEM_OF_SPIRIT, RG_PART_OF_REQUIEM_OF_SPIRIT, RAND_INF_SPLIT_REQUIEM_PART, QUEST_SONG_REQUIEM } },
    { RG_PROGRESSIVE_NOCTURNE_OF_SHADOW,
      { RG_NOCTURNE_OF_SHADOW, RG_PART_OF_NOCTURNE_OF_SHADOW, RAND_INF_SPLIT_NOCTURNE_PART, QUEST_SONG_NOCTURNE } },
    { RG_PROGRESSIVE_PRELUDE_OF_LIGHT,
      { RG_PRELUDE_OF_LIGHT, RG_PART_OF_PRELUDE_OF_LIGHT, RAND_INF_SPLIT_PRELUDE_PART, QUEST_SONG_PRELUDE } },
};

std::unordered_map<QuestItem, RandomizerGet> StaticData::songQuestToProg = {
    { QUEST_SONG_LULLABY, RG_PROGRESSIVE_ZELDAS_LULLABY },
    { QUEST_SONG_EPONA, RG_PROGRESSIVE_EPONAS_SONG },
    { QUEST_SONG_SARIA, RG_PROGRESSIVE_SARIAS_SONG },
    { QUEST_SONG_SUN, RG_PROGRESSIVE_SUNS_SONG },
    { QUEST_SONG_TIME, RG_PROGRESSIVE_SONG_OF_TIME },
    { QUEST_SONG_STORMS, RG_PROGRESSIVE_SONG_OF_STORMS },
    { QUEST_SONG_MINUET, RG_PROGRESSIVE_MINUET_OF_FOREST },
    { QUEST_SONG_BOLERO, RG_PROGRESSIVE_BOLERO_OF_FIRE },
    { QUEST_SONG_SERENADE, RG_PROGRESSIVE_SERENADE_OF_WATER },
    { QUEST_SONG_REQUIEM, RG_PROGRESSIVE_REQUIEM_OF_SPIRIT },
    { QUEST_SONG_NOCTURNE, RG_PROGRESSIVE_NOCTURNE_OF_SHADOW },
    { QUEST_SONG_PRELUDE, RG_PROGRESSIVE_PRELUDE_OF_LIGHT },
};
