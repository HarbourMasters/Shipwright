...
std::map<RandomizerCheck, RandomizerInf> rcToRandomizerInf = {
    ...
    { RC_LH_SCARECROWS_SONG, RAND_INF_LH_SCARECROWS_SONG },
    ...
    { RC_SFM_DEKU_SCRUB_GROTTO_BEEHIVE, RAND_INF_BEEHIVE_SFM_STORMS_GROTTO },
    ...
    { RC_ZR_DEKU_SCRUB_GROTTO_BEEHIVE, RAND_INF_BEEHIVE_ZR_STORMS_GROTTO },
    ...
    { RC_COLOSSUS_DEKU_SCRUB_GROTTO_BEEHIVE, RAND_INF_BEEHIVE_COLOSSUS_GROTTO },
    ...
    { RC_DODONGOS_CAVERN_NEAR_LOWER_LIZALFOS_POT_1, RAND_INF_DODONGOS_CAVERN_NEAR_LOWER_LIZALFOS_POT_1 },
    { RC_DODONGOS_CAVERN_NEAR_LOWER_LIZALFOS_POT_2, RAND_INF_DODONGOS_CAVERN_NEAR_LOWER_LIZALFOS_POT_2 },
    ...
    { RC_LH_WATER_SWITCH_SIGN, RAND_INF_LH_WATER_SWITCH_SIGN },
    { RC_LH_FISHING_ISLAND_WATER_SWITCH_SIGN, RAND_INF_LH_FISHING_ISLAND_WATER_SWITCH_SIGN },
    ...
    { RC_SHADOW_N_UNDER_BLADE_SILVER, RAND_INF_RC_SHADOW_N_UNDER_BLADE_SILVER },
    { RC_SHADOW_TALL_BLOCK_BLADE_SILVER, RAND_INF_RC_SHADOW_TALL_BLOCK_BLADE_SILVER },
    { RC_SHADOW_N_NOOK_BLADE_SILVER, RAND_INF_RC_SHADOW_N_NOOK_BLADE_SILVER },
    { RC_SHADOW_W_NOOK_BLADE_SILVER, RAND_INF_SHADOW_W_NOOK_BLADE_SILVER },
    { RC_SHADOW_S_UNDER_BLADE_SILVER, RAND_INF_SHADOW_S_UNDER_BLADE_SILVER },
    { RC_SHADOW_N_PIT_SILVER, RAND_INF_SHADOW_N_PIT_SILVER },
    { RC_SHADOW_S_PIT_SILVER, RAND_INF_SHADOW_S_PIT_SILVER },
    { RC_SHADOW_BEAMOS_PIT_SILVER, RAND_INF_SHADOW_BEAMOS_PIT_SILVER },
    { RC_SHADOW_E_PIT_SILVER, RAND_INF_SHADOW_E_PIT_SILVER },
    { RC_SHADOW_W_PIT_SILVER, RAND_INF_SHADOW_W_PIT_SILVER },
    { RC_SHADOW_PLATFORM_SPIKES_SILVER, RAND_INF_SHADOW_PLATFORM_SPIKES_SILVER },
    { RC_SHADOW_E_TARGET_SPIKES_SILVER, RAND_INF_SHADOW_E_TARGET_SPIKES_SILVER },
    { RC_SHADOW_FLOOR_SPIKES_SILVER, RAND_INF_SHADOW_FLOOR_SPIKES_SILVER },
    { RC_SHADOW_W_TARGET_SPIKES_SILVER, RAND_INF_SHADOW_W_TARGET_SPIKES_SILVER },
    { RC_SHADOW_AIRBORNE_SPIKES_SILVER, RAND_INF_SHADOW_AIRBORNE_SPIKES_SILVER },
    { RC_SPIRIT_W_HIGH_CHILD_SILVER, RAND_INF_SPIRIT_W_HIGH_CHILD_SILVER },
    { RC_SPIRIT_W_LOW_CHILD_SILVER, RAND_INF_SPIRIT_W_LOW_CHILD_SILVER },
    { RC_SPIRIT_E_LOW_CHILD_SILVER, RAND_INF_SPIRIT_E_LOW_CHILD_SILVER },
    { RC_SPIRIT_E_HIGH_CHILD_SILVER, RAND_INF_SPIRIT_E_HIGH_CHILD_SILVER },
    { RC_SPIRIT_TORCH_CHILD_SILVER, RAND_INF_SPIRIT_TORCH_CHILD_SILVER },
    { RC_SPIRIT_NEAR_LIGHT_SUN_SILVER, RAND_INF_SPIRIT_NEAR_LIGHT_SUN_SILVER },
    { RC_SPIRIT_AIRBORNE_SUN_SILVER, RAND_INF_SPIRIT_AIRBORNE_SUN_SILVER },
    { RC_SPIRIT_MID_PLATFORM_SUN_SILVER, RAND_INF_SPIRIT_MID_PLATFORM_SUN_SILVER },
    { RC_SPIRIT_NEAR_CHEST_SUN_SILVER, RAND_INF_SPIRIT_NEAR_CHEST_SUN_SILVER },
    { RC_SPIRIT_NEAR_DOOR_SUN_SILVER, RAND_INF_SPIRIT_NEAR_DOOR_SUN_SILVER },
    { RC_SPIRIT_NW_BOULDER_SILVER, RAND_INF_SPIRIT_NW_BOULDER_SILVER },
    { RC_SPIRIT_SW_BOULDER_SILVER, RAND_INF_SPIRIT_SW_BOULDER_SILVER },
    { RC_SPIRIT_SE_BOULDER_SILVER, RAND_INF_SPIRIT_SE_BOULDER_SILVER },
    { RC_SPIRIT_NE_BOULDER_SILVER, RAND_INF_SPIRIT_NE_BOULDER_SILVER },
    { RC_SPIRIT_AIRBORNE_BOULDER_SILVER, RAND_INF_SPIRIT_AIRBORNE_BOULDER_SILVER },
    { RC_BOTW_B1_LADDER_SILVER, RAND_INF_BOTW_B1_LADDER_SILVER },
    { RC_BOTW_B2_LADDER_SILVER, RAND_INF_BOTW_B2_LADDER_SILVER },
    { RC_BOTW_B3_LADDER_SILVER, RAND_INF_BOTW_B3_LADDER_SILVER },
    { RC_BOTW_NW_OOZE_SILVER, RAND_INF_BOTW_NW_OOZE_SILVER },
    { RC_BOTW_SE_OOZE_SILVER, RAND_INF_BOTW_SE_OOZE_SILVER },
    { RC_ICE_CAVERN_ICICLES_BLADE_SILVER, RAND_INF_ICE_CAVERN_ICICLES_BLADE_SILVER },
    { RC_ICE_CAVERN_W_INNER_BLADE_SILVER, RAND_INF_ICE_CAVERN_W_INNER_BLADE_SILVER },
    { RC_ICE_CAVERN_OUTER_BLADE_SILVER, RAND_INF_ICE_CAVERN_OUTER_BLADE_SILVER },
    { RC_ICE_CAVERN_E_INNER_BLADE_SILVER, RAND_INF_ICE_CAVERN_E_INNER_BLADE_SILVER },
    { RC_ICE_CAVERN_AIRBORNE_BLADE_SILVER, RAND_INF_ICE_CAVERN_AIRBORNE_BLADE_SILVER },
    { RC_ICE_CAVERN_NEAR_FIRE_BLOCK_SILVER, RAND_INF_ICE_CAVERN_NEAR_FIRE_BLOCK_SILVER },
    { RC_ICE_CAVERN_LOWER_BLOCK_SILVER, RAND_INF_ICE_CAVERN_LOWER_BLOCK_SILVER },
    { RC_ICE_CAVERN_NEAR_BLOCK_SILVER, RAND_INF_ICE_CAVERN_NEAR_BLOCK_SILVER },
    { RC_ICE_CAVERN_FROZEN_BLOCK_SILVER, RAND_INF_ICE_CAVERN_FROZEN_BLOCK_SILVER },
    { RC_ICE_CAVERN_NEAR_GS_BLOCK_SILVER, RAND_INF_ICE_CAVERN_NEAR_GS_BLOCK_SILVER },
    { RC_GTG_FIRE_WALL_SLOPE_SILVER, RAND_INF_GTG_FIRE_WALL_SLOPE_SILVER },
    { RC_GTG_LOWER_BOULDER_SLOPE_SILVER, RAND_INF_GTG_LOWER_BOULDER_SLOPE_SILVER },
    { RC_GTG_TARGET_SLOPE_SILVER, RAND_INF_GTG_TARGET_SLOPE_SILVER },
    { RC_GTG_JUMPDOWN_SLOPE_SILVER, RAND_INF_GTG_JUMPDOWN_SLOPE_SILVER },
    { RC_GTG_UPPER_BOULDER_SLOPE_SILVER, RAND_INF_GTG_UPPER_BOULDER_SLOPE_SILVER },
    { RC_GTG_NEAR_SWITCH_LAVA_SILVER, RAND_INF_GTG_NEAR_SWITCH_LAVA_SILVER },
    { RC_GTG_NEAR_BARRED_DOOR_LAVA_SILVER, RAND_INF_GTG_NEAR_BARRED_DOOR_LAVA_SILVER },
    { RC_GTG_FIRE_RING_LAVA_SILVER, RAND_INF_GTG_FIRE_RING_LAVA_SILVER },
    { RC_GTG_UPPER_LAVA_SILVER, RAND_INF_GTG_UPPER_LAVA_SILVER },
    { RC_GTG_UNDER_LEDGE_LAVA_SILVER, RAND_INF_GTG_UNDER_LEDGE_LAVA_SILVER },
    { RC_GTG_MIDDLE_WATER_SILVER, RAND_INF_GTG_MIDDLE_WATER_SILVER },
    { RC_GTG_ABOVE_TARGET_WATER_SILVER, RAND_INF_GTG_ABOVE_TARGET_WATER_SILVER },
    { RC_GTG_LEFT_WATER_SILVER, RAND_INF_GTG_LEFT_WATER_SILVER },
    { RC_GTG_UNDER_TARGET_WATER_SILVER, RAND_INF_GTG_UNDER_TARGET_WATER_SILVER },
    { RC_GTG_RIGHT_WATER_SILVER, RAND_INF_GTG_RIGHT_WATER_SILVER },
    { RC_GANONS_CASTLE_OUTER_RIGHT_LIGHT_SILVER, RAND_INF_GANONS_CASTLE_OUTER_RIGHT_LIGHT_SILVER },
    { RC_GANONS_CASTLE_OUTER_LEFT_LIGHT_SILVER, RAND_INF_GANONS_CASTLE_OUTER_LEFT_LIGHT_SILVER },
    { RC_GANONS_CASTLE_UPPER_LIGHT_SILVER, RAND_INF_GANONS_CASTLE_UPPER_LIGHT_SILVER },
    { RC_GANONS_CASTLE_INNER_RIGHT_LIGHT_SILVER, RAND_INF_GANONS_CASTLE_INNER_RIGHT_LIGHT_SILVER },
    { RC_GANONS_CASTLE_INNER_LEFT_LIGHT_SILVER, RAND_INF_GANONS_CASTLE_INNER_LEFT_LIGHT_SILVER },
    { RC_GANONS_CASTLE_LARGE_PLATFORM_FOREST_SILVER, RAND_INF_GANONS_CASTLE_LARGE_PLATFORM_FOREST_SILVER },
    { RC_GANONS_CASTLE_SOT_BLOCK_FOREST_SILVER, RAND_INF_GANONS_CASTLE_SOT_BLOCK_FOREST_SILVER },
    { RC_GANONS_CASTLE_SMALL_PLATFORM_FOREST_SILVER, RAND_INF_GANONS_CASTLE_SMALL_PLATFORM_FOREST_SILVER },
    { RC_GANONS_CASTLE_UNDER_LEDGE_FOREST_SILVER, RAND_INF_GANONS_CASTLE_UNDER_LEDGE_FOREST_SILVER },
    { RC_GANONS_CASTLE_ON_TARGET_FOREST_SILVER, RAND_INF_GANONS_CASTLE_ON_TARGET_FOREST_SILVER },
    { RC_GANONS_CASTLE_TORCH_SLUG_FIRE_SILVER, RAND_INF_GANONS_CASTLE_TORCH_SLUG_FIRE_SILVER },
    { RC_GANONS_CASTLE_FLAME_JETS_FIRE_SILVER, RAND_INF_GANONS_CASTLE_FLAME_JETS_FIRE_SILVER },
    { RC_GANONS_CASTLE_DISTANT_PLATFORM_FIRE_SILVER, RAND_INF_GANONS_CASTLE_DISTANT_PLATFORM_FIRE_SILVER },
    { RC_GANONS_CASTLE_CLOSE_PLATFORM_FIRE_SILVER, RAND_INF_GANONS_CASTLE_CLOSE_PLATFORM_FIRE_SILVER },
    { RC_GANONS_GANONS_CASTLE_UNDER_PILLAR_FIRE_SILVER, RAND_INF_GANONS_GANONS_CASTLE_UNDER_PILLAR_FIRE_SILVER },
    { RC_GANONS_CASTLE_AIRBORNE_SPIRIT_SILVER, RAND_INF_GANONS_CASTLE_AIRBORNE_SPIRIT_SILVER },
    { RC_GANONS_CASTLE_NEAR_DOORMAT_SPIRIT_SILVER, RAND_INF_GANONS_CASTLE_NEAR_DOORMAT_SPIRIT_SILVER },
    { RC_GANONS_CASTLE_LOWER_MIDDLE_SPIRIT_SILVER, RAND_INF_GANONS_CASTLE_LOWER_MIDDLE_SPIRIT_SILVER },
    { RC_GANONS_CASTLE_CORNER_SPIRIT_SILVER, RAND_INF_GANONS_CASTLE_CORNER_SPIRIT_SILVER },
    { RC_GANONS_CASTLE_NEAR_BARRED_DOOR_SPIRIT_SILVER, RAND_INF_GANONS_CASTLE_NEAR_BARRED_DOOR_SPIRIT_SILVER },
    { RC_DODONGOS_CAVERN_MQ_BEAMOS_SILVER, RAND_INF_DODONGOS_CAVERN_MQ_BEAMOS_SILVER },
    { RC_DODONGOS_CAVERN_MQ_1F_CRATE_SILVER, RAND_INF_DODONGOS_CAVERN_MQ_1F_CRATE_SILVER },
    { RC_DODONGOS_CAVERN_MQ_LOWER_2F_CRATE_SILVER, RAND_INF_DODONGOS_CAVERN_MQ_LOWER_2F_CRATE_SILVER },
    { RC_DODONGOS_CAVERN_MQ_VINES_SILVER, RAND_INF_DODONGOS_CAVERN_MQ_VINES_SILVER },
    { RC_DODONGOS_CAVERN_MQ_UPPER_2F_CRATE_SILVER, RAND_INF_DODONGOS_CAVERN_MQ_UPPER_2F_CRATE_SILVER },
    { RC_SHADOW_MQ_W_NOOK_SILVER, RAND_INF_SHADOW_MQ_W_NOOK_SILVER },
    { RC_SHADOW_MQ_TALL_BLOCK_BLADE_SILVER, RAND_INF_SHADOW_MQ_TALL_BLOCK_BLADE_SILVER },
    { RC_SHADOW_MQ_NE_UNDER_BLADE_SILVER, RAND_INF_SHADOW_MQ_NE_UNDER_BLADE_SILVER },
    { RC_SHADOW_MQ_S_UNDER_BLADE_SILVER, RAND_INF_SHADOW_MQ_S_UNDER_BLADE_SILVER },
    { RC_SHADOW_MQ_N_NOOK_BLADE_SILVER, RAND_INF_SHADOW_MQ_N_NOOK_BLADE_SILVER },
    { RC_SHADOW_MQ_W_PIT_SILVER, RAND_INF_SHADOW_MQ_W_PIT_SILVER },
    { RC_SHADOW_MQ_HIGH_PIT_SILVER, RAND_INF_SHADOW_MQ_HIGH_PIT_SILVER },
    { RC_SHADOW_MQ_HIGHEST_PIT_SILVER, RAND_INF_SHADOW_MQ_HIGHEST_PIT_SILVER },
    { RC_SHADOW_MQ_N_PIT_SILVER, RAND_INF_SHADOW_MQ_N_PIT_SILVER },
    { RC_SHADOW_MQ_E_PIT_SILVER, RAND_INF_SHADOW_MQ_E_PIT_SILVER },
    { RC_SHADOW_MQ_W_INVISIBLE_BLADE_SILVER, RAND_INF_SHADOW_MQ_W_INVISIBLE_BLADE_SILVER },
    { RC_SHADOW_MQ_SW_INVISIBLE_BLADE_SILVER, RAND_INF_SHADOW_MQ_SW_INVISIBLE_BLADE_SILVER },
    { RC_SHADOW_MQ_NW_INVISIBLE_BLADE_SILVER, RAND_INF_SHADOW_MQ_NW_INVISIBLE_BLADE_SILVER },
    { RC_SHADOW_MQ_S_INVISIBLE_BLADE_SILVER, RAND_INF_SHADOW_MQ_S_INVISIBLE_BLADE_SILVER },
    { RC_SHADOW_MQ_INNER_NE_INVISIBLE_BLADE_SILVER, RAND_INF_SHADOW_MQ_INNER_NE_INVISIBLE_BLADE_SILVER },
    { RC_SHADOW_MQ_SE_INVISIBLE_BLADE_SILVER, RAND_INF_SHADOW_MQ_SE_INVISIBLE_BLADE_SILVER },
    { RC_SHADOW_MQ_OUTSIDE_CIRCLE_INVISIBLE_BLADE_SILVER, RAND_INF_SHADOW_MQ_OUTSIDE_CIRCLE_INVISIBLE_BLADE_SILVER },
    { RC_SHADOW_MQ_OUTER_NE_INVISIBLE_BLADE_SILVER, RAND_INF_SHADOW_MQ_OUTER_NE_INVISIBLE_BLADE_SILVER },
    { RC_SHADOW_MQ_E_INVISIBLE_BLADE_SILVER, RAND_INF_SHADOW_MQ_E_INVISIBLE_BLADE_SILVER },
    { RC_SHADOW_MQ_SOT_BLOCK_INVISIBLE_BLADE_SILVER, RAND_INF_SHADOW_MQ_SOT_BLOCK_INVISIBLE_BLADE_SILVER },
    { RC_SHADOW_MQ_PLATFORM_SPIKES_SILVER, RAND_INF_SHADOW_MQ_PLATFORM_SPIKES_SILVER },
    { RC_SHADOW_MQ_W_TARGET_SPIKES_SILVER, RAND_INF_SHADOW_MQ_W_TARGET_SPIKES_SILVER },
    { RC_SHADOW_MQ_W_AIRBORNE_SPIKES_SILVER, RAND_INF_SHADOW_MQ_W_AIRBORNE_SPIKES_SILVER },
    { RC_SHADOW_MQ_N_TARGET_SPIKES_SILVER, RAND_INF_SHADOW_MQ_N_TARGET_SPIKES_SILVER },
    { RC_SHADOW_MQ_CENTRAL_SPIKES_SILVER, RAND_INF_SHADOW_MQ_CENTRAL_SPIKES_SILVER },
    { RC_SHADOW_MQ_CENTRAL_TARGET_SPIKES_SILVER, RAND_INF_SHADOW_MQ_CENTRAL_TARGET_SPIKES_SILVER },
    { RC_SHADOW_MQ_S_TARGET_SPIKES_SILVER, RAND_INF_SHADOW_MQ_S_TARGET_SPIKES_SILVER },
    { RC_SHADOW_MQ_INSIDE_SPIKES_SILVER, RAND_INF_SHADOW_MQ_INSIDE_SPIKES_SILVER },
    { RC_SHADOW_MQ_E_AIRBORNE_SPIKES_SILVER, RAND_INF_SHADOW_MQ_E_AIRBORNE_SPIKES_SILVER },
    { RC_SHADOW_MQ_E_TARGET_SPIKES_SILVER, RAND_INF_SHADOW_MQ_E_TARGET_SPIKES_SILVER },
    { RC_SPIRIT_MQ_STAIRS_LOBBY_SILVER, RAND_INF_SPIRIT_MQ_STAIRS_LOBBY_SILVER },
    { RC_SPIRIT_MQ_E_BOULDER_LOBBY_SILVER, RAND_INF_SPIRIT_MQ_E_BOULDER_LOBBY_SILVER },
    { RC_SPIRIT_MQ_W_BOULDER_LOBBY_SILVER, RAND_INF_SPIRIT_MQ_W_BOULDER_LOBBY_SILVER },
    { RC_SPIRIT_MQ_CORNER_LOBBY_SILVER, RAND_INF_SPIRIT_MQ_CORNER_LOBBY_SILVER },
    { RC_SPIRIT_MQ_JET_LOBBY_SILVER, RAND_INF_SPIRIT_MQ_JET_LOBBY_SILVER },
    { RC_SPIRIT_MQ_LOWEST_WALL_SILVER, RAND_INF_SPIRIT_MQ_LOWEST_WALL_SILVER },
    { RC_SPIRIT_MQ_MID_LOW_WALL_SILVER, RAND_INF_SPIRIT_MQ_MID_LOW_WALL_SILVER },
    { RC_SPIRIT_MQ_MID_HIGH_WALL_SILVER, RAND_INF_SPIRIT_MQ_MID_HIGH_WALL_SILVER },
    { RC_SPIRIT_MQ_HIGHEST_WALL_SILVER, RAND_INF_SPIRIT_MQ_HIGHEST_WALL_SILVER },
    { RC_SPIRIT_MQ_MIDDLE_WALL_SILVER, RAND_INF_SPIRIT_MQ_MIDDLE_WALL_SILVER },
    { RC_GTG_MQ_ICICLES_SLOPE_SILVER, RAND_INF_GTG_MQ_ICICLES_SLOPE_SILVER },
    { RC_GTG_MQ_JUMPDOWN_SLOPE_SILVER, RAND_INF_GTG_MQ_JUMPDOWN_SLOPE_SILVER },
    { RC_GTG_MQ_HIGH_SLOPE_SILVER, RAND_INF_GTG_MQ_HIGH_SLOPE_SILVER },
    { RC_GTG_MQ_FREEZARD_SLOPE_SILVER, RAND_INF_GTG_MQ_FREEZARD_SLOPE_SILVER },
    { RC_GTG_MQ_PIT_SLOPE_SILVER, RAND_INF_GTG_MQ_PIT_SLOPE_SILVER },
    { RC_GTG_MQ_NEAR_SWITCH_LAVA_SILVER, RAND_INF_GTG_MQ_NEAR_SWITCH_LAVA_SILVER },
    { RC_GTG_MQ_FAR_LAVA_SILVER, RAND_INF_GTG_MQ_FAR_LAVA_SILVER },
    { RC_GTG_MQ_MIDDLE_LAVA_SILVER, RAND_INF_GTG_MQ_MIDDLE_LAVA_SILVER },
    { RC_GTG_MQ_NEAR_BARRED_DOOR_LAVA_SILVER, RAND_INF_GTG_MQ_SILVER_LAVA_4 },
    { RC_GTG_MQ_NEAR_MAZE_LEDGE_LAVA_SILVER, RAND_INF_GTG_MQ_NEAR_MAZE_LEDGE_LAVA_SILVER },
    { RC_GTG_MQ_NEAR_LIT_TORCH_LAVA_SILVER, RAND_INF_GTG_MQ_NEAR_LIT_TORCH_LAVA_SILVER },
    { RC_GTG_MQ_BACK_WATER_SILVER, RAND_INF_GTG_MQ_BACK_WATER_SILVER },
    { RC_GTG_MQ_MIDDLE_WATER_SILVER, RAND_INF_GTG_MQ_MIDDLE_WATER_SILVER },
    { RC_GTG_MQ_FRONT_WATER_SILVER, RAND_INF_GTG_MQ_FRONT_WATER_SILVER },
    { RC_GANONS_CASTLE_MQ_UNDER_PILLAR_FIRE_SILVER, RAND_INF_GANONS_CASTLE_MQ_UNDER_PILLAR_FIRE_SILVER },
    { RC_GANONS_CASTLE_MQ_NEAR_TARGET_FIRE_SILVER, RAND_INF_GANONS_CASTLE_MQ_NEAR_TARGET_FIRE_SILVER },
    { RC_GANONS_CASTLE_MQ_ON_PILLAR_FIRE_SILVER, RAND_INF_GANONS_CASTLE_MQ_ON_PILLAR_FIRE_SILVER },
    { RC_GANONS_CASTLE_MQ_LAUNCH_PLATFORM_FIRE_SILVER, RAND_INF_GANONS_CASTLE_MQ_LAUNCH_PLATFORM_FIRE_SILVER },
    { RC_GANONS_CASTLE_MQ_JET_PLATFORM_FIRE_SILVER, RAND_INF_GANONS_CASTLE_MQ_JET_PLATFORM_FIRE_SILVER },
    { RC_GANONS_CASTLE_MQ_IN_HOLE_WATER_SILVER, RAND_INF_GANONS_CASTLE_MQ_IN_HOLE_WATER_SILVER },
    { RC_GANONS_CASTLE_MQ_AIRBORNE_WATER_SILVER, RAND_INF_GANONS_CASTLE_MQ_AIRBORNE_WATER_SILVER },
    { RC_GANONS_CASTLE_MQ_FROZEN_WATER_SILVER, RAND_INF_GANONS_CASTLE_MQ_FROZEN_WATER_SILVER },
    { RC_GANONS_CASTLE_MQ_OVER_PIT_WATER_SILVER, RAND_INF_GANONS_CASTLE_MQ_OVER_PIT_WATER_SILVER },
    { RC_GANONS_CASTLE_MQ_NOOK_WATER_SILVER, RAND_INF_GANONS_CASTLE_MQ_NOOK_WATER_SILVER },
    { RC_GANONS_CASTLE_MQ_BOMB_FLOWER_SHADOW_SILVER, RAND_INF_GANONS_CASTLE_MQ_BOMB_FLOWER_SHADOW_SILVER },
    { RC_GANONS_CASTLE_MQ_NEAR_TORCH_SHADOW_SILVER, RAND_INF_GANONS_CASTLE_MQ_NEAR_TORCH_SHADOW_SILVER },
    { RC_GANONS_CASTLE_MQ_BEAMOS_PLATFORM_SHADOW_SILVER, RAND_INF_GANONS_CASTLE_MQ_BEAMOS_PLATFORM_SHADOW_SILVER },
    { RC_GANONS_CASTLE_MQ_GUILLOTINE_SHADOW_SILVER, RAND_INF_GANONS_CASTLE_MQ_GUILLOTINE_SHADOW_SILVER },
    { RC_GANONS_CASTLE_MQ_MOVING_PLATFORM_SHADOW_SILVER, RAND_INF_GANONS_CASTLE_MQ_MOVING_PLATFORM_SHADOW_SILVER },
};