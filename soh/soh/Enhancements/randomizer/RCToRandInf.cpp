...
std::map<RandomizerCheck, RandomizerInf> rcToRandomizerInf = {
    ...
    { RC_LH_WARP_WATER_SWITCH_RECTANGLE_SIGN, RAND_INF_LH_WARP_WATER_SWITCH_RECTANGLE_SIGN },
    { RC_LH_FISHING_WATER_SWITCH_RECTANGLE_SIGN, RAND_INF_LH_FISHING_WATER_SWITCH_RECTANGLE_SIGN },
