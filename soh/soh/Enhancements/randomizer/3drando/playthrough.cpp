...
int Playthrough_Init(uint32_t seed, std::unordered_map<RandomizerSettingKey, uint8_t> cvarSettings, std::set<RandomizerCheck> excludedLocations, std::set<int> enabledTricksNums) {
    ...
    Settings::UpdateSettings(cvarSettings, excludedLocations, enabledTricksNums);
...
int Playthrough_Repeat(std::unordered_map<RandomizerSettingKey, uint8_t> cvarSettings, std::set<RandomizerCheck> excludedLocations, std::set<int> enabledTricksNums, int count /*= 1*/) {
    ...
    for (int i = 0; i < count; i++) {
        ...
        ClearProgress();
        Playthrough_Init(Settings::seed, cvarSettings, excludedLocations, enabledTricksNums);
