...
void InitTrickNames() {
    ...
    trickNameTable[RG_GREG_RUPEE] = { //TODO_TRANSALTE
    ...
    trickNameTable[RG_FOREST_TEMPLE_SMALL_KEY] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_FIRE_TEMPLE_SMALL_KEY] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_WATER_TEMPLE_SMALL_KEY] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_SPIRIT_TEMPLE_SMALL_KEY] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_SHADOW_TEMPLE_SMALL_KEY] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_BOTTOM_OF_THE_WELL_SMALL_KEY] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_GERUDO_TRAINING_GROUND_SMALL_KEY] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_GERUDO_FORTRESS_SMALL_KEY] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_GANONS_CASTLE_SMALL_KEY] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_FOREST_TEMPLE_KEY_RING] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_FIRE_TEMPLE_KEY_RING] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_WATER_TEMPLE_KEY_RING] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_SPIRIT_TEMPLE_KEY_RING] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_SHADOW_TEMPLE_KEY_RING] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_BOTTOM_OF_THE_WELL_KEY_RING] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_GERUDO_TRAINING_GROUND_KEY_RING] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_GERUDO_FORTRESS_KEY_RING] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_GANONS_CASTLE_KEY_RING] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_FIRE_TEMPLE_BOSS_KEY] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_WATER_TEMPLE_BOSS_KEY] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_SPIRIT_TEMPLE_BOSS_KEY] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_SHADOW_TEMPLE_BOSS_KEY] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_GANONS_CASTLE_BOSS_KEY] = {//TODO_TRANSALTE
    ...
    trickNameTable[RG_GUARD_HOUSE_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_MARKET_BAZAAR_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_MARKET_POTION_SHOP_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_MASK_SHOP_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_MARKET_SHOOTING_GALLERY_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_BOMBCHU_BOWLING_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_TREASURE_CHEST_GAME_BUILDING_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_BOMBCHU_SHOP_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_RICHARDS_HOUSE_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_ALLEY_HOUSE_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_KAK_BAZAAR_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_KAK_POTION_SHOP_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_BOSS_HOUSE_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_GRANNYS_POTION_SHOP_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_SKULLTULA_HOUSE_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_IMPAS_HOUSE_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_DAMPES_HUT_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_TALONS_HOUSE_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_STABLES_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_BACK_TOWER_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_HYLIA_LAB_KEY] = { //TODO_TRANSLATE
    ...
    trickNameTable[RG_FISHING_HOLE_KEY] = { //TODO_TRANSLATE
