...
constexpr std::array DungeonColors = {
    ...
    void CreateAlwaysIncludedMessages() {
        ...
        CreateMessage(0x09F8, 0, 2, 3,
                UNSKIPPABLE()+ITEM_OBTAINED(ITEM_WALLET_ADULT)+INSTANT_TEXT_ON()+"You got a "+COLOR(QM_RED)+"Child Wallet"+COLOR(QM_WHITE)+"!"+INSTANT_TEXT_OFF()+NEWLINE()+"Now you can carry"+NEWLINE()+"up to "+COLOR(QM_YELLOW)+"99 "+COLOR(QM_WHITE)+COLOR(QM_YELLOW)+"Rupees"+COLOR(QM_WHITE)+"!"+MESSAGE_END(),
