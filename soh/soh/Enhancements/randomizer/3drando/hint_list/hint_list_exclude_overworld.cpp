...
void HintTable_Init_Exclude_Overworld() {
    ...
    hintTable[RHT_KF_MIDOS_TOP_LEFT_CHEST] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_KF_MIDOS_TOP_RIGHT_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #leader of the Kokiri# hides", /*french*/"le #chef des Kokiri# possède", /*spanish*/"el #líder de los Kokiri# esconde"},
                     }, {},
                       //clear text
    ...
    hintTable[RHT_KF_MIDOS_BOTTOM_LEFT_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #leader of the Kokiri# hides", /*french*/"le #chef des Kokiri# possède", /*spanish*/"el #líder de los Kokiri# esconde"},
                     }, {},
                       //clear text
    ...
    hintTable[RHT_KF_MIDOS_BOTTOM_RIGHT_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #leader of the Kokiri# hides", /*french*/"le #chef des Kokiri# possède", /*spanish*/"el #líder de los Kokiri# esconde"},
                     }, {},
                       //clear text
    ...
    hintTable[RHT_GRAVEYARD_SHIELD_GRAVE_CHEST] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_DMT_CHEST] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_GC_MAZE_RIGHT_CHEST] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_GC_MAZE_CENTER_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"in #Goron City# explosives unlock", /*french*/"des explosions dans le #village Goron# révèlent", /*spanish*/"en la #Ciudad Goron# unos explosivos desbloquean"},
  });

    hintTable[RHT_ZD_CHEST] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_GRAVEYARD_HOOKSHOT_CHEST] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_LW_GIFT_FROM_SARIA] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_HC_MALON_EGG] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_LH_CHILD_FISHING] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_LW_OCARINA_MEMORY_GAME] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_KAK_10_GOLD_SKULLTULA_REWARD] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_ZR_FROGS_EPONAS_SONG] = HintText::Exclude(
        {
            // obscure text
    ...
    hintTable[RHT_ZR_FROGS_SARIAS_SONG] = HintText::Exclude(
        {
            // obscure text
    ...
    hintTable[RHT_ZR_FROGS_SUNS_SONG] = HintText::Exclude(
        {
            // obscure text
    ...
    hintTable[RHT_ZR_FROGS_SONG_OF_TIME] = HintText::Exclude(
        {
            // obscure text
    ...
    hintTable[RHT_GF_HBA_1000_POINTS] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_KAK_ANJU_AS_ADULT] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_LLR_TALONS_CHICKENS] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_GC_ROLLING_GORON_AS_CHILD] = HintText::Exclude({
                       //obscure text
  ...
  hintTable[RHT_KAK_GRANNYS_SHOP] = HintText::Exclude({
    ...
    hintTable[RHT_ZR_NEAR_DOMAIN_FREESTANDING_POH] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_LH_FREESTANDING_POH] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_DMT_FREESTANDING_POH] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_DMC_WALL_FREESTANDING_POH] = HintText::Exclude({
                       //obscure text
                       Text{"nestled in a #volcanic wall# is", /*french*/"dans une #alcove volcanique# gît", /*spanish*/"entre unas #murallas volcánicas# yace"},
  });

    hintTable[RHT_DMC_VOLCANO_FREESTANDING_POH] = HintText::Exclude({
                       //obscure text
                       Text{"obscured by #volcanic ash# is", /*french*/"#recouvert de cendres volcaniques# gît", /*spanish*/"bajo la #ceniza volcánica# yace"},
  });

    hintTable[RHT_GF_NORTH_F1_CARPENTER] = HintText::Exclude({
                       //obscure text
                       Text{"#defeating Gerudo guards# reveals", /*french*/"les #geôliers Gerudo# détiennent", /*spanish*/"#derrotar a las guardas Gerudo# revela"},
  });

    hintTable[RHT_GF_NORTH_F2_CARPENTER] = HintText::Exclude({
                       //obscure text
                       Text{"#defeating Gerudo guards# reveals", /*french*/"les #geôliers Gerudo# détiennent", /*spanish*/"#derrotar a las guardas Gerudo# revela"},
  });

    hintTable[RHT_GF_SOUTH_F1_CARPENTER] = HintText::Exclude({
                       //obscure text
                       Text{"#defeating Gerudo guards# reveals", /*french*/"les #geôliers Gerudo# détiennent", /*spanish*/"#derrotar a las guardas Gerudo# revela"},
  });

    hintTable[RHT_GF_SOUTH_F2_CARPENTER] = HintText::Exclude({
                       //obscure text
                       Text{"#defeating Gerudo guards# reveals", /*french*/"les #geôliers Gerudo# détiennent", /*spanish*/"#derrotar a las guardas Gerudo# revela"},
  });


    hintTable[RHT_HF_GS_NEAR_KAK_GROTTO] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_LLR_GS_BACK_WALL] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_LLR_GS_RAIN_SHED] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_LLR_GS_HOUSE_WINDOW] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_LLR_GS_TREE] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_KF_GS_BEAN_PATCH] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_KF_GS_KNOW_IT_ALL_HOUSE] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_KF_GS_HOUSE_OF_TWINS] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_LW_GS_BEAN_PATCH_NEAR_BRIDGE] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_LW_GS_BEAN_PATCH_NEAR_THEATER] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider buried deep in a forest maze# holds", /*french*/"une #Skulltula enterrée dans les bois# a", /*spanish*/"una #Skulltula enterrada en un laberinto forestal# otorga"},
  });

    hintTable[RHT_LW_GS_ABOVE_THEATER] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_SFM_GS] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_OGC_GS] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_HC_GS_TREE] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_MARKET_GS_GUARD_HOUSE] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_DMC_GS_BEAN_PATCH] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_DMT_GS_BEAN_PATCH] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_DMT_GS_NEAR_KAK] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_DMT_GS_ABOVE_DODONGOS_CAVERN] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_DMT_GS_FALLING_ROCKS_PATH] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_GC_GS_CENTER_PLATFORM] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_GC_GS_BOULDER_MAZE] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_KAK_GS_HOUSE_UNDER_CONSTRUCTION] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_KAK_GS_SKULLTULA_HOUSE] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_KAK_GS_GUARDS_HOUSE] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_KAK_GS_TREE] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_KAK_GS_WATCHTOWER] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_KAK_GS_ABOVE_IMPAS_HOUSE] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_GRAVEYARD_GS_WALL] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_GRAVEYARD_GS_BEAN_PATCH] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_ZR_GS_LADDER] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_ZR_GS_TREE] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_ZR_GS_ABOVE_BRIDGE] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_ZR_GS_NEAR_RAISED_GROTTOS] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_ZD_GS_FROZEN_WATERFALL] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_ZF_GS_ABOVE_THE_LOG] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_ZF_GS_TREE] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_LH_GS_BEAN_PATCH] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_LH_GS_SMALL_ISLAND] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_LH_GS_LAB_WALL] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_LH_GS_LAB_CRATE] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_LH_GS_TREE] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_GV_GS_BEAN_PATCH] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_GV_GS_SMALL_BRIDGE] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_GV_GS_PILLAR] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_GV_GS_BEHIND_TENT] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_GF_GS_ARCHERY_RANGE] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_GF_GS_TOP_FLOOR] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_COLOSSUS_GS_BEAN_PATCH] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_COLOSSUS_GS_HILL] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_COLOSSUS_GS_TREE] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_KF_SHOP_ITEM_1] = HintText::Exclude({
                       //obscure text
                       Text{"a #child shopkeeper# sells", /*french*/"la #boutique Kokiri# vend", /*spanish*/"un #joven dependiente# vende"},
  });

    hintTable[RHT_KF_SHOP_ITEM_2] = HintText::Exclude({
                       //obscure text
                       Text{"a #child shopkeeper# sells", /*french*/"la #boutique Kokiri# vend", /*spanish*/"un #joven dependiente# vende"},
  });

    hintTable[RHT_KF_SHOP_ITEM_3] = HintText::Exclude({
                       //obscure text
                       Text{"a #child shopkeeper# sells", /*french*/"la #boutique Kokiri# vend", /*spanish*/"un #joven dependiente# vende"},
  });

    hintTable[RHT_KF_SHOP_ITEM_4] = HintText::Exclude({
                       //obscure text
                       Text{"a #child shopkeeper# sells", /*french*/"la #boutique Kokiri# vend", /*spanish*/"un #joven dependiente# vende"},
  });

    hintTable[RHT_KF_SHOP_ITEM_5] = HintText::Exclude({
                       //obscure text
                       Text{"a #child shopkeeper# sells", /*french*/"la #boutique Kokiri# vend", /*spanish*/"un #joven dependiente# vende"},
  });

    hintTable[RHT_KF_SHOP_ITEM_6] = HintText::Exclude({
                       //obscure text
                       Text{"a #child shopkeeper# sells", /*french*/"la #boutique Kokiri# vend", /*spanish*/"un #joven dependiente# vende"},
  });

    hintTable[RHT_KF_SHOP_ITEM_7] = HintText::Exclude({
                       //obscure text
                       Text{"a #child shopkeeper# sells", /*french*/"la #boutique Kokiri# vend", /*spanish*/"un #joven dependiente# vende"},
  });

    hintTable[RHT_KF_SHOP_ITEM_8] = HintText::Exclude({
                       //obscure text
                       Text{"a #child shopkeeper# sells", /*french*/"la #boutique Kokiri# vend", /*spanish*/"un #joven dependiente# vende"},
  });


    hintTable[RHT_KAK_POTION_SHOP_ITEM_1] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_KAK_POTION_SHOP_ITEM_2] = HintText::Exclude({
                       //obscure text
                       Text{"a #potion seller# offers", /*french*/"l'#apothicaire# vend", /*spanish*/"un #vendedor de pociones# ofrece"},
                     }, {},
                       //clear text
    ...
    hintTable[RHT_KAK_POTION_SHOP_ITEM_3] = HintText::Exclude({
                       //obscure text
                       Text{"a #potion seller# offers", /*french*/"l'#apothicaire# vend", /*spanish*/"un #vendedor de pociones# ofrece"},
                     }, {},
                       //clear text
    ...
    hintTable[RHT_KAK_POTION_SHOP_ITEM_4] = HintText::Exclude({
                       //obscure text
                       Text{"a #potion seller# offers", /*french*/"l'#apothicaire# vend", /*spanish*/"un #vendedor de pociones# ofrece"},
                     }, {},
                       //clear text
    ...
    hintTable[RHT_KAK_POTION_SHOP_ITEM_5] = HintText::Exclude({
                       //obscure text
                       Text{"a #potion seller# offers", /*french*/"l'#apothicaire# vend", /*spanish*/"un #vendedor de pociones# ofrece"},
                     }, {},
                       //clear text
    ...
    hintTable[RHT_KAK_POTION_SHOP_ITEM_6] = HintText::Exclude({
                       //obscure text
                       Text{"a #potion seller# offers", /*french*/"l'#apothicaire# vend", /*spanish*/"un #vendedor de pociones# ofrece"},
                     }, {},
                       //clear text
    ...
    hintTable[RHT_KAK_POTION_SHOP_ITEM_7] = HintText::Exclude({
                       //obscure text
                       Text{"a #potion seller# offers", /*french*/"l'#apothicaire# vend", /*spanish*/"un #vendedor de pociones# ofrece"},
                     }, {},
                       //clear text
    ...
    hintTable[RHT_KAK_POTION_SHOP_ITEM_8] = HintText::Exclude({
                       //obscure text
                       Text{"a #potion seller# offers", /*french*/"l'#apothicaire# vend", /*spanish*/"un #vendedor de pociones# ofrece"},
                     }, {},
                       //clear text
    ...
    hintTable[RHT_MARKET_BOMBCHU_SHOP_ITEM_1] = HintText::Exclude({
                       //obscure text
                       Text{"a #Bombchu merchant# sells", /*french*/"le #marchand de Missiles# vend", /*spanish*/"un #mercader de bombchus# vende"},
  });

    hintTable[RHT_MARKET_BOMBCHU_SHOP_ITEM_2] = HintText::Exclude({
                       //obscure text
                       Text{"a #Bombchu merchant# sells", /*french*/"le #marchand de Missiles# vend", /*spanish*/"un #mercader de bombchus# vende"},
  });

    hintTable[RHT_MARKET_BOMBCHU_SHOP_ITEM_3] = HintText::Exclude({
                       //obscure text
                       Text{"a #Bombchu merchant# sells", /*french*/"le #marchand de Missiles# vend", /*spanish*/"un #mercader de bombchus# vende"},
  });

    hintTable[RHT_MARKET_BOMBCHU_SHOP_ITEM_4] = HintText::Exclude({
                       //obscure text
                       Text{"a #Bombchu merchant# sells", /*french*/"le #marchand de Missiles# vend", /*spanish*/"un #mercader de bombchus# vende"},
  });

    hintTable[RHT_MARKET_BOMBCHU_SHOP_ITEM_5] = HintText::Exclude({
                       //obscure text
                       Text{"a #Bombchu merchant# sells", /*french*/"le #marchand de Missiles# vend", /*spanish*/"un #mercader de bombchus# vende"},
  });

    hintTable[RHT_MARKET_BOMBCHU_SHOP_ITEM_6] = HintText::Exclude({
                       //obscure text
                       Text{"a #Bombchu merchant# sells", /*french*/"le #marchand de Missiles# vend", /*spanish*/"un #mercader de bombchus# vende"},
  });

    hintTable[RHT_MARKET_BOMBCHU_SHOP_ITEM_7] = HintText::Exclude({
                       //obscure text
                       Text{"a #Bombchu merchant# sells", /*french*/"le #marchand de Missiles# vend", /*spanish*/"un #mercader de bombchus# vende"},
  });

    hintTable[RHT_MARKET_BOMBCHU_SHOP_ITEM_8] = HintText::Exclude({
                       //obscure text
                       Text{"a #Bombchu merchant# sells", /*french*/"le #marchand de Missiles# vend", /*spanish*/"un #mercader de bombchus# vende"},
  });


    hintTable[RHT_MARKET_POTION_SHOP_ITEM_1] = HintText::Exclude({
                       //obscure text
                       Text{"a #potion seller# offers", /*french*/"l'#apothicaire# vend", /*spanish*/"un #vendedor de pociones# ofrece"},
                     }, {},
                       //clear text
    ...
    hintTable[RHT_MARKET_POTION_SHOP_ITEM_2] = HintText::Exclude({
                       //obscure text
                       Text{"a #potion seller# offers", /*french*/"l'#apothicaire# vend", /*spanish*/"un #vendedor de pociones# ofrece"},
                     }, {},
                       //clear text
    ...
    hintTable[RHT_MARKET_POTION_SHOP_ITEM_3] = HintText::Exclude({
                       //obscure text
                       Text{"a #potion seller# offers", /*french*/"l'#apothicaire# vend", /*spanish*/"un #vendedor de pociones# ofrece"},
                     }, {},
                       //clear text
    ...
    hintTable[RHT_MARKET_POTION_SHOP_ITEM_4] = HintText::Exclude({
                       //obscure text
                       Text{"a #potion seller# offers", /*french*/"l'#apothicaire# vend", /*spanish*/"un #vendedor de pociones# ofrece"},
                     }, {},
                       //clear text
    ...
    hintTable[RHT_MARKET_POTION_SHOP_ITEM_5] = HintText::Exclude({
                       //obscure text
                       Text{"a #potion seller# offers", /*french*/"l'#apothicaire# vend", /*spanish*/"un #vendedor de pociones# ofrece"},
                     }, {},
                       //clear text
    ...
    hintTable[RHT_MARKET_POTION_SHOP_ITEM_6] = HintText::Exclude({
                       //obscure text
                       Text{"a #potion seller# offers", /*french*/"l'#apothicaire# vend", /*spanish*/"un #vendedor de pociones# ofrece"},
                     }, {},
                       //clear text
    ...
    hintTable[RHT_MARKET_POTION_SHOP_ITEM_7] = HintText::Exclude({
                       //obscure text
                       Text{"a #potion seller# offers", /*french*/"l'#apothicaire# vend", /*spanish*/"un #vendedor de pociones# ofrece"},
                     }, {},
                       //clear text
    ...
    hintTable[RHT_MARKET_POTION_SHOP_ITEM_8] = HintText::Exclude({
                       //obscure text
                       Text{"a #potion seller# offers", /*french*/"l'#apothicaire# vend", /*spanish*/"un #vendedor de pociones# ofrece"},
                     }, {},
                       //clear text
    ...
    hintTable[RHT_MARKET_BAZAAR_ITEM_1] = HintText::Exclude({
                       //obscure text
                       Text{"the #Market Bazaar# offers", /*french*/"le #bazar de la Place du Marché# vend", /*spanish*/"el #bazar del mercado# ofrece"},
  });

    hintTable[RHT_MARKET_BAZAAR_ITEM_2] = HintText::Exclude({
                       //obscure text
                       Text{"the #Market Bazaar# offers", /*french*/"le #bazar de la Place du Marché# vend", /*spanish*/"el #bazar del mercado# ofrece"},
  });

    hintTable[RHT_MARKET_BAZAAR_ITEM_3] = HintText::Exclude({
                       //obscure text
                       Text{"the #Market Bazaar# offers", /*french*/"le #bazar de la Place du Marché# vend", /*spanish*/"el #bazar del mercado# ofrece"},
  });

    hintTable[RHT_MARKET_BAZAAR_ITEM_4] = HintText::Exclude({
                       //obscure text
                       Text{"the #Market Bazaar# offers", /*french*/"le #bazar de la Place du Marché# vend", /*spanish*/"el #bazar del mercado# ofrece"},
  });

    hintTable[RHT_MARKET_BAZAAR_ITEM_5] = HintText::Exclude({
                       //obscure text
                       Text{"the #Market Bazaar# offers", /*french*/"le #bazar de la Place du Marché# vend", /*spanish*/"el #bazar del mercado# ofrece"},
  });

    hintTable[RHT_MARKET_BAZAAR_ITEM_6] = HintText::Exclude({
                       //obscure text
                       Text{"the #Market Bazaar# offers", /*french*/"le #bazar de la Place du Marché# vend", /*spanish*/"el #bazar del mercado# ofrece"},
  });

    hintTable[RHT_MARKET_BAZAAR_ITEM_7] = HintText::Exclude({
                       //obscure text
                       Text{"the #Market Bazaar# offers", /*french*/"le #bazar de la Place du Marché# vend", /*spanish*/"el #bazar del mercado# ofrece"},
  });

    hintTable[RHT_MARKET_BAZAAR_ITEM_8] = HintText::Exclude({
                       //obscure text
                       Text{"the #Market Bazaar# offers", /*french*/"le #bazar de la Place du Marché# vend", /*spanish*/"el #bazar del mercado# ofrece"},
  });


    hintTable[RHT_KAK_BAZAAR_ITEM_1] = HintText::Exclude({
                       //obscure text
                       Text{"the #Kakariko Bazaar# offers", /*french*/"le #bazar de Kakariko# vend", /*spanish*/"el #bazar de Kakariko# ofrece"},
  });

    hintTable[RHT_KAK_BAZAAR_ITEM_2] = HintText::Exclude({
                       //obscure text
                       Text{"the #Kakariko Bazaar# offers", /*french*/"le #bazar de Kakariko# vend", /*spanish*/"el #bazar de Kakariko# ofrece"},
  });

    hintTable[RHT_KAK_BAZAAR_ITEM_3] = HintText::Exclude({
                       //obscure text
                       Text{"the #Kakariko Bazaar# offers", /*french*/"le #bazar de Kakariko# vend", /*spanish*/"el #bazar de Kakariko# ofrece"},
  });

    hintTable[RHT_KAK_BAZAAR_ITEM_4] = HintText::Exclude({
                       //obscure text
                       Text{"the #Kakariko Bazaar# offers", /*french*/"le #bazar de Kakariko# vend", /*spanish*/"el #bazar de Kakariko# ofrece"},
  });

    hintTable[RHT_KAK_BAZAAR_ITEM_5] = HintText::Exclude({
                       //obscure text
                       Text{"the #Kakariko Bazaar# offers", /*french*/"le #bazar de Kakariko# vend", /*spanish*/"el #bazar de Kakariko# ofrece"},
  });

    hintTable[RHT_KAK_BAZAAR_ITEM_6] = HintText::Exclude({
                       //obscure text
                       Text{"the #Kakariko Bazaar# offers", /*french*/"le #bazar de Kakariko# vend", /*spanish*/"el #bazar de Kakariko# ofrece"},
  });

    hintTable[RHT_KAK_BAZAAR_ITEM_7] = HintText::Exclude({
                       //obscure text
                       Text{"the #Kakariko Bazaar# offers", /*french*/"le #bazar de Kakariko# vend", /*spanish*/"el #bazar de Kakariko# ofrece"},
  });

    hintTable[RHT_KAK_BAZAAR_ITEM_8] = HintText::Exclude({
                       //obscure text
                       Text{"the #Kakariko Bazaar# offers", /*french*/"le #bazar de Kakariko# vend", /*spanish*/"el #bazar de Kakariko# ofrece"},
  });


    hintTable[RHT_ZD_SHOP_ITEM_1] = HintText::Exclude({
                       //obscure text
                       Text{"a #Zora shopkeeper# sells", /*french*/"la #boutique Zora# vend", /*spanish*/"el #dependiente Zora# vende"},
  });

    hintTable[RHT_ZD_SHOP_ITEM_2] = HintText::Exclude({
                       //obscure text
                       Text{"a #Zora shopkeeper# sells", /*french*/"la #boutique Zora# vend", /*spanish*/"el #dependiente Zora# vende"},
  });

    hintTable[RHT_ZD_SHOP_ITEM_3] = HintText::Exclude({
                       //obscure text
                       Text{"a #Zora shopkeeper# sells", /*french*/"la #boutique Zora# vend", /*spanish*/"el #dependiente Zora# vende"},
  });

    hintTable[RHT_ZD_SHOP_ITEM_4] = HintText::Exclude({
                       //obscure text
                       Text{"a #Zora shopkeeper# sells", /*french*/"la #boutique Zora# vend", /*spanish*/"el #dependiente Zora# vende"},
  });

    hintTable[RHT_ZD_SHOP_ITEM_5] = HintText::Exclude({
                       //obscure text
                       Text{"a #Zora shopkeeper# sells", /*french*/"la #boutique Zora# vend", /*spanish*/"el #dependiente Zora# vende"},
  });

    hintTable[RHT_ZD_SHOP_ITEM_6] = HintText::Exclude({
                       //obscure text
                       Text{"a #Zora shopkeeper# sells", /*french*/"la #boutique Zora# vend", /*spanish*/"el #dependiente Zora# vende"},
  });

    hintTable[RHT_ZD_SHOP_ITEM_7] = HintText::Exclude({
                       //obscure text
                       Text{"a #Zora shopkeeper# sells", /*french*/"la #boutique Zora# vend", /*spanish*/"el #dependiente Zora# vende"},
  });

    hintTable[RHT_ZD_SHOP_ITEM_8] = HintText::Exclude({
                       //obscure text
                       Text{"a #Zora shopkeeper# sells", /*french*/"la #boutique Zora# vend", /*spanish*/"el #dependiente Zora# vende"},
  });


    hintTable[RHT_GC_SHOP_ITEM_1] = HintText::Exclude({
                       //obscure text
                       Text{"a #Goron shopkeeper# sells", /*french*/"la #boutique Goron# vend", /*spanish*/"el #dependiente Goron# vende"},
  });

    hintTable[RHT_GC_SHOP_ITEM_2] = HintText::Exclude({
                       //obscure text
                       Text{"a #Goron shopkeeper# sells", /*french*/"la #boutique Goron# vend", /*spanish*/"el #dependiente Goron# vende"},
  });

    hintTable[RHT_GC_SHOP_ITEM_3] = HintText::Exclude({
                       //obscure text
                       Text{"a #Goron shopkeeper# sells", /*french*/"la #boutique Goron# vend", /*spanish*/"el #dependiente Goron# vende"},
  });

    hintTable[RHT_GC_SHOP_ITEM_4] = HintText::Exclude({
                       //obscure text
                       Text{"a #Goron shopkeeper# sells", /*french*/"la #boutique Goron# vend", /*spanish*/"el #dependiente Goron# vende"},
  });

    hintTable[RHT_GC_SHOP_ITEM_5] = HintText::Exclude({
                       //obscure text
                       Text{"a #Goron shopkeeper# sells", /*french*/"la #boutique Goron# vend", /*spanish*/"el #dependiente Goron# vende"},
  });

    hintTable[RHT_GC_SHOP_ITEM_6] = HintText::Exclude({
                       //obscure text
                       Text{"a #Goron shopkeeper# sells", /*french*/"la #boutique Goron# vend", /*spanish*/"el #dependiente Goron# vende"},
  });

    hintTable[RHT_GC_SHOP_ITEM_7] = HintText::Exclude({
                       //obscure text
                       Text{"a #Goron shopkeeper# sells", /*french*/"la #boutique Goron# vend", /*spanish*/"el #dependiente Goron# vende"},
  });

    hintTable[RHT_GC_SHOP_ITEM_8] = HintText::Exclude({
                       //obscure text
                       Text{"a #Goron shopkeeper# sells", /*french*/"la #boutique Goron# vend", /*spanish*/"el #dependiente Goron# vende"},
  });


    hintTable[RHT_HF_DEKU_SCRUB_GROTTO] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_LLR_DEKU_SCRUB_GROTTO_LEFT] = HintText::Exclude({
                       //obscure text
                       Text{"a #trio of scrubs# sells", /*french*/"le #trio de peste Mojo à la ferme# vend", /*spanish*/"un #trío de dekus# de una granja venden"},
  });

    hintTable[RHT_LLR_DEKU_SCRUB_GROTTO_RIGHT] = HintText::Exclude({
                       //obscure text
                       Text{"a #trio of scrubs# sells", /*french*/"le #trio de peste Mojo à la ferme# vend", /*spanish*/"un #trío de dekus# de una granja venden"},
  });

    hintTable[RHT_LLR_DEKU_SCRUB_GROTTO_CENTER] = HintText::Exclude({
                       //obscure text
                       Text{"a #trio of scrubs# sells", /*french*/"le #trio de peste Mojo à la ferme# vend", /*spanish*/"un #trío de dekus# de una granja venden"},
  });


    hintTable[RHT_LW_DEKU_SCRUB_NEAR_DEKU_THEATER_RIGHT] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_LW_DEKU_SCRUB_NEAR_DEKU_THEATER_LEFT] = HintText::Exclude({
                       //obscure text
                       Text{"a pair of #scrubs in the woods# sells", /*french*/"le #duo de peste Mojo près du théâtre# vend", /*spanish*/"un par de #dekus del bosque# venden"},
  });

    hintTable[RHT_LW_DEKU_SCRUB_NEAR_BRIDGE] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_LW_DEKU_SCRUB_GROTTO_REAR] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_LW_DEKU_SCRUB_GROTTO_FRONT] = HintText::Exclude({
                       //obscure text
                       Text{"a #scrub underground duo# sells", /*french*/"le #duo de peste Mojo dans les sous-bois# vend", /*spanish*/"un #par de dekus subterráneos# del bosque venden"},
  });


    hintTable[RHT_SFM_DEKU_SCRUB_GROTTO_REAR] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_SFM_DEKU_SCRUB_GROTTO_FRONT] = HintText::Exclude({
                       //obscure text
                       Text{"a #scrub underground duo# sells", /*french*/"le #duo de peste Mojo au cur du sanctuaire sylvestre# vend", /*spanish*/"un #par de dekus subterráneos# de la pradera sagrada venden"},
  });


    hintTable[RHT_GC_DEKU_SCRUB_GROTTO_LEFT] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_GC_DEKU_SCRUB_GROTTO_RIGHT] = HintText::Exclude({
                       //obscure text
                       Text{"a #trio of scrubs# sells", /*french*/"le #trio de peste Mojo dans le village Goron# vend", /*spanish*/"un #trío de dekus# de la Ciudad Goron venden"},
  });

    hintTable[RHT_GC_DEKU_SCRUB_GROTTO_CENTER] = HintText::Exclude({
                       //obscure text
                       Text{"a #trio of scrubs# sells", /*french*/"le #trio de peste Mojo dans le village Goron# vend", /*spanish*/"un #trío de dekus# de la Ciudad Goron venden"},
  });


    hintTable[RHT_DMC_DEKU_SCRUB_GROTTO_LEFT] = HintText::Exclude({
                       //obscure text
                       Text{"a #trio of scrubs# sells", /*french*/"le #trio de peste Mojo dans le volcan# vend", /*spanish*/"un #trío de dekus# del volcán venden"},
  });

    hintTable[RHT_DMC_DEKU_SCRUB_GROTTO_RIGHT] = HintText::Exclude({
                       //obscure text
                       Text{"a #trio of scrubs# sells", /*french*/"le #trio de peste Mojo dans le volcan# vend", /*spanish*/"un #trío de dekus# del volcán venden"},
  });

    hintTable[RHT_DMC_DEKU_SCRUB_GROTTO_CENTER] = HintText::Exclude({
                       //obscure text
                       Text{"a #trio of scrubs# sells", /*french*/"le #trio de peste Mojo dans le volcan# vend", /*spanish*/"un #trío de dekus# del volcán venden"},
  });


    hintTable[RHT_ZR_DEKU_SCRUB_GROTTO_REAR] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_ZR_DEKU_SCRUB_GROTTO_FRONT] = HintText::Exclude({
                       //obscure text
                       Text{"a #scrub underground duo# sells", /*french*/"le #duo de peste Mojo près du fleuve# vend", /*spanish*/"un #par de dekus subterráneos# del río venden"},
  });


    hintTable[RHT_LH_DEKU_SCRUB_GROTTO_LEFT] = HintText::Exclude({
                       //obscure text
                       Text{"a #trio of scrubs# sells", /*french*/"le #trio de peste Mojo près du lac# vend", /*spanish*/"un #trío de dekus# del lago venden"},
  });

    hintTable[RHT_LH_DEKU_SCRUB_GROTTO_RIGHT] = HintText::Exclude({
                       //obscure text
                       Text{"a #trio of scrubs# sells", /*french*/"le #trio de peste Mojo près du lac# vend", /*spanish*/"un #trío de dekus# del lago venden"},
  });

    hintTable[RHT_LH_DEKU_SCRUB_GROTTO_CENTER] = HintText::Exclude({
                       //obscure text
                       Text{"a #trio of scrubs# sells", /*french*/"le #trio de peste Mojo près du lac# vend", /*spanish*/"un #trío de dekus# del lago venden"},
  });


    hintTable[RHT_GV_DEKU_SCRUB_GROTTO_REAR] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_GV_DEKU_SCRUB_GROTTO_FRONT] = HintText::Exclude({
                       //obscure text
                       Text{"a #scrub underground duo# sells", /*french*/"le #duo de peste Mojo près de la vallée# vend", /*spanish*/"un #par de dekus subterráneos# del valle venden"},
  });


    hintTable[RHT_COLOSSUS_DEKU_SCRUB_GROTTO_FRONT] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_COLOSSUS_DEKU_SCRUB_GROTTO_REAR] = HintText::Exclude({
                       //obscure text
                       Text{"a #scrub underground duo# sells", /*french*/"le #duo de peste Mojo dans le désert# vend", /*spanish*/"un #par de dekus subterráneos# del desierto venden"},
  });
    ...
    hintTable[RHT_LLR_STABLES_RIGHT_COW] = HintText::Exclude({
                       //obscure text
                       Text{"a #cow in a stable# gifts", /*french*/"la #vache dans l'étable# donne", /*spanish*/"una #vaca del establo# brinda"},
  });

    hintTable[RHT_LLR_TOWER_RIGHT_COW] = HintText::Exclude({
                       //obscure text
                       Text{"a #cow in a ranch silo# gifts", /*french*/"la #vache dans le silo de la ferme# donne", /*spanish*/"una #vaca del granero# brinda"},
  });

    hintTable[RHT_LLR_TOWER_LEFT_COW] = HintText::Exclude({
                       //obscure text
                       Text{"a #cow in a ranch silo# gifts", /*french*/"la #vache dans le silo de la ferme# donne", /*spanish*/"una #vaca del granero# brinda"},
  });

    hintTable[RHT_KAK_IMPAS_HOUSE_COW] = HintText::Exclude({
                       //obscure text
                       Text{"a #cow imprisoned in a house# protects", /*french*/"la #vache en cage# donne", /*spanish*/"una #vaca enjaulada de una casa# brinda"},
  });

    hintTable[RHT_DMT_COW_GROTTO_COW] = HintText::Exclude({
                       //obscure text
    ...
    hintTable[RHT_KF_LINKS_HOUSE_POT] = HintText::Exclude({
                    //obscure text
                    Text{"a #pot in a room# holds", /*french*/"a #pot in a room# holds", /*spanish*/"a #pot in a room# holds"},
    });
    hintTable[RHT_KF_TWINS_HOUSE_POT_1] = HintText::Exclude({
                    //obscure text
                    Text{"a #pot in a room# holds", /*french*/"a #pot in a room# holds", /*spanish*/"a #pot in a room# holds"},
    });
    hintTable[RHT_KF_TWINS_HOUSE_POT_2] = HintText::Exclude({
                    //obscure text
                    Text{"a #pot in a room# holds", /*french*/"a #pot in a room# holds", /*spanish*/"a #pot in a room# holds"},
    });
    hintTable[RHT_KF_BROTHERS_HOUSE_POT_1] = HintText::Exclude({
                    //obscure text
                    Text{"a #pot in a room# holds", /*french*/"a #pot in a room# holds", /*spanish*/"a #pot in a room# holds"},
    });
    hintTable[RHT_KF_BROTHERS_HOUSE_POT_2] = HintText::Exclude({
                    //obscure text
                    Text{"a #pot in a room# holds", /*french*/"a #pot in a room# holds", /*spanish*/"a #pot in a room# holds"},
    });
    hintTable[RHT_GF_BREAK_ROOM_POT_1] = HintText::Exclude({
                    //obscure text
                    Text{"a #pot in a room# holds", /*french*/"a #pot in a room# holds", /*spanish*/"a #pot in a room# holds"},
    });
    hintTable[RHT_GF_BREAK_ROOM_POT_2] = HintText::Exclude({
                    // obscure text
                    Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GF_KITCHEN_POT_1] = HintText::Exclude({
                    // obscure text
                    Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GF_KITCHEN_POT_2] = HintText::Exclude({
                    // obscure text
                    Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GF_NORTH_F1_CARPENTER_POT_1] = HintText::Exclude({
                    // obscure text
                    Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GF_NORTH_F1_CARPENTER_POT_2] = HintText::Exclude({
                    //obscure text
                    Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GF_NORTH_F1_CARPENTER_POT_3] = HintText::Exclude({
                    // obscure text
                    Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GF_NORTH_F2_CARPENTER_POT_1] = HintText::Exclude({
                    // obscure text
                    Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GF_NORTH_F2_CARPENTER_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GF_SOUTH_F1_CARPENTER_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GF_SOUTH_F1_CARPENTER_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GF_SOUTH_F1_CARPENTER_POT_3] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GF_SOUTH_F1_CARPENTER_CELL_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GF_SOUTH_F1_CARPENTER_CELL_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GF_SOUTH_F1_CARPENTER_CELL_POT_3] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GF_SOUTH_F1_CARPENTER_CELL_POT_4] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_WASTELAND_NEAR_GS_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_WASTELAND_NEAR_GS_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_WASTELAND_NEAR_GS_POT_3] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_WASTELAND_NEAR_GS_POT_4] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_3] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_4] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_5] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_6] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_7] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_8] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_9] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_10] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_11] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_12] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_13] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_14] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_15] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_16] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_17] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_18] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_19] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_20] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_21] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_22] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_23] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_24] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_25] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_26] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_27] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_28] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_29] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_30] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_31] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_32] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_33] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_34] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_35] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_36] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_37] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_38] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_39] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_40] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_41] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_42] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_43] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_CHILD_POT_44] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_ADULT_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_ADULT_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_ADULT_POT_3] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_ADULT_POT_4] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_ADULT_POT_5] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_ADULT_POT_6] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_ADULT_POT_7] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_ADULT_POT_8] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_ADULT_POT_9] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_ADULT_POT_10] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_GUARD_HOUSE_ADULT_POT_11] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_BACK_ALLEY_HOUSE_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_BACK_ALLEY_HOUSE_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_MK_BACK_ALLEY_HOUSE_POT_3] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_KAK_NEAR_POTION_SHOP_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_KAK_NEAR_POTION_SHOP_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_KAK_NEAR_POTION_SHOP_POT_3] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_KAK_NEAR_IMPAS_HOUSE_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_KAK_NEAR_IMPAS_HOUSE_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_KAK_NEAR_IMPAS_HOUSE_POT_3] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_KAK_NEAR_GUARDS_HOUSE_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_KAK_NEAR_GUARDS_HOUSE_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_KAK_NEAR_GUARDS_HOUSE_POT_3] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_KAK_NEAR_MEDICINE_SHOP_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_KAK_NEAR_MEDICINE_SHOP_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GY_DAMPES_GRAVE_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GY_DAMPES_GRAVE_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GY_DAMPES_GRAVE_POT_3] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GY_DAMPES_GRAVE_POT_4] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GY_DAMPES_GRAVE_POT_5] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GY_DAMPES_GRAVE_POT_6] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GC_LOWER_STAIRCASE_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GC_LOWER_STAIRCASE_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GC_UPPER_STAIRCASE_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GC_UPPER_STAIRCASE_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GC_UPPER_STAIRCASE_POT_3] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GC_MEDIGORON_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GC_DARUNIA_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GC_DARUNIA_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_GC_DARUNIA_POT_3] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_DMC_NEAR_GC_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_DMC_NEAR_GC_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_DMC_NEAR_GC_POT_3] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_DMC_NEAR_GC_POT_4] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_ZD_NEAR_SHOP_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_ZD_NEAR_SHOP_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_ZD_NEAR_SHOP_POT_3] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_ZD_NEAR_SHOP_POT_4] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_ZD_NEAR_SHOP_POT_5] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_ZF_HIDDEN_CAVE_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_ZF_HIDDEN_CAVE_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_ZF_HIDDEN_CAVE_POT_3] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_ZF_NEAR_JABU_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_ZF_NEAR_JABU_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_ZF_NEAR_JABU_POT_3] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_ZF_NEAR_JABU_POT_4] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_LLR_FRONT_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_LLR_FRONT_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_LLR_FRONT_POT_3] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_LLR_FRONT_POT_4] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_LLR_RAIN_SHED_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_LLR_RAIN_SHED_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_LLR_RAIN_SHED_POT_3] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_LLR_TALONS_HOUSE_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_LLR_TALONS_HOUSE_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_LLR_TALONS_HOUSE_POT_3] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_HF_COW_GROTTO_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_HF_COW_GROTTO_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_HC_STORMS_GROTTO_POT_1] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_HC_STORMS_GROTTO_POT_2] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_HC_STORMS_GROTTO_POT_3] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
    hintTable[RHT_HC_STORMS_GROTTO_POT_4] = HintText::Exclude({
                // obscure text
                Text{ "a #pot in a room# holds", /*french*/ "a #pot in a room# holds", /*spanish*/ "a #pot in a room# holds" },
    });
}
