...
void HintTable_Init_Item() {
    ...
    hintTable[HYLIAN_SHIELD] = HintText::Item(
        {
            ...
            Text{ "Like Like's metal meal", /*french*/ "un amuse-gueule de Pudding",
    ...
    hintTable[IRON_BOOTS] = HintText::Item(
        ...
        },
        {
            ...
            Text{ "a feature of the Water Temple", /*french*/ "une particularité du Temple de l'Eau",
    ...
    hintTable[HOVER_BOOTS] = HintText::Item(
        {
            ...
            Text{ "sacred slippers", /*french*/ "une paire de pantoufles sacrées",
                  /*spanish*/ "unos escurridizos botines" },
            Text{ "spacewalkers", /*french*/ "une paire de bottes spatiales",
    ...
    hintTable[BOOMERANG] = HintText::Item(
        ...
        {
            // ambiguous text
            Text{ "something that can grab things", /*french*/ "une chose qui peut attraper",
                  /*spanish*/ "algo que pueda agarrar cosas" },
            Text{ "something that can stun", /*french*/ "une chose qui peut paralyser",
    ...
    hintTable[LENS_OF_TRUTH] = HintText::Item(
        ...
        {
            // ambiguous text
            Text{ "a secret-finding tool", /*french*/ "un cherche-secrets",
    ...
    hintTable[MEGATON_HAMMER] = HintText::Item(
        ...
        {
            // ambiguous text
            Text{ "something that can remove boulders", /*french*/ "une chose qui enlève les rochers",
    ...
    hintTable[STONE_OF_AGONY] = HintText::Item(
        ...
        {
            // ambiguous text
            Text{ "a prize of the House of Skulltulas", /*french*/ "un prix de la maison des Skulltulas",
    ...
    hintTable[DINS_FIRE] = HintText::Item(
        ...
        {
            // ambiguous text
            Text{ "a Great Fairy's power", /*french*/ "le pouvoir d'une grande fée",
    ...
    hintTable[GERUDO_MEMBERSHIP_CARD] = HintText::Item(
        ...
        {
            Text{ "a token of recognition", /*french*/ "une preuve de reconnaissance",
    ...
    hintTable[MAGIC_BEAN] = HintText::Item(
        ...
        {
            // ambiguous text
            Text{ "something sometimes buried", /*french*/ "une chose parfois enterrée",
    ...
    hintTable[MAGIC_BEAN_PACK] = HintText::Item(
        {
            // obscure text
            Text{ "wizardly legumes", /*french*/ "un paquet de légumes ensorcelés",
    ...
    hintTable[DOUBLE_DEFENSE] = HintText::Item(
        ...
        },
        {
            ...
            Text{ "a Great Fairy's power", /*french*/ "le pouvoir d'une grande fée",
                  /*spanish*/ "el poder de una Gran Hada" },
            Text{ "something heart-shaped", /*french*/ "une chose en forme de coeur",
    ...
    hintTable[GOLD_SKULLTULA_TOKEN] = HintText::Item(
        {
            // obscure text
            Text{ "proof of destruction", /*french*/ "un certificat d'élimination",
            ...
            Text{ "one percent of a curse", /*french*/ "un centième de malédiction",
        ...
        // clear text
        Text{ "a Gold Skulltula Token", /*french*/ "un Symbole de Skulltula d'or",
    ...
    hintTable[POCKET_EGG] = HintText::Item(
        ...
        {
            // ambiguous text
            Text{ "a trade quest item", /*french*/ "un objet de quête d'échanges",
    ...
    hintTable[ODD_POTION] = HintText::Item(
        ...
        {
            // ambiguous text
            Text{ "something that contains medicine", /*french*/ "une chose médicamenteuse",
                  /*spanish*/ "algo que contenga medicina" },
            Text{ "something with a strange smell", /*french*/ "une chose qui sent bizarre",
    ...
    hintTable[CLAIM_CHECK] = HintText::Item(
        {
            // obscure text
            Text{ "a three day wait", /*french*/ "un rendez-vous dans trois jours",
    ...
    hintTable[PROGRESSIVE_STRENGTH] = HintText::Item(
        {
            // obscure text
            Text{ "power gloves", /*french*/ "une paire de gants de travail",
    ...
    hintTable[PROGRESSIVE_NUT_UPGRADE] = HintText::Item(
        ...
        {
            // ambiguous text
            Text{ "some Deku munitions", /*french*/ "un paquet de munitions Mojo",
                  /*spanish*/ "un montón de municiones Deku" },
            Text{ "something that can stun", /*french*/ "une chose qui peut paralyser",
                  /*spanish*/ "algo que pueda paralizar" },
        },
        // clear text
        Text{ "Deku Nut Capacity", /*french*/ "une Augmentation de Noix Mojo",
    ...
    hintTable[PROGRESSIVE_STICK_UPGRADE] = HintText::Item(
        ...
        // clear text
        Text{ "Deku Stick Capacity", /*french*/ "une augmentation de bâtons Mojo",
    ...
    hintTable[PROGRESSIVE_OCARINA] = HintText::Item(
        ...
        },
        {
            ...
            Text{ "something kept by the royal family", /*french*/ "une chose qui paralyse",
    ...
    hintTable[BOTTLE_WITH_RED_POTION] = HintText::Item(
        ...
        // clear text
        Text{ "a Red Potion Bottle", /*french*/ "un flacon de potion rouge",
    ...
    hintTable[BOTTLE_WITH_GREEN_POTION] = HintText::Item(
        ...
        // clear text
        Text{ "a Green Potion Bottle", /*french*/ "un flacon de potion verte",
    ...
    hintTable[BOTTLE_WITH_BLUE_POTION] = HintText::Item(
        ...
        // clear text
        Text{ "a Blue Potion Bottle", /*french*/ "un flacon de potion bleue",
    ...
    hintTable[BOTTLE_WITH_FISH] = HintText::Item(
        {
            ...
            Text{ "a deity's snack", /*french*/ "le repas d'un dieu marin",
    ...
    hintTable[BOTTLE_WITH_BUGS] = HintText::Item(
        {
            ...
            Text{ "Skulltula finders", /*french*/ "une poignée de trouve-Skulltula",
    ...
    hintTable[BOTTLE_WITH_BIG_POE] = HintText::Item(
        {
            // obscure text
            Text{ "the spookiest ghost", /*french*/ "un épouvantable spectre",
    ...
    hintTable[SARIAS_SONG] = HintText::Item(
        {
            ...
            Text{ "Saria's phone number", /*french*/ "le téléphone d'une amie",
    ...
    hintTable[SONG_OF_STORMS] = HintText::Item(
        {
            ...
            Text{ "windmill acceleration", /*french*/ "l'accélérateur de moulins",
    ...
    hintTable[MINUET_OF_FOREST] = HintText::Item(
        ...
        {
            // ambiguous text
            Text{ "a warp song", /*french*/ "une chanson de téléportation",
    ...
    hintTable[REQUIEM_OF_SPIRIT] = HintText::Item(
        {
            // obscure text
            Text{ "a song of sandy statues", /*french*/ "la mélodie d'une grande statue",
    ...
    hintTable[NOCTURNE_OF_SHADOW] = HintText::Item(
        {
            // obscure text
            Text{ "a song of spooky spirits", /*french*/ "une hymne de chair de poule",
    ...
    hintTable[PRELUDE_OF_LIGHT] = HintText::Item(
        {
            // obscure text
            Text{ "a luminous prologue melody", /*french*/ "une matine illuminée",
    ...
    hintTable[DODONGOS_CAVERN_MAP] = HintText::Item(
        ...
        // clear text
        Text{ "the Dodongo's Cavern Map", /*french*/ "la carte de la Caverne Dodongo",
    ...
    hintTable[JABU_JABUS_BELLY_MAP] = HintText::Item(
        ...
        // clear text
        Text{ "the Jabu-Jabu's Belly Map", /*french*/ "la carte de Jabu-Jabu",
    ...
    hintTable[FOREST_TEMPLE_MAP] = HintText::Item(
        ...
        // clear text
        Text{ "the Forest Temple Map", /*french*/ "la carte du Temple de la Forêt",
    ...
    hintTable[FIRE_TEMPLE_MAP] = HintText::Item(
        ...
        // clear text
        Text{ "the Fire Temple Map", /*french*/ "la carte du Temple du Feu",
    ...
    hintTable[WATER_TEMPLE_MAP] = HintText::Item(
        ...
        // clear text
        Text{ "the Water Temple Map", /*french*/ "la carte du Temple de l'Eau",
    ...
    hintTable[SPIRIT_TEMPLE_MAP] = HintText::Item(
        ...
        // clear text
        Text{ "the Spirit Temple Map", /*french*/ "la carte du Temple de l'Esprit",
    ...
    hintTable[SHADOW_TEMPLE_MAP] = HintText::Item(
        ...
        // clear text
        Text{ "the Shadow Temple Map", /*french*/ "la carte du Temple de l'Ombre",
    ...
    hintTable[BOTTOM_OF_THE_WELL_MAP] = HintText::Item(
        ...
        // clear text
        Text{ "the Bottom of the Well Map", /*french*/ "la carte du fond du Puits",
    ...
    hintTable[ICE_CAVERN_MAP] = HintText::Item(
        ...
        // clear text
        Text{ "the Ice Cavern Map", /*french*/ "la carte de la Caverne Polaire",
    ...
    hintTable[DEKU_TREE_COMPASS] = HintText::Item(
        ...
        // clear text
        Text{ "the Deku Tree Compass", /*french*/ "la boussole de l'Arbre Mojo",
    ...
    hintTable[DODONGOS_CAVERN_COMPASS] = HintText::Item(
        ...
        // clear text
        Text{ "the Dodongo's Cavern Compass", /*french*/ "la boussole de la Caverne Dodongo",
    ...
    hintTable[JABU_JABUS_BELLY_COMPASS] = HintText::Item(
        ...
        // clear text
        Text{ "the Jabu-Jabu's Belly Compass", /*french*/ "la boussole de Jabu-Jabu",
              /*spanish*/ "la brújula de la Tripa de Jabu-Jabu" });
    hintTable[FOREST_TEMPLE_COMPASS] = HintText::Item(
        {
            // obscure text
            Text{ "a sylvan treasure tracker", /*french*/ "un cherche-trésor sylvestre",
        ...
        // clear text
        Text{ "the Forest Temple Compass", /*french*/ "la boussole du Temple de la Forêt",
    ...
    hintTable[FIRE_TEMPLE_COMPASS] = HintText::Item(
        ...
        // clear text
        Text{ "the Fire Temple Compass", /*french*/ "la boussole du Temple du Feu",
    ...
    hintTable[WATER_TEMPLE_COMPASS] = HintText::Item(
        ...
        // clear text
        Text{ "the Water Temple Compass", /*french*/ "la boussole du Temple de l'Eau",
    ...
    hintTable[SPIRIT_TEMPLE_COMPASS] = HintText::Item(
        ...
        // clear text
        Text{ "the Spirit Temple Compass", /*french*/ "la boussole du Temple de l'Esprit",
              /*spanish*/ "la brújula del Templo del Espíritu" });
    hintTable[SHADOW_TEMPLE_COMPASS] = HintText::Item(
        {
            // obscure text
            Text{ "a creepy treasure tracker", /*french*/ "un cherche-trésor sinistre",
        ...
        // clear text
        Text{ "the Shadow Temple Compass", /*french*/ "la boussole du Temple de l'Ombre",
    ...
    hintTable[BOTTOM_OF_THE_WELL_COMPASS] = HintText::Item(
        ...
        // clear text
        Text{ "the Bottom of the Well Compass", /*french*/ "la boussole du fond du Puits",
    ...
    hintTable[ICE_CAVERN_COMPASS] = HintText::Item(
        ...
        // clear text
        Text{ "the Ice Cavern Compass", /*french*/ "la Boussole de la Caverne Polaire",
              /*spanish*/ "la brújula de la Caverna de hielo" });
    hintTable[FOREST_TEMPLE_BOSS_KEY] = HintText::Item(
        {
            // obscure text
            Text{ "a sylvan master of unlocking", /*french*/ "un anti-grosse porte sylvestre",
                  /*spanish*/ "la clave enselvada de un jefe" },
            Text{ "a sylvan dungeon's master pass", /*french*/ "une clé maléfique sylvestree",
        ...
        // clear text
        Text{ "the Forest Temple Boss Key", /*french*/ "la Clé d'Or du Temple de la Forêt",
              /*spanish*/ "la gran llave del Templo del Bosque" });
    hintTable[FIRE_TEMPLE_BOSS_KEY] = HintText::Item(
        {
            // obscure text
            Text{ "a molten master of unlocking", /*french*/ "un anti-grosse porte fondu",
                  /*spanish*/ "la clave fundido de un jefe" },
            Text{ "a molten dungeon's master pass", /*french*/ "une clé maléfique fondu",
        ...
        // clear text
        Text{ "the Fire Temple Boss Key", /*french*/ "la Clé d'Or du Temple du Feu",
              /*spanish*/ "la gran llave del Templo del Fuego" });
    hintTable[WATER_TEMPLE_BOSS_KEY] = HintText::Item(
        {
            // obscure text
            Text{ "a wet master of unlocking", /*french*/ "un anti-grosse porte humide",
                  /*spanish*/ "la clave mojado de un jefe" },
            Text{ "a wet dungeon's master pass", /*french*/ "une clé maléfique humide",
        ...
        // clear text
        Text{ "the Water Temple Boss Key", /*french*/ "la Clé d'Or du Temple de l'Eau",
              /*spanish*/ "la gran llave del Templo del Agua" });
    hintTable[SPIRIT_TEMPLE_BOSS_KEY] = HintText::Item(
        {
            // obscure text
            Text{ "a sandy master of unlocking", /*french*/ "un anti-grosse porte sableux",
                  /*spanish*/ "la clave arenoso de un jefe" },
            Text{ "a sandy dungeon's master pass", /*french*/ "une clé maléfique sableux",
        ...
        // clear text
        Text{ "the Spirit Temple Boss Key", /*french*/ "la Clé d'Or du Temple de l'Esprit",
              /*spanish*/ "la gran llave del Templo del Espíritu" });
    hintTable[SHADOW_TEMPLE_BOSS_KEY] = HintText::Item(
        {
            // obscure text
            Text{ "a creepy master of unlocking", /*french*/ "un anti-grosse porte sinistre",
                  /*spanish*/ "la clave siniestra de un jefe" },
            Text{ "a creepy dungeon's master pass", /*french*/ "une clé maléfique sinistre",
        ...
        // clear text
        Text{ "the Shadow Temple Boss Key", /*french*/ "la Clé d'Or du Temple de l'Ombre",
              /*spanish*/ "la gran llave del Templo de las Sombras" });
    hintTable[GANONS_CASTLE_BOSS_KEY] = HintText::Item(
        {
            // obscure text
            Text{ "a final master of unlocking", /*french*/ "un anti-grosse porte final",
                  /*spanish*/ "la clave final de un jefe" },
            Text{ "a final dungeon's master pass", /*french*/ "une clé maléfique final",
        ...
        // clear text
        Text{ "the Ganon's Castle Boss Key", /*french*/ "la Clé d'Or du Château de Ganon",
              /*spanish*/ "la gran llave del Castillo de Ganon" });
    hintTable[FOREST_TEMPLE_SMALL_KEY] = HintText::Item(
        {
            // obscure text
            Text{ "a sylvan tool for unlocking", /*french*/ "un anti-porte sylvestre",
                  /*spanish*/ "una clave de una entrada enselvada" },
            Text{ "a sylvan dungeon pass", /*french*/ "le rêve sylvestre d'un prisonnier",
                  /*spanish*/ "un pase de una mazmorra enselvada" },
            Text{ "a sylvan lock remover", /*french*/ "un efface-serrure sylvestre",
                  /*spanish*/ "un destructor de cerraduras enselvada" },
            Text{ "a sylvan lockpick", /*french*/ "un crochet à porte sylvestre",
        ...
        // clear text
        Text{ "a Forest Temple Small Key", /*french*/ "une petite clé du Temple de la Forêt",
              /*spanish*/ "una llave pequeña del Templo del Bosque" });
    hintTable[FIRE_TEMPLE_SMALL_KEY] = HintText::Item(
        {
            // obscure text
            Text{ "a molten tool for unlocking", /*french*/ "un anti-porte fondu",
                  /*spanish*/ "una clave de una entrada fundida" },
            Text{ "a molten dungeon pass", /*french*/ "le rêve fondu d'un prisonnier",
                  /*spanish*/ "un pase de una mazmorra fundida" },
            Text{ "a molten lock remover", /*french*/ "un efface-serrure fondu",
                  /*spanish*/ "un destructor de cerraduras fundida" },
            Text{ "a molten lockpick", /*french*/ "un crochet à porte fondu",
        ...
        // clear text
        Text{ "a Fire Temple Small Key", /*french*/ "une petite clé du Temple du Feu",
              /*spanish*/ "una llave pequeña del Templo del Fuego" });
    hintTable[WATER_TEMPLE_SMALL_KEY] = HintText::Item(
        {
            // obscure text
            Text{ "a wet tool for unlocking", /*french*/ "un anti-porte humide",
                  /*spanish*/ "una clave de una entrada mojada" },
            Text{ "a wet dungeon pass", /*french*/ "le rêve humide d'un prisonnier",
                  /*spanish*/ "un pase de una mazmorra mojada" },
            Text{ "a wet lock remover", /*french*/ "un efface-serrure humide",
                  /*spanish*/ "un destructor de cerraduras mojada" },
            Text{ "a wet lockpick", /*french*/ "un crochet à porte humide",
        ...
        // clear text
        Text{ "a Water Temple Small Key", /*french*/ "une petite clé du Temple de l'Eau",
              /*spanish*/ "una llave pequeña del Templo del Agua" });
    hintTable[SPIRIT_TEMPLE_SMALL_KEY] = HintText::Item(
        {
            // obscure text
            Text{ "a sandy tool for unlocking", /*french*/ "un anti-porte sableux",
                  /*spanish*/ "una clave de una entrada arenosa" },
            Text{ "a sandy dungeon pass", /*french*/ "le rêve sableux d'un prisonnier",
                  /*spanish*/ "un pase de una mazmorra arenosa" },
            Text{ "a sandy lock remover", /*french*/ "un efface-serrure sableux",
                  /*spanish*/ "un destructor de cerraduras arenosa" },
            Text{ "a sandy lockpick", /*french*/ "un crochet à porte sableux",
        ...
        // clear text
        Text{ "a Spirit Temple Small Key", /*french*/ "une petite clé du Temple de l'Esprit",
              /*spanish*/ "una llave pequeña del Templo del Espíritu" });
    hintTable[SHADOW_TEMPLE_SMALL_KEY] = HintText::Item(
        {
            // obscure text
            Text{ "a creepy tool for unlocking", /*french*/ "un anti-porte sinistre",
                  /*spanish*/ "una clave de una entrada siniestra:a" },
            Text{ "a creepy dungeon pass", /*french*/ "le rêve sinistre d'un prisonnier",
                  /*spanish*/ "un pase de una mazmorra siniestra:a" },
            Text{ "a creepy lock remover", /*french*/ "un efface-serrure sinistre",
                  /*spanish*/ "un destructor de cerraduras siniestra:a" },
            Text{ "a creepy lockpick", /*french*/ "un crochet à porte sinistre",
        ...
        // clear text
        Text{ "a Shadow Temple Small Key", /*french*/ "une petite clé du Temple de l'Ombre",
              /*spanish*/ "una llave pequeña del Templo de las Sombras" });
    hintTable[GERUDO_TRAINING_GROUNDS_SMALL_KEY] = HintText::Item(
        {
            // obscure text
            Text{ "a labyrinthian tool for unlocking", /*french*/ "un anti-porte labyrinthique",
                  /*spanish*/ "una clave de una entrada laberíntica" },
            Text{ "a labyrinthian dungeon pass", /*french*/ "le rêve labyrinthique d'un prisonnier",
                  /*spanish*/ "un pase de una mazmorra laberíntica" },
            Text{ "a labyrinthian lock remover", /*french*/ "un efface-serrure labyrinthique",
                  /*spanish*/ "un destructor de cerraduras laberíntica" },
            Text{ "a labyrinthian lockpick", /*french*/ "un crochet à porte labyrinthique",
        ...
        // clear text
        Text{ "a Gerudo Training Ground Small Key", /*french*/ "une petite clé du Gymnase Gerudo",
              /*spanish*/ "una llave pequeña del Centro de Instrucción Gerudo" });
    hintTable[GERUDO_FORTRESS_SMALL_KEY] = HintText::Item(
        {
            // obscure text
            Text{ "an imprisoned tool for unlocking", /*french*/ "un anti-porte emprisonné",
                  /*spanish*/ "una clave de una entrada encarcelada" },
            Text{ "an imprisoned dungeon pass", /*french*/ "le rêve emprisonné d'un prisonnier",
                  /*spanish*/ "un pase de una mazmorra encarcelada" },
            Text{ "an imprisoned lock remover", /*french*/ "un efface-serrure emprisonné",
                  /*spanish*/ "un destructor de cerraduras encarcelada" },
            Text{ "an imprisoned lockpick", /*french*/ "un crochet à porte emprisonné",
        ...
        // clear text
        Text{ "a Gerudo Fortress Small Key", /*french*/ "une petite clé de la Repaire des Voleurs",
              /*spanish*/ "una llave pequeña de la Fortaleza Gerudo" });
    hintTable[BOTTOM_OF_THE_WELL_SMALL_KEY] = HintText::Item(
        {
            // obscure text
            Text{ "a moldy tool for unlocking", /*french*/ "un anti-porte moisi",
                  /*spanish*/ "una clave de una entrada mohosa" },
            Text{ "a moldy dungeon pass", /*french*/ "le rêve moisi d'un prisonnier",
                  /*spanish*/ "un pase de una mazmorra mohosa" },
            Text{ "a moldy lock remover", /*french*/ "un efface-serrure moisi",
                  /*spanish*/ "un destructor de cerraduras mohosa" },
            Text{ "a moldy lockpick", /*french*/ "un crochet à porte moisi",
        ...
        // clear text
        Text{ "a Bottom of the Well Small Key", /*french*/ "une petite clé du fond du Puits",
              /*spanish*/ "una llave pequeña del Fondo del pozo" });
    hintTable[GANONS_CASTLE_SMALL_KEY] = HintText::Item(
        {
            // obscure text
            Text{ "a final tool for unlocking", /*french*/ "un anti-porte final",
                  /*spanish*/ "una clave de una entrada final" },
            Text{ "a final dungeon pass", /*french*/ "le rêve final d'un prisonnier",
                  /*spanish*/ "un pase de una mazmorra final" },
            Text{ "a final lock remover", /*french*/ "un efface-serrure final",
                  /*spanish*/ "un destructor de cerraduras final" },
            Text{ "a final lockpick", /*french*/ "un crochet à porte final",
        ...
        // clear text
        Text{ "a Ganon's Castle Small Key", /*french*/ "une petite clé du Château de Ganon",
              /*spanish*/ "una llave pequeña del Castillo de Ganon" });
    hintTable[FOREST_TEMPLE_KEY_RING] = HintText::Item(
        {
            // obscure text
            Text{ "a sylvan toolbox for unlocking", /*french*/ "des anti-portes sylvestres",
                  /*spanish*/ "un conjunto silvestre de cerrajero" },
            Text{ "a sylvan dungeon season pass", /*french*/ "les rêves sylvestres d'un prisonnier",
                  /*spanish*/ "un pase vip de mazmorras silvestre" },
            Text{ "a sylvan jingling ring", /*french*/ "des efface-serrures sylvestres",
                  /*spanish*/ "una cadena multiusos silvestre" },
            Text{ "a sylvan skeleton key", /*french*/ "des crochets à porte sylvestres",
        ...
        // clear text
        Text{ "a Forest Temple Key Ring", /*french*/ "un trousseau de clés du Temple de la Forêt",
              /*spanish*/ "un llavero del Templo del Bosque" });
    hintTable[FIRE_TEMPLE_KEY_RING] = HintText::Item(
        {
            // obscure text
            Text{ "a molten toolbox for unlocking", /*french*/ "des anti-portes fondus",
                  /*spanish*/ "un conjunto fundido de cerrajero" },
            Text{ "a molten dungeon season pass", /*french*/ "les rêves fondus d'un prisonnier",
                  /*spanish*/ "un pase vip de mazmorras fundido" },
            Text{ "a molten jingling ring", /*french*/ "des efface-serrures fondus",
                  /*spanish*/ "una cadena multiusos fundida" },
            Text{ "a molten skeleton key", /*french*/ "des crochets à porte fondus",
        ...
        // clear text
        Text{ "a Fire Temple Key Ring", /*french*/ "un trousseau de clés du Temple du Feu",
              /*spanish*/ "un llavero del Templo del Fuego" });
    hintTable[WATER_TEMPLE_KEY_RING] = HintText::Item(
        {
            // obscure text
            Text{ "a wet toolbox for unlocking", /*french*/ "des anti-portes humides",
                  /*spanish*/ "un conjunto abisal de cerrajero" },
            Text{ "a wet dungeon season pass", /*french*/ "les rêves humides d'un prisonnier",
                  /*spanish*/ "un pase vip de mazmorras abisal" },
            Text{ "a wet jingling ring", /*french*/ "des efface-serrures humides",
                  /*spanish*/ "una cadena multiusos abisal" },
            Text{ "a wet skeleton key", /*french*/ "des crochets à porte humides",
        ...
        // clear text
        Text{ "a Water Temple Key Ring", /*french*/ "un trousseau de clés du Temple de l'Eau",
              /*spanish*/ "un llavero del Templo del Agua" });
    hintTable[SPIRIT_TEMPLE_KEY_RING] = HintText::Item(
        {
            // obscure text
            Text{ "a sandy toolbox for unlocking", /*french*/ "des anti-portes sableux",
                  /*spanish*/ "un conjunto arenoso de cerrajero" },
            Text{ "a sandy dungeon season pass", /*french*/ "les rêves sableux d'un prisonnier",
                  /*spanish*/ "un pase vip de mazmorras arenoso" },
            Text{ "a sandy jingling ring", /*french*/ "des efface-serrures sableux",
                  /*spanish*/ "una cadena multiusos arenosa" },
            Text{ "a sandy skeleton key", /*french*/ "des crochets à porte sableux",
        ...
        // clear text
        Text{ "a Spirit Temple Key Ring", /*french*/ "un trousseau de clés du Temple de l'Esprit",
              /*spanish*/ "un llavero del Templo del Espíritu" });
    hintTable[SHADOW_TEMPLE_KEY_RING] = HintText::Item(
        {
            // obscure text
            Text{ "a creepy toolbox for unlocking", /*french*/ "des anti-portes sinistres",
                  /*spanish*/ "un conjunto tenebroso de cerrajero" },
            Text{ "a creepy dungeon season pass", /*french*/ "les rêves sinistres d'un prisonnier",
                  /*spanish*/ "un pase vip de mazmorras tenebroso" },
            Text{ "a creepy jingling ring", /*french*/ "des efface-serrures sinistres",
                  /*spanish*/ "una cadena multiusos tenebrosa" },
            Text{ "a creepy skeleton key", /*french*/ "des crochets à porte sinistres",
        ...
        // clear text
        Text{ "a Shadow Temple Key Ring", /*french*/ "un trousseau de clés du Temple de l'Ombre",
              /*spanish*/ "un llavero del Templo de las Sombras" });
    hintTable[GERUDO_TRAINING_GROUNDS_KEY_RING] = HintText::Item(
        {
            // obscure text
            Text{ "a labyrinthian toolbox for unlocking", /*french*/ "des anti-portes labyrinthiques",
                  /*spanish*/ "un conjunto laberíntico de cerrajero" },
            Text{ "a labyrinthian dungeon season pass", /*french*/ "les rêves labyrinthiques d'un prisonnier",
                  /*spanish*/ "un pase vip de mazmorras laberíntico" },
            Text{ "a labyrinthian jingling ring", /*french*/ "des efface-serrures labyrinthiques",
                  /*spanish*/ "una cadena multiusos laberíntica" },
            Text{ "a labyrinthian skeleton key", /*french*/ "des crochets à porte labyrinthiques",
        ...
        // clear text
        Text{ "a Gerudo Training Ground Key Ring", /*french*/ "un trousseau de clés du Gymnase Gerudo",
              /*spanish*/ "un llavero del Centro de Instrucción Gerudo" });
    hintTable[GERUDO_FORTRESS_KEY_RING] = HintText::Item(
        {
            // obscure text
            Text{ "an imprisoned toolbox for unlocking", /*french*/ "des anti-portes emprisonnés",
                  /*spanish*/ "un conjunto enjaulado de cerrajero" },
            Text{ "an imprisoned dungeon season pass", /*french*/ "les rêves emprisonnés d'un prisonnier",
                  /*spanish*/ "un pase vip de una mazmorra enjaulado" },
            Text{ "an imprisoned jingling ring", /*french*/ "des efface-serrures emprisonnés",
                  /*spanish*/ "una cadena multiusos enjaulada" },
            Text{ "an imprisoned skeleton key", /*french*/ "des crochets à porte emprisonnés",
        ...
        // clear text
        Text{ "a Gerudo Fortress Key Ring", /*french*/ "un trousseau de clés de la Repaire des Voleurs",
              /*spanish*/ "un llavero de la Fortaleza Gerudo" });
    hintTable[BOTTOM_OF_THE_WELL_KEY_RING] = HintText::Item(
        {
            // obscure text
            Text{ "a moldy toolbox for unlocking", /*french*/ "des anti-portes moisis",
                  /*spanish*/ "un conjunto subterráneo de cerrajero" },
            Text{ "a moldy dungeon season pass", /*french*/ "les rêves moisis d'un prisonnier",
                  /*spanish*/ "un pase vip de una mazmorra subterráneo" },
            Text{ "a moldy jingling ring", /*french*/ "des efface-serrures moisis",
                  /*spanish*/ "una cadena multiusos subterránea" },
            Text{ "a moldy skeleton key", /*french*/ "des crochets à porte moisis",
        ...
        // clear text
        Text{ "a Bottom of the Well Key Ring", /*french*/ "un trousseau de clés du fond du Puits",
              /*spanish*/ "un llavero del Fondo del pozo" });
    hintTable[GANONS_CASTLE_KEY_RING] = HintText::Item(
        {
            // obscure text
            Text{ "a final toolbox for unlocking", /*french*/ "des anti-portes finaux",
                  /*spanish*/ "un conjunto decisivo de cerrajero" },
            Text{ "a final dungeon season pass", /*french*/ "les rêves finaux d'un prisonnier",
                  /*spanish*/ "un pase vip de una mazmorra decisivo" },
            Text{ "a final jingling ring", /*french*/ "des efface-serrures finaux",
                  /*spanish*/ "una cadena multiusos decisiva" },
            Text{ "a final skeleton key", /*french*/ "des crochets à porte finaux",
        ...
        // clear text
        Text{ "a Ganon's Castle Key Ring", /*french*/ "un trousseau de clés du Château de Ganon",
              /*spanish*/ "un llavero del Castillo de Ganon" });

    hintTable[TREASURE_GAME_SMALL_KEY] = HintText::Item(
        {
            // obscure text
            Text{ "a gambler's tool for unlocking", /*french*/ "un anti-porte de parieur",
                  /*spanish*/ "una clave de un juego de azar" },
            Text{ "a gambler's dungeon pass", /*french*/ "le rêve d'un prisonnier parieur",
                  /*spanish*/ "un pase de un juego de azar" },
            Text{ "a gambler's lock remover", /*french*/ "un efface-serrure de parieur",
                  /*spanish*/ "un destructor de cerraduras del juego de azar" },
            Text{ "a gambler's lockpick", /*french*/ "un crochet à serrure de parieur",
        ...
        // clear text
        Text{ "a Treasure Chest Shop Small Key", /*french*/ "une petite clé de la chasse aux trésors",
    ...
    hintTable[KOKIRI_EMERALD] = HintText::Item(
        {
            ...
            Text{ "a gift before death", /*french*/ "le dernier souffle d'un arbre",
    ...
    hintTable[GORON_RUBY] = HintText::Item(
        {
            ...
            Text{ "sworn brotherhood", /*french*/ "un serment de fraternité",
    ...
    hintTable[HEART_CONTAINER] = HintText::Item(
        {
            ...
            Text{ "a Valentine's gift", /*french*/ "un cadeau de Saint-Valentin",
    ...
    hintTable[ICE_TRAP] = HintText::Item(
        {
            ...
            Text{ "a chilling discovery", /*french*/ "une frissonante découverte",
    ...
    hintTable[BOMBS_20] = HintText::Item(
        {
            ...
            Text{ "plenty of blast balls", /*french*/ "une abondance de boules bleues",
    ...
    hintTable[BOMBCHU_5] = HintText::Item(
        {
            // obscure text
            Text{ "a few mice bombs", /*french*/ "une poignée de mignons explosifs",
                  /*spanish*/ "un par de bombas roedoras" },
            Text{ "a few proximity mice", /*french*/ "une poignée de jouets à remonter",
                  /*spanish*/ "un par de explosivos ratoncitos" },
            Text{ "a few wall crawlers", /*french*/ "une poignée de rapides grimpeurs",
                  /*spanish*/ "un par de trepaparedes" },
            Text{ "a few trail blazers", /*french*/ "une poignée de zigzags éclatants",
    ...
    hintTable[BOMBCHU_10] = HintText::Item(
        {
            // obscure text
            Text{ "some mice bombs", /*french*/ "un paquet de mignons explosifs",
                  /*spanish*/ "unas cuantas bombas roedoras" },
            Text{ "some proximity mice", /*french*/ "un paquet de jouets à remonter",
                  /*spanish*/ "unos cuantos explosivos ratoncitos" },
            Text{ "some wall crawlers", /*french*/ "un paquet de rapides grimpeurs",
                  /*spanish*/ "unos cuantos trepaparedes" },
            Text{ "some trail blazers", /*french*/ "un paquet de zigzags éclatants",
    ...
    hintTable[BOMBCHU_20] = HintText::Item(
        {
            // obscure text
            Text{ "plenty of mice bombs", /*french*/ "une abondance de mignons explosifs",
                  /*spanish*/ "bastantes bombas roedoras" },
            Text{ "plenty of proximity mice", /*french*/ "une abondance de jouets à remonter",
                  /*spanish*/ "bastantes explosivos ratoncitos" },
            Text{ "plenty of wall crawlers", /*french*/ "une abondance de rapides grimpeurs",
                  /*spanish*/ "bastantes trepaparedes" },
            Text{ "plenty of trail blazers", /*french*/ "une abondance de zigzags éclatants",
    ...
    hintTable[ARROWS_30] = HintText::Item(
        {
            // obscure text
            Text{ "plenty of danger darts", /*french*/ "une abondance d'obus",
                  /*spanish*/ "bastantes peligrosos dardos" },
            Text{ "plenty of sharp shafts", /*french*/ "une abondance de piquets",
    ...
    hintTable[DEKU_NUTS_5] = HintText::Item(
        {
            ...
            Text{ "some scrub spit", /*french*/ "une poignée de crachats Mojo",
    ...
    hintTable[DEKU_NUTS_10] = HintText::Item(
        {
            ...
            Text{ "plenty of flashbangs", /*french*/ "un paquet d'éclats",
                  /*spanish*/ "unas cuantas semillas aturdidoras" },
            Text{ "plenty of scrub spit", /*french*/ "un paquet de crachats Mojo",
    ...
    hintTable[DEKU_SEEDS_30] = HintText::Item(
        {
            // obscure text
            Text{ "catapult ammo", /*french*/ "un paquet de délicieuses munitions",
    ...
    hintTable[TRIFORCE_PIECE] = HintText::Item(
        ...
        {},
        // clear text
        Text{ "a Piece of the Triforce", /*french*/ "un fragment de la Triforce",
    ...
    hintTable[EPONA] = HintText::Item(
        ...
        },
        {
            ...
            Text{ "a song sung by frogs", /*french*/ "une chanson aimée des grenouilles",
                  /*spanish*/ "una melodía de ranas" },
            Text{ "something to cross a broken bridge", /*french*/ "une chose pour traverser un pont brisé",
    ...
    //                      Text{"an unknown treasure",  /*french*/"un trésor inconnu", /*spanish*/"un desconocido
    //                      tesoro"},
    //                    },
    //                      //clear text
    //                      Text{"An Error (Please Report This)", /*french*/"une erreur (signaler S.V.P.)",
    //                      /*spanish*/"un error (repórtelo si es posible)"}
    // );
}
