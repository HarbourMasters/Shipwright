...
public:
  ...
  //bool IsChecked(SaveContext saveContext) {
  //  
  //}
};
...
static std::unordered_map<RandomizerCheck, RandomizerInf> randomizerFlagLookup = {
    { RC_KF_LINKS_HOUSE_COW, RAND_INF_COWS_MILKED_LINKS_HOUSE_COW },
    ...
    { RC_HF_COW_GROTTO_GOSSIP_STONE, RAND_INF_COWS_MILKED_HF_COW_GROTTO_GOSSIP_STONE },
