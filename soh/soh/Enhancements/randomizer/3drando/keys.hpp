...
//USELES_CHECKS
  DODONGOS_CAVERN_LIZALFOS_PLATFORM_USELESS_CHECK,
  JABU_JABUS_BELLY_BOTTOM_ROOM_USELESS_CHECK,
  ICE_CAVERN_MAP_ROOM_FROZEN_USELESS_CHECK,
  GV_OCTOROK_GROTTO_USELESS_CHECK,
  KF_ABOVE_BEAN_PATCH_USELESS_CHECK,
