...
DungeonInfo::DungeonInfo(std::string name_, uint32_t hintKey_, uint32_t map_, uint32_t compass_, uint32_t smallKey_,
                         ...
                         std::vector<uint32_t> sharedLocations_, std::vector<uint32_t> bossRoomLocations_)
...
void DungeonInfo::PlaceVanillaMap() {
    ...
    auto mapLocation = FilterFromPool(
        dungeonLocations, [](const uint32_t loc) { return Location(loc)->IsCategory(Category::cVanillaMap); })[0];
...
void DungeonInfo::PlaceVanillaCompass() {
    ...
    auto dungeonLocations = GetDungeonLocations();
    auto compassLocation = FilterFromPool(
        dungeonLocations, [](const uint32_t loc) { return Location(loc)->IsCategory(Category::cVanillaCompass); })[0];
...
void DungeonInfo::PlaceVanillaBossKey() {
    ...
    auto dungeonLocations = GetDungeonLocations();
    auto bossKeyLocation = FilterFromPool(
        dungeonLocations, [](const uint32_t loc) { return Location(loc)->IsCategory(Category::cVanillaBossKey); })[0];
...
void DungeonInfo::PlaceVanillaSmallKeys() {
    ...
    auto smallKeyLocations = FilterFromPool(
        dungeonLocations, [](const uint32_t loc) { return Location(loc)->IsCategory(Category::cVanillaSmallKey); });
...
DungeonInfo ForestTemple = DungeonInfo("Forest Temple", FOREST_TEMPLE, FOREST_TEMPLE_MAP, FOREST_TEMPLE_COMPASS,
...
DungeonInfo FireTemple = DungeonInfo("Fire Temple", FIRE_TEMPLE, FIRE_TEMPLE_MAP, FIRE_TEMPLE_COMPASS,
                                     FIRE_TEMPLE_SMALL_KEY, FIRE_TEMPLE_KEY_RING, FIRE_TEMPLE_BOSS_KEY, 8, 5,
                                     {
                                         // Vanilla Locations
...
DungeonInfo WaterTemple = DungeonInfo("Water Temple", WATER_TEMPLE, WATER_TEMPLE_MAP, WATER_TEMPLE_COMPASS,
                                      WATER_TEMPLE_SMALL_KEY, WATER_TEMPLE_KEY_RING, WATER_TEMPLE_BOSS_KEY, 6, 2,
                                      {
                                          // Vanilla Locations
...
DungeonInfo SpiritTemple = DungeonInfo("Spirit Temple", SPIRIT_TEMPLE, SPIRIT_TEMPLE_MAP, SPIRIT_TEMPLE_COMPASS,
...
DungeonInfo ShadowTemple = DungeonInfo("Shadow Temple", SHADOW_TEMPLE, SHADOW_TEMPLE_MAP, SHADOW_TEMPLE_COMPASS,
...
DungeonInfo GanonsCastle = DungeonInfo("Ganon's Castle", GANONS_CASTLE, NONE, NONE, GANONS_CASTLE_SMALL_KEY,
                                       GANONS_CASTLE_KEY_RING, GANONS_CASTLE_BOSS_KEY, 2, 3,
                                       {
                                           // Vanilla Locations
