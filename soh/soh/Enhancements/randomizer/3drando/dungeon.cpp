...
DungeonInfo::DungeonInfo(std::string name_, uint32_t hintKey_, RandomizerGet map_, RandomizerGet compass_,
                         ...
                         uint8_t vanillaKeyCount_, uint8_t mqKeyCount_, std::vector<uint32_t> vanillaLocations_,
                         std::vector<uint32_t> mqLocations_, std::vector<uint32_t> sharedLocations_,
