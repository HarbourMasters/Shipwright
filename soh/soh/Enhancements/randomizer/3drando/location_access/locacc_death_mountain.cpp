...
void AreaTable_Init_DeathMountain() {
        ...
        },
        {
            ...
            LocationAccess(DMT_GS_ABOVE_DODONGOS_CAVERN, { [] {
                               return IsAdult && AtNight &&
                                      (CanUse(MEGATON_HAMMER) || (LogicDMTGSLowerHookshot && CanUse(HOOKSHOT)) ||
                                       (LogicDMTGSLowerBean && CanPlantBean(DEATH_MOUNTAIN_TRAIL)) ||
                                       (LogicDMTGSLowerHovers && CanUse(HOVER_BOOTS)) || LogicDMTGSLowerJS) &&
                                      CanGetNightTimeGS;
                           } }),
        },
        {
            ...
            Entrance(DEATH_MOUNTAIN_SUMMIT, { [] {
                         return Here(DEATH_MOUNTAIN_TRAIL, [] { return CanBlastOrSmash; }) ||
                                (IsAdult && ((CanPlantBean(DEATH_MOUNTAIN_TRAIL) && GoronBracelet) ||
                                             (HoverBoots && LogicDMTClimbHovers)));
                     } }),
    ...
    areaTable[DEATH_MOUNTAIN_SUMMIT] = Area(
        ...
        },
        {
            ...
            LocationAccess(DMT_GS_FALLING_ROCKS_PATH, { [] {
                               return IsAdult && AtNight && (CanUse(MEGATON_HAMMER) || LogicDMTGSUpper) &&
                                      CanGetNightTimeGS;
                           } }),
    ...
    areaTable[GORON_CITY] = Area(
        "Goron City", "Goron City", GORON_CITY, NO_DAY_NIGHT_CYCLE,
        {
            ...
            EventAccess(&GCWoodsWarpOpen, { [] {
                return GCWoodsWarpOpen ||
                       (CanBlastOrSmash || CanUse(DINS_FIRE) || CanUse(BOW) || GoronBracelet || GoronCityChildFire);
            } }),
            ...
            EventAccess(&StopGCRollingGoronAsAdult, { [] {
                return StopGCRollingGoronAsAdult || (IsAdult && (GoronBracelet || HasExplosives || Bow ||
                                                                 (LogicGoronCityLinkGoronDins && CanUse(DINS_FIRE))));
            } }),
        },
        {
            // Locations
        ...
        },
        {
            ...
            Entrance(GC_DARUNIAS_CHAMBER,
                     { [] { return (IsAdult && StopGCRollingGoronAsAdult) || GCDaruniasDoorOpenChild; } }),
            Entrance(GC_GROTTO_PLATFORM, { [] {
                         return IsAdult && ((CanPlay(SongOfTime) && ((EffectiveHealth > 2) || CanUse(GORON_TUNIC) ||
                                            ...
                                            (EffectiveHealth > 2 && CanUse(HOOKSHOT) && LogicGoronCityGrotto));
                     } }),
        });
    ...
    areaTable[DMC_UPPER_NEARBY] = Area(
        ...
        { // Exits
          ...
          Entrance(DMC_UPPER_GROTTO, { [] {
                       return Here(DMC_UPPER_NEARBY, [] { return CanBlastOrSmash && (FireTimer >= 8 || Hearts >= 3); });
                   } }) });
        ...
        },
        {
            ...
            Entrance(DMC_CENTRAL_NEARBY, { [] {
                         return IsAdult && CanUse(GORON_TUNIC) && CanUse(DISTANT_SCARECROW) &&
                                ((EffectiveHealth > 2) ||
                                 (Fairy && ShuffleDungeonEntrances.IsNot(SHUFFLEDUNGEONS_OFF)) || CanUse(NAYRUS_LOVE));
                     } }),
             ...
             },
             {
                 ...
                 Entrance(DMC_LOWER_NEARBY, { [] {
                              return Hearts >= 3 && (CanUse(HOVER_BOOTS) ||
                                                     (LogicCraterBoulderJS && IsAdult && CanUse(MEGATON_HAMMER)) ||
                                                     (LogicCraterBoulderSkip && IsAdult));
                          } }),
             });

    areaTable[DMC_LOWER_NEARBY] =
        Area("DMC Lower Nearby", "Death Mountain Crater", DEATH_MOUNTAIN_CRATER, NO_DAY_NIGHT_CYCLE, {}, {},
             {
                 // Exits
    ...
    areaTable[DMC_LOWER_LOCAL] = Area(
        "DMC Lower Local", "Death Mountain Crater", DEATH_MOUNTAIN_CRATER, NO_DAY_NIGHT_CYCLE, {}, {},
        {
            // Exits
            ...
            Entrance(DMC_CENTRAL_LOCAL, { [] {
                         return (CanUse(HOVER_BOOTS) || CanUse(HOOKSHOT) ||
                                 (IsAdult && CanShield && LogicCraterBoleroJump)) &&
                                FireTimer >= 24;
                     } }),
        });
        ...
        "DMC Central Nearby", "Death Mountain Crater", DEATH_MOUNTAIN_CRATER, NO_DAY_NIGHT_CYCLE, {},
        {
            ...
            LocationAccess(DMC_VOLCANO_FREESTANDING_POH, { [] {
                               return IsAdult && Hearts >= 3 &&
                                      (CanPlantBean(DMC_CENTRAL_LOCAL) || (LogicCraterBeanPoHWithHovers && HoverBoots));
                           } }),
    ...
    areaTable[DMC_CENTRAL_LOCAL] = Area(
        ...
        },
        {
            ...
            Entrance(DMC_LOWER_NEARBY, { [] {
                         return (IsAdult && CanPlantBean(DMC_CENTRAL_LOCAL)) || CanUse(HOVER_BOOTS) || CanUse(HOOKSHOT);
                     } }),
