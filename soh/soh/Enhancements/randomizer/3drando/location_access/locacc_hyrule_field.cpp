...
void AreaTable_Init_HyruleField() {
  ...
  areaTable[HF_COW_GROTTO] = Area("HF Cow Grotto", "HF Cow Grotto", NONE, NO_DAY_NIGHT_CYCLE, grottoEvents, {
                  ...
                  LocationAccess(HF_COW_GROTTO_COW,          {[]{return HasFireSource && CanUse(EPONAS_SONG);}}),
  ...
  areaTable[LON_LON_RANCH] = Area("Lon Lon Ranch", "Lon Lon Ranch", LON_LON_RANCH, NO_DAY_NIGHT_CYCLE, {
                  //Events
                  EventAccess(&Epona,    {[]{return Epona    || (CanUse(EPONAS_SONG) && IsAdult && AtDay);}}),
                  EventAccess(&LinksCow, {[]{return LinksCow || (CanUse(EPONAS_SONG) && IsAdult && AtDay);}}),
                }, {
                  //Locations
  ...
  areaTable[LLR_STABLES] = Area("LLR Stables", "LLR Stables", NONE, NO_DAY_NIGHT_CYCLE, {}, {
                  //Locations
                  LocationAccess(LLR_STABLES_LEFT_COW,  {[]{return CanUse(EPONAS_SONG);}}),
                  LocationAccess(LLR_STABLES_RIGHT_COW, {[]{return CanUse(EPONAS_SONG);}}),
                }, {
                  //Exits
                  Entrance(LON_LON_RANCH, {[]{return true;}}),
  });
  ...
  areaTable[LLR_TOWER] = Area("LLR Tower", "LLR Tower", NONE, NO_DAY_NIGHT_CYCLE, {}, {
                  ...
                  LocationAccess(LLR_TOWER_LEFT_COW,   {[]{return CanUse(EPONAS_SONG);}}),
                  LocationAccess(LLR_TOWER_RIGHT_COW,  {[]{return CanUse(EPONAS_SONG);}}),
                }, {
                  //Exits
                  Entrance(LON_LON_RANCH, {[]{return true;}}),
  });
