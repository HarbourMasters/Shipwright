...
void AreaTable_Init_IceCavern() {
            ...
            Area("Ice Cavern Beginning", "Ice Cavern", ICE_CAVERN, NO_DAY_NIGHT_CYCLE, {}, {},
                 {
                     ...
                     Entrance(ICE_CAVERN_MAIN, { [] {
                                  return Here(ICE_CAVERN_BEGINNING,
                                              [] { return IsAdult || HasExplosives || CanUse(DINS_FIRE); });
                              } }),
                 });
        ...
        areaTable[ICE_CAVERN_MAIN] =
            Area("Ice Cavern", "Ice Cavern", ICE_CAVERN, NO_DAY_NIGHT_CYCLE,
                 ...
                 },
                 {
                     ...
                     LocationAccess(ICE_CAVERN_GS_PUSH_BLOCK_ROOM, { [] {
                                        return BlueFire && (HookshotOrBoomerang ||
                                                            (LogicIceBlockGS && IsAdult && CanUse(HOVER_BOOTS)));
                                    } }),
                 },
                 {});
    }
    ...
    if (Dungeon::IceCavern.IsMQ()) {
            ...
            Area("Ice Cavern MQ Beginning", "Ice Cavern", ICE_CAVERN, NO_DAY_NIGHT_CYCLE,
                 ...
                 {},
                 {
                     ...
                     Entrance(ICE_CAVERN_MQ_MAP_ROOM, { [] {
                                  return IsAdult || CanUse(DINS_FIRE) ||
        ...
        areaTable[ICE_CAVERN_MQ_MAP_ROOM] = Area(
            "Ice Cavern MQ Map Room", "Ice Cavern", ICE_CAVERN, NO_DAY_NIGHT_CYCLE,
            {
                // Events
        ...
        areaTable[ICE_CAVERN_MQ_IRON_BOOTS_REGION] = Area(
            "Ice Cavern MQ Iron Boots Region", "Ice Cavern", ICE_CAVERN, NO_DAY_NIGHT_CYCLE, {},
            {
                ...
                LocationAccess(ICE_CAVERN_MQ_GS_SCARECROW, { [] {
                                   return (CanUse(SCARECROW) || (HoverBoots && CanUse(LONGSHOT)) ||
                                           LogicIceMQScarecrow) &&
                                          IsAdult;
                               } }),
        ...
        areaTable[ICE_CAVERN_MQ_COMPASS_ROOM] = Area(
            "Ice Cavern MQ Compass Room", "Ice Cavern", ICE_CAVERN, NO_DAY_NIGHT_CYCLE, {},
            {
                // Locations
