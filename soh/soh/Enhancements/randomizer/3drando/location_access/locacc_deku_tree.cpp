...
void AreaTable_Init_DekuTree() {
    ...
    if (Dungeon::DekuTree.IsVanilla()) {
        areaTable[DEKU_TREE_LOBBY] = Area(
            ...
            },
            {
                ...
                Entrance(DEKU_TREE_BASEMENT_LOWER,
                         { [] { return Here(DEKU_TREE_LOBBY, [] { return IsAdult || CanChildAttack || Nuts; }); } }),
        ...
        areaTable[DEKU_TREE_COMPASS_ROOM] =
            Area("Deku Tree Compass Room", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE,
                 {
                     // Events
                     EventAccess(&DekuBabaSticks,
                                 { [] { return DekuBabaSticks || (IsAdult || KokiriSword || Boomerang); } }),
        ...
        areaTable[DEKU_TREE_BASEMENT_LOWER] = Area(
            "Deku Tree Basement Lower", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE,
            {
                ...
                EventAccess(&DekuBabaSticks,
                            { [] { return DekuBabaSticks || (IsAdult || KokiriSword || Boomerang); } }),
                EventAccess(&DekuBabaNuts, { [] {
                                                return DekuBabaNuts || (IsAdult || KokiriSword || Slingshot || Sticks ||
            ...
            },
            {
                ...
                LocationAccess(DEKU_TREE_GS_BASEMENT_VINES, { [] {
                                   return CanUseProjectile || CanUse(DINS_FIRE) ||
                                          (LogicDekuBasementGS && (IsAdult || Sticks || KokiriSword));
                               } }),
            },
            {
                // Exits
                     ...
                     Entrance(DEKU_TREE_MQ_BASEMENT_BACK_ROOM, { [] {
                                  return Here(DEKU_TREE_MQ_BASEMENT_WATER_ROOM_BACK,
                                         ...
                                         Here(DEKU_TREE_MQ_BASEMENT_WATER_ROOM_BACK, [] {
                                             return IsAdult || KokiriSword || CanUseProjectile || (Nuts && Sticks);
                                         });
                              } }),
