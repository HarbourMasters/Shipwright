    ...
    areaTable[KOKIRI_FOREST] = Area(
        ...
        },
        {
            ...
            LocationAccess(KF_GS_HOUSE_OF_TWINS, { [] {
                               return IsAdult && AtNight &&
                                      (HookshotOrBoomerang || (LogicAdultKokiriGS && CanUse(HOVER_BOOTS))) &&
                                      CanGetNightTimeGS;
                           } }),
        ...
        },
        {
            ...
            Entrance(KF_OUTSIDE_DEKU_TREE,
                     { [] { return IsAdult || OpenForest.Is(OPENFOREST_OPEN) || ShowedMidoSwordAndShield; } }),
        ...
        Area("KF Outside Deku Tree", "Kokiri Forest", KOKIRI_FOREST, NO_DAY_NIGHT_CYCLE,
             {
                 ...
                 EventAccess(&DekuBabaSticks, { [] {
                     return DekuBabaSticks ||
                            ((IsAdult && ShuffleDungeonEntrances.Is(SHUFFLEDUNGEONS_OFF)) || KokiriSword || Boomerang);
                 } }),
                 EventAccess(&DekuBabaNuts, { [] {
                     return DekuBabaNuts || ((IsAdult && ShuffleDungeonEntrances.Is(SHUFFLEDUNGEONS_OFF)) ||
        ...
        },
        {
            ...
            Entrance(LW_BRIDGE, { [] {
                         return CanLeaveForest &&
                                ((IsAdult && (CanPlantBean(THE_LOST_WOODS) || LogicLostWoodsBridge)) ||
                                    ...
                                    return IsAdult && AtNight &&
                                           (CanPlantBean(LW_BEYOND_MIDO) ||
                                            (LogicLostWoodsGSBean && CanUse(HOOKSHOT) &&
                                             (CanUse(LONGSHOT) || CanUse(BOW) || CanUse(SLINGSHOT) || HasBombchus ||
                                              CanUse(DINS_FIRE)))) &&
                                           CanGetNightTimeGS;
                                } }),
        ...
        Area("SFM Entryway", "Sacred Forest Meadow", SACRED_FOREST_MEADOW, NO_DAY_NIGHT_CYCLE, {}, {},
             {
                 ...
                 Entrance(SACRED_FOREST_MEADOW, { [] {
                              return IsAdult || Slingshot || Sticks || KokiriSword || CanUse(DINS_FIRE) ||
    ...
    areaTable[SFM_WOLFOS_GROTTO] = Area("SFM Wolfos Grotto", "SFM Wolfos Grotto", NONE, NO_DAY_NIGHT_CYCLE, {},
                                        {
                                            ...
                                            LocationAccess(SFM_WOLFOS_GROTTO_CHEST, { [] {
                                                               return IsAdult || Slingshot || Sticks || KokiriSword ||
