    ...
    areaTable[ZORAS_RIVER] = Area(
        ...
        },
        {
            ...
            Entrance(ZR_BEHIND_WATERFALL, { [] {
                         return CanPlay(ZeldasLullaby) || (IsChild && LogicZoraWithCucco) ||
                                (IsAdult && CanUse(HOVER_BOOTS) && LogicZoraWithHovers);
                     } }),
        });
        ...
        },
        {
            ...
            LocationAccess(ZD_GS_FROZEN_WATERFALL, { [] {
                               return IsAdult && AtNight &&
                                      (HookshotOrBoomerang || CanUse(SLINGSHOT) || Bow || MagicMeter ||
                                       LogicDomainGS) &&
                                      CanGetNightTimeGS;
                           } }),
        ...
        },
        {
            ...
            Entrance(ZD_BEHIND_KING_ZORA, { [] {
                         return DeliverLetter || ZorasFountain.Is(ZORASFOUNTAIN_OPEN) ||
                                (ZorasFountain.Is(ZORASFOUNTAIN_ADULT) && IsAdult) || (LogicKingZoraSkip && IsAdult);
                     } }),
    ...
    areaTable[ZD_BEHIND_KING_ZORA] = Area("ZD Behind King Zora", "Zoras Domain", NONE, NO_DAY_NIGHT_CYCLE, {}, {},
                                          {
                                              ...
                                              Entrance(ZORAS_DOMAIN, { [] {
                                                           return DeliverLetter ||
                                                                  ZorasFountain.Is(ZORASFOUNTAIN_OPEN) ||
