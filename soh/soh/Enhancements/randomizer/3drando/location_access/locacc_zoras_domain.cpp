...
void AreaTable_Init_ZorasDomain() {
  ...
  areaTable[ZORAS_RIVER] = Area("Zora River", "Zora River", ZORAS_RIVER, DAY_NIGHT_CYCLE, {
                  ...
                  EventAccess(&BeanPlantFairy,   {[]{return BeanPlantFairy   || (CanPlantBean(ZORAS_RIVER) && CanUse(SONG_OF_STORMS));}}),
                  ...
                  LocationAccess(ZR_FROGS_OCARINA_GAME,                {[]{return IsChild && CanUse(ZELDAS_LULLABY) && CanUse(SARIAS_SONG) && CanUse(SUNS_SONG) && CanUse(EPONAS_SONG) && CanUse(SONG_OF_TIME) && CanUse(SONG_OF_STORMS);}}),
                  LocationAccess(ZR_FROGS_IN_THE_RAIN,                 {[]{return IsChild && CanUse(SONG_OF_STORMS);}}),
                  LocationAccess(ZR_FROGS_ZELDAS_LULLABY,              {[]{return IsChild && CanUse(ZELDAS_LULLABY);}}),
                  LocationAccess(ZR_FROGS_EPONAS_SONG,                 {[]{return IsChild && CanUse(EPONAS_SONG);}}),
                  LocationAccess(ZR_FROGS_SARIAS_SONG,                 {[]{return IsChild && CanUse(SARIAS_SONG);}}),
                  LocationAccess(ZR_FROGS_SUNS_SONG,                   {[]{return IsChild && CanUse(SUNS_SONG);}}),
                  LocationAccess(ZR_FROGS_SONG_OF_TIME,                {[]{return IsChild && CanUse(SONG_OF_TIME);}}),
                  ...
                  Entrance(ZR_BEHIND_WATERFALL, {[]{return CanUse(ZELDAS_LULLABY) || (IsChild && LogicZoraWithCucco) || (IsAdult && CanUse(HOVER_BOOTS) && LogicZoraWithHovers);}}),
  });
  ...
  areaTable[ZF_GREAT_FAIRY_FOUNTAIN] = Area("ZF Great Fairy Fountain", "ZF Great Fairy Fountain", NONE, NO_DAY_NIGHT_CYCLE, {}, {
                  //Locations
                  LocationAccess(ZF_GREAT_FAIRY_REWARD, {[]{return CanUse(ZELDAS_LULLABY);}}),
                }, {
                  //Exits
                  Entrance(ZORAS_FOUNTAIN, {[]{return true;}}),
  });
