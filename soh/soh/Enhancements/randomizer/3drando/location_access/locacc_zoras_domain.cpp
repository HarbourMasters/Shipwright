...
void AreaTable_Init_ZorasDomain() {
  ...
  areaTable[ZORAS_DOMAIN] = Area("Zoras Domain", "Zoras Domain", ZORAS_DOMAIN, NO_DAY_NIGHT_CYCLE, {
                  ...
                  LocationAccess(ZD_GS_FROZEN_WATERFALL, {[]{return IsAdult && AtNight && (HookshotOrBoomerang || CanUse(SLINGSHOT) || Bow || (MagicMeter && (MasterSword || BiggoronSword)) || LogicDomainGS) && CanGetNightTimeGS;}}),
