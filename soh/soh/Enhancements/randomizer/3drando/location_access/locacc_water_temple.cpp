...
void AreaTable_Init_WaterTemple() {
    ...
    if (Dungeon::WaterTemple.IsVanilla()) {
        ...
        areaTable[WATER_TEMPLE_LOBBY] = Area(
            "Water Temple Lobby", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {},
            {
                ...
                Entrance(WATER_TEMPLE_HIGH_WATER, { [] {
                             return IsAdult && (CanUse(HOVER_BOOTS) || (LogicDamageBoost && Bombs && CanTakeDamage));
                         } }),
        ...
        areaTable[WATER_TEMPLE_CRACKED_WALL] =
            Area("Water Temple Cracked Wall", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
        ...
        areaTable[WATER_TEMPLE_BLOCK_ROOM] =
            Area("Water Temple Block Room", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {},
                 {
                     // Exits
                     Entrance(WATER_TEMPLE_BOULDERS_LOWER,
            ...
            Area("Water Temple South Lower", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     ...
                     LocationAccess(WATER_TEMPLE_GS_BEHIND_GATE,
                                    { [] { return CanUse(HOOKSHOT) || (IsAdult && CanUse(HOVER_BOOTS)); } }),
                 },
                 {
                     // Exits
        ...
        areaTable[WATER_TEMPLE_DRAGON_ROOM] =
            Area("Water Temple Dragon Room", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
                     LocationAccess(WATER_TEMPLE_DRAGON_CHEST, { [] {
                                        return (CanUse(HOOKSHOT) && CanUse(IRON_BOOTS)) ||
                                               (((IsAdult && LogicWaterDragonAdult &&
                                                  (CanUse(HOOKSHOT) || CanUse(BOW) || HasBombchus)) ||
                                                 (IsChild && LogicWaterDragonChild &&
                                                  (CanUse(SLINGSHOT) || CanUse(BOOMERANG) || HasBombchus))) &&
                 ...
                 },
                 {
                     ...
                     LocationAccess(WATER_TEMPLE_GS_CENTRAL_PILLAR, { [] {
                                        return CanUse(LONGSHOT) ||
                                               (((LogicWaterCentralGSFW && CanUse(FARORES_WIND) &&
                                                  (CanUse(BOW) || CanUse(DINS_FIRE) || SmallKeys(WATER_TEMPLE, 5))) ||
                                                 (LogicWaterCentralGSIrons && CanUse(IRON_BOOTS) &&
                                                  ((CanUse(HOOKSHOT) && CanUse(BOW)) || (CanUse(DINS_FIRE))))) &&
                                                WaterTempleHigh && HookshotOrBoomerang);
                                    } }),
                 },
                 {
                     // Exits
        ...
        areaTable[WATER_TEMPLE_BLOCK_CORRIDOR] =
            Area("Water Temple Block Corridor", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
            ...
            Area("Water Temple Falling Platform Room", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     ...
                     LocationAccess(WATER_TEMPLE_GS_FALLING_PLATFORM_ROOM, { [] {
                                        return CanUse(LONGSHOT) ||
                                               (LogicWaterFallingPlatformGSBoomerang && IsChild && CanUse(BOOMERANG)) ||
                                               (LogicWaterFallingPlatformGSHookshot && IsAdult && CanUse(HOOKSHOT));
                                    } }),
                 },
                 {
                     // Exits
        ...
        areaTable[WATER_TEMPLE_DARK_LINK_ROOM] = Area(
            "Water Temple Dark Link Room", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {},
            {
                // Exits
                Entrance(WATER_TEMPLE_DRAGON_PILLARS_ROOM,
        ...
        areaTable[WATER_TEMPLE_MQ_LOBBY] = Area(
            "Water Temple MQ Lobby", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {},
            {
                ...
                Entrance(WATER_TEMPLE_MQ_DARK_LINK_REGION,
                         { [] { return SmallKeys(WATER_TEMPLE, 1) && IsAdult && CanUse(LONGSHOT); } }),
                Entrance(WATER_TEMPLE_BOSS_ENTRYWAY,
                         { [] { return BossKeyWaterTemple && IsAdult && CanUse(LONGSHOT); } }),
            });
            ...
            Area("Water Temple MQ Dive", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     ...
                     LocationAccess(WATER_TEMPLE_MQ_CENTRAL_PILLAR_CHEST, { [] {
                                        return IsAdult && CanUse(ZORA_TUNIC) && CanUse(HOOKSHOT) &&
                                               ((LogicWaterMQCentralPillar && CanUse(FIRE_ARROWS)) ||
        ...
        areaTable[WATER_TEMPLE_MQ_BASEMENT_GATED_AREAS] = Area(
            "Water Temple MQ Basement Gated Areas", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
            {
                ...
                LocationAccess(WATER_TEMPLE_MQ_GS_FREESTANDING_KEY_AREA, { [] {
                                   return LogicWaterMQLockedGS ||
                                          (SmallKeys(WATER_TEMPLE, 2) &&
