...
void AreaTable_Init_ForestTemple() {
    ...
    if (Dungeon::ForestTemple.IsVanilla()) {
            ...
            Area("Forest Temple First Room", "Forest Temple", FOREST_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     ...
                     LocationAccess(FOREST_TEMPLE_GS_FIRST_ROOM, { [] {
                                        return (IsAdult && Bombs) || CanUse(BOW) || CanUse(HOOKSHOT) ||
                                               CanUse(BOOMERANG) || CanUse(SLINGSHOT) || HasBombchus ||
                                               CanUse(DINS_FIRE) ||
                                               (LogicForestFirstGS && (CanJumpslash || (IsChild && Bombs)));
                                    } }),
                 },
                 {
                     // Exits
        ...
        areaTable[FOREST_TEMPLE_LOBBY] =
            Area("Forest Temple Lobby", "Forest Temple", FOREST_TEMPLE, NO_DAY_NIGHT_CYCLE,
                 {
                     // Events
        ...
        areaTable[FOREST_TEMPLE_NW_OUTDOORS_LOWER] = Area(
            "Forest Temple NW Outdoors Lower", "Forest Temple", FOREST_TEMPLE, NO_DAY_NIGHT_CYCLE,
            {
                ...
                EventAccess(&DekuBabaSticks,
                            { [] { return DekuBabaSticks || (IsAdult || KokiriSword || Boomerang); } }),
        ...
        areaTable[FOREST_TEMPLE_NE_OUTDOORS_LOWER] = Area(
            ...
            },
            {
                ...
                LocationAccess(FOREST_TEMPLE_RAISED_ISLAND_COURTYARD_CHEST, { [] {
                                   return CanUse(HOOKSHOT) || HasAccessTo(FOREST_TEMPLE_FALLING_ROOM) ||
                                          (HasAccessTo(FOREST_TEMPLE_NE_OUTDOORS_UPPER) && IsAdult &&
                                           LogicForestOutdoorsLedge && HoverBoots);
                               } }),
            ...
            },
            {
                ...
                Entrance(FOREST_TEMPLE_NE_OUTDOORS_UPPER,
                         { [] { return CanUse(LONGSHOT) || (LogicForestVines && CanUse(HOOKSHOT)); } }),
                Entrance(FOREST_TEMPLE_SEWER, { [] {
                             return GoldScale || CanUse(IRON_BOOTS) || HasAccessTo(FOREST_TEMPLE_NE_OUTDOORS_UPPER);
                         } }),
        ...
        areaTable[FOREST_TEMPLE_NE_OUTDOORS_UPPER] =
            Area("Forest Temple NE Outdoors Upper", "Forest Temple", FOREST_TEMPLE, NO_DAY_NIGHT_CYCLE,
                 {
                     // Events
                     EventAccess(&DekuBabaSticks,
                                 { [] { return DekuBabaSticks || (IsAdult || KokiriSword || Boomerang); } }),
                 ...
                 {},
                 {
                     ...
                     Entrance(FOREST_TEMPLE_FALLING_ROOM,
                              { [] { return LogicForestDoorFrame && CanUse(HOVER_BOOTS) && CanUse(SCARECROW); } }),
                 });
                     ...
                     LocationAccess(FOREST_TEMPLE_MAP_CHEST, { [] {
                                        return Here(FOREST_TEMPLE_MAP_ROOM, [] {
                                            return HasExplosives || CanUse(MEGATON_HAMMER) || CanUse(BOW) ||
                                                   ((IsAdult || Sticks || KokiriSword || Slingshot) &&
        ...
        areaTable[FOREST_TEMPLE_BLOCK_PUSH_ROOM] =
            Area("Forest Temple Block Push Room", "Forest Temple", FOREST_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
                 ...
                 },
                 {
                     ...
                     Entrance(FOREST_TEMPLE_NW_OUTDOORS_UPPER, { [] {
                                  return CanUse(HOVER_BOOTS) ||
                                         (LogicForestOutsideBackdoor && CanJumpslash && GoronBracelet);
                              } }),
                     ...
                     Entrance(FOREST_TEMPLE_NW_CORRIDOR_STRAIGHTENED,
                              { [] { return CanUse(BOW) && GoronBracelet && SmallKeys(FOREST_TEMPLE, 2); } }),
                 });
    ...
    if (Dungeon::ForestTemple.IsMQ()) {
        areaTable[FOREST_TEMPLE_MQ_LOBBY] =
            Area("Forest Temple MQ Lobby", "Forest Temple", FOREST_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
                     LocationAccess(FOREST_TEMPLE_MQ_FIRST_ROOM_CHEST, { [] {
                                        return IsAdult || Bombs || CanUse(STICKS) || Nuts || CanUse(BOOMERANG) ||
                                               CanUse(DINS_FIRE) || KokiriSword || CanUse(SLINGSHOT);
                                    } }),
                 ...
                 },
                 {
                     ...
                     Entrance(FOREST_TEMPLE_MQ_CENTRAL_AREA,
                              { [] { return SmallKeys(FOREST_TEMPLE, 1) && (IsAdult || CanChildAttack || Nuts); } }),
                 });
        ...
        areaTable[FOREST_TEMPLE_MQ_CENTRAL_AREA] =
            Area("Forest Temple MQ Central Area", "Forest Temple", FOREST_TEMPLE, NO_DAY_NIGHT_CYCLE,
                 ...
                 },
                 {
                     ...
                     LocationAccess(FOREST_TEMPLE_MQ_WOLFOS_CHEST, { [] {
                                        return (CanPlay(SongOfTime) || IsChild) &&
                                               (IsAdult || CanUse(DINS_FIRE) || CanUse(STICKS) || CanUse(SLINGSHOT) ||
                                                KokiriSword);
                                    } }),
                 ...
                 {
                     // Exits
                     Entrance(FOREST_TEMPLE_MQ_NW_OUTDOORS,
                              { [] { return (IsAdult && CanUse(BOW)) || (IsChild && CanUse(SLINGSHOT)); } }),
                     Entrance(FOREST_TEMPLE_MQ_NE_OUTDOORS, { [] {
                                  return (IsAdult && CanUse(BOW)) || (IsChild && CanUse(SLINGSHOT));
                              } }), // This is as far as child can get
                     Entrance(FOREST_TEMPLE_MQ_AFTER_BLOCK_PUZZLE, { [] {
                                  return IsAdult && (GoronBracelet || (LogicForestMQBlockPuzzle && HasBombchus &&
                                                                       IsAdult && CanUse(HOOKSHOT)));
                              } }),
                     // Trick: IsAdult && (GoronBracelet || (LogicForestMQBlockPuzzle && HasBombchus && IsAdult &&
                     // CanUse(HOOKSHOT)))
                     Entrance(FOREST_TEMPLE_MQ_OUTDOOR_LEDGE, { [] {
                                  return (LogicForestMQHallwaySwitchJS && IsAdult && CanUse(HOVER_BOOTS)) ||
                                         (LogicForestMQHallwaySwitchBoomerang && CanUse(BOOMERANG)) ||
                                         (LogicForestMQHallwaySwitchHookshot && IsAdult && CanUse(HOOKSHOT));
                              } }),
                     // Trick (Hookshot trick not added to either n64 or oot3d rando as of yet, to enable in SoH needs
                     // uncommenting in randomizer_tricks.cpp): (LogicForestMQHallwaySwitchJS && IsAdult &&
                     // CanUse(HOVER_BOOTS)) || (LogicForestMQHallwaySwitchHookshot && IsAdult && CanUse(HOOKSHOT))
        ...
        areaTable[FOREST_TEMPLE_MQ_AFTER_BLOCK_PUZZLE] =
            Area("Forest Temple MQ After Block Puzzle", "Forest Temple", FOREST_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 ...
                 },
                 {
                     ...
                     Entrance(FOREST_TEMPLE_MQ_OUTDOOR_LEDGE, { [] {
                                  return SmallKeys(FOREST_TEMPLE, 3) ||
                                         (LogicForestMQHallwaySwitchJS &&
                                          ((IsAdult && CanUse(HOOKSHOT)) ||
                                           (LogicForestOutsideBackdoor && (IsAdult || (IsChild && CanUse(STICKS))))));
                              } }),
                     // Trick (Doing the hallway switch jumpslash as child requires sticks and has been added above):
                     // SmallKeys(FOREST_TEMPLE, 3) || (LogicForestMQHallwaySwitchJS && ((IsAdult && CanUse(HOOKSHOT))
                 ...
                 },
                 {
                     ...
                     Entrance(FOREST_TEMPLE_MQ_NE_OUTDOORS, { [] {
                                  return (IsAdult && (CanUse(IRON_BOOTS) || CanUse(LONGSHOT) ||
                                                      (LogicForestMQWellSwim && CanUse(HOOKSHOT)))) ||
                                         ProgressiveScale >= 2;
                              } }),
        ...
        areaTable[FOREST_TEMPLE_MQ_OUTDOORS_TOP_LEDGES] =
            Area("Forest Temple MQ Outdoors Top Ledges", "Forest Temple", FOREST_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 ...
                 },
                 {
                     ...
                     Entrance(FOREST_TEMPLE_MQ_NE_OUTDOORS_LEDGE,
                              { [] { return LogicForestOutdoorsLedge && IsAdult && CanUse(HOVER_BOOTS); } }),
