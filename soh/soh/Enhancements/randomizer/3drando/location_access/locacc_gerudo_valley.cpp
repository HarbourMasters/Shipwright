...
void RegionTable_Init_GerudoValley() {
  ...
  areaTable[RR_GERUDO_FORTRESS] = Region("Gerudo Fortress", "Gerudo Fortress", {RA_GERUDO_FORTRESS}, NO_DAY_NIGHT_CYCLE, {
                  ...
                  LOCATION(RC_GF_KITCHEN_POT_1,      (logic->GerudoToken || logic->Bow || logic->Hookshot) && logic->CanBreakPots),
                  LOCATION(RC_GF_KITCHEN_POT_2,      (logic->GerudoToken || logic->Bow || logic->Hookshot) && logic->CanBreakPots),
