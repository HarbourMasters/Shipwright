...
void AreaTable_Init_FireTemple() {
  ...
  areaTable[FIRE_TEMPLE_BIG_LAVA_ROOM] = Area("Fire Temple Big Lava Room", "Fire Temple", FIRE_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {}, {
                  ...
                  Entrance(FIRE_TEMPLE_BIG_LAVA_ROOM_NORTH_TILES, {[]{return IsAdult && (CanUse(SONG_OF_TIME) || LogicFireSongOfTime);}}),
  ...
  areaTable[FIRE_TEMPLE_WEST_CENTRAL_LOWER] = Area("Fire Temple West Central Lower", "Fire Temple", FIRE_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {
                  //Locations
                  LocationAccess(FIRE_TEMPLE_HIGHEST_GORON_CHEST, {[]{return Here(FIRE_TEMPLE_WEST_CENTRAL_UPPER, []{return (CanUse(SONG_OF_TIME) || LogicRustedSwitches) && CanUse(MEGATON_HAMMER);});}}),
                }, {
                  //Exits
                  Entrance(FIRE_TEMPLE_FIRE_MAZE_ROOM,     {[]{return SmallKeys(FIRE_TEMPLE, 8);}}),
                  Entrance(FIRE_TEMPLE_WEST_CENTRAL_UPPER, {[]{return IsAdult && CanUse(SONG_OF_TIME);}}),
  ...
  areaTable[FIRE_TEMPLE_MQ_UPPER_MAZE] = Area("Fire Temple MQ Upper Maze", "Fire Temple", FIRE_TEMPLE, NO_DAY_NIGHT_CYCLE, {
                  //Events
                  //EventAccess(&WallFairy, {[]{return WallFairy || (IsAdult && (((CanUse(SONG_OF_TIME) && CanUse(HOOKSHOT) && HasExplosives) || CanUse(LONGSHOT))));}}),
                  ...
                  LocationAccess(FIRE_TEMPLE_MQ_GS_SKULL_ON_FIRE,          {[]{return IsAdult && ((CanUse(SONG_OF_TIME) && CanUse(HOOKSHOT) && HasExplosives) || CanUse(LONGSHOT));}}),
  }, {
                  //Exits
  ...
  areaTable[FIRE_TEMPLE_MQ_UPPER] = Area("Fire Temple MQ Upper", "Fire Temple", FIRE_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {
                  ...
                  LocationAccess(FIRE_TEMPLE_MQ_GS_FIRE_WALL_MAZE_SIDE_ROOM, {[]{return CanUse(SONG_OF_TIME) || HoverBoots || LogicFireMQFlameMaze;}}),
                    //Trick: CanUse(SONG_OF_TIME) || HoverBoots || LogicFireMQFlameMaze
