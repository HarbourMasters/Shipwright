...
void AreaTable_Init_FireTemple() {
    ...
    if (Dungeon::FireTemple.IsVanilla()) {
            ...
            Area("Fire Temple Loop Enemies", "Fire Temple", FIRE_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {},
                 {
                     ...
                     Entrance(FIRE_TEMPLE_LOOP_TILES,
                              { [] { return Here(FIRE_TEMPLE_LOOP_ENEMIES, [] { return IsAdult || KokiriSword; }); } }),
                 });
                     ...
                     Entrance(FIRE_TEMPLE_LOOP_HAMMER_SWITCH, { [] {
                                  return Here(FIRE_TEMPLE_LOOP_FLARE_DANCER, [] {
                                      return (HasExplosives || CanUse(MEGATON_HAMMER) || CanUse(HOOKSHOT)) &&
                                             (IsAdult || KokiriSword || Slingshot || Boomerang);
                                  });
                              } }),
                 });
        ...
        areaTable[FIRE_TEMPLE_SHORTCUT_ROOM] =
            Area("Fire Temple Shortcut Room", "Fire Temple", FIRE_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
                     LocationAccess(FIRE_TEMPLE_BOULDER_MAZE_SHORTCUT_CHEST,
        ...
        areaTable[FIRE_TEMPLE_BOULDER_MAZE_LOWER] =
            Area("Fire Temple Boulder Maze Lower", "Fire Temple", FIRE_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
                     LocationAccess(FIRE_TEMPLE_BOULDER_MAZE_LOWER_CHEST, { [] { return true; } }),
                     LocationAccess(FIRE_TEMPLE_GS_BOULDER_MAZE,
                                    { [] { return HasExplosives && (IsAdult || Boomerang || CanUse(HOOKSHOT)); } }),
                 },
                 {
                     // Exits
                     Entrance(FIRE_TEMPLE_SHORTCUT_ROOM, { [] { return true; } }),
        ...
        areaTable[FIRE_TEMPLE_SCARECROW_ROOM] =
            Area("Fire Temple Scarecrow Room", "Fire Temple", FIRE_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
        ...
        areaTable[FIRE_TEMPLE_FIRE_MAZE_UPPER] =
            Area("Fire Temple Fire Maze Upper", "Fire Temple", FIRE_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {},
                 {
                     // Exits
        ...
        areaTable[FIRE_TEMPLE_WEST_CENTRAL_LOWER] = Area(
            ...
            {
                // Locations
                LocationAccess(FIRE_TEMPLE_HIGHEST_GORON_CHEST, { [] {
                                   return Here(FIRE_TEMPLE_WEST_CENTRAL_UPPER, [] {
                                       return (CanPlay(SongOfTime) || LogicRustedSwitches) && CanUse(MEGATON_HAMMER);
                                   });
                               } }),
            },
            {
        ...
        areaTable[FIRE_TEMPLE_WEST_CENTRAL_UPPER] =
            Area("Fire Temple West Central Upper", "Fire Temple", FIRE_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {},
                 {
                     // Exits
        ...
        areaTable[FIRE_TEMPLE_WEST_CLIMB] =
            Area("Fire Temple West Climb", "Fire Temple", FIRE_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {},
                 {
                     // Exits
        ...
        areaTable[FIRE_TEMPLE_MQ_LOWER] = Area(
            "Fire Temple MQ Lower", "Fire Temple", FIRE_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
            {
                ...
                LocationAccess(
                    FIRE_TEMPLE_MQ_NEAR_BOSS_CHEST, { [] {
                        return IsAdult && (LogicFewerTunicRequirements || CanUse(GORON_TUNIC)) &&
                               (((CanUse(HOVER_BOOTS) || (LogicFireMQNearBoss && CanUse(BOW))) && HasFireSource) ||
                                (CanUse(HOOKSHOT) && CanUse(FIRE_ARROWS) ||
            ...
            },
            {
                ...
                Entrance(FIRE_TEMPLE_MQ_LOWER_LOCKED_DOOR,
                         { [] { return SmallKeys(FIRE_TEMPLE, 5) && (IsAdult || KokiriSword); } }),
            ...
            Area("Fire Temple MQ Lower Locked Door", "Fire Temple", FIRE_TEMPLE, NO_DAY_NIGHT_CYCLE,
                 ...
                 },
                 {
                     ...
                     LocationAccess(FIRE_TEMPLE_MQ_MEGATON_HAMMER_CHEST,
                                    { [] { return IsAdult && (HasExplosives || Hammer || Hookshot); } }),
        ...
        areaTable[FIRE_TEMPLE_MQ_BIG_LAVA_ROOM] = Area(
            "Fire Temple MQ Big Lava Room", "Fire Temple", FIRE_TEMPLE, NO_DAY_NIGHT_CYCLE,
            {
                ...
                EventAccess(&FairyPot, { [] {
                    return FairyPot || (HasFireSource && (Bow || LogicFireMQBKChest) && IsAdult &&
                                        (CanUse(HOOKSHOT) || LogicFireSongOfTime));
                } }),
            ...
            },
            {
                ...
                LocationAccess(FIRE_TEMPLE_MQ_BOSS_KEY_CHEST, { [] {
                                   return HasFireSource && (Bow || LogicFireMQBKChest) && IsAdult && CanUse(HOOKSHOT);
                               } }),
                // Trick: HasFireSource && (Bow || LogicFireMQBKChest) && IsAdult && CanUse(HOOKSHOT)
                LocationAccess(FIRE_TEMPLE_MQ_BIG_LAVA_ROOM_BLOCKED_DOOR_CHEST, { [] {
                                   return HasFireSource && HasExplosives && IsAdult &&
                                          (CanUse(HOOKSHOT) || LogicFireMQBlockedChest);
                               } }),
            ...
            },
            {
                ...
                Entrance(FIRE_TEMPLE_MQ_LOWER_MAZE, { [] {
                             return IsAdult && CanUse(GORON_TUNIC) && SmallKeys(FIRE_TEMPLE, 2) &&
                                    (HasFireSource || (LogicFireMQClimb && HoverBoots));
                         } }),
                // Trick: IsAdult && CanUse(GORON_TUNIC) && SmallKeys(FIRE_TEMPLE, 2) && (HasFireSource ||
                // (LogicFireMQClimb && HoverBoots))
            });

        areaTable[FIRE_TEMPLE_MQ_LOWER_MAZE] =
            Area("Fire Temple MQ Lower Maze", "Fire Temple", FIRE_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
                     ...
                     LocationAccess(FIRE_TEMPLE_MQ_LIZALFOS_MAZE_SIDE_ROOM_CHEST, { [] {
                                        return HasExplosives &&
                                               (LogicFireMQMazeSideRoom || HasAccessTo(FIRE_TEMPLE_MQ_UPPER_MAZE));
                                    } }),
                     // Trick: HasExplosives && (LogicFireMQMazeSideRoom || FIRE_TEMPLE_MQ_UPPER_MAZE.Adult())
                 },
                 {
                     // Exits
                     Entrance(FIRE_TEMPLE_MQ_UPPER_MAZE, { [] {
                                  return (IsAdult && ((HasExplosives && CanUse(HOOKSHOT)) ||
                                                      (LogicFireMQMazeHovers && CanUse(HOVER_BOOTS)))) ||
                                         LogicFireMQMazeJump;
                              } }),
            ...
            Area("Fire Temple MQ Upper", "Fire Temple", FIRE_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     ...
                     LocationAccess(FIRE_TEMPLE_MQ_GS_FIRE_WALL_MAZE_SIDE_ROOM,
                                    { [] { return CanPlay(SongOfTime) || HoverBoots || LogicFireMQFlameMaze; } }),
                     ...
                     LocationAccess(FIRE_TEMPLE_MQ_GS_ABOVE_FIRE_WALL_MAZE, { [] {
                                        return (IsAdult && CanUse(HOOKSHOT) && SmallKeys(FIRE_TEMPLE, 5)) ||
                                               (LogicFireMQAboveMazeGS && IsAdult && CanUse(LONGSHOT));
                                    } }),
