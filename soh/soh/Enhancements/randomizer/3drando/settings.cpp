...
namespace Settings {
  ...
  Option ShuffleSwim            = Option::Bool("Shuffle Swim",           {"Off", "On"});
  ...
  Option LogicDekuB1BackflipOverSpikedLog         = LogicTrick(std::to_string(RT_DEKU_B1_BACKFLIP_OVER_SPIKED_LOG));
