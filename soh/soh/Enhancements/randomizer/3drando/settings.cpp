...
namespace Settings {
  ...
  Option SariaHintText       = Option::Bool("Saria's Magic Hint",     {"Off", "On"},                                                          {"", ""},                                                                                                         OptionCategory::Setting,    0);
  Option FrogsHintText       = Option::Bool("Final Frogs Hint",       {"Off", "On"},                                                          {"", ""},                                                                                                         OptionCategory::Setting,    0);  
