...
typedef enum {
    ...
    RC_GANONDORF_HINT,
    RC_KF_STORMS_GROTTO_BEEHIVE_1,
    RC_KF_STORMS_GROTTO_BEEHIVE_2,
    RC_LW_NEAR_SHORTCUTS_GROTTO_BEEHIVE_1,
    RC_LW_NEAR_SHORTCUTS_GROTTO_BEEHIVE_2,
    RC_LW_DEKU_SCRUB_GROTTO_BEEHIVE,
    RC_SFM_STORMS_GROTTO_BEEHIVE,
    RC_HF_NEAR_MARKET_GROTTO_BEEHIVE_1,
    RC_HF_NEAR_MARKET_GROTTO_BEEHIVE_2,
    RC_HF_OPEN_GROTTO_BEEHIVE_1,
    RC_HF_OPEN_GROTTO_BEEHIVE_2,
    RC_HF_SOUTHEAST_GROTTO_BEEHIVE_1,
    RC_HF_SOUTHEAST_GROTTO_BEEHIVE_2,
    RC_HF_INSIDE_FENCE_GROTTO_BEEHIVE,
    RC_LLR_GROTTO_BEEHIVE,
    RC_KAK_OPEN_GROTTO_BEEHIVE_1,
    RC_KAK_OPEN_GROTTO_BEEHIVE_2,
    RC_DMT_COW_GROTTO_BEEHIVE,
    RC_DMT_STORMS_GROTTO_BEEHIVE_1,
    RC_DMT_STORMS_GROTTO_BEEHIVE_2,
    RC_GC_GROTTO_BEEHIVE,
    RC_DMC_UPPER_GROTTO_BEEHIVE_1,
    RC_DMC_UPPER_GROTTO_BEEHIVE_2,
    RC_DMC_HAMMER_GROTTO_BEEHIVE,
    RC_ZR_OPEN_GROTTO_BEEHIVE_1,
    RC_ZR_OPEN_GROTTO_BEEHIVE_2,
    RC_ZR_STORMS_GROTTO_BEEHIVE,
    RC_ZD_IN_FRONT_OF_KING_ZORA_BEEHIVE_1,
    RC_ZD_IN_FRONT_OF_KING_ZORA_BEEHIVE_2,
    RC_ZD_BEHIND_KING_ZORA_BEEHIVE,
    RC_LH_GROTTO_BEEHIVE,
    RC_GV_STORMS_GROTTO_BEEHIVE,
