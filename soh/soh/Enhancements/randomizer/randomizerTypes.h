...
typedef enum {
    ...
    RR_BOTW_KEESE_BEAMOS_ROOM,
    RR_BOTW_LOCKED_CAGE,
    RR_BOTW_WEST_INNER_ROOM,
    RR_BOTW_EAST_INNER_ROOM,
    RR_BOTW_WEST_LEDGE,
    RR_BOTW_COFFIN_ROOM,
    ...
    RR_BOTW_MQ_MIDDLE,
    RR_BOTW_MQ_EAST_INNER_ROOM,
    RR_BOTW_MQ_WEST_INNER_ROOM,
    RR_BOTW_MQ_WEST_CAGE,
    RR_BOTW_MQ_WEST_LEDGE,
    RR_BOTW_MQ_COFFIN_ROOM,
    RR_BOTW_MQ_NORTHEAST_CRAWLSPACE,
