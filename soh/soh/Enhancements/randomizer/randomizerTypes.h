...
typedef enum {
    ...
    RCTYPE_BOSS_HEART_OR_OTHER_REWARD, // Boss heart container or lesser dungeon rewards (lens, ice arrow) RANDOTODO more concise name?
    RCTYPE_POT,                        // Pots
...
typedef enum {
    ...
    RR_BOTW_LOBBY,
    RR_BOTW_REQUIRES_LENS,
    RR_BOTW_SOUTHWEST_ROOM,
    RR_BOTW_3_HIDDEN_PITS_ROOM,
    RR_BOTW_OUTER_CAGE,
    RR_BOTW_INNER_ROOMS,
    RR_BOTW_COFFIN_ROOM,
    RR_BOTW_DEAD_HAND_ROOM,
    RR_BOTW_B3,
    RR_BOTW_B3_EAST_BOMB_FLOWERS,
    RR_BOTW_B3_PLATFORM,

    RR_BOTW_MQ_LOBBY,
    RR_BOTW_MQ_WEST_SWITCH,
    RR_BOTW_MQ_COFFIN_ROOM,
    RR_BOTW_MQ_OUTER_CAGE,
    RR_BOTW_MQ_DEAD_HAND_ROOM,
    RR_BOTW_MQ_WOODEN_X_ROOM,
    RR_BOTW_MQ_B3,
    RR_BOTW_MQ_B3_SWITCH,
...
typedef enum {
    ...
    RC_BOTW_SOUTH_SUNKEN_CHEST,
    RC_BOTW_SOUTH_BURIED_CHEST,
    RC_BOTW_WEST_SUNKEN_CHEST,
    RC_BOTW_ENTRYWAY_WEST_POT,
    RC_BOTW_ENTRYWAY_EAST_POT,
    RC_BOTW_SUNKEN_POT,
    RC_BOTW_WEST_FAKE_WALL_CHEST,
    RC_BOTW_EAST_FAKE_WALL_CHEST,
    RC_BOTW_WOODEN_X_ROOM_WEST_CHEST,
    RC_BOTW_WOODEN_X_ROOM_EAST_CHEST,
    RC_BOTW_NORTH_BURIED_CHEST,
    RC_BOTW_FAKE_WALL_NORTH_POT,
    RC_BOTW_FAKE_WALL_CENTRAL_POT,
    RC_BOTW_FAKE_WALL_SOUTH_POT,
    RC_BOTW_3_HIDDEN_PITS_CHEST,
    RC_BOTW_3_HIDDEN_PITS_POT,
    RC_BOTW_OUTER_CAGE_CHEST,
    RC_BOTW_OUTER_CAGE_GS,
    RC_BOTW_INNER_WEST_ROOM_GS,
    RC_BOTW_UNSEEN_LEDGE_GS,
    RC_BOTW_COFFIN_KEY,
    RC_BOTW_OPEN_COFFIN_HEART,
    RC_BOTW_SE_COFFIN_HEART,
    RC_BOTW_DEAD_HAND_CHEST,
    RC_BOTW_INVISIBLE_CHEST,
    RC_BOTW_B3_CHEST,
    RC_BOTW_B3_WEST_CENTER_POT,
    RC_BOTW_B3_EAST_CENTER_POT,
    RC_BOTW_B3_WEST_V_N_POT,
    RC_BOTW_B3_WEST_V_NW_POT,
    RC_BOTW_B3_WEST_V_W_POT,
    RC_BOTW_B3_WEST_V_SW_POT,
    RC_BOTW_B3_WEST_V_S_POT,
    RC_BOTW_B3_EAST_V_N_POT,
    RC_BOTW_B3_EAST_V_NW_POT,
    RC_BOTW_B3_EAST_V_W_POT,
    RC_BOTW_B3_EAST_V_SW_POT,
    RC_BOTW_B3_EAST_V_S_POT,
    RC_BOTW_B3_SUN_FAIRY,
    RC_BOTW_B3_PLATFORM_N_RUPEE,
    RC_BOTW_B3_PLATFORM_NW_RUPEE,
    RC_BOTW_B3_PLATFORM_NE_RUPEE,
    RC_BOTW_B3_PLATFORM_W_RUPEE,
    RC_BOTW_B3_PLATFORM_E_RUPEE,

    RC_BOTW_MQ_CAGED_POT,
    RC_BOTW_MQ_N_BURIED_HEART,
    RC_BOTW_MQ_S_BURIED_HEART,
    RC_BOTW_MQ_COFFIN_ROOM_GS,
    RC_BOTW_MQ_NE_COFFIN_HEART,
    RC_BOTW_MQ_S_COFFIN_HEART,
    RC_BOTW_MQ_DEAD_HAND_CHEST,
    RC_BOTW_MQ_DEAD_HAND_BURIED_KEY,
    RC_BOTW_MQ_WOODEN_X_CHEST,
    RC_BOTW_MQ_UNSEEN_LEDGE_KEY,
    RC_BOTW_MQ_UNDER_GRAVE_GS,
    RC_BOTW_MQ_WOODEN_X_ROOM_W_POT,
    RC_BOTW_MQ_WOODEN_X_ROOM_C_POT,
    RC_BOTW_MQ_WOODEN_X_ROOM_E_POT,
    RC_BOTW_MQ_UNSEEN_LEDGE_NW_POT,
    RC_BOTW_MQ_UNSEEN_LEDGE_NE_POT,
    RC_BOTW_MQ_UNSEEN_LEDGE_S_POT,
    RC_BOTW_MQ_NEAR_POTS_SUN_FAIRY,
    RC_BOTW_MQ_B3_GS,
    RC_BOTW_MQ_B3_S_HEART,
    RC_BOTW_MQ_B3_NW_HEART,
    RC_BOTW_MQ_B3_NE_HEART,
    RC_BOTW_MQ_B3_SUN_FAIRY,
...
typedef enum {
    ...
    RHT_BOTW_WEST_FAKE_WALL_CHEST,
    RHT_BOTW_SOUTH_BURIED_CHEST,
    RHT_BOTW_NORTH_BURIED_CHEST,
    RHT_BOTW_WEST_SUNKEN_CHEST,
    RHT_BOTW_COFFIN_KEY,
    RHT_BOTW_WOODEN_X_ROOM_WEST_CHEST,
    RHT_BOTW_WOODEN_X_ROOM_EAST_CHEST,
    RHT_BOTW_EAST_FAKE_WALL_CHEST,
    RHT_BOTW_3_HIDDEN_PITS_CHEST,
    RHT_BOTW_OUTER_CAGE_CHEST,
    RHT_BOTW_B3_CHEST,
    RHT_BOTW_SOUTH_SUNKEN_CHEST,
    RHT_BOTW_INVISIBLE_CHEST,
    RHT_BOTW_DEAD_HAND_CHEST,
    RHT_BOTW_WEST_INNER_ROOM_GS,
    RHT_BOTW_INVISIBLE_LEDGE_GS,
    RHT_BOTW_OUTER_CAGE_GS,
    RHT_BOTW_MQ_WOODEN_X_CHEST,
    RHT_BOTW_MQ_UNSEEN_LEDGE_KEY,
    RHT_BOTW_MQ_DEAD_HAND_CHEST,
    RHT_BOTW_MQ_DEAD_HAND_BURIED_KEY,
    RHT_BOTW_MQ_REDEAD_CHEST,
    RHT_BOTW_MQ_COFFIN_ROOM_GS,
    RHT_BOTW_MQ_UNDER_GRAVE_GS,
    RHT_BOTW_MQ_B3_GS,
    ...
    RHT_WASTELAND_NW_POT,
    RHT_WASTELAND_NE_POT,
    RHT_WASTELAND_SW_POT,
    RHT_WASTELAND_SE_POT,
    RHT_POT_MARKET,
    RHT_POT_KAKARIKO,
    RHT_POT_GRAVEYARD,
    RHT_POT_GORON_CITY,
    ...
    RHT_BOTW_3_HIDDEN_PITS_POT,
    RHT_BOTW_ENTRYWAY_EAST_POT,
    RHT_BOTW_ENTRYWAY_WEST_POT,
    RHT_BOTW_SUNKEN_POT,
    RHT_BOTW_FAKE_WALL_SOUTH_POT,
    RHT_BOTW_FAKE_WALL_CENTRAL_POT,
    RHT_BOTW_FAKE_WALL_NORTH_POT,
    RHT_BOTW_B3_WEST_CENTER_POT,
    RHT_BOTW_B3_EAST_CENTER_POT,
    RHT_BOTW_B3_WEST_V_N_POT,
    RHT_BOTW_B3_WEST_V_MID_NW_POT,
    RHT_BOTW_B3_WEST_V_W_POT,
    RHT_BOTW_B3_WEST_V_SW_POT,
    RHT_BOTW_B3_WEST_V_S_POT,
    RHT_BOTW_B3_EAST_V_N_POT,
    RHT_BOTW_B3_EAST_V_NW_POT,
    RHT_BOTW_B3_EAST_V_W_POT,
    RHT_BOTW_B3_EAST_V_SW_POT,
    RHT_BOTW_B3_EAST_V_S_POT,
    RHT_BOTW_MQ_WOODEN_X_ROOM_W_POT,
    RHT_BOTW_MQ_WOODEN_X_ROOM_C_POT,
    RHT_BOTW_MQ_WOODEN_X_ROOM_E_POT,
    RHT_BOTW_MQ_CAGED_POT,
    RHT_BOTW_MQ_UNSEEN_LEDGE_S_POT,
    RHT_BOTW_MQ_UNSEEN_LEDGE_NE_POT,
    RHT_BOTW_MQ_UNSEEN_LEDGE_NW_POT,
    RHT_POT_ICE_CAVERN,
    // Ganon Line
    RHT_GANON_JOKE01,
    RHT_GANON_JOKE02,
    ...
    RHT_BOTW_SE_COFFIN_HEART,
    RHT_BOTW_OPEN_COFFIN_HEART,
    RHT_BOTW_MQ_B3_S_HEART,
    RHT_BOTW_MQ_B3_NW_HEART,
    RHT_BOTW_MQ_B3_NE_HEART,
    RHT_BOTW_B3_PLATFORM_N_RUPEE,
    RHT_BOTW_B3_PLATFORM_NW_RUPEE,
    RHT_BOTW_B3_PLATFORM_NE_RUPEE,
    RHT_BOTW_B3_PLATFORM_W_RUPEE,
    RHT_BOTW_B3_PLATFORM_E_RUPEE,
    RHT_BOTW_MQ_N_BURIED_HEART,
    RHT_BOTW_MQ_S_BURIED_HEART,
    RHT_BOTW_MQ_NE_COFFIN_HEART,
    RHT_BOTW_MQ_S_COFFIN_HEART,
    ...
    RHT_BOTW_MQ_NEAR_POTS_SUN_FAIRY,
    RHT_BOTW_MQ_B3_SUN_FAIRY,
    // MAX
    RHT_MAX
