...
typedef enum {
    ...
    RCTYPE_GRASS,                      // Grass
    RCTYPE_SILVER_RUPEE,               // Silver Rupees
} RandomizerCheckType;
...
typedef enum {
    ...
    // Vanilla Silver Rupee Locations
...
typedef enum {
    ...
    RG_BOTTOMLESS_SILVER_RUPEE_POUCH,
    RG_HINT,
    RG_TYCOON_WALLET,
    RG_BRONZE_SCALE,
    RG_CHILD_WALLET,
...
typedef enum {
    ...
    RHT_SPIRIT_LOBBY_SILVER_RUPEE,
    RHT_SHADOW_SPINNING_SCYTHE_SILVER_RUPEE,
    RHT_SHADOW_INVISIBLE_SCYTHE_SILVER_RUPEE,
    ...
    RHT_WATER_TRIAL_SILVER_RUPEE,
    RHT_SHADOW_TRIAL_SILVER_RUPEE,
    // Items
    RHT_KOKIRI_SWORD,
    RHT_MASTER_SWORD,
    RHT_GIANTS_KNIFE,
