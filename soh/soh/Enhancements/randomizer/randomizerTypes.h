...
typedef enum {
    ...
    RHT_BOTW_MQ_IMVISIBLE_LEDGE_KEY,
    ...
    RHT_BOTW_MQ_INVISIBLE_LEDGE_S_POT,
    RHT_BOTW_MQ_INVISIBLE_LEDGE_NE_POT,
    RHT_BOTW_MQ_INVISIBLE_LEDGE_NW_POT,
    RHT_POT_ICE_CAVERN,
    // Ganon Line
    RHT_GANON_JOKE01,
    RHT_GANON_JOKE02,
