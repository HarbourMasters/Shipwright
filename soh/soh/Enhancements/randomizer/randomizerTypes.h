...
typedef enum {
    ITEMLOGIC_NONE,
    ITEMLOGIC_KOKIRISWORD,
    ITEMLOGIC_MASTERSWORD,
    ITEMLOGIC_BIGGORONSWORD,
    ITEMLOGIC_DEKUSHIELD,
    ITEMLOGIC_HYLIANSHIELD,
    ITEMLOGIC_MIRRORSHIELD,
    ITEMLOGIC_GORONTUNIC,
    ITEMLOGIC_ZORATUNIC,
    ITEMLOGIC_IRONBOOTS,
    ITEMLOGIC_HOVERBOOTS,
    ITEMLOGIC_BOOMERANG,
    ITEMLOGIC_LENSOFTRUTH,
    ITEMLOGIC_HAMMER,
    ITEMLOGIC_SHARDOFAGONY,
    ITEMLOGIC_DINSFIRE,
    ITEMLOGIC_FARORESWIND,
    ITEMLOGIC_NAYRUSLOVE,
    ITEMLOGIC_FIREARROWS,
    ITEMLOGIC_ICEARROWS,
    ITEMLOGIC_LIGHTARROWS,
    ITEMLOGIC_GERUDOTOKEN,
    ITEMLOGIC_MAGICBEAN,
    ITEMLOGIC_MAGICBEANPACK,
    ITEMLOGIC_DOUBLEDEFENSE,
    ITEMLOGIC_WEIRDEGG,
    ITEMLOGIC_ZELDASLETTER,
    ITEMLOGIC_POCKETEGG,
    ITEMLOGIC_COJIRO,
    ITEMLOGIC_ODDMUSHROOM,
    ITEMLOGIC_ODDPOULTICE,
    ITEMLOGIC_POACHERSSAW,
    ITEMLOGIC_BROKENSWORD,
    ITEMLOGIC_PRESCRIPTION,
    ITEMLOGIC_EYEBALLFROG,
    ITEMLOGIC_EYEDROPS,
    ITEMLOGIC_CLAIMCHECK,
    ITEMLOGIC_GOLDSKULLTULATOKENS,
    ITEMLOGIC_PROGRESSIVEHOOKSHOT,
    ITEMLOGIC_PROGRESSIVESTRENGTH,
    ITEMLOGIC_PROGRESSIVEBOMBBAG,
    ITEMLOGIC_PROGRESSIVEBOW,
    ITEMLOGIC_PROGRESSIVEBULLETBAG,
    ITEMLOGIC_PROGRESSIVEWALLET,
    ITEMLOGIC_PROGRESSIVESCALE,
    ITEMLOGIC_BOMBCHUS,
    ITEMLOGIC_PROGRESSIVEMAGIC,
    ITEMLOGIC_PROGRESSIVEOCARINA,
    ITEMLOGIC_PROGRESSIVEGIANTKNIFE,
    ITEMLOGIC_BOTTLES,
    ITEMLOGIC_RUTOSLETTER,
    ITEMLOGIC_BOTTLEWITHBIGPOE,
    ITEMLOGIC_ZELDASLULLABY,
    ITEMLOGIC_EPONASSONG,
    ITEMLOGIC_SARIASSONG,
    ITEMLOGIC_SUNSSONG,
    ITEMLOGIC_SONGOFTIME,
    ITEMLOGIC_SONGOFSTORMS,
    ITEMLOGIC_MINUETOFFOREST,
    ITEMLOGIC_BOLEROOFFIRE,
    ITEMLOGIC_SERENADEOFWATER,
    ITEMLOGIC_NOCTURNEOFSHADOW,
    ITEMLOGIC_REQUIEMOFSPIRIT,
    ITEMLOGIC_PRELUDEOFLIGHT,
    ITEMLOGIC_MAPDEKUTREE,
    ITEMLOGIC_MAPDODONGOSCAVERN,
    ITEMLOGIC_MAPJABUJABUSBELLY,
    ITEMLOGIC_MAPFORESTTEMPLE,
    ITEMLOGIC_MAPFIRETEMPLE,
    ITEMLOGIC_MAPWATERTEMPLE,
    ITEMLOGIC_MAPSPIRITTEMPLE,
    ITEMLOGIC_MAPSHADOWTEMPLE,
    ITEMLOGIC_MAPBOTTOMOFTHEWELL,
    ITEMLOGIC_MAPICECAVERN,
    ITEMLOGIC_COMPASSDEKUTREE,
    ITEMLOGIC_COMPASSDODONGOSCAVERN,
    ITEMLOGIC_COMPASSJABUJABUSBELLY,
    ITEMLOGIC_COMPASSFORESTTEMPLE,
    ITEMLOGIC_COMPASSFIRETEMPLE,
    ITEMLOGIC_COMPASSWATERTEMPLE,
    ITEMLOGIC_COMPASSSPIRITTEMPLE,
    ITEMLOGIC_COMPASSSHADOWTEMPLE,
    ITEMLOGIC_COMPASSBOTTOMOFTHEWELL,
    ITEMLOGIC_COMPASSICECAVERN,
    ITEMLOGIC_BOSSKEYFORESTTEMPLE,
    ITEMLOGIC_BOSSKEYFIRETEMPLE,
    ITEMLOGIC_BOSSKEYWATERTEMPLE,
    ITEMLOGIC_BOSSKEYSPIRITTEMPLE,
    ITEMLOGIC_BOSSKEYSHADOWTEMPLE,
    ITEMLOGIC_BOSSKEYGANONSCASTLE,
    ITEMLOGIC_FORESTTEMPLEKEYS,
    ITEMLOGIC_FIRETEMPLEKEYS,
    ITEMLOGIC_WATERTEMPLEKEYS,
    ITEMLOGIC_SPIRITTEMPLEKEYS,
    ITEMLOGIC_SHADOWTEMPLEKEYS,
    ITEMLOGIC_BOTTOMOFTHEWELLKEYS,
    ITEMLOGIC_GERUDOTRAININGGROUNDSKEYS,
    ITEMLOGIC_GERUDOFORTRESSKEYS,
    ITEMLOGIC_GANONSCASTLEKEYS,
    ITEMLOGIC_TREASUREGAMEKEYS,
    ITEMLOGIC_KOKIRIEMERALD,
    ITEMLOGIC_GORONRUBY,
    ITEMLOGIC_ZORASAPPHIRE,
    ITEMLOGIC_FORESTMEDALLION,
    ITEMLOGIC_FIREMEDALLION,
    ITEMLOGIC_WATERMEDALLION,
    ITEMLOGIC_SPIRITMEDALLION,
    ITEMLOGIC_SHADOWMEDALLION,
    ITEMLOGIC_LIGHTMEDALLION,
    ITEMLOGIC_GREG,
    ITEMLOGIC_PIECEOFHEART,
    ITEMLOGIC_HEARTCONTAINER,
    ITEMLOGIC_BOMBCHUS5,
    ITEMLOGIC_BOMBCHUS10,
    ITEMLOGIC_BOMBCHUS20,
    ITEMLOGIC_BOMBCHUDROP,
    ITEMLOGIC_NUTS,
    ITEMLOGIC_BUYARROW,
    ITEMLOGIC_BUYBOMB,
    ITEMLOGIC_STICKS,
    ITEMLOGIC_FISHACCESS,
    ITEMLOGIC_BUYMAGICPOTION,
    ITEMLOGIC_BUYBOMBCHUS,
    ITEMLOGIC_BUYSEED,
    ITEMLOGIC_BLUEFIREACCESS,
    ITEMLOGIC_BUGSACCESS,
    ITEMLOGIC_FAIRYACCESS,
    ITEMLOGIC_CANSUMMONGOHMA,
    ITEMLOGIC_CANSUMMONKINGDODONGO,
    ITEMLOGIC_CANSUMMONBARINADE,
    ITEMLOGIC_CANSUMMONPHANTOMGANON,
    ITEMLOGIC_CANSUMMONVOLVAGIA,
    ITEMLOGIC_CANSUMMONMORPHA,
    ITEMLOGIC_CANSUMMONBONGOBONGO,
    ITEMLOGIC_CANSUMMONTWINROVA,
    ITEMLOGIC_CANSUMMONGANON,
    ITEMLOGIC_FISHINGPOLE,
    ITEMLOGIC_OCARINAABUTTON,
    ITEMLOGIC_OCARINACUPBUTTON,
    ITEMLOGIC_OCARINACDOWNBUTTON,
    ITEMLOGIC_OCARINACLEFTBUTTON,
    ITEMLOGIC_OCARINACRIGHTBUTTON,
    ITEMLOGIC_TRIFORCEPIECES,
} ItemLogic;
