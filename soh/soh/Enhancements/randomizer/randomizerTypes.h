...
typedef enum {
    ...
    // Beehives
    RHT_KF_STORMS_GROTTO_BEEHIVE_LEFT,
    RHT_KF_STORMS_GROTTO_BEEHIVE_RIGHT,
    RHT_LW_NEAR_SHORTCUTS_GROTTO_BEEHIVE_LEFT,
    RHT_LW_NEAR_SHORTCUTS_GROTTO_BEEHIVE_RIGHT,
    RHT_LW_SCRUBS_GROTTO_BEEHIVE,
    RHT_SFM_STORMS_GROTTO_BEEHIVE,
    RHT_HF_NEAR_MARKET_GROTTO_BEEHIVE_LEFT,
    RHT_HF_NEAR_MARKET_GROTTO_BEEHIVE_RIGHT,
    RHT_HF_OPEN_GROTTO_BEEHIVE_LEFT,
    RHT_HF_OPEN_GROTTO_BEEHIVE_RIGHT,
    RHT_HF_SOUTHEAST_GROTTO_BEEHIVE_LEFT,
    RHT_HF_SOUTHEAST_GROTTO_BEEHIVE_RIGHT,
    RHT_HF_INSIDE_FENCE_GROTTO_BEEHIVE,
    RHT_LLR_GROTTO_BEEHIVE,
    RHT_KAK_OPEN_GROTTO_BEEHIVE_LEFT,
    RHT_KAK_OPEN_GROTTO_BEEHIVE_RIGHT,
    RHT_DMT_COW_GROTTO_BEEHIVE,
    RHT_DMT_STORMS_GROTTO_BEEHIVE_LEFT,
    RHT_DMT_STORMS_GROTTO_BEEHIVE_RIGHT,
    RHT_GC_GROTTO_BEEHIVE,
    RHT_DMC_UPPER_GROTTO_BEEHIVE_LEFT,
    RHT_DMC_UPPER_GROTTO_BEEHIVE_RIGHT,
    RHT_DMC_HAMMER_GROTTO_BEEHIVE,
    RHT_ZR_OPEN_GROTTO_BEEHIVE_LEFT,
    RHT_ZR_OPEN_GROTTO_BEEHIVE_RIGHT,
    RHT_ZR_STORMS_GROTTO_BEEHIVE,
    RHT_ZD_IN_FRONT_OF_KING_ZORA_BEEHIVE_LEFT,
    RHT_ZD_IN_FRONT_OF_KING_ZORA_BEEHIVE_RIGHT,
    RHT_ZD_BEHIND_KING_ZORA_BEEHIVE,
    RHT_LH_GROTTO_BEEHIVE,
    RHT_GV_DEKU_SCRUB_GROTTO_BEEHIVE,
    RHT_COLOSSUS_GROTTO_BEEHIVE,
    // Items
    RHT_KOKIRI_SWORD,
    RHT_MASTER_SWORD,
    RHT_GIANTS_KNIFE,
