...
ImVec4 plandomizerGetItemColor(Rando::Item randoItem) {
    ...
    if (randoItem.GetItemType() == ITEMTYPE_SONG) {
        ...
        textureID = std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetInstance()->GetWindow()->GetGui())->GetTextureByName(
...
void PlandomizerItemImageCorrection(Rando::Item randoItem) {
    ...
    if (randoItem.GetItemType() == ITEMTYPE_SMALLKEY || randoItem.GetItemType() == ITEMTYPE_FORTRESS_SMALLKEY) {
        textureID = std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetInstance()->GetWindow()->GetGui())->GetTextureByName("ITEM_KEY_SMALL");
        return;
    }
    if (randoItem.GetItemType() == ITEMTYPE_BOSSKEY) {
        textureID = std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetInstance()->GetWindow()->GetGui())->GetTextureByName("ITEM_KEY_BOSS");
        return;
    }

    for (auto& map : itemImageMap) {
        if (map.first == randoItem.GetRandomizerGet()) {
            textureID = std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetInstance()->GetWindow()->GetGui())->GetTextureByName(map.second.c_str());
    ...
    if (randoItem.GetRandomizerGet() >= RG_GOHMA_SOUL && randoItem.GetRandomizerGet() <= RG_GANON_SOUL) {
        textureID = std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetInstance()->GetWindow()->GetGui())->GetTextureByName("BOSS_SOUL");
    }

    if (randoItem.GetRandomizerGet() >= RG_OCARINA_A_BUTTON &&
        randoItem.GetRandomizerGet() <= RG_OCARINA_C_RIGHT_BUTTON) {
        textureID = std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetInstance()->GetWindow()->GetGui())->GetTextureByName("ITEM_OCARINA_TIME");
    }
        ...
        if (spoilerLogData.size() > 0) {
            if (ImGui::BeginTable("HashIcons", 5)) {
                ...
                for (auto& hash : plandoHash) {
                    ImGui::PushID(index);
                    textureID =
                        std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetInstance()->GetWindow()->GetGui())->GetTextureByName(gSeedTextures[hash].tex);
                    ImGui::PushStyleVar(ImGuiStyleVar_FramePadding, ImVec2(2.0f, 2.0f));
                    auto upRet = ImGui::ImageButton(
                        "HASH_ARROW_UP",
                        std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetInstance()->GetWindow()->GetGui())->GetTextureByName("HASH_ARROW_UP"),
                    ...
                    auto downRet = ImGui::ImageButton(
                        "HASH_ARROW_DWN",
                        std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetInstance()->GetWindow()->GetGui())->GetTextureByName("HASH_ARROW_DWN"),
...
void PlandomizerWindow::InitElement() {
    std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetInstance()->GetWindow()->GetGui())->LoadGuiTexture("ITEM_RUPEE_GRAYSCALE", gRupeeCounterIconTex,
                                                                        ImVec4(1, 1, 1, 1));
    std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetInstance()->GetWindow()->GetGui())->LoadGuiTexture("ITEM_HEART_GRAYSCALE", gHeartFullTex,
                                                                        ImVec4(0.87f, 0.10f, 0.10f, 1));
    std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetInstance()->GetWindow()->GetGui())->LoadGuiTexture("ITEM_SEEDS", gItemIconDekuSeedsTex,
                                                                        ImVec4(1, 1, 1, 1));
    std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetInstance()->GetWindow()->GetGui())->LoadGuiTexture("ITEM_ARROWS_SMALL", gDropArrows1Tex,
                                                                        ImVec4(1, 1, 1, 1));
    std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetInstance()->GetWindow()->GetGui())->LoadGuiTexture("ITEM_ARROWS_MEDIUM", gDropArrows2Tex,
                                                                        ImVec4(1, 1, 1, 1));
    std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetInstance()->GetWindow()->GetGui())->LoadGuiTexture("ITEM_ARROWS_LARGE", gDropArrows3Tex,
                                                                        ImVec4(1, 1, 1, 1));
    std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetInstance()->GetWindow()->GetGui())->LoadGuiTexture("ITEM_ICE_TRAP", gMagicArrowEquipEffectTex,
                                                                        ImVec4(1, 1, 1, 1));
    std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetInstance()->GetWindow()->GetGui())->LoadGuiTexture("HASH_ARROW_UP", gEmptyCDownArrowTex,
                                                                        ImVec4(1, 1, 1, 1));
    std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetInstance()->GetWindow()->GetGui())->LoadGuiTexture("HASH_ARROW_DWN", gEmptyCDownArrowTex,
                                                                        ImVec4(1, 1, 1, 1));
    std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetInstance()->GetWindow()->GetGui())->LoadGuiTexture("BOSS_SOUL", gBossSoulTex, ImVec4(1, 1, 1, 1));
    std::dynamic_pointer_cast<Fast::Fast3dGui>(Ship::Context::GetInstance()->GetWindow()->GetGui())->LoadGuiTexture("TRIFORCE_PIECE", gTriforcePieceTex,
                                                                        ImVec4(1, 1, 1, 1));
}
