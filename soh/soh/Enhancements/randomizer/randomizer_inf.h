...
typedef enum {
    ...
    RAND_INF_BOTW_MQ_INVISIBLE_LEDGE_NW_POT,
    RAND_INF_BOTW_MQ_INVISIBLE_LEDGE_NE_POT,
    ...
    RAND_INF_RHT_BOTW_B3_PLATFORM_NW_RUPEE,
    RAND_INF_BOTW_B3_PLATFORM_N_RUPEE,
    RAND_INF_RHT_BOTW_B3_PLATFORM_NE_RUPEE,
