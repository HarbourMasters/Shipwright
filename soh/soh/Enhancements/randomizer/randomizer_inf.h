...
typedef enum {
    ...
    RAND_INF_BEEHIVE_KF_STORMS_GROTTO_1,
    RAND_INF_BEEHIVE_KF_STORMS_GROTTO_2,
    RAND_INF_BEEHIVE_LW_NEAR_SHORTCUTS_GROTTO_1,
    RAND_INF_BEEHIVE_LW_NEAR_SHORTCUTS_GROTTO_2,
    RAND_INF_BEEHIVE_LW_DEKU_SCRUB_GROTTO,
    RAND_INF_BEEHIVE_SFM_STORMS_GROTTO,
    RAND_INF_BEEHIVE_HF_NEAR_MARKET_GROTTO_1,
    RAND_INF_BEEHIVE_HF_NEAR_MARKET_GROTTO_2,
    RAND_INF_BEEHIVE_HF_OPEN_GROTTO_1,
    RAND_INF_BEEHIVE_HF_OPEN_GROTTO_2,
    RAND_INF_BEEHIVE_HF_SOUTHEAST_GROTTO_1,
    RAND_INF_BEEHIVE_HF_SOUTHEAST_GROTTO_2,
    RAND_INF_BEEHIVE_HF_INSIDE_FENCE_GROTTO,
    RAND_INF_BEEHIVE_LLR_GROTTO,
    RAND_INF_BEEHIVE_KAK_OPEN_GROTTO_1,
    RAND_INF_BEEHIVE_KAK_OPEN_GROTTO_2,
    RAND_INF_BEEHIVE_DMT_COW_GROTTO,
    RAND_INF_BEEHIVE_DMT_STORMS_GROTTO_1,
    RAND_INF_BEEHIVE_DMT_STORMS_GROTTO_2,
    RAND_INF_BEEHIVE_GC_GROTTO,
    RAND_INF_BEEHIVE_DMC_UPPER_GROTTO_1,
    RAND_INF_BEEHIVE_DMC_UPPER_GROTTO_2,
    RAND_INF_BEEHIVE_DMC_HAMMER_GROTTO,
    RAND_INF_BEEHIVE_ZR_OPEN_GROTTO_1,
    RAND_INF_BEEHIVE_ZR_OPEN_GROTTO_2,
    RAND_INF_BEEHIVE_ZR_STORMS_GROTTO,
    RAND_INF_BEEHIVE_ZD_IN_FRONT_OF_KING_ZORA_1,
    RAND_INF_BEEHIVE_ZD_IN_FRONT_OF_KING_ZORA_2,
