...
typedef enum {
    ...
    RAND_INF_NEAR_KAK_TREE,
    RAND_INF_SOUTH_HF_TREE,
    RAND_INF_NEAR_LLR_TREE,
    RAND_INF_NEAR_LH_TREE,
    RAND_INF_NEAR_GV_TREE,
    RAND_INF_NEAR_ZR_TREE,
    RAND_INF_MARKET_DAY_TREE,
    RAND_INF_MARKET_NIGHT_TREE,
    RAND_INF_NEAR_KAK_S_TREE,
    //CUSTOM ADD HERE
    RAND_INF_HC_NEAR_GUARDS_TREE_5,
    RAND_INF_HC_NEAR_GUARDS_TREE_4,
    RAND_INF_HC_NEAR_GUARDS_TREE_3,
    RAND_INF_HC_NEAR_GUARDS_TREE_2,
    RAND_INF_HC_NEAR_GUARDS_TREE_1,
    RAND_INF_HF_SOUTH_TREE_1,
    RAND_INF_HF_NORTHWEST_TREE_2,
    RAND_INF_HF_SOUTHEAST_TREE_4,
    RAND_INF_HF_NORTHWEST_TREE_1,
    RAND_INF_HF_EAST_TREE_1,
    RAND_INF_HF_SOUTHEAST_TREE_3,
    RAND_INF_HF_SOUTHEAST_TREE_2,
    RAND_INF_HF_NEAR_HC_GROTTO_TREE_3,
    RAND_INF_HF_SOUTHEAST_TREE_1,
    RAND_INF_TREE_HF_YELLOW_GROTTO_TREE,
    RAND_INF_HF_TREE_NEAR_HC_GROTTO_2,
    RAND_INF_HF_TREE_NEAR_HC_GROTTO_1,
    RAND_INF_ZF_TREE,
    RAND_INF_ZR_TREE,
    RAND_INF_KAK_TREE,
    RAND_INF_LLR_TREE,
    RAND_INF_HF_ADULT_NEAR_GV_TREE,
    RAND_INF_HC_SKULLTULA_TREE,
    RAND_INF_HC_NEAR_GUARDS_TREE,
    RAND_INF_HC_GROTTO_TREE,
