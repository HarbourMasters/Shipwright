...
class Context {
  public:
    ...
    std::chrono::system_clock::time_point metricStart;
    std::chrono::system_clock::time_point SCLResetStart;
    std::chrono::system_clock::time_point SCLResetEnd;
    std::chrono::system_clock::time_point LogicResetStart;
    std::chrono::system_clock::time_point LogicResetEnd;
    std::chrono::system_clock::time_point areaResetStart;
    std::chrono::system_clock::time_point areaResetEnd;
    std::chrono::duration<double, std::milli> updateHelpersDuration;
    std::chrono::system_clock::time_point logStart;
    std::chrono::system_clock::time_point logEnd;
