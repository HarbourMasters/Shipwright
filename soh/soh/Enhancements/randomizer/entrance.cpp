...
int EntranceShuffler::ShuffleAllEntrances() {
    ...
    std::vector<EntranceInfoPair> entranceShuffleTable = {
        ...
        { { EntranceType::Overworld, RR_GF_OUTSIDE_GATE,         RR_WASTELAND_SOUTH_OF_RIVER, ENTR_HAUNTED_WASTELAND_EAST_EXIT },
          { EntranceType::Overworld, RR_WASTELAND_SOUTH_OF_RIVER, RR_GF_OUTSIDE_GATE,         ENTR_GERUDOS_FORTRESS_GATE_EXIT } },
        { { EntranceType::Overworld, RR_WASTELAND_NORTH, RR_DESERT_COLOSSUS,         ENTR_DESERT_COLOSSUS_EAST_EXIT },
          { EntranceType::Overworld, RR_DESERT_COLOSSUS,         RR_WASTELAND_NORTH, ENTR_HAUNTED_WASTELAND_WEST_EXIT } },
