...
int EntranceShuffler::ShuffleAllEntrances() {
    ...
    std::vector<EntranceInfoPair> entranceShuffleTable = {
        ...
        { { EntranceType::Overworld, RR_LW_UNDERWATER_SHORTCUT,  RR_ZR_UNDERWATER_SHORTCUT,  ENTR_ZORAS_RIVER_UNDERWATER_SHORTCUT },
          { EntranceType::Overworld, RR_ZR_UNDERWATER_SHORTCUT,  RR_LW_UNDERWATER_SHORTCUT,  ENTR_LOST_WOODS_UNDERWATER_SHORTCUT } },
