...
int EntranceShuffler::ShuffleAllEntrances() {
    ...
    std::vector<EntranceInfoPair> entranceShuffleTable = {
        ...
        { { EntranceType::Dungeon,      RR_GF_GROUND_BOTTOM,                 RR_GERUDO_TRAINING_GROUND_ENTRYWAY,   ENTR_GERUDO_TRAINING_GROUND_ENTRANCE },
          { EntranceType::Dungeon,      RR_GERUDO_TRAINING_GROUND_ENTRYWAY,  RR_GF_GROUND_BOTTOM,                  ENTR_GERUDOS_FORTRESS_OUTSIDE_GERUDO_TRAINING_GROUND } },
        ...
        { { EntranceType::GrottoGrave, RR_GF_GROUND_BOTTOM,         RR_GF_STORMS_GROTTO,         ENTRANCE_GROTTO_LOAD(GROTTO_GF_STORMS_OFFSET) },
          { EntranceType::GrottoGrave, RR_GF_STORMS_GROTTO,         RR_GF_GROUND_BOTTOM,         ENTRANCE_GROTTO_EXIT(GROTTO_GF_STORMS_OFFSET) } },
