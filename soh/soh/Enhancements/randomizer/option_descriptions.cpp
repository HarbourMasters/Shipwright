...
void Settings::CreateOptionDescriptions() {
    ...
    mOptionDescriptions[RSK_SHUFFLE_SIGNS] =
        "Signs and readable pedestals/plinths will grant a randomized item the first time they are read. "
        "Signs will have a different appearance when they hold a randomized item.\n"
        "\n"
