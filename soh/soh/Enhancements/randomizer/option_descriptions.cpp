...
void Settings::CreateOptionDescriptions() {
    ...
    mOptionDescriptions[RSK_BOMBCHU_BAG] =
        ...
        "Bombchus.\n\n"
        "Single Bag - Bombchus require their own bag to be found before use. 6 of them are added to the pool. The "
        "first Bombchu Bag you find will be a Bag containing 20 chus, and subsequent bags will be replaced with "
        "Bombchu Ammo refills. Once found, they can be replenished at shops selling refills, Bombchu Bowling and the "
        "carpet merchant. Bombchu Bowling is opened by obtaining the Bombchu Bag.\n\n"
