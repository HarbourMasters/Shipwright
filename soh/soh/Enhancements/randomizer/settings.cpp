...
void Settings::CreateOptions() {
    ...
    OPT_U8(RSK_SHUFFLE_SONGS, "Shuffle Songs", {"Vanilla", "Song Locations", "Dungeon Rewards", "Anywhere"}, OptionCategory::Setting, CVAR_RANDOMIZER_SETTING("ShuffleSongs"), mOptionDescriptions[RSK_SHUFFLE_SONGS], WidgetType::Combobox, RO_SONG_SHUFFLE_SONG_LOCATIONS);
