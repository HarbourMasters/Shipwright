...
void Settings::CreateOptions() {
    ...
    mOptions[RSK_SHUFFLE_CRATES] = Option::U8("Shuffle Crates", {"Off", "Dungeons", "Overworld", "All Crates"}, OptionCategory::Setting, CVAR_RANDOMIZER_SETTING("ShuffleCrates"), mOptionDescriptions[RSK_SHUFFLE_POTS], WidgetType::Combobox, RO_SHUFFLE_CRATES_OFF);
