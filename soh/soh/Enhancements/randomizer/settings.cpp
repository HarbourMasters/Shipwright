...
void Settings::CreateOptions() {
    ...
    mOptions[RSK_SHUFFLE_FREESTANDING] = Option::Bool("Shuffle Freestanding Items", CVAR_RANDOMIZER_SETTING("ShuffleFreestanding"), mOptionDescriptions[RSK_SHUFFLE_FREESTANDING], IMFLAG_SEPARATOR_BOTTOM, WidgetType::Checkbox, RO_GENERIC_OFF);
