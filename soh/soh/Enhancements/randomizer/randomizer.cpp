...
void GenerateRandomizerImgui(std::string seed = "") {
    ...
    cvarSettings[RSK_LOGIC_RULES] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_LOGIC_RULES, RO_LOGIC_GLITCHLESS);
    cvarSettings[RSK_ALL_LOCATIONS_REACHABLE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_ALL_LOCATIONS_REACHABLE, RO_GENERIC_ON);
    cvarSettings[RSK_FOREST] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_FOREST, RO_FOREST_CLOSED);
    cvarSettings[RSK_KAK_GATE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_KAKARIKO_GATE, RO_KAK_GATE_CLOSED);
    cvarSettings[RSK_DOOR_OF_TIME] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_DOOR_OF_TIME, RO_DOOROFTIME_CLOSED);
    cvarSettings[RSK_ZORAS_FOUNTAIN] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_ZORAS_FOUNTAIN, 0);
    cvarSettings[RSK_STARTING_AGE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_AGE, RO_AGE_CHILD);
    cvarSettings[RSK_GERUDO_FORTRESS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_GERUDO_FORTRESS, RO_GF_NORMAL);
    cvarSettings[RSK_RAINBOW_BRIDGE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_RAINBOW_BRIDGE, RO_BRIDGE_VANILLA);
    cvarSettings[RSK_RAINBOW_BRIDGE_STONE_COUNT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STONE_COUNT, 3);
    cvarSettings[RSK_RAINBOW_BRIDGE_MEDALLION_COUNT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MEDALLION_COUNT, 6);
    cvarSettings[RSK_RAINBOW_BRIDGE_REWARD_COUNT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_REWARD_COUNT, 9);
    cvarSettings[RSK_RAINBOW_BRIDGE_DUNGEON_COUNT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_DUNGEON_COUNT, 8);
    cvarSettings[RSK_RAINBOW_BRIDGE_TOKEN_COUNT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_TOKEN_COUNT, 100);
    cvarSettings[RSK_BRIDGE_OPTIONS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_BRIDGE_REWARD_OPTIONS, 0);
    cvarSettings[RSK_GANONS_TRIALS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_GANON_TRIAL, RO_GANONS_TRIALS_SET_NUMBER);
    cvarSettings[RSK_TRIAL_COUNT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_GANON_TRIAL_COUNT, 6);
    cvarSettings[RSK_STARTING_OCARINA] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_OCARINA, 0);
    cvarSettings[RSK_SHUFFLE_OCARINA] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_OCARINAS, 0) ||
                                        CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_OCARINA, 0);
    cvarSettings[RSK_STARTING_KOKIRI_SWORD] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_KOKIRI_SWORD, 0);
    cvarSettings[RSK_SHUFFLE_KOKIRI_SWORD] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_KOKIRI_SWORD, 0) ||
                                             CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_KOKIRI_SWORD, 0);
    cvarSettings[RSK_SHUFFLE_MASTER_SWORD] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_MASTER_SWORD, 0);
    cvarSettings[RSK_STARTING_DEKU_SHIELD] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_DEKU_SHIELD, 0);
    cvarSettings[RSK_STARTING_ZELDAS_LULLABY] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_ZELDAS_LULLABY, 0);
    cvarSettings[RSK_STARTING_EPONAS_SONG] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_EPONAS_SONG, 0);
    cvarSettings[RSK_STARTING_SARIAS_SONG] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_SARIAS_SONG, 0);
    cvarSettings[RSK_STARTING_SUNS_SONG] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_SUNS_SONG, 0);
    cvarSettings[RSK_STARTING_SONG_OF_TIME] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_SONG_OF_TIME, 0);
    cvarSettings[RSK_STARTING_SONG_OF_STORMS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_SONG_OF_STORMS, 0);
    cvarSettings[RSK_STARTING_MINUET_OF_FOREST] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_MINUET_OF_FOREST, 0);
    cvarSettings[RSK_STARTING_BOLERO_OF_FIRE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_BOLERO_OF_FIRE, 0);
    cvarSettings[RSK_STARTING_SERENADE_OF_WATER] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_SERENADE_OF_WATER, 0);
    cvarSettings[RSK_STARTING_REQUIEM_OF_SPIRIT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_REQUIEM_OF_SPIRIT, 0);
    cvarSettings[RSK_STARTING_NOCTURNE_OF_SHADOW] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_NOCTURNE_OF_SHADOW, 0);
    cvarSettings[RSK_STARTING_PRELUDE_OF_LIGHT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_PRELUDE_OF_LIGHT, 0);
    cvarSettings[RSK_STARTING_SKULLTULA_TOKEN] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_SKULLTULA_TOKEN, 0);
    cvarSettings[RSK_STARTING_MAPS_COMPASSES] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_MAPS_COMPASSES, RO_DUNGEON_ITEM_LOC_OWN_DUNGEON);
    cvarSettings[RSK_SHUFFLE_DUNGEON_REWARDS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_DUNGEON_REWARD, RO_DUNGEON_REWARDS_END_OF_DUNGEON);
    cvarSettings[RSK_SHUFFLE_SONGS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_SONGS, RO_SONG_SHUFFLE_SONG_LOCATIONS);
    cvarSettings[RSK_SHUFFLE_TOKENS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_TOKENS, RO_TOKENSANITY_OFF);
    cvarSettings[RSK_SHOPSANITY] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHOPSANITY, RO_SHOPSANITY_OFF);
    cvarSettings[RSK_SHOPSANITY_PRICES] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHOPSANITY_PRICES, RO_SHOPSANITY_PRICE_BALANCED);
    cvarSettings[RSK_SHOPSANITY_PRICES_AFFORDABLE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHOPSANITY_PRICES_AFFORDABLE, RO_SHOPSANITY_OFF);
    cvarSettings[RSK_SHUFFLE_SCRUBS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_SCRUBS, RO_SCRUBS_OFF);
    cvarSettings[RSK_SHUFFLE_COWS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_COWS, 0);
    cvarSettings[RSK_SHUFFLE_ADULT_TRADE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_ADULT_TRADE, 0);
    cvarSettings[RSK_SHUFFLE_MAGIC_BEANS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_BEANS, 0);
    cvarSettings[RSK_SHUFFLE_MERCHANTS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_MERCHANTS, RO_SHUFFLE_MERCHANTS_OFF);
    cvarSettings[RSK_SHUFFLE_100_GS_REWARD] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_100GS_REWARD, RO_GENERIC_OFF);
    cvarSettings[RSK_ENABLE_BOMBCHU_DROPS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_ENABLE_BOMBCHU_DROPS, 0);
    cvarSettings[RSK_BOMBCHUS_IN_LOGIC] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_BOMBCHUS_IN_LOGIC, 0);
    cvarSettings[RSK_SKIP_CHILD_ZELDA] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SKIP_CHILD_ZELDA, 0);

    // if we skip child zelda, we start with zelda's letter, and malon starts
    // at the ranch, so we should *not* shuffle the weird egg
    cvarSettings[RSK_SHUFFLE_WEIRD_EGG] = ((CVarGetInteger(CVAR_RANDOMIZER_SETTING_SKIP_CHILD_ZELDA, 0) == 0) &&
                                            CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_WEIRD_EGG, 0));
    cvarSettings[RSK_SHUFFLE_GERUDO_MEMBERSHIP_CARD] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_GERUDO_TOKEN, 0);
    cvarSettings[RSK_SHUFFLE_FROG_SONG_RUPEES] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_FROG_SONG_RUPEES, 0);
    cvarSettings[RSK_ITEM_POOL] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_ITEM_POOL, RO_ITEM_POOL_BALANCED);
    cvarSettings[RSK_ICE_TRAPS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_ICE_TRAPS, RO_ICE_TRAPS_NORMAL);
    cvarSettings[RSK_TOT_ALTAR_HINT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_ALTAR_HINT, RO_GENERIC_ON);
    cvarSettings[RSK_LIGHT_ARROWS_HINT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_LA_HINT, RO_GENERIC_ON);
    cvarSettings[RSK_DAMPES_DIARY_HINT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_DAMPE_HINT, RO_GENERIC_OFF);
    cvarSettings[RSK_GREG_HINT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_GREG_HINT, RO_GENERIC_OFF);
    cvarSettings[RSK_SARIA_HINT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SARIA_HINT, RO_GENERIC_OFF);
    cvarSettings[RSK_FROGS_HINT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_FROGS_HINT, RO_GENERIC_OFF);
    cvarSettings[RSK_WARP_SONG_HINTS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_WARP_SONG_TEXT, RO_GENERIC_OFF);
    cvarSettings[RSK_SCRUB_TEXT_HINT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SCRUB_TEXT, RO_GENERIC_OFF);
    cvarSettings[RSK_KAK_10_SKULLS_HINT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_10GS_HINT, RO_GENERIC_OFF);
    cvarSettings[RSK_KAK_20_SKULLS_HINT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_20GS_HINT, RO_GENERIC_OFF);
    cvarSettings[RSK_KAK_30_SKULLS_HINT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_30GS_HINT, RO_GENERIC_OFF);
    cvarSettings[RSK_KAK_40_SKULLS_HINT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_40GS_HINT, RO_GENERIC_OFF);
    cvarSettings[RSK_KAK_50_SKULLS_HINT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_50GS_HINT, RO_GENERIC_OFF);
    cvarSettings[RSK_GOSSIP_STONE_HINTS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_GOSSIP_STONE_HINTS, RO_GOSSIP_STONES_NEED_NOTHING);
    cvarSettings[RSK_HINT_CLARITY] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_HINT_CLARITY, RO_HINT_CLARITY_CLEAR);
    cvarSettings[RSK_HINT_DISTRIBUTION] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_HINT_DISTRIBUTION, RO_HINT_DIST_BALANCED);
    cvarSettings[RSK_BLUE_FIRE_ARROWS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_BLUE_FIRE_ARROWS, 0);
    cvarSettings[RSK_SUNLIGHT_ARROWS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SUNLIGHT_ARROWS, 0);
    cvarSettings[RSK_KEYSANITY] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_KEYSANITY, RO_DUNGEON_ITEM_LOC_OWN_DUNGEON);
    cvarSettings[RSK_GERUDO_KEYS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_GERUDO_KEYS, RO_GERUDO_KEYS_VANILLA);
    cvarSettings[RSK_KEYRINGS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS, RO_KEYRINGS_OFF);
    int maxKeyringCount = (CVarGetInteger(CVAR_RANDOMIZER_SETTING_GERUDO_FORTRESS, RO_GF_NORMAL) == RO_GF_NORMAL &&
                       CVarGetInteger(CVAR_RANDOMIZER_SETTING_GERUDO_KEYS, RO_GERUDO_KEYS_VANILLA) != RO_GERUDO_KEYS_VANILLA) ? 9 : 8;
    cvarSettings[RSK_KEYRINGS_RANDOM_COUNT] = std::min(CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_RANDOM_COUNT, maxKeyringCount), maxKeyringCount);
    ...
    cvarSettings[RSK_KEYRINGS_GERUDO_FORTRESS] =
        (CVarGetInteger(CVAR_RANDOMIZER_SETTING_GERUDO_FORTRESS, RO_GF_NORMAL) == RO_GF_NORMAL &&
         CVarGetInteger(CVAR_RANDOMIZER_SETTING_GERUDO_KEYS, RO_GERUDO_KEYS_VANILLA) != RO_GERUDO_KEYS_VANILLA)
            ? CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_GERUDO_FORTRESS, RO_GENERIC_OFF) : RO_GENERIC_OFF;
    cvarSettings[RSK_KEYRINGS_FOREST_TEMPLE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_FOREST_TEMPLE, 0);
    cvarSettings[RSK_KEYRINGS_FIRE_TEMPLE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_FIRE_TEMPLE, 0);
    cvarSettings[RSK_KEYRINGS_WATER_TEMPLE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_WATER_TEMPLE, 0);
    cvarSettings[RSK_KEYRINGS_SPIRIT_TEMPLE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_SPIRIT_TEMPLE, 0);
    cvarSettings[RSK_KEYRINGS_SHADOW_TEMPLE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_SHADOW_TEMPLE, 0);
    cvarSettings[RSK_KEYRINGS_BOTTOM_OF_THE_WELL] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_BOTTOM_OF_WELL, 0);
    cvarSettings[RSK_KEYRINGS_GTG] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_GTG, 0);
    cvarSettings[RSK_KEYRINGS_GANONS_CASTLE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_GANONS_CASTLE, 0);
    cvarSettings[RSK_BOSS_KEYSANITY] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_BOSS_KEYSANITY, RO_DUNGEON_ITEM_LOC_OWN_DUNGEON);
    cvarSettings[RSK_GANONS_BOSS_KEY] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_GANON_BOSS_KEY, RO_GANON_BOSS_KEY_VANILLA);
    cvarSettings[RSK_LACS_STONE_COUNT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_LACS_STONE_COUNT, 3);
    cvarSettings[RSK_LACS_MEDALLION_COUNT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_LACS_MEDALLION_COUNT, 6);
    cvarSettings[RSK_LACS_REWARD_COUNT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_LACS_REWARD_COUNT, 9);
    cvarSettings[RSK_LACS_DUNGEON_COUNT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_LACS_DUNGEON_COUNT, 8);
    cvarSettings[RSK_LACS_TOKEN_COUNT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_LACS_TOKEN_COUNT, 100);
    cvarSettings[RSK_LACS_OPTIONS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_LACS_REWARD_OPTIONS, 0);
    cvarSettings[RSK_STARTING_CONSUMABLES] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_CONSUMABLES, 0);
    cvarSettings[RSK_FULL_WALLETS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_FULL_WALLETS, 0);
    ...
    cvarSettings[RSK_CUCCO_COUNT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_CUCCOS_TO_RETURN, 7);
    cvarSettings[RSK_BIG_POE_COUNT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_BIG_POE_TARGET_COUNT, 10);

    // If we skip child zelda, skip child stealth is pointless, so this needs to be reflected in the spoiler log
    cvarSettings[RSK_SKIP_CHILD_STEALTH] = !CVarGetInteger(CVAR_RANDOMIZER_SETTING_SKIP_CHILD_ZELDA, 0) && CVarGetInteger(CVAR_RANDOMIZER_SETTING_SKIP_CHILD_STEALTH, 0);

    cvarSettings[RSK_SKIP_EPONA_RACE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SKIP_EPONA_RACE, 0);
    cvarSettings[RSK_SKIP_TOWER_ESCAPE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SKIP_TOWER_ESCAPE, 0);
    cvarSettings[RSK_COMPLETE_MASK_QUEST] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_COMPLETE_MASK_QUEST, 0);
    cvarSettings[RSK_SKIP_SCARECROWS_SONG] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SKIP_SCARECROWS_SONG, 0);
    cvarSettings[RSK_ENABLE_GLITCH_CUTSCENES] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_ENABLE_GLITCH_CUTSCENES, 0);

    cvarSettings[RSK_SKULLS_SUNS_SONG] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_GS_EXPECT_SUNS_SONG, 0);
    // Link's Pocket has to have a dungeon reward if the other rewards are shuffled to end of dungeon.
    cvarSettings[RSK_LINKS_POCKET] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_DUNGEON_REWARD, RO_DUNGEON_REWARDS_END_OF_DUNGEON) != RO_DUNGEON_REWARDS_END_OF_DUNGEON ? 
                                        CVarGetInteger(CVAR_RANDOMIZER_SETTING_LINKS_POCKET, RO_LINKS_POCKET_DUNGEON_REWARD) : RO_LINKS_POCKET_DUNGEON_REWARD;

    if (OTRGlobals::Instance->HasMasterQuest() && OTRGlobals::Instance->HasOriginal()) {
        // If both OTRs are loaded.
        cvarSettings[RSK_RANDOM_MQ_DUNGEONS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS, RO_MQ_DUNGEONS_NONE);
        cvarSettings[RSK_MQ_DUNGEON_COUNT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MQ_DUNGEON_COUNT, 12);
    ...
    cvarSettings[RSK_TRIFORCE_HUNT] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_TRIFORCE_HUNT, 0);
    cvarSettings[RSK_TRIFORCE_HUNT_PIECES_TOTAL] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_TRIFORCE_HUNT_TOTAL_PIECES, 30);
    cvarSettings[RSK_TRIFORCE_HUNT_PIECES_REQUIRED] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_TRIFORCE_HUNT_REQUIRED_PIECES, 20);
    
    cvarSettings[RSK_MQ_DEKU_TREE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_DEKU_TREE, 0);
    cvarSettings[RSK_MQ_DODONGOS_CAVERN] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_DODONGOS_CAVERN, 0);
    cvarSettings[RSK_MQ_JABU_JABU] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_JABU_JABU, 0);
    cvarSettings[RSK_MQ_FOREST_TEMPLE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_FOREST_TEMPLE, 0);
    cvarSettings[RSK_MQ_FIRE_TEMPLE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_FIRE_TEMPLE, 0);
    cvarSettings[RSK_MQ_WATER_TEMPLE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_WATER_TEMPLE, 0);
    cvarSettings[RSK_MQ_SPIRIT_TEMPLE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_SPIRIT_TEMPLE, 0);
    cvarSettings[RSK_MQ_SHADOW_TEMPLE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_SHADOW_TEMPLE, 0);
    cvarSettings[RSK_MQ_BOTTOM_OF_THE_WELL] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_BOTTOM_OF_WELL, 0);
    cvarSettings[RSK_MQ_ICE_CAVERN] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_ICE_CAVERN, 0);
    cvarSettings[RSK_MQ_GTG] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_GTG, 0);
    cvarSettings[RSK_MQ_GANONS_CASTLE] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_GANONS_CASTLE, 0);

    // Enable if any of the entrance rando options are enabled.
    cvarSettings[RSK_SHUFFLE_ENTRANCES] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_DUNGEONS_ENTRANCES, RO_DUNGEON_ENTRANCE_SHUFFLE_OFF) ||
                                          CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_BOSS_ENTRANCES, RO_BOSS_ROOM_ENTRANCE_SHUFFLE_OFF) ||
                                          CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_OVERWORLD_ENTRANCES, RO_GENERIC_OFF) ||
                                          CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_INTERIORS_ENTRANCES, RO_INTERIOR_ENTRANCE_SHUFFLE_OFF) ||
                                          CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_GROTTOS_ENTRANCES, RO_GENERIC_OFF) ||
                                          CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_OWL_DROPS, RO_GENERIC_OFF) ||
                                          CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_WARP_SONGS, RO_GENERIC_OFF) ||
                                          CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_OVERWORLD_SPAWNS, RO_GENERIC_OFF);

    cvarSettings[RSK_SHUFFLE_DUNGEON_ENTRANCES] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_DUNGEONS_ENTRANCES, RO_DUNGEON_ENTRANCE_SHUFFLE_OFF);
    cvarSettings[RSK_SHUFFLE_BOSS_ENTRANCES] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_BOSS_ENTRANCES, RO_BOSS_ROOM_ENTRANCE_SHUFFLE_OFF);
    cvarSettings[RSK_SHUFFLE_OVERWORLD_ENTRANCES] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_OVERWORLD_ENTRANCES, RO_GENERIC_OFF);
    cvarSettings[RSK_SHUFFLE_INTERIOR_ENTRANCES] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_INTERIORS_ENTRANCES, RO_INTERIOR_ENTRANCE_SHUFFLE_OFF);
    cvarSettings[RSK_SHUFFLE_GROTTO_ENTRANCES] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_GROTTOS_ENTRANCES, RO_GENERIC_OFF);
    cvarSettings[RSK_SHUFFLE_OWL_DROPS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_OWL_DROPS, RO_GENERIC_OFF);
    cvarSettings[RSK_SHUFFLE_WARP_SONGS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_WARP_SONGS, RO_GENERIC_OFF);
    cvarSettings[RSK_SHUFFLE_OVERWORLD_SPAWNS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_OVERWORLD_SPAWNS, RO_GENERIC_OFF);
    cvarSettings[RSK_MIXED_ENTRANCE_POOLS] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MIXED_ENTRANCES, RO_GENERIC_OFF);
    cvarSettings[RSK_MIX_DUNGEON_ENTRANCES] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MIX_DUNGEONS, RO_GENERIC_OFF);
    cvarSettings[RSK_MIX_BOSS_ENTRANCES] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MIX_BOSSES, RO_GENERIC_OFF);
    cvarSettings[RSK_MIX_OVERWORLD_ENTRANCES] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MIX_OVERWORLD, RO_GENERIC_OFF);
    cvarSettings[RSK_MIX_INTERIOR_ENTRANCES] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MIX_INTERIORS, RO_GENERIC_OFF);
    cvarSettings[RSK_MIX_GROTTO_ENTRANCES] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_MIX_GROTTOS, RO_GENERIC_OFF);
    cvarSettings[RSK_DECOUPLED_ENTRANCES] = CVarGetInteger(CVAR_RANDOMIZER_SETTING_DECOUPLE_ENTRANCES, RO_GENERIC_OFF);

    // todo: this efficently when we build out cvar array support
    std::set<RandomizerCheck> excludedLocations;
    std::stringstream excludedLocationStringStream(CVarGetString(CVAR_RANDOMIZER_SETTING_EXCLUDED_LOCATIONS, ""));
    ...
    std::set<RandomizerTrick> enabledTricks;
    std::stringstream enabledTrickStringStream(CVarGetString(CVAR_RANDOMIZER_SETTING_ENABLED_TRICKS, ""));
...
void RandomizerSettingsWindow::DrawElement() {
    ...
    UIWidgets::Spacer(0);
    UIWidgets::EnhancementCheckbox("Manual seed entry", CVAR_RANDOMIZER_SETTING_MANUAL_SEED_ENTRY, false, "");
    if (CVarGetInteger(CVAR_RANDOMIZER_SETTING_MANUAL_SEED_ENTRY, 0)) {
        ImGui::Text("Seed");
    ...
    UIWidgets::Spacer(0);
    ImGui::BeginDisabled(CVarGetInteger(CVAR_RANDOMIZER_SETTING_DONT_GENERATE_SPOILER, 0) && gSaveContext.gameMode != GAMEMODE_FILE_SELECT);
    if (ImGui::Button("Generate Randomizer")) {
        GenerateRandomizer(CVarGetInteger(CVAR_RANDOMIZER_SETTING_MANUAL_SEED_ENTRY, 0) ? seedString : "");
    }
    ImGui::EndDisabled();
    ...
    if (ImGui::BeginTabBar("Randomizer Settings", ImGuiTabBarFlags_NoCloseWithMiddleMouseButton)) {
        if (ImGui::BeginTabItem("World")) {
            ...
            if (ImGui::BeginTable("tableRandoWorld", 3, ImGuiTableFlags_BordersH | ImGuiTableFlags_BordersV)) {
                ...
                ImGui::BeginDisabled(CVarGetInteger(CVAR_RANDOMIZER_SETTING_LOGIC_RULES, RO_LOGIC_GLITCHLESS) == RO_LOGIC_VANILLA);
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_FOREST, randoForest, RO_FOREST_CLOSED);
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_KAKARIKO_GATE, randoKakarikoGate, RO_KAK_GATE_CLOSED);
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_DOOR_OF_TIME, randoDoorOfTime, RO_DOOROFTIME_CLOSED);
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_ZORAS_FOUNTAIN, randoZorasFountain, RO_ZF_CLOSED);
                ...
                bool disableRandoStartingAge = CVarGetInteger(CVAR_RANDOMIZER_SETTING_FOREST, RO_FOREST_CLOSED) == RO_FOREST_CLOSED || 
                    ((CVarGetInteger(CVAR_RANDOMIZER_SETTING_DOOR_OF_TIME, RO_DOOROFTIME_CLOSED) == RO_DOOROFTIME_CLOSED) &&
                    (CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_OCARINAS, RO_GENERIC_OFF) == RO_GENERIC_OFF)); // closed door of time with ocarina shuffle off
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_STARTING_AGE, randoStartingAge, RO_AGE_CHILD, disableRandoStartingAge, disableRandoStartingAgeText, RO_AGE_CHILD);
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_GERUDO_FORTRESS, randoGerudoFortress, RO_GF_NORMAL);
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_RAINBOW_BRIDGE, randoRainbowBridge, RO_BRIDGE_VANILLA);
                ImGui::PopItemWidth();
                switch (CVarGetInteger(CVAR_RANDOMIZER_SETTING_RAINBOW_BRIDGE, RO_BRIDGE_VANILLA)) {
                    ...
                    case RO_BRIDGE_STONES:
                        ...
                        UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_BRIDGE_REWARD_OPTIONS, randoBridgeRewardOptions, RO_BRIDGE_STANDARD_REWARD);
                        switch (CVarGetInteger(CVAR_RANDOMIZER_SETTING_BRIDGE_REWARD_OPTIONS, RO_BRIDGE_STANDARD_REWARD)) {
                            case RO_BRIDGE_STANDARD_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Stone Count: %d", "##RandoStoneCount",
                                                                CVAR_RANDOMIZER_SETTING_STONE_COUNT, 1, 3, "", 3, true, true, false);
                                break;
                            case RO_BRIDGE_GREG_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Stone Count: %d", "##RandoStoneCount",
                                                                CVAR_RANDOMIZER_SETTING_STONE_COUNT, 1, 4, "", 4, true, true, false);
                                break;
                        ...
                        switch (CVarGetInteger(CVAR_RANDOMIZER_SETTING_BRIDGE_REWARD_OPTIONS, RO_BRIDGE_STANDARD_REWARD)) {
                            case RO_BRIDGE_STANDARD_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Medallion Count: %d", "##RandoMedallionCount",
                                                                CVAR_RANDOMIZER_SETTING_MEDALLION_COUNT, 1, 6, "", 6, true, true, false);
                                break;
                            case RO_BRIDGE_GREG_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Medallion Count: %d", "##RandoMedallionCount",
                                                                CVAR_RANDOMIZER_SETTING_MEDALLION_COUNT, 1, 7, "", 7, true, true, false);
                                break;
                            case RO_BRIDGE_WILDCARD_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Medallion Count: %d", "##RandoMedallionCount",
                                                                CVAR_RANDOMIZER_SETTING_MEDALLION_COUNT, 1, 6, "", 6, true, true, false);
                        ...
                        switch (CVarGetInteger(CVAR_RANDOMIZER_SETTING_BRIDGE_REWARD_OPTIONS, RO_BRIDGE_STANDARD_REWARD)) {
                            case RO_BRIDGE_STANDARD_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Reward Count: %d", "##RandoRewardCount",
                                                                CVAR_RANDOMIZER_SETTING_REWARD_COUNT, 1, 9, "", 9, true, true, false);
                                break;
                            case RO_BRIDGE_GREG_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Reward Count: %d", "##RandoRewardCount",
                                                                CVAR_RANDOMIZER_SETTING_REWARD_COUNT, 1, 10, "", 10, true, true, false);
                                break;
                            case RO_BRIDGE_WILDCARD_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Reward Count: %d", "##RandoRewardCount",
                                                                CVAR_RANDOMIZER_SETTING_REWARD_COUNT, 1, 9, "", 9, true, true, false);
                        ...
                        switch (CVarGetInteger(CVAR_RANDOMIZER_SETTING_BRIDGE_REWARD_OPTIONS, RO_BRIDGE_STANDARD_REWARD)) {
                            case RO_BRIDGE_STANDARD_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Dungeon Count: %d", "##RandoDungeonCount",
                                                                CVAR_RANDOMIZER_SETTING_DUNGEON_COUNT, 1, 8, "", 8, true, true, false);
                                break;
                            case RO_BRIDGE_GREG_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Dungeon Count: %d", "##RandoDungeonCount",
                                                                CVAR_RANDOMIZER_SETTING_DUNGEON_COUNT, 1, 9, "", 9, true, true, false);
                                break;
                            case RO_BRIDGE_WILDCARD_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Dungeon Count: %d", "##RandoDungeonCount",
                                                                CVAR_RANDOMIZER_SETTING_DUNGEON_COUNT, 1, 8, "", 8, true, true, false);
                    ...
                    case RO_BRIDGE_TOKENS:
                        UIWidgets::PaddedEnhancementSliderInt("Token Count: %d", "##RandoTokenCount",
                                                        CVAR_RANDOMIZER_SETTING_TOKEN_COUNT, 1, 100, "", 100, true, true, false);
                        break;
                    case RO_BRIDGE_GREG:
                        break;
                }
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_GANON_TRIAL, randoGanonsTrial, RO_GANONS_TRIALS_SET_NUMBER);
                ImGui::PopItemWidth();
                if (CVarGetInteger(CVAR_RANDOMIZER_SETTING_GANON_TRIAL, RO_GANONS_TRIALS_SET_NUMBER) == RO_GANONS_TRIALS_SET_NUMBER) {
                    UIWidgets::PaddedEnhancementSliderInt("Ganon's Trial Count: %d", "##RandoTrialCount",
                                                    CVAR_RANDOMIZER_SETTING_GANON_TRIAL_COUNT, 1, 6, "", 6, true, true, false);
                ...
                if (OTRGlobals::Instance->HasMasterQuest() && OTRGlobals::Instance->HasOriginal()) {
                    ...
                    UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS, randoMqDungeons, RO_MQ_DUNGEONS_NONE);
                    ImGui::PopItemWidth();
                    if (CVarGetInteger(CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS, RO_MQ_DUNGEONS_NONE) == RO_MQ_DUNGEONS_SET_NUMBER) {
                        UIWidgets::PaddedEnhancementSliderInt(
                            "Master Quest Dungeon Count: %d", "##RandoMqDungeonCount", CVAR_RANDOMIZER_SETTING_MQ_DUNGEON_COUNT, 1,
                            12, "", CVarGetInteger(CVAR_RANDOMIZER_SETTING_MQ_DUNGEON_COUNT, 12), true, true, false);
                    }
                    else if (CVarGetInteger(CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS, RO_MQ_DUNGEONS_NONE) == RO_MQ_DUNGEONS_SELECTION) {
                        UIWidgets::EnhancementCheckbox("Deku Tree##RandomizeMqDungeons",
                                                       CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_DEKU_TREE);
                        UIWidgets::EnhancementCheckbox("Dodongo's Cavern##RandomizeMqDungeons",
                                                       CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_DODONGOS_CAVERN);
                        UIWidgets::EnhancementCheckbox("Jabu Jabu's Belly##RandomizeMqDungeons",
                                                       CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_JABU_JABU);
                        UIWidgets::EnhancementCheckbox("Forest Temple##RandomizeMqDungeons",
                                                       CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_FOREST_TEMPLE);
                        UIWidgets::EnhancementCheckbox("Fire Temple##RandomizeMqDungeons",
                                                       CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_FIRE_TEMPLE);
                        UIWidgets::EnhancementCheckbox("Water Temple##RandomizeMqDungeons",
                                                       CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_WATER_TEMPLE);
                        UIWidgets::EnhancementCheckbox("Spirit Temple##RandomizeMqDungeons",
                                                       CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_SPIRIT_TEMPLE);
                        UIWidgets::EnhancementCheckbox("Shadow Temple##RandomizeMqDungeons",
                                                       CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_SHADOW_TEMPLE);
                        UIWidgets::EnhancementCheckbox("Bottom of the Well##RandomizeMqDungeons",
                                                       CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_BOTTOM_OF_WELL);
                        UIWidgets::EnhancementCheckbox("Ice Cavern##RandomizeMqDungeons",
                                                       CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_ICE_CAVERN);
                        UIWidgets::EnhancementCheckbox("Gerudo Training Grounds##RandomizeMqDungeons", CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_GTG);
                        UIWidgets::EnhancementCheckbox("Ganon's Castle##RandomizeMqDungeons",
                                                       CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS_GANONS_CASTLE);
                    }
                ...
                // Triforce Hunt
                UIWidgets::EnhancementCheckbox("Triforce Hunt", CVAR_RANDOMIZER_SETTING_TRIFORCE_HUNT);
                UIWidgets::InsertHelpHoverText(
                ...
                if (CVarGetInteger(CVAR_RANDOMIZER_SETTING_TRIFORCE_HUNT, 0)) {
                    // Triforce Hunt (total pieces)
                    UIWidgets::Spacer(0);
                    int totalPieces = CVarGetInteger(CVAR_RANDOMIZER_SETTING_TRIFORCE_HUNT_TOTAL_PIECES, 30);
                    ...
                    ImGui::SameLine();
                    UIWidgets::EnhancementSliderInt("", "##TriforceHuntTotalPieces", CVAR_RANDOMIZER_SETTING_TRIFORCE_HUNT_TOTAL_PIECES, 1, 100, "", 30);

                    // Triforce Hunt (required pieces)
                    int requiredPieces = CVarGetInteger(CVAR_RANDOMIZER_SETTING_TRIFORCE_HUNT_REQUIRED_PIECES, 20);
                    ImGui::Text("Triforce Pieces to win: %d", requiredPieces);
                    UIWidgets::InsertHelpHoverText(
                        "The amount of Triforce pieces required to win the game."
                    );
                    ImGui::SameLine();
                    UIWidgets::EnhancementSliderInt("", "##TriforceHuntRequiredPieces", CVAR_RANDOMIZER_SETTING_TRIFORCE_HUNT_REQUIRED_PIECES, 1, totalPieces, "", 20);
                }
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_SHUFFLE_DUNGEONS_ENTRANCES, randoShuffleDungeonsEntrances, RO_DUNGEON_ENTRANCE_SHUFFLE_OFF);
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_SHUFFLE_BOSS_ENTRANCES, randoShuffleBossEntrances, RO_BOSS_ROOM_ENTRANCE_SHUFFLE_OFF);

                UIWidgets::PaddedSeparator();

                // Shuffle Overworld Entrances
                UIWidgets::EnhancementCheckbox("Shuffle Overworld Entrances", CVAR_RANDOMIZER_SETTING_SHUFFLE_OVERWORLD_ENTRANCES);
                UIWidgets::InsertHelpHoverText(
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_SHUFFLE_INTERIORS_ENTRANCES, randoShuffleInteriorsEntrances, RO_INTERIOR_ENTRANCE_SHUFFLE_OFF);

                UIWidgets::PaddedSeparator();

                // Shuffle Grotto Entrances
                UIWidgets::EnhancementCheckbox("Shuffle Grotto Entrances", CVAR_RANDOMIZER_SETTING_SHUFFLE_GROTTOS_ENTRANCES);
                UIWidgets::InsertHelpHoverText(
                ...
                // Shuffle Owl Drops
                UIWidgets::EnhancementCheckbox("Shuffle Owl Drops", CVAR_RANDOMIZER_SETTING_SHUFFLE_OWL_DROPS);
                UIWidgets::InsertHelpHoverText(
                ...
                // Shuffle Warp Songs
                UIWidgets::EnhancementCheckbox("Shuffle Warp Songs", CVAR_RANDOMIZER_SETTING_SHUFFLE_WARP_SONGS);
                UIWidgets::InsertHelpHoverText(
                ...
                UIWidgets::EnhancementCheckbox("Shuffle Overworld Spawns", CVAR_RANDOMIZER_SETTING_SHUFFLE_OVERWORLD_SPAWNS);
                UIWidgets::InsertHelpHoverText(
                ...
                // Decouple Entrances
                UIWidgets::EnhancementCheckbox("Decouple Entrances", CVAR_RANDOMIZER_SETTING_DECOUPLE_ENTRANCES);
                UIWidgets::InsertHelpHoverText(
                ...
                UIWidgets::EnhancementCheckbox("Mixed Entrance Pools", CVAR_RANDOMIZER_SETTING_MIXED_ENTRANCES);
                UIWidgets::InsertHelpHoverText(
                ...
                if (CVarGetInteger(CVAR_RANDOMIZER_SETTING_MIXED_ENTRANCES, RO_GENERIC_OFF)) {
                    if (CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_DUNGEONS_ENTRANCES, RO_GENERIC_OFF)) {
                        UIWidgets::Spacer(0);
                        ImGui::SetCursorPosX(20);
                        UIWidgets::EnhancementCheckbox("Mix Dungeons", CVAR_RANDOMIZER_SETTING_MIX_DUNGEONS);
                        UIWidgets::InsertHelpHoverText("Dungeon entrances will be part of the mixed pool");
                    }
                    if (CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_BOSS_ENTRANCES, RO_BOSS_ROOM_ENTRANCE_SHUFFLE_OFF) ==
                        RO_BOSS_ROOM_ENTRANCE_SHUFFLE_FULL) {
                        UIWidgets::Spacer(0);
                        ImGui::SetCursorPosX(20);
                        UIWidgets::EnhancementCheckbox("Mix Bosses", CVAR_RANDOMIZER_SETTING_MIX_BOSSES);
                        UIWidgets::InsertHelpHoverText("Boss entrances will be part of the mixed pool");
                    }
                    if (CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_OVERWORLD_ENTRANCES, RO_GENERIC_OFF)) {
                        UIWidgets::Spacer(0);
                        ImGui::SetCursorPosX(20);
                        UIWidgets::EnhancementCheckbox("Mix Overworld", CVAR_RANDOMIZER_SETTING_MIX_OVERWORLD);
                        UIWidgets::InsertHelpHoverText("Overworld entrances will be part of the mixed pool");
                    }
                    if (CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_INTERIORS_ENTRANCES, RO_GENERIC_OFF)) {
                        UIWidgets::Spacer(0);
                        ImGui::SetCursorPosX(20);
                        UIWidgets::EnhancementCheckbox("Mix Interiors", CVAR_RANDOMIZER_SETTING_MIX_INTERIORS);
                        UIWidgets::InsertHelpHoverText("Interior entrances will be part of the mixed pool");
                    }
                    if (CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_GROTTOS_ENTRANCES, RO_GENERIC_OFF)) {
                        UIWidgets::Spacer(0);
                        ImGui::SetCursorPosX(20);
                        UIWidgets::EnhancementCheckbox("Mix Grottos", CVAR_RANDOMIZER_SETTING_MIX_GROTTOS);
        ...
        if (ImGui::BeginTabItem("Items")) {
            ...
            if (ImGui::BeginTable("tableRandoStartingInventory", 3, ImGuiTableFlags_BordersH | ImGuiTableFlags_BordersV)) {
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_SHUFFLE_SONGS, randoShuffleSongs, RO_SONG_SHUFFLE_SONG_LOCATIONS);
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_SHUFFLE_TOKENS, randoTokensanity, RO_TOKENSANITY_OFF);

                UIWidgets::PaddedEnhancementCheckbox("Nighttime GS expect Sun's Song", CVAR_RANDOMIZER_SETTING_GS_EXPECT_SUNS_SONG, true, false);
                UIWidgets::InsertHelpHoverText(
                ...
                bool disableShuffleKokiriSword = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_KOKIRI_SWORD, 0);
                static const char* disableShuffleKokiriSwordText = "This option is disabled because \"Start with Kokiri Sword\" is enabled.";
                UIWidgets::EnhancementCheckbox(Settings::ShuffleKokiriSword.GetName().c_str(), CVAR_RANDOMIZER_SETTING_SHUFFLE_KOKIRI_SWORD,
                ...
                // bool disableShuffleMasterSword = CvarGetInteger(CVAR_RANDOMIZER_SETTING("StartingMasterSword"), 0);
                // static const char* disableShuffleMasterSwordText = "This option is disabled because \"Start with Master Sword\" is enabled.";
                UIWidgets::EnhancementCheckbox(Settings::ShuffleMasterSword.GetName().c_str(), CVAR_RANDOMIZER_SETTING_SHUFFLE_MASTER_SWORD);
                UIWidgets::InsertHelpHoverText(
                ...
                bool disableShuffleOcarinas = CVarGetInteger(CVAR_RANDOMIZER_SETTING_STARTING_OCARINA, 0);
                static const char* disableShuffleOcarinasText = "This option is disabled because \"Start with Fairy Ocarina\" is enabled.";
                UIWidgets::EnhancementCheckbox(Settings::ShuffleOcarinas.GetName().c_str(), CVAR_RANDOMIZER_SETTING_SHUFFLE_OCARINAS,
                ...
                bool disableShuffleWeirdEgg = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SKIP_CHILD_ZELDA, 0);
                static const char* disableShuffleWeirdEggText = "This option is disabled because \"Skip Child Zelda\" is enabled.";
                UIWidgets::EnhancementCheckbox(Settings::ShuffleWeirdEgg.GetName().c_str(), CVAR_RANDOMIZER_SETTING_SHUFFLE_WEIRD_EGG,
                ...
                UIWidgets::EnhancementCheckbox(Settings::ShuffleGerudoToken.GetName().c_str(), CVAR_RANDOMIZER_SETTING_SHUFFLE_GERUDO_TOKEN);
                UIWidgets::InsertHelpHoverText(
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_SHOPSANITY, randoShopsanity, RO_SHOPSANITY_OFF);

                // Shopsanity Prices
                switch (CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHOPSANITY, RO_SHOPSANITY_OFF)) {
                    ...
                    default:
                        ...
                        UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_SHOPSANITY_PRICES, randoShopsanityPrices, RO_SHOPSANITY_PRICE_BALANCED);
                        UIWidgets::EnhancementCheckbox(Settings::ShopsanityPricesAffordable.GetName().c_str(), CVAR_RANDOMIZER_SETTING_SHOPSANITY_PRICES_AFFORDABLE,
                            CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHOPSANITY_PRICES, RO_SHOPSANITY_PRICE_BALANCED) == RO_SHOPSANITY_PRICE_BALANCED,
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_SHUFFLE_SCRUBS, randoShuffleScrubs, RO_SCRUBS_OFF);

                UIWidgets::PaddedSeparator();

                // Shuffle Cows
                UIWidgets::EnhancementCheckbox(Settings::ShuffleCows.GetName().c_str(), CVAR_RANDOMIZER_SETTING_SHUFFLE_COWS);
                UIWidgets::InsertHelpHoverText("Cows give a randomized item from the pool upon performing Epona's Song in front of them.");

                UIWidgets::PaddedSeparator();

                UIWidgets::EnhancementCheckbox(Settings::ShuffleMagicBeans.GetName().c_str(), CVAR_RANDOMIZER_SETTING_SHUFFLE_BEANS);
                UIWidgets::InsertHelpHoverText(
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_SHUFFLE_MERCHANTS, randoShuffleMerchants, RO_SHUFFLE_MERCHANTS_OFF);

                UIWidgets::PaddedSeparator();

                // Shuffle Frog Song Rupees
                UIWidgets::EnhancementCheckbox(Settings::ShuffleFrogSongRupees.GetName().c_str(), CVAR_RANDOMIZER_SETTING_SHUFFLE_FROG_SONG_RUPEES);
                UIWidgets::InsertHelpHoverText(
                ...
                UIWidgets::EnhancementCheckbox(Settings::ShuffleAdultTradeQuest.GetName().c_str(), CVAR_RANDOMIZER_SETTING_SHUFFLE_ADULT_TRADE);
                UIWidgets::InsertHelpHoverText(
                ...
                bool forceEnable100GSShuffle =
                    (CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_GANON_BOSS_KEY, RO_GANON_BOSS_KEY_VANILLA) == RO_GANON_BOSS_KEY_KAK_TOKENS);
                ...
                UIWidgets::EnhancementCheckbox(Settings::Shuffle100GSReward.GetName().c_str(), CVAR_RANDOMIZER_SETTING_SHUFFLE_100GS_REWARD,
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_SHUFFLE_DUNGEON_REWARD, randoShuffleDungeonRewards, RO_DUNGEON_REWARDS_END_OF_DUNGEON);
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_STARTING_MAPS_COMPASSES, randoShuffleMapsAndCompasses, RO_DUNGEON_ITEM_LOC_OWN_DUNGEON);
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_KEYSANITY, randoShuffleSmallKeys, RO_DUNGEON_ITEM_LOC_OWN_DUNGEON);
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS, randoShuffleKeyRings, RO_KEYRINGS_OFF);
                ImGui::PopItemWidth();
                switch (CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS, RO_KEYRINGS_OFF)) {
                    case RO_KEYRINGS_COUNT:
                        maxKeyringCount = (CVarGetInteger(CVAR_RANDOMIZER_SETTING_GERUDO_FORTRESS, RO_GF_NORMAL) == RO_GF_NORMAL &&
                                            CVarGetInteger(CVAR_RANDOMIZER_SETTING_GERUDO_KEYS, RO_GERUDO_KEYS_VANILLA) != RO_GERUDO_KEYS_VANILLA) ? 9 : 8;
                        UIWidgets::PaddedEnhancementSliderInt("Key Ring Count: %d",
                                                              "##RandomizeShuffleKeyRingsRandomCount",
                                                              CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_RANDOM_COUNT, 1,
                                                              maxKeyringCount, "", maxKeyringCount, true, true, false);
                        break;
                    case RO_KEYRINGS_SELECTION:
                        disableGFKeyring =
                            CVarGetInteger(CVAR_RANDOMIZER_SETTING_GERUDO_FORTRESS, RO_GF_NORMAL) != RO_GF_NORMAL || CVarGetInteger(CVAR_RANDOMIZER_SETTING_GERUDO_KEYS, RO_GERUDO_KEYS_VANILLA) == RO_GERUDO_KEYS_VANILLA;
                        UIWidgets::EnhancementCheckbox("Gerudo Fortress##RandomizeShuffleKeyRings", CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_GERUDO_FORTRESS,
                        ...
                        UIWidgets::EnhancementCheckbox("Forest Temple##RandomizeShuffleKeyRings", CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_FOREST_TEMPLE);
                        UIWidgets::EnhancementCheckbox("Fire Temple##RandomizeShuffleKeyRings", CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_FIRE_TEMPLE);
                        UIWidgets::EnhancementCheckbox("Water Temple##RandomizeShuffleKeyRings", CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_WATER_TEMPLE);
                        UIWidgets::EnhancementCheckbox("Spirit Temple##RandomizeShuffleKeyRings", CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_SPIRIT_TEMPLE);
                        UIWidgets::EnhancementCheckbox("Shadow Temple##RandomizeShuffleKeyRings", CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_SHADOW_TEMPLE);
                        UIWidgets::EnhancementCheckbox("Bottom of the Well##RandomizeShuffleKeyRings", CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_BOTTOM_OF_WELL);
                        UIWidgets::EnhancementCheckbox("Gerudo Training Grounds##RandomizeShuffleKeyRings", CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_GTG);
                        UIWidgets::EnhancementCheckbox("Ganon's Castle##RandomizeShuffleKeyRings", CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_GANONS_CASTLE);
                        break;
                    default:
                        break;
                }
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_GERUDO_KEYS, randoShuffleGerudoFortressKeys, RO_GERUDO_KEYS_VANILLA);
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_BOSS_KEYSANITY, randoShuffleBossKeys, RO_DUNGEON_ITEM_LOC_OWN_DUNGEON);
                ...
                bool disableGBK = CVarGetInteger(CVAR_RANDOMIZER_SETTING_TRIFORCE_HUNT, 0);
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_SHUFFLE_GANON_BOSS_KEY, randoShuffleGanonsBossKey,
                                               RO_GANON_BOSS_KEY_VANILLA, disableGBK, disableGBKText,
                                               RO_GANON_BOSS_KEY_VANILLA);
                ImGui::PopItemWidth();
                switch (CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_GANON_BOSS_KEY, RO_GANON_BOSS_KEY_VANILLA)) {
                    case RO_GANON_BOSS_KEY_LACS_STONES:
                        ...
                        UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_LACS_REWARD_OPTIONS, randoLACSRewardOptions, RO_LACS_STANDARD_REWARD);
                        switch (CVarGetInteger(CVAR_RANDOMIZER_SETTING_LACS_REWARD_OPTIONS, RO_LACS_STANDARD_REWARD)) {
                            case RO_LACS_STANDARD_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Stone Count: %d", "##RandoLacsStoneCount", 
                                                            CVAR_RANDOMIZER_SETTING_LACS_STONE_COUNT, 1, 3, "", 3, true, true, false);
                                break;
                            case RO_LACS_GREG_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Stone Count: %d", "##RandoLacsStoneCount", 
                                                            CVAR_RANDOMIZER_SETTING_LACS_STONE_COUNT, 1, 4, "", 3, true, true, false);
                                break;
                        ...
                        switch (CVarGetInteger(CVAR_RANDOMIZER_SETTING_LACS_REWARD_OPTIONS, RO_LACS_STANDARD_REWARD)) {
                            case RO_LACS_STANDARD_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Medallion Count: %d", "##RandoLacsMedallionCount", 
                                                            CVAR_RANDOMIZER_SETTING_LACS_MEDALLION_COUNT, 1, 6, "", 6, true, true, false);
                                break;
                            case RO_LACS_GREG_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Medallion Count: %d", "##RandoLacsMedallionCount", 
                                                            CVAR_RANDOMIZER_SETTING_LACS_MEDALLION_COUNT, 1, 7, "", 6, true, true, false);
                                break;
                            case RO_LACS_WILDCARD_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Medallion Count: %d", "##RandoLacsMedallionCount", 
                                                            CVAR_RANDOMIZER_SETTING_LACS_MEDALLION_COUNT, 1, 6, "", 6, true, true, false);
                        ...
                        switch (CVarGetInteger(CVAR_RANDOMIZER_SETTING_LACS_REWARD_OPTIONS, RO_LACS_STANDARD_REWARD)) {
                            case RO_LACS_STANDARD_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Reward Count: %d", "##RandoLacsRewardCount", 
                                                            CVAR_RANDOMIZER_SETTING_LACS_REWARD_COUNT, 1, 9, "", 9, true, true, false);
                                break;
                            case RO_LACS_GREG_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Reward Count: %d", "##RandoLacsRewardCount", 
                                                            CVAR_RANDOMIZER_SETTING_LACS_REWARD_COUNT, 1, 10, "", 9, true, true, false);
                                break;
                            case RO_LACS_WILDCARD_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Reward Count: %d", "##RandoLacsRewardCount", 
                                                            CVAR_RANDOMIZER_SETTING_LACS_REWARD_COUNT, 1, 9, "", 9, true, true, false);
                        ...
                        switch (CVarGetInteger(CVAR_RANDOMIZER_SETTING_LACS_REWARD_OPTIONS, RO_LACS_STANDARD_REWARD)) {
                            case RO_LACS_STANDARD_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Dungeon Count: %d", "##RandoLacsDungeonCount", 
                                                            CVAR_RANDOMIZER_SETTING_LACS_DUNGEON_COUNT, 1, 8, "", 8, true, true, false);
                                break;
                            case RO_LACS_GREG_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Dungeon Count: %d", "##RandoLacsDungeonCount", 
                                                            CVAR_RANDOMIZER_SETTING_LACS_DUNGEON_COUNT, 1, 9, "", 8, true, true, false);
                                break;
                            case RO_LACS_WILDCARD_REWARD:
                                UIWidgets::PaddedEnhancementSliderInt("Dungeon Count: %d", "##RandoLacsDungeonCount", 
                                                            CVAR_RANDOMIZER_SETTING_LACS_DUNGEON_COUNT, 1, 8, "", 8, true, true, false);
                    ...
                    case RO_GANON_BOSS_KEY_LACS_TOKENS:
                        UIWidgets::PaddedEnhancementSliderInt("Token Count: %d", "##RandoLacsTokenCount",
                                                        CVAR_RANDOMIZER_SETTING_LACS_TOKEN_COUNT, 1, 100, "", 100, true, true, false);
                        break;
                    default:
                        break;
                }
        ...
        if (ImGui::BeginTabItem("Gameplay")) {
            ...
            if (ImGui::BeginTable("tableRandoGameplay", 3, ImGuiTableFlags_BordersH | ImGuiTableFlags_BordersV)) {
                ...
                // Cuccos to return
                int cuccos = CVarGetInteger(CVAR_RANDOMIZER_SETTING_CUCCOS_TO_RETURN, 7);
                ...
                ImGui::SameLine();
                UIWidgets::EnhancementSliderInt("", "##RandoCuccosToReturn", CVAR_RANDOMIZER_SETTING_CUCCOS_TO_RETURN, 0, 7, "", 7);
                UIWidgets::PaddedSeparator();

                // Big Poe Target Count
                int poes = CVarGetInteger(CVAR_RANDOMIZER_SETTING_BIG_POE_TARGET_COUNT, 10);
                ...
                ImGui::SameLine();
                UIWidgets::EnhancementSliderInt("", "##RandoBigPoeTargetCount", CVAR_RANDOMIZER_SETTING_BIG_POE_TARGET_COUNT, 1, 10, "", 10);
                UIWidgets::PaddedSeparator();

                // Skip child stealth
                // Disabled when Skip Child Zelda is active
                bool disableChildStealth = CVarGetInteger(CVAR_RANDOMIZER_SETTING_SKIP_CHILD_ZELDA, 0);
                static const char* disableChildStealthText = "This option is disabled because \"Skip Child Zelda\" is enabled";
                UIWidgets::EnhancementCheckbox(Settings::SkipChildStealth.GetName().c_str(), CVAR_RANDOMIZER_SETTING_SKIP_CHILD_STEALTH, disableChildStealth, disableChildStealthText);
                UIWidgets::InsertHelpHoverText("The crawlspace into Hyrule Castle goes straight to Zelda, skipping the guards.");

                UIWidgets::PaddedSeparator();

                // Skip child zelda
                UIWidgets::EnhancementCheckbox("Skip Child Zelda", CVAR_RANDOMIZER_SETTING_SKIP_CHILD_ZELDA);
                ...
                // Skip Epona race
                UIWidgets::EnhancementCheckbox(Settings::SkipEponaRace.GetName().c_str(), CVAR_RANDOMIZER_SETTING_SKIP_EPONA_RACE);
                UIWidgets::InsertHelpHoverText("Epona can be summoned with Epona's Song without needing to race Ingo.");

                UIWidgets::PaddedSeparator();

                // Skip tower escape
                UIWidgets::EnhancementCheckbox(Settings::SkipTowerEscape.GetName().c_str(), CVAR_RANDOMIZER_SETTING_SKIP_TOWER_ESCAPE);
                UIWidgets::InsertHelpHoverText("The tower escape sequence between Ganondorf and Ganon will be skipped.");

                UIWidgets::PaddedSeparator();

                // Complete mask quest
                UIWidgets::EnhancementCheckbox(Settings::CompleteMaskQuest.GetName().c_str(), CVAR_RANDOMIZER_SETTING_COMPLETE_MASK_QUEST);
                UIWidgets::InsertHelpHoverText("Once the happy mask shop is opened, all masks will be available to be borrowed.");

                UIWidgets::PaddedSeparator();

                // Skip Scarecrow Song
                UIWidgets::EnhancementCheckbox(Settings::FreeScarecrow.GetName().c_str(), CVAR_RANDOMIZER_SETTING_SKIP_SCARECROWS_SONG);
                UIWidgets::InsertHelpHoverText(
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_ITEM_POOL, randoItemPool, RO_ITEM_POOL_BALANCED);
                UIWidgets::PaddedSeparator();
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_ICE_TRAPS, randoIceTraps, RO_ICE_TRAPS_NORMAL);
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_GOSSIP_STONE_HINTS, randoGossipStoneHints, RO_GOSSIP_STONES_NEED_NOTHING);
                if (CVarGetInteger(CVAR_RANDOMIZER_SETTING_GOSSIP_STONE_HINTS, RO_GOSSIP_STONES_NEED_NOTHING) != RO_GOSSIP_STONES_NONE) {
                    // Hint Clarity
                    UIWidgets::Spacer(0);
                    ImGui::Indent();
                    ...
                    UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_HINT_CLARITY, randoHintClarity, RO_HINT_CLARITY_CLEAR);
                    ...
                    UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_HINT_DISTRIBUTION, randoHintDistribution, RO_HINT_DIST_BALANCED);
                    ImGui::Unindent();
                }
                ...
                UIWidgets::PaddedEnhancementCheckbox("Altar Text", CVAR_RANDOMIZER_SETTING_ALTAR_HINT, true, false, false, "", UIWidgets::CheckboxGraphics::Cross, true);
                ...
                UIWidgets::PaddedEnhancementCheckbox("Light Arrows", CVAR_RANDOMIZER_SETTING_LA_HINT, true, false, false, "", UIWidgets::CheckboxGraphics::Cross, true);
                ...
                UIWidgets::PaddedEnhancementCheckbox("Dampe's Diary (Hookshot)", CVAR_RANDOMIZER_SETTING_DAMPE_HINT, true, false);
                ...
                UIWidgets::PaddedEnhancementCheckbox("Greg the Green Rupee", CVAR_RANDOMIZER_SETTING_GREG_HINT, true, false);
                ...
                UIWidgets::PaddedEnhancementCheckbox("Saria (Magic)", CVAR_RANDOMIZER_SETTING_SARIA_HINT, true, false);
                ...
                UIWidgets::PaddedEnhancementCheckbox("Frog Ocarina Game", CVAR_RANDOMIZER_SETTING_FROGS_HINT, true, false);
                ...
                UIWidgets::PaddedEnhancementCheckbox("Warp Song text", CVAR_RANDOMIZER_SETTING_WARP_SONG_TEXT, true, false, !CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_WARP_SONGS, RO_GENERIC_OFF),
                ...
                UIWidgets::PaddedEnhancementCheckbox("Scrub Item text", CVAR_RANDOMIZER_SETTING_SCRUB_TEXT, true, false, false, "", UIWidgets::CheckboxGraphics::Cross, false);
                UIWidgets::InsertHelpHoverText("Business scrubs will reveal the identity of what they're selling.");
                UIWidgets::PaddedEnhancementCheckbox("House of Skulltula: 10", CVAR_RANDOMIZER_SETTING_10GS_HINT, true, false);
                UIWidgets::PaddedEnhancementCheckbox("House of Skulltula: 20", CVAR_RANDOMIZER_SETTING_20GS_HINT, true, false);
                UIWidgets::PaddedEnhancementCheckbox("House of Skulltula: 30", CVAR_RANDOMIZER_SETTING_30GS_HINT, true, false);
                UIWidgets::PaddedEnhancementCheckbox("House of Skulltula: 40", CVAR_RANDOMIZER_SETTING_40GS_HINT, true, false);
                UIWidgets::PaddedEnhancementCheckbox("House of Skulltula: 50", CVAR_RANDOMIZER_SETTING_50GS_HINT, true, false);
                ImGui::Unindent();
                ...
                UIWidgets::EnhancementCheckbox("Full Wallets", CVAR_RANDOMIZER_SETTING_FULL_WALLETS);
                UIWidgets::InsertHelpHoverText("Start with a full wallet. All wallet upgrades come filled with rupees.");

                UIWidgets::PaddedSeparator();

                // Bombchus in Logic
                UIWidgets::EnhancementCheckbox(Settings::BombchusInLogic.GetName().c_str(), CVAR_RANDOMIZER_SETTING_BOMBCHUS_IN_LOGIC);
                UIWidgets::InsertHelpHoverText(
                ...
                UIWidgets::EnhancementCheckbox("Enable Bombchu Drops", CVAR_RANDOMIZER_SETTING_ENABLE_BOMBCHU_DROPS);
                UIWidgets::InsertHelpHoverText(
                ...
                UIWidgets::EnhancementCheckbox("Blue Fire Arrows", CVAR_RANDOMIZER_SETTING_BLUE_FIRE_ARROWS);
                UIWidgets::InsertHelpHoverText(
                ...
                UIWidgets::EnhancementCheckbox("Sunlight Arrows", CVAR_RANDOMIZER_SETTING_SUNLIGHT_ARROWS);
                UIWidgets::InsertHelpHoverText(
                            ...
                            for (auto& [randomizerCheck, rcObject] : rcObjects) {
                                if (rcObject->visibleInImgui && !excludedLocations.count(rcObject->rc) &&
                                    ...
                                    if (ImGui::ArrowButton(std::to_string(rcObject->rc).c_str(), ImGuiDir_Right)) {
                                        ...
                                        CVarSetString(CVAR_RANDOMIZER_SETTING_EXCLUDED_LOCATIONS, excludedLocationString.c_str());
                                ...
                                if (rcObject->visibleInImgui && elfound != excludedLocations.end()) {
                                    if (ImGui::ArrowButton(std::to_string(rcObject->rc).c_str(), ImGuiDir_Left)) {
                                        ...
                                        if (excludedLocationString == "") {
                                            CVarClear(CVAR_RANDOMIZER_SETTING_EXCLUDED_LOCATIONS);
                                        } else {
                                            CVarSetString(CVAR_RANDOMIZER_SETTING_EXCLUDED_LOCATIONS, excludedLocationString.c_str());
                                        }
                                        Ship::Context::GetInstance()->GetWindow()->GetGui()->SaveConsoleVariablesOnNextTick();
        ...
        if (ImGui::BeginTabItem("Tricks/Glitches")) {
            if (!tricksTabOpen) {
                ...
                std::stringstream enabledGlitchStringStream(CVarGetString(CVAR_RANDOMIZER_SETTING_ENABLED_GLITCHES, ""));
            ...
            if (ImGui::BeginTable("tableRandoLogic", 1, ImGuiTableFlags_BordersH | ImGuiTableFlags_BordersV)) {
                ...
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_LOGIC_RULES, randoLogicRules, RO_LOGIC_GLITCHLESS);
                if (CVarGetInteger(CVAR_RANDOMIZER_SETTING_LOGIC_RULES, RO_LOGIC_GLITCHLESS) == RO_LOGIC_GLITCHLESS) {
                    ImGui::SameLine();
                    UIWidgets::EnhancementCheckbox(Settings::LocationsReachable.GetName().c_str(), CVAR_RANDOMIZER_SETTING_ALL_LOCATIONS_REACHABLE, false, "", UIWidgets::CheckboxGraphics::Cross, RO_GENERIC_ON);
                    UIWidgets::InsertHelpHoverText(
                ...
                if (CVarGetInteger(CVAR_RANDOMIZER_SETTING_LOGIC_RULES, RO_LOGIC_GLITCHLESS) == RO_LOGIC_VANILLA) {
                    ImGui::SameLine();
                ...
                UIWidgets::EnhancementCheckbox(Settings::EnableGlitchCutscenes.GetName().c_str(), CVAR_RANDOMIZER_SETTING_ENABLE_GLITCH_CUTSCENES);
                UIWidgets::InsertHelpHoverText(
            ...
            if (CVarGetInteger(CVAR_RANDOMIZER_SETTING_LOGIC_RULES, RO_LOGIC_GLITCHLESS) != RO_LOGIC_NO_LOGIC) {
                ImGui::SameLine();
                if (ImGui::Button("Disable All")) {
                    ...
                    CVarClear(CVAR_RANDOMIZER_SETTING_ENABLED_TRICKS);
                    Ship::Context::GetInstance()->GetWindow()->GetGui()->SaveConsoleVariablesOnNextTick();
                }
                ImGui::SameLine();
                if (ImGui::Button("Enable All")) {
                    ...
                    CVarSetString(CVAR_RANDOMIZER_SETTING_ENABLED_TRICKS, enabledTrickString.c_str());
                    Ship::Context::GetInstance()->GetWindow()->GetGui()->SaveConsoleVariablesOnNextTick();
                }
            }
        ...
        if (ImGui::BeginTabItem("Starting Inventory")) {
            ...
            if (ImGui::BeginTable("tableRandoStartingInventory", 3, ImGuiTableFlags_BordersH | ImGuiTableFlags_BordersV)) {
                ...
                ImGui::BeginDisabled(
                    CVarGetInteger(CVAR_RANDOMIZER_SETTING_SHUFFLE_DUNGEON_REWARD, RO_DUNGEON_REWARDS_END_OF_DUNGEON) == RO_DUNGEON_REWARDS_END_OF_DUNGEON ||
                    CVarGetInteger(CVAR_RANDOMIZER_SETTING_LOGIC_RULES, RO_LOGIC_GLITCHLESS) == RO_LOGIC_VANILLA
                );
                ImGui::Text("%s", Settings::LinksPocketItem.GetName().c_str());
                UIWidgets::EnhancementCombobox(CVAR_RANDOMIZER_SETTING_LINKS_POCKET, randoLinksPocket, RO_LINKS_POCKET_DUNGEON_REWARD);
                UIWidgets::PaddedSeparator();
                ImGui::EndDisabled();

                UIWidgets::EnhancementCheckbox(Settings::StartingKokiriSword.GetName().c_str(), CVAR_RANDOMIZER_SETTING_STARTING_KOKIRI_SWORD);
                UIWidgets::PaddedSeparator();
                UIWidgets::EnhancementCheckbox(Settings::StartingDekuShield.GetName().c_str(), CVAR_RANDOMIZER_SETTING_STARTING_DEKU_SHIELD);
                ...
                ImGui::BeginDisabled(CVarGetInteger(CVAR_RANDOMIZER_SETTING_LOGIC_RULES, RO_LOGIC_GLITCHLESS) == RO_LOGIC_VANILLA);
                UIWidgets::EnhancementCheckbox(Settings::StartingOcarina.GetName().c_str(), CVAR_RANDOMIZER_SETTING_STARTING_OCARINA);
                UIWidgets::PaddedSeparator();
                ImGui::EndDisabled();
                UIWidgets::EnhancementCheckbox(Settings::StartingConsumables.GetName().c_str(), CVAR_RANDOMIZER_SETTING_STARTING_CONSUMABLES);
                UIWidgets::PaddedSeparator();
                UIWidgets::EnhancementSliderInt("Gold Skulltula Tokens: %d", "##RandoStartingSkulltulaToken", CVAR_RANDOMIZER_SETTING_STARTING_SKULLTULA_TOKEN, 0, 100, "", 0);
                UIWidgets::PaddedSeparator();
                ...
                UIWidgets::EnhancementCheckbox(Settings::StartingZeldasLullaby.GetName().c_str(), CVAR_RANDOMIZER_SETTING_STARTING_ZELDAS_LULLABY);
                UIWidgets::EnhancementCheckbox(Settings::StartingEponasSong.GetName().c_str(), CVAR_RANDOMIZER_SETTING_STARTING_EPONAS_SONG);
                UIWidgets::EnhancementCheckbox(Settings::StartingSariasSong.GetName().c_str(), CVAR_RANDOMIZER_SETTING_STARTING_SARIAS_SONG);
                UIWidgets::EnhancementCheckbox(Settings::StartingSunsSong.GetName().c_str(), CVAR_RANDOMIZER_SETTING_STARTING_SUNS_SONG);
                UIWidgets::EnhancementCheckbox(Settings::StartingSongOfTime.GetName().c_str(), CVAR_RANDOMIZER_SETTING_STARTING_SONG_OF_TIME);
                UIWidgets::EnhancementCheckbox(Settings::StartingSongOfStorms.GetName().c_str(), CVAR_RANDOMIZER_SETTING_STARTING_SONG_OF_STORMS);
                UIWidgets::PaddedSeparator();

                ImGui::Text("Warp Songs");
                UIWidgets::PaddedSeparator();
                UIWidgets::EnhancementCheckbox(Settings::StartingMinuetOfForest.GetName().c_str(), CVAR_RANDOMIZER_SETTING_STARTING_MINUET_OF_FOREST);
                UIWidgets::EnhancementCheckbox(Settings::StartingBoleroOfFire.GetName().c_str(), CVAR_RANDOMIZER_SETTING_STARTING_BOLERO_OF_FIRE);
                UIWidgets::EnhancementCheckbox(Settings::StartingSerenadeOfWater.GetName().c_str(), CVAR_RANDOMIZER_SETTING_STARTING_SERENADE_OF_WATER);
                UIWidgets::EnhancementCheckbox(Settings::StartingRequiemOfSpirit.GetName().c_str(), CVAR_RANDOMIZER_SETTING_STARTING_REQUIEM_OF_SPIRIT);
                UIWidgets::EnhancementCheckbox(Settings::StartingNocturneOfShadow.GetName().c_str(), CVAR_RANDOMIZER_SETTING_STARTING_NOCTURNE_OF_SHADOW);
                UIWidgets::EnhancementCheckbox(Settings::StartingPreludeOfLight.GetName().c_str(), CVAR_RANDOMIZER_SETTING_STARTING_PRELUDE_OF_LIGHT);
                UIWidgets::PaddedSeparator();
