...
static const char* englishRupeeNames[165] = { 
    "?????",                "Bad RNG Rolls",        "Bananas",              "Beanbean Coins",       "Beans",
    "Bells",                "Belly",                "Berries",              "Bison Dollars",        "Bitcoin",
    "Blue Essence",         "Bolts",                "Bones",                "Boondollars",          "Bottle Caps",
    "Bratwürste",           "Bucks",                "BugFrags",             "Bullets",              "Bǎn",
    ...
    "Extinction Points",    "Flanian Pobble Beans", "Floopies",             "Flurbos",              "Friends",
    "Frog Coins",           "Gald",                 "Gekz",                 "Gems",                 "Gil",
    "Glimmer",              "Gold",                 "Gold Dragons",         "Goober Dollars",       "Green Herbs",
    "Gummybears",           "Hell",                 "Hylian Loaches",       "ISK",                  "Ice Traps",
    "Jiggies",              "KF7 Ammo",             "Kinstones",            "Kroner",               "Leaves",
    ...
    "Mora",                 "Mumbo Tokens",         "Munny",                "Mushrooms",            "Neopoints",
    "Noted Runite Ore",     "Notes",                "Nuyen",                "Orbs",                 "Pix",
    "Pixels",               "Platinum",             "Pokos",                "Pokédollars",          "Pokémon",
    "Potch",                "Pounds",               "Power Pellets",        "Primogems",            "Refined Metal",
    "Remote Mines",         "Retweets",             "Rhinu",                "Rings",                "Riot Points",
    "Robux",                "Rubies",               "Rubles",               "Rupees",               "Ryō",
    "Réals",                "Saint Quartz",         "Septims",              "Shillings",            "Silver",
    "Simoleons",            "Smackaroos",           "Social Credit",        "Souls",                "Spent Casings",
    "Spice",                "Spondulicks",          "Star Bits",            "Star Chips",           "Stars",
    "Stones of Barenziah",  "Stones of Jordan",     "Store Credit",         "Strawbs",              "Studs",
    "Super Sea Snails",     "Talent",               "Teef",                 "Telecrystals",         "Tiberium",
    "TokKul",               "Toys",                 "Turnips",              "Upvotes",              "V-Bucks",
    "Vespene Gas",          "Watts",                "Widgets",              "Woolongs",             "World Dollars",
    "Wumpa Fruit",          "Zenny",                "Zorkmids",             "[404 ERROR]",          "[P]"
};
