...
std::map<RandomizerCheck, RandomizerInf> rcToRandomizerInf = {
    ...
    { RC_JABU_JABUS_BELLY_MQ_WONDER_PLATFORMS_COW, RAND_INF_JABU_JABUS_BELLY_MQ_WONDER_PLATFORMS_COW },
    ...
    { RC_GANONS_CASTLE_MQ_WONDER_1, RAND_INF_GANONS_CASTLE_MQ_WONDER_1 },
    { RC_GANONS_CASTLE_MQ_WONDER_2, RAND_INF_GANONS_CASTLE_MQ_WONDER_2 },
};
