...
std::unordered_map<s16, s16> itemIdToModel = { { GI_NONE, GID_MAXIMUM },
                                               ...
                                               { GI_ZELDAS_LULLABY, GID_SONG_GENERIC },
                                               { GI_EPONAS_SONG, GID_SONG_GENERIC },
                                               { GI_SARIAS_SONG, GID_SONG_GENERIC },
                                               { GI_SUNS_SONG, GID_SONG_GENERIC },
                                               { GI_SONG_OF_TIME, GID_SONG_GENERIC },
                                               { GI_SONG_OF_STORMS, GID_SONG_GENERIC },
...
std::unordered_map<std::string, RandomizerGet> SpoilerfileGetNameToEnum = {
    ...
    { "Petite Clé de la Forteresse Gerudo", RG_GERUDO_FORTRESS_SMALL_KEY },
    ...
    { "Porte-clés de la Forteresse Gerudo", RG_GERUDO_FORTRESS_KEY_RING },
    ...
    { "Acheter des Noix Mojo (5)", RG_BUY_DEKU_NUT_5 },
    { "Buy Arrows (30)", RG_BUY_ARROWS_30 },
    { "Acheter des Flèches (30)", RG_BUY_ARROWS_30 },
    { "Buy Arrows (50)", RG_BUY_ARROWS_50 },
    { "Acheter des Flèches (50)", RG_BUY_ARROWS_50 },
    { "Buy Bombs (5) [25, ", RG_BUY_BOMBS_525 },
    { "Acheter des Bombes (5) [25, ", RG_BUY_BOMBS_525 },
    { "Buy Deku Nut (10)", RG_BUY_DEKU_NUT_10 },
    { "Acheter des Noix Mojo (10)", RG_BUY_DEKU_NUT_10 },
    { "Buy Deku Stick (1)", RG_BUY_DEKU_STICK_1 },
    { "Acheter un Bâton Mojo (1)", RG_BUY_DEKU_STICK_1 },
    { "Buy Bombs (10)", RG_BUY_BOMBS_10 },
    { "Acheter des Bombes ", RG_BUY_BOMBS_10 },
    { "Buy Fish", RG_BUY_FISH },
    { "Acheter un Poisson", RG_BUY_FISH },
    { "Buy Red Potion [30, ", RG_BUY_RED_POTION_30 },
    { "Acheter une Potion Rouge [30, ", RG_BUY_RED_POTION_30 },
    { "Buy Green Potion", RG_BUY_GREEN_POTION },
    { "Acheter une Potion Verte", RG_BUY_GREEN_POTION },
    { "Buy Blue Potion", RG_BUY_BLUE_POTION },
    { "Acheter une Potion Bleue", RG_BUY_BLUE_POTION },
    { "Buy Hylian Shield", RG_BUY_HYLIAN_SHIELD },
    { "Acheter un Bouclier Hylien", RG_BUY_HYLIAN_SHIELD },
    { "Buy Deku Shield", RG_BUY_DEKU_SHIELD },
    { "Acheter un Bouclier Mojo", RG_BUY_DEKU_SHIELD },
    { "Buy Goron Tunic", RG_BUY_GORON_TUNIC },
    { "Acheter une Tunique Goron", RG_BUY_GORON_TUNIC },
    { "Buy Zora Tunic", RG_BUY_ZORA_TUNIC },
    { "Acheter une Tunique Zora", RG_BUY_ZORA_TUNIC },
    { "Buy Heart", RG_BUY_HEART },
    { "Acheter un Coeur", RG_BUY_HEART },
    { "Buy Bombchu (10)", RG_BUY_BOMBCHU_10 },
    { "Acheter des Missiles (10)", RG_BUY_BOMBCHU_10 },
    { "Buy Bombchu (20)", RG_BUY_BOMBCHU_20 },
    { "Acheter des Missiles", RG_BUY_BOMBCHU_20 },
    { "Buy Bombchu (5)", RG_BUY_BOMBCHU_5 },
    { "Acheter des Missiles", RG_BUY_BOMBCHU_5 },
    { "Buy Deku Seeds (30)", RG_BUY_DEKU_SEEDS_30 },
    { "Acheter des Graines Mojo (30)", RG_BUY_DEKU_SEEDS_30 },
    { "Sold Out", RG_SOLD_OUT },
    { "Rupture de de stock", RG_SOLD_OUT },
    { "Buy Blue Fire", RG_BUY_BLUE_FIRE },
    { "Achter une Flamme Bleue", RG_BUY_BLUE_FIRE },
    { "Buy Bottle Bug", RG_BUY_BOTTLE_BUG },
    { "Acheter des Insecte en bouteille", RG_BUY_BOTTLE_BUG },
    { "Buy Poe", RG_BUY_POE },
    { "Acheter un Esprit", RG_BUY_POE },
    { "Buy Fairy's Spirit", RG_BUY_FAIRYS_SPIRIT },
    { "Acheter un Esprit de Fée", RG_BUY_FAIRYS_SPIRIT },
    { "Buy Arrows (10)", RG_BUY_ARROWS_10 },
    { "Acheter des Flèches (10)", RG_BUY_ARROWS_10 },
    { "Buy Bombs (20)", RG_BUY_BOMBS_20 },
    { "Acheter des Bombes (20)", RG_BUY_BOMBS_20 },
    { "Buy Bombs (30)", RG_BUY_BOMBS_30 },
    { "Acheter des Bombes (30)", RG_BUY_BOMBS_30 },
    { "Buy Bombs (5) [35, ", RG_BUY_BOMBS_535 },
    { "Acheter des Bombes (5) [35, ", RG_BUY_BOMBS_535 },
    { "Buy Red Potion [40, ", RG_BUY_RED_POTION_40 },
    { "Acheter une Potion Rouge [40, ", RG_BUY_RED_POTION_40 },
    { "Buy Red Potion [50, ", RG_BUY_RED_POTION_50 },
    { "Acheter une Potion Rouge [50, ", RG_BUY_RED_POTION_50 },
...
std::string FormatJsonHintText(std::string jsonHint) {
    ...
    for (std::string specialCharacter : {"è"}) {
