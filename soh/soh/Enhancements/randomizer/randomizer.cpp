...
void Randomizer::CreateCustomMessages() {
    ...
    const std::array<GetItemMessage, 112> getItemMessages = { {
        ...
        GIMESSAGE(RG_PROG_BOMBCHU_BAG, ITEM_BOMBCHU, "You found the %rBombchu Bag%w!",
...
static std::unordered_map<RandomizerGet, GameplayStatTimestamp> randomizerGetToStatsTimeStamp = {
    ...
    { RG_MARKET_SHOOTING_KEY, TIMESTAMP_FOUND_MARKET_SHOOTING_GALLERY_KEY },
    { RG_BOMBCHU_BOWLING_KEY, TIMESTAMP_FOUND_BOMBCHU_BOWLING_KEY },
    { RG_TCG_BUILDING_KEY, TIMESTAMP_FOUND_TREASURE_CHEST_GAME_BUILDING_KEY },
    ...
    { RG_GRANNYS_SHOP_KEY, TIMESTAMP_FOUND_GRANNYS_POTION_SHOP_KEY },
    ...
    { RG_KAK_SHOOTING_KEY, TIMESTAMP_FOUND_KAK_SHOOTING_GALLERY_KEY },
...
void Randomizer_GameplayStats_SetTimestamp(uint16_t item) {
    ...
    if ((item >= RG_BOMBCHU_5 && item <= RG_BOMBCHU_20) || item == RG_PROG_BOMBCHU_BAG) {
