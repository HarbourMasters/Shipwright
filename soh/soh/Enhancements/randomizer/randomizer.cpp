...
void InitRandoItemTable() {
    ...
    static GetItemEntry randoGetItemTable[] = {
        ...
        GET_ITEM(RG_OCARINA_A_BUTTON,                  OBJECT_GI_MAP,      GID_OCARINA_A_BUTTON,       TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR,     MOD_RANDOMIZER, RG_OCARINA_A_BUTTON),
        GET_ITEM(RG_OCARINA_C_LEFT_BUTTON,             OBJECT_GI_MAP,      GID_OCARINA_C_LEFT_BUTTON,  TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR,     MOD_RANDOMIZER, RG_OCARINA_C_LEFT_BUTTON),
        GET_ITEM(RG_OCARINA_C_RIGHT_BUTTON,            OBJECT_GI_MAP,      GID_OCARINA_C_RIGHT_BUTTON, TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR,     MOD_RANDOMIZER, RG_OCARINA_C_RIGHT_BUTTON),
        GET_ITEM(RG_OCARINA_C_UP_BUTTON,               OBJECT_GI_MAP,      GID_OCARINA_C_UP_BUTTON,    TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR,     MOD_RANDOMIZER, RG_OCARINA_C_UP_BUTTON),
        GET_ITEM(RG_OCARINA_C_DOWN_BUTTON,             OBJECT_GI_MAP,      GID_OCARINA_C_DOWN_BUTTON,  TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR,     MOD_RANDOMIZER, RG_OCARINA_C_DOWN_BUTTON),
    };
