...
void InitRandoItemTable() {
    ...
    static GetItemEntry extendedVanillaGetItemTable[] = {
        GET_ITEM_CUSTOM_TABLE(ITEM_MEDALLION_LIGHT,                 OBJECT_GI_MEDAL,    GID_MEDALLION_LIGHT,  0x40,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_LIGHT_MEDALLION),
        GET_ITEM_CUSTOM_TABLE(ITEM_MEDALLION_FOREST,                OBJECT_GI_MEDAL,    GID_MEDALLION_FOREST, 0x3E,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_FOREST_MEDALLION),
        GET_ITEM_CUSTOM_TABLE(ITEM_MEDALLION_FIRE,                  OBJECT_GI_MEDAL,    GID_MEDALLION_FIRE,   0x3C,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_FIRE_MEDALLION),
        GET_ITEM_CUSTOM_TABLE(ITEM_MEDALLION_WATER,                 OBJECT_GI_MEDAL,    GID_MEDALLION_WATER,  0x3D,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_WATER_MEDALLION),
        GET_ITEM_CUSTOM_TABLE(ITEM_MEDALLION_SHADOW,                OBJECT_GI_MEDAL,    GID_MEDALLION_SHADOW, 0x41,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_SHADOW_MEDALLION),
        GET_ITEM_CUSTOM_TABLE(ITEM_MEDALLION_SPIRIT,                OBJECT_GI_MEDAL,    GID_MEDALLION_SPIRIT, 0x3F,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_SPIRIT_MEDALLION),

        GET_ITEM_CUSTOM_TABLE(ITEM_KOKIRI_EMERALD,                  OBJECT_GI_JEWEL,    GID_KOKIRI_EMERALD,   0x80,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_KOKIRI_EMERALD),
        GET_ITEM_CUSTOM_TABLE(ITEM_GORON_RUBY,                      OBJECT_GI_JEWEL,    GID_GORON_RUBY,       0x81,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_GORON_RUBY),
        GET_ITEM_CUSTOM_TABLE(ITEM_ZORA_SAPPHIRE,                   OBJECT_GI_JEWEL,    GID_ZORA_SAPPHIRE,    0x82,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_ZORA_SAPPHIRE),

        GET_ITEM_CUSTOM_TABLE(ITEM_SONG_LULLABY,                    OBJECT_GI_MELODY,   GID_SONG_ZELDA,       0xD4,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_ZELDAS_LULLABY),
        GET_ITEM_CUSTOM_TABLE(ITEM_SONG_SUN,                        OBJECT_GI_MELODY,   GID_SONG_SUN,         0xD3,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_SUNS_SONG),
        GET_ITEM_CUSTOM_TABLE(ITEM_SONG_EPONA,                      OBJECT_GI_MELODY,   GID_SONG_EPONA,       0xD2,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_EPONAS_SONG),
        GET_ITEM_CUSTOM_TABLE(ITEM_SONG_STORMS,                     OBJECT_GI_MELODY,   GID_SONG_STORM,       0xD6,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_SONG_OF_STORMS),
        GET_ITEM_CUSTOM_TABLE(ITEM_SONG_TIME,                       OBJECT_GI_MELODY,   GID_SONG_TIME,        0xD5,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_SONG_OF_TIME),
        GET_ITEM_CUSTOM_TABLE(ITEM_SONG_SARIA,                      OBJECT_GI_MELODY,   GID_SONG_SARIA,       0xD1,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_SARIAS_SONG),

        GET_ITEM_CUSTOM_TABLE(ITEM_SONG_MINUET,                     OBJECT_GI_MELODY,   GID_SONG_MINUET,      0x73,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_MINUET_OF_FOREST),
        GET_ITEM_CUSTOM_TABLE(ITEM_SONG_BOLERO,                     OBJECT_GI_MELODY,   GID_SONG_BOLERO,      0x74,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_BOLERO_OF_FIRE),
        GET_ITEM_CUSTOM_TABLE(ITEM_SONG_SERENADE,                   OBJECT_GI_MELODY,   GID_SONG_SERENADE,    0x75,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_SERENADE_OF_WATER),
        GET_ITEM_CUSTOM_TABLE(ITEM_SONG_NOCTURNE,                   OBJECT_GI_MELODY,   GID_SONG_NOCTURNE,    0x77,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_NOCTURNE_OF_SHADOW),
        GET_ITEM_CUSTOM_TABLE(ITEM_SONG_REQUIEM,                    OBJECT_GI_MELODY,   GID_SONG_REQUIEM,     0x76,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_REQUIEM_OF_SPIRIT),
        GET_ITEM_CUSTOM_TABLE(ITEM_SONG_PRELUDE,                    OBJECT_GI_MELODY,   GID_SONG_PRELUDE,     0x78,                        0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_MAJOR, MOD_NONE, MOD_RANDOMIZER, RG_PRELUDE_OF_LIGHT),
    };
