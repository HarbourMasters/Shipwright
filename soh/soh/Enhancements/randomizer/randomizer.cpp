...
std::map<RandomizerCheck, RandomizerInf> rcToRandomizerInf = {
    ...
    { RC_BOTW_MQ_INVISIBLE_LEDGE_NE_POT,                               RAND_INF_BOTW_MQ_INVISIBLE_LEDGE_NW_POT },
    { RC_BOTW_MQ_INVISIBLE_LEDGE_NE_POT,                               RAND_INF_BOTW_MQ_INVISIBLE_LEDGE_NE_POT },
    { RC_BOTW_MQ_INVISIBLE_LEDGE_S_POT,                              RAND_INF_BOTW_MQ_INVISIBLE_LEDGE_S_POT },
