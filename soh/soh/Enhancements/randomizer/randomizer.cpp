...
ItemObtainability Randomizer::GetItemObtainabilityFromRandomizerGet(RandomizerGet randoGet) {
    ...
    switch (randoGet) {
        ...
        case RG_FOREST_TEMPLE_SMALL_KEY:
            return OTRGlobals::Instance->gRandoContext->GetDungeon(FOREST_TEMPLE)
                               ->GetTotalSmallKeys(&gSaveContext) < FOREST_TEMPLE_SMALL_KEY_MAX
                       ? CAN_OBTAIN
                       : CANT_OBTAIN_ALREADY_HAVE;
        case RG_FIRE_TEMPLE_SMALL_KEY:
            return OTRGlobals::Instance->gRandoContext->GetDungeon(FIRE_TEMPLE)
                               ->GetTotalSmallKeys(&gSaveContext) < FIRE_TEMPLE_SMALL_KEY_MAX
                       ? CAN_OBTAIN
                       : CANT_OBTAIN_ALREADY_HAVE;
        case RG_WATER_TEMPLE_SMALL_KEY:
            return OTRGlobals::Instance->gRandoContext->GetDungeon(WATER_TEMPLE)
                               ->GetTotalSmallKeys(&gSaveContext) < WATER_TEMPLE_SMALL_KEY_MAX
                       ? CAN_OBTAIN
                       : CANT_OBTAIN_ALREADY_HAVE;
        case RG_SPIRIT_TEMPLE_SMALL_KEY:
            return OTRGlobals::Instance->gRandoContext->GetDungeon(SPIRIT_TEMPLE)
                               ->GetTotalSmallKeys(&gSaveContext) < SPIRIT_TEMPLE_SMALL_KEY_MAX
                       ? CAN_OBTAIN
                       : CANT_OBTAIN_ALREADY_HAVE;
        case RG_SHADOW_TEMPLE_SMALL_KEY:
            return OTRGlobals::Instance->gRandoContext->GetDungeon(SHADOW_TEMPLE)
        ...
        case RG_GANONS_CASTLE_SMALL_KEY:
            return OTRGlobals::Instance->gRandoContext->GetDungeon(GANONS_CASTLE)
