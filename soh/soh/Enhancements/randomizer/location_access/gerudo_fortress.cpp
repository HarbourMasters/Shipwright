...
void RegionTable_Init_GerudoFortress() {
    areaTable[RR_GERUDO_FORTRESS] = Region("Gerudo Fortress", "Gerudo Fortress", {RA_GERUDO_FORTRESS}, NO_DAY_NIGHT_CYCLE, {
        ...
        LOCATION(RC_GF_OUTSIDE_CENTER_CRATE_1,        true),
        LOCATION(RC_GF_OUTSIDE_CENTER_CRATE_2,        true),
        LOCATION(RC_GF_OUTSIDE_CENTER_CRATE_3,        true),
        LOCATION(RC_GF_OUTSIDE_CENTER_CRATE_4,        true),
        LOCATION(RC_GF_OUTSIDE_LEFT_CRATE_1,          true),
        LOCATION(RC_GF_OUTSIDE_LEFT_CRATE_2,          true),
        LOCATION(RC_GF_ARCHERY_RANGE_CRATE_1,         true),
        LOCATION(RC_GF_ARCHERY_RANGE_CRATE_2,         true),
        LOCATION(RC_GF_ARCHERY_RANGE_CRATE_3,         true),
        LOCATION(RC_GF_ARCHERY_RANGE_CRATE_4,         true),
        LOCATION(RC_GF_ARCHERY_RANGE_CRATE_5,         true),
        LOCATION(RC_GF_ARCHERY_RANGE_CRATE_6,         true),
        LOCATION(RC_GF_ARCHERY_RANGE_CRATE_7,         true),
        LOCATION(RC_GF_ARCHERY_START_CRATE_1,         true),
        LOCATION(RC_GF_ARCHERY_START_CRATE_2,         true),
        LOCATION(RC_GF_ARCHERY_LEFT_END_CRATE_1,      true),
        LOCATION(RC_GF_ARCHERY_LEFT_END_CRATE_2,      true),
        LOCATION(RC_GF_ARCHERY_RIGHT_END_CRATE_1,     true),
        LOCATION(RC_GF_ARCHERY_RIGHT_END_CRATE_2,     true),
        LOCATION(RC_GF_KITCHEN_CRATE_1,               true),
        LOCATION(RC_GF_KITCHEN_CRATE_2,               true),
        LOCATION(RC_GF_KITCHEN_CRATE_3,               true),
        LOCATION(RC_GF_KITCHEN_CRATE_4,               true),
        LOCATION(RC_GF_KITCHEN_CRATE_5,               true),
        LOCATION(RC_GF_BREAK_ROOM_CRATE_1,            true),
        LOCATION(RC_GF_BREAK_ROOM_CRATE_2,            true),
        LOCATION(RC_GF_BREAK_ROOM_CRATE_3,            true),
        LOCATION(RC_GF_BREAK_ROOM_CRATE_4,            true),
        LOCATION(RC_GF_NORTH_F1_CARPENTER_CRATE,      true),
        LOCATION(RC_GF_NORTH_F3_CARPENTER_CRATE,      true),
        LOCATION(RC_GF_SOUTH_F2_CARPENTER_CRATE_1,    true),
        LOCATION(RC_GF_SOUTH_F2_CARPENTER_CRATE_2,    true),
