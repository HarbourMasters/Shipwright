...
void RegionTable_Init_WaterTemple() {
    // clang-format off
    // Vanilla/MQ Decider
    areaTable[RR_WATER_TEMPLE_ENTRYWAY] = Region("Water Temple Entryway", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
...
#pragma region Vanilla
    ...
    areaTable[RR_WATER_TEMPLE_LOBBY] = Region("Water Temple Lobby", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_EAST_LOWER] = Region("Water Temple East Lower", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_WATER_TEMPLE_MAP_ROOM] = Region("Water Temple Map Room", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_CRACKED_WALL] = Region("Water Temple Cracked Wall", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_TORCH_ROOM] = Region("Water Temple Torch Room", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_NORTH_LOWER] = Region("Water Temple North Lower", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
    ...
    areaTable[RR_WATER_TEMPLE_BOULDERS_LOWER] = Region("Water Temple Boulders Lower", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_BLOCK_ROOM] = Region("Water Temple Block Room", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_JETS_ROOM] = Region("Water Temple Jets Room", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
        Entrance(RR_WATER_TEMPLE_BLOCK_ROOM,     []{return logic->CanUse(RG_HOOKSHOT);}),
        Entrance(RR_WATER_TEMPLE_BOULDERS_UPPER, []{return true;}),
    });

    areaTable[RR_WATER_TEMPLE_BOULDERS_UPPER] = Region("Water Temple Boulders Upper", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
    ...
    areaTable[RR_WATER_TEMPLE_BOSS_KEY_ROOM] = Region("Water Temple Boss Key Room", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_WATER_TEMPLE_SOUTH_LOWER] = Region("Water Temple South Lower", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_WEST_LOWER] = Region("Water Temple West Lower", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
    ...
    areaTable[RR_WATER_TEMPLE_DRAGON_ROOM] = Region("Water Temple Dragon Room", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_CENTRAL_PILLAR_LOWER] = Region("Water Temple Central Pillar Lower", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
    ...
    areaTable[RR_WATER_TEMPLE_CENTRAL_PILLAR_UPPER] = Region("Water Temple Central Pillar Upper", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_WATER_TEMPLE_CENTRAL_PILLAR_BASEMENT] = Region("Water Temple Central Pillar Basement", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_EAST_MIDDLE] = Region("Water Temple East Middle", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_WEST_MIDDLE] = Region("Water Temple West Middle", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
        Entrance(RR_WATER_TEMPLE_LOBBY,      []{return true;}),
        Entrance(RR_WATER_TEMPLE_HIGH_WATER, []{return logic->CanUseProjectile();}),
    });

    areaTable[RR_WATER_TEMPLE_HIGH_WATER] = Region("Water Temple High Water", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_WATER_TEMPLE_BLOCK_CORRIDOR] = Region("Water Temple Block Corridor", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_FALLING_PLATFORM_ROOM] = Region("Water Temple Falling Platform Room", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_DRAGON_PILLARS_ROOM] = Region("Water Temple Dragon Pillars Room", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_DARK_LINK_ROOM] = Region("Water Temple Dark Link Room", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
    ...
    areaTable[RR_WATER_TEMPLE_LONGSHOT_ROOM] = Region("Water Temple Longshot Room", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_RIVER] = Region("Water Temple River", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_PRE_BOSS_ROOM] = Region("Water Temple Pre Boss Room", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {
        //Events
        EventAccess(&logic->FairyPot, []{return true;}),
    }, {
        // Locations
...
#pragma region MQ
    ...
    areaTable[RR_WATER_TEMPLE_MQ_3F_SOUTH_LEDGE] = Region("Water Temple MQ 3F South Ledge", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
    ...
    areaTable[RR_WATER_TEMPLE_MQ_MAIN] = Region("Water Temple MQ Main", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
    ...
    areaTable[RR_WATER_TEMPLE_MQ_3F_CENTRAL] = Region("Water Temple MQ 3F Central", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
        Entrance(RR_WATER_TEMPLE_MQ_MAIN,                []{return true;}),
    ...
    areaTable[RR_WATER_TEMPLE_MQ_2F_CENTRAL] = Region("Water Temple MQ 2F Central", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
        Entrance(RR_WATER_TEMPLE_MQ_MAIN,                  []{return true;}),
    ...
    areaTable[RR_WATER_TEMPLE_MQ_HIGH_EMBLEM] = Region("Water Temple MQ High Emblem", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_WATER_TEMPLE_MQ_3F_NORTH_LEDGE] = Region("Water Temple MQ 3F North Ledge", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
    ...
    areaTable[RR_WATER_TEMPLE_MQ_BOSS_DOOR] = Region("Water Temple MQ Main", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
        Entrance(RR_WATER_TEMPLE_MQ_3F_NORTH_LEDGE, []{return logic->CanUse(RG_ICE_ARROWS) || logic->TakeDamage();}),
        Entrance(RR_WATER_TEMPLE_BOSS_ENTRYWAY,     []{return logic->HasItem(RG_WATER_TEMPLE_BOSS_KEY);}),
    });

    areaTable[RR_WATER_TEMPLE_MQ_EAST_TOWER] = Region("Water Temple MQ East Tower", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_WATER_TEMPLE_MQ_EAST_TOWER_1F_ROOM] = Region("Water Temple MQ East Tower 1F Room", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_CENTRAL_PILLAR_1F] = Region("Water Temple MQ Central Pillar 1F", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_WATER_TEMPLE_MQ_CENTRAL_PILLAR_2F] = Region("Water Temple MQ Central Pillar 2F", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_WATER_TEMPLE_MQ_CENTRAL_PILLAR_HIGH] = Region("Water Temple MQ Central Pillar High", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_WATER_TEMPLE_MQ_CENTRAL_PILLAR_B1] = Region("Water Temple MQ Central Pillar B1", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
    ...
    areaTable[RR_WATER_TEMPLE_MQ_CENTRAL_PILLAR_B1_FINAL] = Region("Water Temple MQ Central Pillar B1 Final", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_STORAGE_ROOM] = Region("Water Temple MQ Storage Room", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_BEHIND_BLUE_SWITCH_2F] = Region("Water Temple MQ Behind Blue Switch 2F", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_BEHIND_BLUE_SWITCH_3F] = Region("Water Temple MQ Behind Blue Switch 2F", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_LIZALFOS_HALLWAY] = Region("Water Temple MQ Lizalfos Hallway", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_3F_EAST_LEDGE] = Region("Water Temple MQ 3F East Ledge", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
        Entrance(RR_WATER_TEMPLE_MQ_MAIN,       []{return true;}),
        Entrance(RR_WATER_TEMPLE_MQ_3F_CENTRAL, []{return logic->CanUse(RG_HOOKSHOT) || logic->CanUse(RG_HOVER_BOOTS);}),*/
    });

    areaTable[RR_WATER_TEMPLE_MQ_LIZALFOS_CAGE] = Region("Water Temple MQ Lizalfos Cage", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_WATERFALL] = Region("Water Temple Waterfall", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
    ...
    areaTable[RR_WATER_TEMPLE_MQ_STALFOS_PIT] = Region("Water Temple MQ Stalfos Pit", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_WATER_TEMPLE_MQ_STALFOS_PIT_POTS] = Region("Water Temple MQ Stalfos Pit Pots", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {
        //Events
        EventAccess(&logic->FairyPot, []{return true;}),
    ...
    areaTable[RR_WATER_TEMPLE_MQ_STALFOS_PIT_UPPER] = Region("Water Temple MQ Stalfos Pit Upper", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_AFTER_DARK_LINK] = Region("Water Temple MQ After Dark Link", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {
        //Events
        EventAccess(&logic->FairyPot, []{return true;}),
    }, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_RIVER_SKULL] = Region("Water Temple MQ River Skull", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_RIVER_POTS] = Region("Water Temple MQ River Pots", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {
        //Events
        EventAccess(&logic->FairyPot, []{return true;}),
    }, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_DRAGON_ROOM_TUNNEL] = Region("Water Temple MQ Dragon Room Tunnel", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, 
    {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_DRAGON_ROOM_ALCOVE] = Region("Water Temple MQ Dragon Room Alcove", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_WATER_TEMPLE_MQ_DRAGON_ROOM_DOOR] = Region("Water Temple MQ Dragon Room Door", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, 
    {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_BOSS_KEY_ROOM_SWITCH] = Region("Water Temple MQ Boss Key Room Switch", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_BOSS_KEY_ROOM_PIT] = Region("Water Temple MQ Boss Key Room Pit", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, 
    {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_BOSS_KEY_ROOM_CHEST] = Region("Water Temple MQ Boss Key Room Chest", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_B1_GATE_SWITCH] = Region("Water Temple MQ B1 Gate Switch", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_WATER_TEMPLE_MQ_TRIANGLE_TORCH_ROOM] = Region("Water Temple MQ Triangle Torch Room", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, 
    {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_TRIANGLE_TORCH_CAGE] = Region("Water Temple MQ Triangle Torch Cage", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_CRATES_WHIRLPOOLS_ROOM] = Region("Water Temple MQ Crates Whirlpools Room", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, 
    {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_SINGLE_STALFOS_ROOM] = Region("Water Temple MQ Single Stalfos Room", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_4_TORCH_ROOM] = Region("Water Temple MQ 4 Torch Room", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
    ...
    areaTable[RR_WATER_TEMPLE_MQ_DODONGO_ROOM] = Region("Water Temple MQ Dodongo Room", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_WATER_TEMPLE_MQ_CRATES_WHIRLPOOLS_CAGE] = Region("Water Temple MQ Basement Gated Areas", SCENE_WATER_TEMPLE, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
...
#pragma endregion
    ...
    // Boss Room
    areaTable[RR_WATER_TEMPLE_BOSS_ENTRYWAY] = Region("Water Temple Boss Entryway", SCENE_WATER_TEMPLE_BOSS, {RA_WATER_TEMPLE}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        // Exits
    ...
    areaTable[RR_WATER_TEMPLE_BOSS_ROOM] = Region("Water Temple Boss Room", SCENE_WATER_TEMPLE_BOSS, {}, NO_DAY_NIGHT_CYCLE, {
        // Events
