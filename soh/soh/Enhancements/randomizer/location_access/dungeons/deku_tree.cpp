...
#pragma region MQ
    ...
    areaTable[RR_DEKU_TREE_MQ_BASEMENT_GRAVE_ROOM] = Region("Deku Tree MQ Basement Grave Room", SCENE_DEKU_TREE, {
        ...
        LOCATION(RC_MQ_DEKU_TREE_WONDER_BASEMENT_GRAVE_1, logic->CanJumpslashExceptHammer()),
        LOCATION(RC_MQ_DEKU_TREE_WONDER_BASEMENT_GRAVE_2, logic->CanJumpslashExceptHammer()),
        LOCATION(RC_MQ_DEKU_TREE_WONDER_BASEMENT_GRAVE_3, logic->CanJumpslashExceptHammer()),
        LOCATION(RC_MQ_DEKU_TREE_WONDER_BASEMENT_GRAVE_4, logic->CanJumpslashExceptHammer()),
    }, {
        //Exits
