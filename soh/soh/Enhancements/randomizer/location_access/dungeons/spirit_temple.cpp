...
#pragma region MQ
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_SOT_SUN_ROOM] = Region("Spirit Temple MQ SoT Sun Room", SCENE_SPIRIT_TEMPLE, {}, {
        ...
        LOCATION(RC_MQ_SPIRIT_TEMPLE_WONDER_CHEST_HAMMER,     logic->CanUse(RG_MEGATON_HAMMER)),
        LOCATION(RC_MQ_SPIRIT_TEMPLE_WONDER_CHEST_SLASH,      logic->CanJumpslashExceptHammer()),
