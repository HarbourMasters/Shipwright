...
#pragma region Vanilla
    ...
    areaTable[RR_SPIRIT_TEMPLE_FOYER] = Region("Spirit Temple Foyer", SCENE_SPIRIT_TEMPLE, {
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_CHILD_SIDE_HUB,  logic->IsChild/*CanUse(RG_CRAWL)*/),
    ...
    areaTable[RR_SPIRIT_TEMPLE_CHILD_SIDE_HUB] = Region("Spirit Temple Child Side Hub", SCENE_SPIRIT_TEMPLE, {
        ...
        //Exits
        ENTRANCE(RR_SPIRIT_TEMPLE_FOYER,               logic->IsChild/*CanUse(RG_CRAWL)*/),
        ENTRANCE(RR_SPIRIT_TEMPLE_CHILD_BOXES,         logic->IsChild/*CanUse(RG_CRAWL)*/),
    ...
    areaTable[RR_SPIRIT_TEMPLE_1F_ANUBIS] = Region("Spirit Temple 1F Anubis", SCENE_SPIRIT_TEMPLE, {}, {
        ...
        //Exits
        ENTRANCE(RR_SPIRIT_TEMPLE_SWITCH_BRIDGE_NORTH, AnyAgeTime([]{return logic->CanHitSwitch() || logic->CanKillEnemy(RE_ANUBIS);})),
        ENTRANCE(RR_SPIRIT_TEMPLE_RUPEE_BRIDGE_NORTH,  AnyAgeTime([]{return logic->CanHitSwitch() || logic->CanKillEnemy(RE_ANUBIS);})),
    });

    areaTable[RR_SPIRIT_TEMPLE_RUPEE_BRIDGE_NORTH] = Region("Spirit Temple Rupee Bridge North", SCENE_SPIRIT_TEMPLE, {
        //Events
        EVENT_ACCESS(LOGIC_SPIRIT_SILVER_RUPEE_BRIDGE, true/*CanClimb()*/),
    }, {
        //Locations
    ...
    areaTable[RR_SPIRIT_TEMPLE_SUN_ON_FLOOR_1F] = Region("Spirit Temple Sun On Floor 1F", SCENE_SPIRIT_TEMPLE, {}, {
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_SUN_ON_FLOOR_2F, true/*CanClimbHigh()*/),
    });
    ...
    areaTable[RR_SPIRIT_TEMPLE_SUN_ON_FLOOR_2F] = Region("Spirit Temple Sun On Floor 2F", SCENE_SPIRIT_TEMPLE, {}, {
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_STATUE_ROOM,     logic->SpiritSunOnFloorToStatue()),
    });
    ...
    areaTable[RR_SPIRIT_TEMPLE_BOULDERS] = Region("Spirit Temple Boulders", SCENE_SPIRIT_TEMPLE, {}, {
        ...
        //Exits
        ENTRANCE(RR_SPIRIT_TEMPLE_ABOVE_BOULDERS, true/*CanClimb() || IsAdult() || CanGroundJump*/),
    ...
    areaTable[RR_SPIRIT_TEMPLE_1F_MIRROR_ROOM] = Region("Spirit Temple 1F Mirror Room", SCENE_SPIRIT_TEMPLE, {}, {}, {
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_2F_MIRROR_ROOM, true/*CanClimbHigh()*/),
    });
    ...
    areaTable[RR_SPIRIT_TEMPLE_2F_MIRROR_ROOM] = Region("Spirit Temple 2F Mirror Room", SCENE_SPIRIT_TEMPLE, {}, {
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_STATUE_ROOM_ADULT, true/*str0 || SunlightArrows()*/),
    });
    ...
    areaTable[RR_SPIRIT_TEMPLE_STATUE_ROOM_CHILD] = Region("Spirit Temple Statue Rooom Child", SCENE_SPIRIT_TEMPLE, {}, {
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_EMPTY_STAIRS,     true/*str0*/),
        //!QUANTUM LOGIC!
        ...
        ENTRANCE(RR_DESERT_COLOSSUS,               ctx->GetOption(RSK_SHUFFLE_DUNGEON_ENTRANCES).Is(RO_DUNGEON_ENTRANCE_SHUFFLE_OFF) && /*str0 &&*/
    ...
    areaTable[RR_SPIRIT_TEMPLE_STATUE_ROOM] = Region("Spirit Temple Statue Room", SCENE_SPIRIT_TEMPLE, {}, {
        ...
        //Exits
        ENTRANCE(RR_SPIRIT_TEMPLE_STATUE_ROOM_CHILD, true/*CanClimb()*/),
        ENTRANCE(RR_SPIRIT_TEMPLE_PLATFORM,          logic->Get(LOGIC_SPIRIT_PLATFORM_LOWERED) && 
                                                     (logic->CanUse(RG_LONGSHOT) || (ctx->GetTrickOption(RT_SPIRIT_PLATFORM_HOOKSHOT) && logic->CanUse(RG_HOOKSHOT)))),
    ...
    areaTable[RR_SPIRIT_TEMPLE_SUN_BLOCK_ROOM] = Region("Spirit Temple Sun Block Room", SCENE_SPIRIT_TEMPLE, {}, {}, {
        //Exits
        ENTRANCE(RR_SPIRIT_TEMPLE_EMPTY_STAIRS,          true/*str0 || SunlightArrows*/),
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_SKULLTULA_STAIRS,      true/*str0 || SunlightArrows*/),
    });
    ...
    areaTable[RR_SPIRIT_TEMPLE_BIG_WALL_BASE] = Region("Spirit Temple Big Wall Base", SCENE_SPIRIT_TEMPLE, {}, {}, {
        //Exits
        ENTRANCE(RR_SPIRIT_TEMPLE_BEAMOS_PITS,    true),
        ENTRANCE(RR_SPIRIT_TEMPLE_BIG_WALL_UPPER, (ctx->GetTrickOption(RT_SPIRIT_WALL) || 
    ...
    areaTable[RR_SPIRIT_TEMPLE_BIG_MIRROR_CAVE] = Region("Spirit Temple Big Mirror Cave", SCENE_SPIRIT_TEMPLE, {
        ...
        EVENT_ACCESS(LOGIC_SPIRIT_PUSHED_4F_MIRRORS, logic->HasExplosives()/*&& str0*/),
    }, {
        //Locations
...
#pragma region MQ
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_FOYER] = Region("Spirit Temple MQ Lobby", SCENE_SPIRIT_TEMPLE, {
        ...
        //Exits
        ENTRANCE(RR_SPIRIT_TEMPLE_ENTRYWAY,           true),
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_CHILD_SIDE_HUB,  logic->IsChild/*logic->CanUse(RG_CRAWL) && logic->HasSoul(RG_NABOORU_SOUL)*/),
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_CHILD_SIDE_HUB] = Region("Spirit Temple MQ Child Side Hub", SCENE_SPIRIT_TEMPLE, {
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_FOYER,               logic->IsChild/*logic->CanUse(RG_CRAWL)*/),
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_1F_CHEST_SWITCH,     logic->IsChild/*logic->CanUse(RG_CRAWL)*/ && logic->Get(LOGIC_SPIRIT_MQ_CRAWL_BOULDER)),
    });

    areaTable[RR_SPIRIT_TEMPLE_MQ_GIBDO_GRAVES] = Region("Spirit Temple MQ Gibdo Graves", SCENE_SPIRIT_TEMPLE, {
        //Events
        EVENT_ACCESS(LOGIC_SPIRIT_MQ_GIBDOS_CLEARED,  /*str0 && */
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_GIBDO_POTS,     /*str0 && */
                                                     (logic->CanUse(RG_BOMBCHU_5) && logic->CanHitEyeTargets()) ||
                                                     logic->CanUse(RG_HOVER_BOOTS)/* || (IsAdult && CanBunnyJump())*/),
    });
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_ANUBIS_BRIDGE_GRAVE] = Region("Spirit Temple MQ Anubis Bridge Grave", SCENE_SPIRIT_TEMPLE, {
        //Events
        EVENT_ACCESS(LOGIC_SPIRIT_MQ_MAP_ROOM_ENEMIES, /*(*/logic->CanKillEnemy(RE_ANUBIS) && logic->CanKillEnemy(RE_KEESE)/*) && (str0 || CanUse(RG_HOVER_BOOTS) || CanUse(RG_HOOKSHOT) || (logic->IsAdult && CanBunnyJump())) ||
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_ANUBIS_BRIDGE_CHEST, true/*str0 || CanUse(RG_HOVER_BOOTS) || CanUse(RG_HOOKSHOT) || (logic->IsAdult && CanBunnyJump())*/),
    });
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_1F_CHEST_SWITCH] = Region("Spirit Temple MQ West 1F Rusted Switch", SCENE_SPIRIT_TEMPLE, {
        ...
        //Exits
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_CHILD_SIDE_HUB,  logic->IsChild/*logic->CanUse(RG_CRAWL)*/ && logic->Get(LOGIC_SPIRIT_MQ_CRAWL_BOULDER)),
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_UNDER_LIKE_LIKE] = Region("Spirit Temple MQ Under Like Like", SCENE_SPIRIT_TEMPLE, {}, {
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_SUN_ON_FLOOR,    logic->CanHitSwitch()/* && CanClimbHigh()*/),
    });
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_STATUE_ROOM_CHILD] = Region("Spirit Temple MQ Statue Room Child", SCENE_SPIRIT_TEMPLE, {}, {
        ...
        ENTRANCE(RR_DESERT_COLOSSUS,                      logic->IsChild/*CanUse(RG_CRAWL)*/ && ctx->GetOption(RSK_SHUFFLE_DUNGEON_ENTRANCES).Is(RO_DUNGEON_ENTRANCE_SHUFFLE_OFF) &&
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_STATUE_ROOM] = Region("Spirit Temple MQ Statue Room", SCENE_SPIRIT_TEMPLE, {
        ...
        //Exits
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_STATUE_ROOM_CHILD, true/*logic->CanClimb()*/),
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_SUN_BLOCK_ROOM] = Region("Spirit Temple MQ Sun Block Room", SCENE_SPIRIT_TEMPLE, {}, {
        ...
        //Exits
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_FLAMETHROWER_STAIRS, true/*str0 || SunlightArrows()*/),
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_SKULLTULA_STAIRS,    true/*str0 || SunlightArrows()*/),
    });
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_3_SUNS_ROOM_1F] = Region("Spirit Temple MQ 3 Suns Room 1F", SCENE_SPIRIT_TEMPLE, {}, {}, {
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_3_SUNS_ROOM_2F, logic->Get(LOGIC_SPIRIT_MQ_3SUNS_ENEMIES)/* && CanClimbHigh()*/),
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_SYMPHONY_ROOM_LOWER] = Region("Spirit Temple MQ Symphony Room Lower", SCENE_SPIRIT_TEMPLE, {}, {}, {
        //Exits
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_SYMPHONY_ROOM_UPPER, true/*CanClimb() || IsAdult || CanGroundJump()*/),
        //Implies CanPassEnemy(RE_MOBLIN_CHIEF)
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_BEAMOS_PITS] = Region("Spirit Temple MQ Beamos Pits", SCENE_SPIRIT_TEMPLE, {}, {
        ...
        //Exits
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_FIRE_WALL_STAIRS_UPPER, logic->CanAvoidEnemy(RE_BEAMOS, true, 4) && logic->CanUse(RG_SONG_OF_TIME)/* && str0*/),
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_SOT_SUN_ROOM,           logic->CanAvoidEnemy(RE_BEAMOS, true, 4) && logic->CanUse(RG_SONG_OF_TIME)/* && str0*/),
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_BIG_WALL_BASE] = Region("Spirit Temple MQ Big Wall Base", SCENE_SPIRIT_TEMPLE, {}, {
        ...
        ENTRANCE(RR_SPIRIT_TEMPLE_MQ_BIG_WALL_UPPER, /*(*/logic->CanKillEnemy(RE_KEESE)/*|| CanUse(RG_SKULL_MASK)) && CanClimbHigh()*/),
    });
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_BIG_WALL_UPPER] = Region("Spirit Temple MQ Big Wall Upper", SCENE_SPIRIT_TEMPLE, {
        ...
        EVENT_ACCESS(LOGIC_SPIRIT_MQ_BIG_WALL_SILVERS, /*(*/logic->CanKillEnemy(RE_KEESE)/*|| CanUse(RG_SKULL_MASK)) && CanClimbHigh()*/),
    }, {}, {
        //Exits
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_BIG_MIRROR_CAVE] = Region("Spirit Temple MQ Big Mirror Cave", SCENE_SPIRIT_TEMPLE, {
        //Events
        //WARNING: Not currently a permanent flag, needs to be one for doorsanity
        EVENT_ACCESS(LOGIC_SPIRIT_PUSHED_4F_MIRRORS, ((logic->IsAdult && logic->CanUse(RG_MIRROR_SHIELD)) || logic->SunlightArrows())/* && str0*/),
    }, {
        //Locations
