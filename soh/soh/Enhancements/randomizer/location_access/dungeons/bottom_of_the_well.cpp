...
void RegionTable_Init_BottomOfTheWell() {
    ...
    areaTable[RR_BOTTOM_OF_THE_WELL_ENTRYWAY] = Region("Bottom of the Well Entryway", SCENE_BOTTOM_OF_THE_WELL, {}, {}, {
        ...
        ENTRANCE(RR_BOTTOM_OF_THE_WELL_PERIMETER,    ctx->GetDungeon(BOTTOM_OF_THE_WELL)->IsVanilla() && logic->IsChild && logic->CanPassEnemy(RE_BIG_SKULLTULA)),
        ENTRANCE(RR_BOTTOM_OF_THE_WELL_MQ_PERIMETER, ctx->GetDungeon(BOTTOM_OF_THE_WELL)->IsMQ()      && logic->IsChild),
...
#pragma region Vanilla
    ...
    areaTable[RR_BOTTOM_OF_THE_WELL_PERIMETER] = Region("Bottom of the Well Perimeter", SCENE_BOTTOM_OF_THE_WELL, {
        ...
        ENTRANCE(RR_BOTTOM_OF_THE_WELL_KEESE_BEAMOS_ROOM, logic->IsChild && logic->SmallKeys(SCENE_BOTTOM_OF_THE_WELL, 3)),
        ENTRANCE(RR_BOTTOM_OF_THE_WELL_COFFIN_ROOM,       logic->Get(LOGIC_BOTW_LOWERED_WATER) || logic->HasItem(RG_BRONZE_SCALE)),
        ENTRANCE(RR_BOTTOM_OF_THE_WELL_DEAD_HAND_ROOM,    logic->Get(LOGIC_BOTW_LOWERED_WATER) && logic->IsChild),
    ...
    areaTable[RR_BOTTOM_OF_THE_WELL_BEHIND_FAKE_WALLS] = Region("Bottom of the Well Behind Fake Walls", SCENE_BOTTOM_OF_THE_WELL, {}, {
        ...
        ENTRANCE(RR_BOTTOM_OF_THE_WELL_INNER_ROOMS,       logic->SmallKeys(SCENE_BOTTOM_OF_THE_WELL, 3)),
        ENTRANCE(RR_BOTTOM_OF_THE_WELL_BASEMENT,          true),
    ...
    areaTable[RR_BOTTOM_OF_THE_WELL_KEESE_BEAMOS_ROOM] = Region("Bottom of the Well Keese-Beamos Room", SCENE_BOTTOM_OF_THE_WELL, {}, {
        ...
        //Exits
        ENTRANCE(RR_BOTTOM_OF_THE_WELL_PERIMETER,                    logic->IsChild && logic->SmallKeys(SCENE_BOTTOM_OF_THE_WELL, 3) && (ctx->GetTrickOption(RT_LENS_BOTW) || logic->CanUse(RG_LENS_OF_TRUTH))),
    ...
    areaTable[RR_BOTTOM_OF_THE_WELL_INNER_ROOMS] = Region("Bottom of the Well Inner Rooms", SCENE_BOTTOM_OF_THE_WELL, {
        ...
        //Exits
        ENTRANCE(RR_BOTTOM_OF_THE_WELL_BEHIND_FAKE_WALLS, logic->SmallKeys(SCENE_BOTTOM_OF_THE_WELL, 3)),
    });
    ...
    areaTable[RR_BOTTOM_OF_THE_WELL_COFFIN_ROOM] = Region("Bottom of the Well Coffin Room", SCENE_BOTTOM_OF_THE_WELL, {}, {
        ...
        //Exits
        ENTRANCE(RR_BOTTOM_OF_THE_WELL_PERIMETER, logic->Get(LOGIC_BOTW_LOWERED_WATER) || logic->HasItem(RG_BRONZE_SCALE)),
    });
...
#pragma region MQ
    ...
    areaTable[RR_BOTTOM_OF_THE_WELL_MQ_PERIMETER] = Region("Bottom of the Well MQ Perimeter", SCENE_BOTTOM_OF_THE_WELL, {
        ...
        ENTRANCE(RR_BOTTOM_OF_THE_WELL_MQ_COFFIN_ROOM,      (logic->Get(LOGIC_BOTW_LOWERED_WATER) || logic->HasItem(RG_BRONZE_SCALE)) && logic->SmallKeys(SCENE_BOTTOM_OF_THE_WELL, 2)),
        ENTRANCE(RR_BOTTOM_OF_THE_WELL_MQ_LOCKED_CAGE,      logic->IsChild && logic->SmallKeys(SCENE_BOTTOM_OF_THE_WELL, 2) && logic->CanUseProjectile()),
        ENTRANCE(RR_BOTTOM_OF_THE_WELL_MQ_DEAD_HAND_ROOM,   logic->IsChild && logic->Get(LOGIC_BOTW_LOWERED_WATER)),
    ...
    areaTable[RR_BOTTOM_OF_THE_WELL_MQ_COFFIN_ROOM] = Region("Bottom of the Well MQ Coffin Room", SCENE_BOTTOM_OF_THE_WELL, {}, {
        ...
        //Exits
        ENTRANCE(RR_BOTTOM_OF_THE_WELL_MQ_PERIMETER,  (logic->Get(LOGIC_BOTW_LOWERED_WATER) || logic->HasItem(RG_BRONZE_SCALE)) && logic->SmallKeys(SCENE_BOTTOM_OF_THE_WELL, 2)),
    });
    ...
    areaTable[RR_BOTTOM_OF_THE_WELL_MQ_LOCKED_CAGE] = Region("Bottom of the Well MQ Locked Cage", SCENE_BOTTOM_OF_THE_WELL, {
        ...
        //Exits
        ENTRANCE(RR_BOTTOM_OF_THE_WELL_MQ_PERIMETER, logic->IsChild && logic->SmallKeys(SCENE_BOTTOM_OF_THE_WELL, 2)),
    });
    ...
    areaTable[RR_BOTTOM_OF_THE_WELL_MQ_MIDDLE] = Region("Bottom of the Well MQ Middle", SCENE_BOTTOM_OF_THE_WELL, {}, {
        ...
        ENTRANCE(RR_BOTTOM_OF_THE_WELL_MQ_BASEMENT_SWITCH_PLATFORM, logic->Get(LOGIC_BOTW_MQ_OPENED_MIDDLE_HOLE)),
        ENTRANCE(RR_BOTTOM_OF_THE_WELL_MQ_BASEMENT,                 true),
    });
