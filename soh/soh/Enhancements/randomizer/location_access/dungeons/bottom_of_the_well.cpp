...
#pragma region MQ
    ...
    areaTable[RR_BOTW_MQ_PERIMETER] = Region("Bottom of the Well MQ Perimeter", SCENE_BOTTOM_OF_THE_WELL, {
        ...
        LOCATION(RC_MQ_BOTTOM_OF_THE_WELL_WONDER_MAIN_ROOM_LEFT_1,  logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_BOTTOM_OF_THE_WELL_WONDER_MAIN_ROOM_LEFT_2,  logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_BOTTOM_OF_THE_WELL_WONDER_MAIN_ROOM_LEFT_3,  logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_BOTTOM_OF_THE_WELL_WONDER_MAIN_ROOM_LEFT_4,  logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_BOTTOM_OF_THE_WELL_WONDER_MAIN_ROOM_RIGHT_1, logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_BOTTOM_OF_THE_WELL_WONDER_MAIN_ROOM_RIGHT_2, logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_BOTTOM_OF_THE_WELL_WONDER_MAIN_ROOM_RIGHT_3, logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_BOTTOM_OF_THE_WELL_WONDER_MAIN_ROOM_RIGHT_4, logic->CanUse(RG_FAIRY_SLINGSHOT)),
    }, {
        //Exits
    ...
    areaTable[RR_BOTW_MQ_INVISIBLE_PATH] = Region("Bottom of the Well Invisible Path", SCENE_BOTTOM_OF_THE_WELL, {}, {
        ...
        LOCATION(RC_MQ_BOTTOM_OF_THE_WELL_WONDER_SIDE_ROOM_1,    logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_BOTTOM_OF_THE_WELL_WONDER_SIDE_ROOM_2,    logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_BOTTOM_OF_THE_WELL_WONDER_SIDE_ROOM_3,    logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_BOTTOM_OF_THE_WELL_WONDER_SIDE_ROOM_4,    logic->CanUse(RG_FAIRY_SLINGSHOT)),
    }, {
        //Exits
