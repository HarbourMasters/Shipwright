...
void RegionTable_Init_DodongosCavern() {
    // clang-format off
    // Vanilla/MQ Decider
    areaTable[RR_DODONGOS_CAVERN_ENTRYWAY] = Region("Dodongos Cavern Entryway", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
...
#pragma region Vanilla
    ...
    areaTable[RR_DODONGOS_CAVERN_BEGINNING] = Region("Dodongos Cavern Beginning", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
    ...
    areaTable[RR_DODONGOS_CAVERN_LOBBY] = Region("Dodongos Cavern Lobby", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_DODONGOS_CAVERN_LOBBY_SWITCH] = Region("Dodongos Cavern Lobby Switch", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
        Entrance(RR_DODONGOS_CAVERN_LOBBY,        []{return true;}),
        Entrance(RR_DODONGOS_CAVERN_DODONGO_ROOM, []{return true;}),
    });

    areaTable[RR_DODONGOS_CAVERN_SE_CORRIDOR] = Region("Dodongos Cavern SE Corridor", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_SE_ROOM] = Region("Dodongos Cavern SE Room", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_NEAR_LOWER_LIZALFOS] = Region("Dodongos Cavern Near Lower Lizalfos", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
        Entrance(RR_DODONGOS_CAVERN_SE_CORRIDOR,    []{return true;}),
        Entrance(RR_DODONGOS_CAVERN_LOWER_LIZALFOS, []{return true;}),
    });

    areaTable[RR_DODONGOS_CAVERN_LOWER_LIZALFOS] = Region("Dodongos Cavern Lower Lizalfos", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_DODONGO_ROOM] = Region("Dodongos Cavern Dodongo Room", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_NEAR_DODONGO_ROOM] = Region("Dodongos Cavern Near Dodongo Room", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_STAIRS_LOWER] = Region("Dodongos Cavern Stairs Lower", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
        Entrance(RR_DODONGOS_CAVERN_LOBBY,        []{return true;}),
    ...
    areaTable[RR_DODONGOS_CAVERN_STAIRS_UPPER] = Region("Dodongos Cavern Stairs Upper", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_COMPASS_ROOM] = Region("Dodongos Cavern Compass Room", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_ARMOS_ROOM] = Region("Dodongos Cavern Armos Room", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
        Entrance(RR_DODONGOS_CAVERN_STAIRS_UPPER,    []{return true;}),
        Entrance(RR_DODONGOS_CAVERN_BOMB_ROOM_LOWER, []{return true;}),
    });

    areaTable[RR_DODONGOS_CAVERN_BOMB_ROOM_LOWER] = Region("Dodongos Cavern Bomb Room Lower", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_2F_SIDE_ROOM] = Region("Dodongos Cavern 2F Side Room", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_FIRST_SLINGSHOT_ROOM] = Region("Dodongos Cavern First Slingshot Room", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_UPPER_LIZALFOS] = Region("Dodongos Cavern Upper Lizalfos", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
        LOCATION(RC_DODONGOS_CAVERN_LOWER_LIZALFOS_HEART,       true),
    ...
    areaTable[RR_DODONGOS_CAVERN_SECOND_SLINGSHOT_ROOM] = Region("Dodongos Cavern Second Slingshot Room", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Location
    ...
    areaTable[RR_DODONGOS_CAVERN_BOMB_ROOM_UPPER] = Region("Dodongos Cavern Bomb Room Upper", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_FAR_BRIDGE] = Region("Dodongos Cavern Far Bridge", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_BOSS_AREA] = Region("Dodongos Cavern Boss Region", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_DODONGOS_CAVERN_BACK_ROOM] = Region("Dodongos Cavern Back Room", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
...
#pragma region MQ
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_BEGINNING] = Region("Dodongos Cavern MQ Beginning", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
        Entrance(RR_DODONGOS_CAVERN_ENTRYWAY, []{return true;}),
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_LOBBY] = Region("Dodongos Cavern MQ Lobby", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_GOSSIP_STONE] = Region("Dodongos Cavern MQ Gossip Stone", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_MOUTH_SIDE_BRIDGE] = Region("Dodongos Cavern MQ Mouth Side Bridge", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_STAIRS_LOWER] = Region("Dodongos Cavern MQ Stairs Lower", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_STAIRS_PAST_MUD_WALL] = Region("Dodongos Cavern MQ Stairs Past Mud Wall", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_STAIRS_UPPER] = Region("Dodongos Cavern MQ Stairs Upper", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_STAIRS_PAST_BIG_SKULLTULAS] = Region("Dodongos Cavern MQ Past Big Skulltulas", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_DODONGO_ROOM] = Region("Dodongos Cavern MQ Dodongo Room", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_TORCH_PUZZLE_LOWER] = Region("Dodongos Cavern MQ Torch Puzzle Lower", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_BIG_BLOCK_ROOM] = Region("Dodongos Cavern MQ Torch Puzzle Lower", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_LARVAE_ROOM] = Region("Dodongos Cavern MQ Larvae Room", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_UPPER_LIZALFOS] = Region("Dodongos Cavern MQ Before Upper Lizalfos", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_TWO_FIRES_ROOM] = Region("Dodongos Cavern MQ Before Upper Lizalfos", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_TORCH_PUZZLE_UPPER] = Region("Dodongos Cavern MQ Torch Puzzle Upper", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_LOWER_RIGHT_SIDE] = Region("Dodongos Cavern MQ Lower Right Side", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_LOWER_LIZALFOS] = Region("Dodongos Cavern MQ Lower Lizalfos", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_POES_ROOM] = Region("Dodongos Cavern MQ Poes Room", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_MAD_SCRUB_ROOM] = Region("Dodongos Cavern Mad Scrub Room", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_BEHIND_MOUTH] = Region("Dodongos Cavern MQ Behind Mouth", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_BACK_BEHIND_FIRE] = Region("Dodongos Cavern MQ Back Behind Fire", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_BACK_SWITCH_GRAVE] = Region("Dodongos Cavern MQ BossArea", SCENE_DODONGOS_CAVERN, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {
        //Events
        EventAccess(&logic->FairyPot, []{return true;}),
    }, {
        //Locations
...
#pragma endregion
    ...
    // Boss Room
    areaTable[RR_DODONGOS_CAVERN_BOSS_ENTRYWAY] = Region("Dodongos Cavern Boss Entryway", SCENE_DODONGOS_CAVERN_BOSS, {RA_DODONGOS_CAVERN}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        // Exits
    ...
    areaTable[RR_DODONGOS_CAVERN_BOSS_ROOM] = Region("Dodongos Cavern Boss Room", SCENE_DODONGOS_CAVERN_BOSS, {}, NO_DAY_NIGHT_CYCLE, {
        // Events
