...
#pragma region MQ
    ...
    areaTable[RR_FOREST_TEMPLE_MQ_NW_COURTYARD] = Region("Forest Temple MQ NW Courtyard", SCENE_FOREST_TEMPLE, {}, {
        ...
        //Exits
        ENTRANCE(RR_FOREST_TEMPLE_MQ_NE_COURTYARD,       (((logic->CanUse(RG_IRON_BOOTS) || logic->CanUse(RG_LONGSHOT) || (ctx->GetTrickOption(RT_FOREST_WELL_SWIM) && logic->CanUse(RG_HOOKSHOT))) && logic->HasItem(RG_BRONZE_SCALE)) || logic->HasItem(RG_GOLDEN_SCALE)) && logic->WaterTimer() >= 16),
        ENTRANCE(RR_FOREST_TEMPLE_MQ_NORTH_PASSAGE,      logic->CanUse(RG_FIRE_ARROWS)), // temp flag, can't be event
    ...
    areaTable[RR_FOREST_TEMPLE_MQ_NORTH_PASSAGE] = Region("Forest Temple MQ North Passage", SCENE_FOREST_TEMPLE, {}, {}, {
        ENTRANCE(RR_FOREST_TEMPLE_MQ_NW_COURTYARD,         logic->HasFireSourceWithTorch()),
