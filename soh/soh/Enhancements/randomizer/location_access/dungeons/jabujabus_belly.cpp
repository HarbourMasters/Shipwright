...
#pragma region MQ
    ...
    areaTable[RR_JABU_JABUS_BELLY_MQ_BEGINNING] = Region("Jabu Jabus Belly MQ Beginning", SCENE_JABU_JABU, {
        ...
        LOCATION(RC_MQ_JABU_JABU_WONDER_ENTRANCE_LEFT_COW,     logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_JABU_JABU_WONDER_ENTRANCE_RIGHT_COW,    logic->CanUse(RG_FAIRY_SLINGSHOT)),
    }, {
        //Exits
        ENTRANCE(RR_JABU_JABUS_BELLY_ENTRYWAY,     true),
    ...
    areaTable[RR_JABU_JABUS_BELLY_MQ_LIFT_ROOM] = Region("Jabu Jabus Belly MQ Lift Room", SCENE_JABU_JABU, {
        ...
        LOCATION(RC_MQ_JABU_JABU_WONDER_ELEVATOR_COW,             logic->CanUse(RG_FAIRY_SLINGSHOT) && (logic->HasItem(RG_SILVER_SCALE) || logic->CanUse(RG_IRON_BOOTS))),
    }, {
        //Exits
    ...
    areaTable[RR_JABU_JABUS_BELLY_MQ_HOLES_BASEMENT] = Region("Jabu Jabus Belly MQ Holes Basement", SCENE_JABU_JABU, {}, {
        ...
        LOCATION(RC_MQ_JABU_JABU_WONDER_BASEMENT_RIGHT_COW_1,         logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_JABU_JABU_WONDER_BASEMENT_RIGHT_COW_2,         logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_JABU_JABU_WONDER_BASEMENT_RIGHT_COW_3,         logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_JABU_JABU_WONDER_BASEMENT_LEFT_COW_1,          logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_JABU_JABU_WONDER_BASEMENT_LEFT_COW_2,          logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_JABU_JABU_WONDER_BASEMENT_LEFT_COW_3,          logic->CanUse(RG_FAIRY_SLINGSHOT)),
    }, {
        //Exits
    ...
    areaTable[RR_JABU_JABUS_BELLY_MQ_FORK_NORTH_EAST] = Region("Jabu Jabus Belly MQ Fork North East", SCENE_JABU_JABU, {}, {
        ...
        LOCATION(RC_MQ_JABU_JABU_WONDER_FALLING_LIKE_LIKES_COW_RIGHT_1, logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_JABU_JABU_WONDER_FALLING_LIKE_LIKES_COW_RIGHT_2, logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_JABU_JABU_WONDER_FALLING_LIKE_LIKES_COW_RIGHT_3, logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_JABU_JABU_WONDER_FALLING_LIKE_LIKES_COW_LEFT_1,  logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_JABU_JABU_WONDER_FALLING_LIKE_LIKES_COW_LEFT_2,  logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_JABU_JABU_WONDER_FALLING_LIKE_LIKES_COW_LEFT_3,  logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_MQ_JABU_JABU_WONDER_FALLING_LIKE_LIKES_EXPLOSION_1, logic->HasExplosives()),
        LOCATION(RC_MQ_JABU_JABU_WONDER_FALLING_LIKE_LIKES_EXPLOSION_2, logic->HasExplosives()),
        LOCATION(RC_MQ_JABU_JABU_WONDER_FALLING_LIKE_LIKES_EXPLOSION_3, logic->HasExplosives()),
    }, {
        //Exits
