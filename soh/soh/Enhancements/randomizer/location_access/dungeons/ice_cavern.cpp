...
void RegionTable_Init_IceCavern() {
    // clang-format off
    // Vanilla/MQ Decider
    areaTable[RR_ICE_CAVERN_ENTRYWAY] = Region("Ice Cavern Entryway", SCENE_ICE_CAVERN, {RA_ICE_CAVERN}, {}, {}, {
        //Exits
...
#pragma region Vanilla
    ...
    areaTable[RR_ICE_CAVERN_BEGINNING] = Region("Ice Cavern Beginning", SCENE_ICE_CAVERN, {RA_ICE_CAVERN}, {}, {
        //Locations
    ...
    areaTable[RR_ICE_CAVERN_MAIN] = Region("Ice Cavern", SCENE_ICE_CAVERN, {RA_ICE_CAVERN}, {
        //Events
...
#pragma region MQ
    ...
    areaTable[RR_ICE_CAVERN_MQ_BEGINNING] = Region("Ice Cavern MQ Beginning", SCENE_ICE_CAVERN, {RA_ICE_CAVERN}, {}, {
        //Locations
    ...
    areaTable[RR_ICE_CAVERN_MQ_HUB] = Region("Ice Cavern MQ Hub", SCENE_ICE_CAVERN, {RA_ICE_CAVERN}, {
        //Events
    ...
    areaTable[RR_ICE_CAVERN_MQ_MAP_ROOM] = Region("Ice Cavern MQ Map Room", SCENE_ICE_CAVERN, {RA_ICE_CAVERN}, {
        //Events
    ...
    areaTable[RR_ICE_CAVERN_MQ_SCARECROW_ROOM] = Region("Ice Cavern MQ Scarecrow Room", SCENE_ICE_CAVERN, {RA_ICE_CAVERN}, {}, {
        //Locations
    ...
    areaTable[RR_ICE_CAVERN_MQ_WEST_CORRIDOR] = Region("Ice Cavern MQ West Corridor", SCENE_ICE_CAVERN, {RA_ICE_CAVERN}, {}, {
        //Locations
    ...
    areaTable[RR_ICE_CAVERN_MQ_STALFOS_ROOM] = Region("Ice Cavern MQ Stalfos Room", SCENE_ICE_CAVERN, {RA_ICE_CAVERN}, {}, {
        //Locations
    ...
    areaTable[RR_ICE_CAVERN_MQ_COMPASS_ROOM] = Region("Ice Cavern MQ Compass Room", SCENE_ICE_CAVERN, {RA_ICE_CAVERN}, {
        //Events
