...
void RegionTable_Init_GoronCity() {
    // clang-format off
    areaTable[RR_GORON_CITY] = Region("Goron City", SCENE_GORON_CITY, {RA_GORON_CITY}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_GC_MEDIGORON] = Region("GC Medigoron", SCENE_GORON_CITY, {RA_GORON_CITY}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_GC_WOODS_WARP] = Region("GC Woods Warp", SCENE_GORON_CITY, {RA_GORON_CITY}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_GC_DARUNIAS_CHAMBER] = Region("GC Darunias Chamber", SCENE_GORON_CITY, {RA_GORON_CITY}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_GC_GROTTO_PLATFORM] = Region("GC Grotto Platform", SCENE_GORON_CITY, {RA_GORON_CITY}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
    ...
    areaTable[RR_GC_SHOP] = Region("GC Shop", SCENE_GORON_SHOP, {}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_GC_GROTTO] = Region("GC Grotto", SCENE_GROTTOS, {}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
