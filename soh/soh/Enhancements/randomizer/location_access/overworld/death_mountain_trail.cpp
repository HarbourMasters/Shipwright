...
void RegionTable_Init_DeathMountainTrail() {
    // clang-format off
    areaTable[RR_DEATH_MOUNTAIN_TRAIL] = Region("Death Mountain", SCENE_DEATH_MOUNTAIN_TRAIL, {RA_DEATH_MOUNTAIN_TRAIL}, {
        //Events
    ...
    areaTable[RR_DEATH_MOUNTAIN_SUMMIT] = Region("Death Mountain Summit", SCENE_DEATH_MOUNTAIN_TRAIL, {RA_DEATH_MOUNTAIN_TRAIL}, {
        //Events
    ...
    areaTable[RR_DMT_OWL_FLIGHT] = Region("DMT Owl Flight", SCENE_DEATH_MOUNTAIN_TRAIL, {RA_DEATH_MOUNTAIN_TRAIL}, {}, {}, {
        //Exits
