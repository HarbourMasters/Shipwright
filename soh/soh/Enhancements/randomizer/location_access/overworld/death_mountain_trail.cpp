...
void RegionTable_Init_DeathMountainTrail() {
    ...
    areaTable[RR_DEATH_MOUNTAIN_TRAIL] = Region("Death Mountain", SCENE_DEATH_MOUNTAIN_TRAIL, {
        //Events
        EVENT_ACCESS(LOGIC_BEAN_PLANT_FAIRY, logic->IsChild && logic->CanUse(RG_MAGIC_BEAN) && logic->CanUse(RG_SONG_OF_STORMS) && (logic->HasExplosives() || logic->HasItem(RG_GORONS_BRACELET))),
    }, {
        //Locations
    ...
    areaTable[RR_DEATH_MOUNTAIN_SUMMIT] = Region("Death Mountain Summit", SCENE_DEATH_MOUNTAIN_TRAIL, {
        ...
        EVENT_ACCESS(LOGIC_BUG_ROCK,          logic->IsChild),
    }, {
        //Locations
