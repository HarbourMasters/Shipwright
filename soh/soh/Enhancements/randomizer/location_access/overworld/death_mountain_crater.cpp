...
void RegionTable_Init_DeathMountainCrater() {
    // clang-format off
    areaTable[RR_DMC_UPPER_NEARBY] = Region("DMC Upper Nearby", SCENE_DEATH_MOUNTAIN_CRATER, {RA_DEATH_MOUNTAIN_CRATER}, {}, {}, {
        //Exits
    ...
    areaTable[RR_DMC_UPPER_LOCAL] = Region("DMC Upper Local", SCENE_DEATH_MOUNTAIN_CRATER, {RA_DEATH_MOUNTAIN_CRATER}, {
        //Events
    ...
    areaTable[RR_DMC_LADDER_AREA_NEARBY] = Region("DMC Ladder Region Nearby", SCENE_DEATH_MOUNTAIN_CRATER, {RA_DEATH_MOUNTAIN_CRATER}, {}, {
        //Locations
    ...
    areaTable[RR_DMC_LOWER_NEARBY] = Region("DMC Lower Nearby", SCENE_DEATH_MOUNTAIN_CRATER, {RA_DEATH_MOUNTAIN_CRATER}, {}, {
        // Locations
    ...
    areaTable[RR_DMC_LOWER_LOCAL] = Region("DMC Lower Local", SCENE_DEATH_MOUNTAIN_CRATER, {RA_DEATH_MOUNTAIN_CRATER}, {}, {}, {
        //Exits
    ...
    areaTable[RR_DMC_CENTRAL_NEARBY] = Region("DMC Central Nearby", SCENE_DEATH_MOUNTAIN_CRATER, {RA_DEATH_MOUNTAIN_CRATER}, {}, {
        //Locations
    ...
    areaTable[RR_DMC_CENTRAL_LOCAL] = Region("DMC Central Local", SCENE_DEATH_MOUNTAIN_CRATER, {RA_DEATH_MOUNTAIN_CRATER}, {
        //Events
    ...
    areaTable[RR_DMC_DISTANT_PLATFORM] = Region("DMC Distant Platform", SCENE_DEATH_MOUNTAIN_CRATER, {RA_DEATH_MOUNTAIN_CRATER}, {}, {
        //Locations
