...
void RegionTable_Init_SacredForestMeadow() {
    // clang-format off
    areaTable[RR_SFM_ENTRYWAY] = Region("SFM Entryway", SCENE_SACRED_FOREST_MEADOW, {RA_SACRED_FOREST_MEADOW}, {}, {}, {
        //Exits
    ...
    areaTable[RR_SACRED_FOREST_MEADOW] = Region("Sacred Forest Meadow", SCENE_SACRED_FOREST_MEADOW, {RA_SACRED_FOREST_MEADOW}, {
        //Events
