...
void RegionTable_Init_Market() {
    // clang-format off
    areaTable[RR_MARKET_ENTRANCE] = Region("Market Entrance", SCENE_MARKET_ENTRANCE_DAY, {RA_THE_MARKET}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
    ...
    areaTable[RR_THE_MARKET] = Region("Market", SCENE_MARKET_DAY, {RA_THE_MARKET}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_MARKET_BACK_ALLEY] = Region("Market Back Alley", SCENE_BACK_ALLEY_DAY, {RA_THE_MARKET}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
        Entrance(RR_THE_MARKET,                []{return true;}),
    ...
    areaTable[RR_MARKET_GUARD_HOUSE] = Region("Market Guard House", SCENE_MARKET_GUARD_HOUSE, {}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_MARKET_BAZAAR] = Region("Market Bazaar", SCENE_BAZAAR, {}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_MARKET_MASK_SHOP] = Region("Market Mask Shop", SCENE_HAPPY_MASK_SHOP, {}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_MARKET_SHOOTING_GALLERY] = Region("Market Shooting Gallery", SCENE_SHOOTING_GALLERY, {}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_MARKET_BOMBCHU_BOWLING] = Region("Market Bombchu Bowling", SCENE_BOMBCHU_BOWLING_ALLEY, {}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_MARKET_POTION_SHOP] = Region("Market Potion Shop", SCENE_POTION_SHOP_MARKET, {}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_MARKET_TREASURE_CHEST_GAME] = Region("Market Treasure Chest Game", SCENE_TREASURE_BOX_SHOP, {}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_MARKET_BOMBCHU_SHOP] = Region("Market Bombchu Shop", SCENE_BOMBCHU_SHOP, {}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_MARKET_DOG_LADY_HOUSE] = Region("Market Dog Lady House", SCENE_DOG_LADY_HOUSE, {}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_MARKET_MAN_IN_GREEN_HOUSE] = Region("Market Man in Green House", SCENE_BACK_ALLEY_HOUSE, {}, NO_DAY_NIGHT_CYCLE, {}, {
        // Locations
