...
void RegionTable_Init_HyruleField() {
    ...
    areaTable[RR_HYRULE_FIELD] = Region("Hyrule Field", SCENE_HYRULE_FIELD, {
        ...
        EventAccess(LOGIC_BORROW_RIGHT_MASKS, []{return logic->IsChild && logic->Get(LOGIC_BORROW_BUNNY_HOOD) && logic->HasItem(RG_KOKIRI_EMERALD) && logic->HasItem(RG_GORON_RUBY) && logic->HasItem(RG_ZORA_SAPPHIRE) && logic->HasItem(RG_CHILD_WALLET);}, true),
    }, {
        //Locations
        ...
        LOCATION_NNL(RC_HF_NEAR_LLR_TREE,          logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_NEAR_LH_TREE,           logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_CHILD_NEAR_GV_TREE,     logic->IsChild && logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_ADULT_NEAR_GV_TREE,     logic->IsAdult && logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_NEAR_ZR_TREE,           logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_NEAR_KAK_TREE,          logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_NEAR_KAK_SMALL_TREE,    logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_NEAR_MARKET_TREE_1,     logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_NEAR_MARKET_TREE_2,     logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_NEAR_MARKET_TREE_3,     logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_NORTHWEST_TREE_1,       logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_NORTHWEST_TREE_2,       logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_NORTHWEST_TREE_3,       logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_NORTHWEST_TREE_4,       logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_NORTHWEST_TREE_5,       logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_NORTHWEST_TREE_6,       logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_EAST_TREE_1,            logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_EAST_TREE_2,            logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_EAST_TREE_3,            logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_EAST_TREE_4,            logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_EAST_TREE_5,            logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_EAST_TREE_6,            logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_SOUTHEAST_TREE_1,       logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_SOUTHEAST_TREE_2,       logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_SOUTHEAST_TREE_3,       logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_SOUTHEAST_TREE_4,       logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_SOUTHEAST_TREE_5,       logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_SOUTHEAST_TREE_6,       logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_SOUTHEAST_TREE_7,       logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_SOUTHEAST_TREE_8,       logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_SOUTHEAST_TREE_9,       logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_SOUTHEAST_TREE_10,      logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_SOUTHEAST_TREE_11,      logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_SOUTHEAST_TREE_12,      logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_SOUTHEAST_TREE_13,      logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_SOUTHEAST_TREE_14,      logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_SOUTHEAST_TREE_15,      logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_SOUTHEAST_TREE_16,      logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_SOUTHEAST_TREE_17,      logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_SOUTHEAST_TREE_18,      logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_SOUTHEAST_TREE_19,      logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_CHILD_SOUTHEAST_TREE_1, logic->IsChild && logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_CHILD_SOUTHEAST_TREE_2, logic->IsChild && logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_CHILD_SOUTHEAST_TREE_3, logic->IsChild && logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_CHILD_SOUTHEAST_TREE_4, logic->IsChild && logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_CHILD_SOUTHEAST_TREE_5, logic->IsChild && logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_CHILD_SOUTHEAST_TREE_6, logic->IsChild && logic->CanBonkTrees()),
        LOCATION_NNL(RC_HF_TEKTITE_GROTTO_TREE,    logic->CanBonkTrees()),
