...
void RegionTable_Init_HyruleField() {
    // clang-format off
    areaTable[RR_HYRULE_FIELD] = Region("Hyrule Field", SCENE_HYRULE_FIELD, {RA_HYRULE_FIELD}, DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_HF_SOUTHEAST_GROTTO] = Region("HF Southeast Grotto", SCENE_GROTTOS, {}, NO_DAY_NIGHT_CYCLE, grottoEvents, {
        //Locations
    ...
    areaTable[RR_HF_OPEN_GROTTO] = Region("HF Open Grotto", SCENE_GROTTOS, {}, NO_DAY_NIGHT_CYCLE, grottoEvents, {
        //Locations
    ...
    areaTable[RR_HF_INSIDE_FENCE_GROTTO] = Region("HF Inside Fence Grotto", SCENE_GROTTOS, {}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_HF_COW_GROTTO] = Region("HF Cow Grotto", SCENE_GROTTOS, {}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
        Entrance(RR_HYRULE_FIELD,              []{return true;}),
        Entrance(RR_HF_COW_GROTTO_BEHIND_WEBS, []{return logic->HasFireSource();}),
    });

    areaTable[RR_HF_COW_GROTTO_BEHIND_WEBS] = Region("HF Cow Grotto Behind Webs", SCENE_GROTTOS, {}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_HF_NEAR_MARKET_GROTTO] = Region("HF Near Market Grotto", SCENE_GROTTOS, {}, NO_DAY_NIGHT_CYCLE, grottoEvents, {
        //Locations
    ...
    areaTable[RR_HF_FAIRY_GROTTO] = Region("HF Fairy Grotto", SCENE_GROTTOS, {}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_HF_NEAR_KAK_GROTTO] = Region("HF Near Kak Grotto", SCENE_GROTTOS, {}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_HF_TEKTITE_GROTTO] = Region("HF Tektite Grotto", SCENE_GROTTOS, {}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
