...
void RegionTable_Init_HauntedWasteland() {
    // clang-format off
    areaTable[RR_WASTELAND_NEAR_FORTRESS] = Region("Wasteland Near Fortress", SCENE_HAUNTED_WASTELAND, {RA_HAUNTED_WASTELAND}, NO_DAY_NIGHT_CYCLE, {},
    {
        //Locations
    ...
    areaTable[RR_HAUNTED_WASTELAND] = Region("Haunted Wasteland", SCENE_HAUNTED_WASTELAND, {RA_HAUNTED_WASTELAND}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_WASTELAND_NEAR_COLOSSUS] = Region("Wasteland Near Colossus", SCENE_HAUNTED_WASTELAND, {RA_HAUNTED_WASTELAND}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
