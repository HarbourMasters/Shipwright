...
void RegionTable_Init_HauntedWasteland() {
    ...
    areaTable[RR_HAUNTED_WASTELAND] = Region("Haunted Wasteland", SCENE_HAUNTED_WASTELAND, {
        ...
        LOCATION(RC_WASTELAND_GS,               logic->CanGetEnemyDrop(RE_GOLD_SKULLTULA, ED_BOOMERANG) || (logic->IsAdult && logic->CanGroundJumpJumpSlash())), // need to jumpslash immediately with two handed weapons
