...
void RegionTable_Init_LakeHylia() {
    // clang-format off
    areaTable[RR_LAKE_HYLIA] = Region("Lake Hylia", SCENE_LAKE_HYLIA, {RA_LAKE_HYLIA}, {
        //Events
    ...
    areaTable[RR_LH_FISHING_ISLAND] = Region("LH Fishing Island", SCENE_LAKE_HYLIA, {RA_LAKE_HYLIA}, {}, {}, {
        //Exits
    ...
    areaTable[RR_LH_OWL_FLIGHT] = Region("LH Owl Flight", SCENE_LAKE_HYLIA, {RA_LAKE_HYLIA}, {}, {}, {
        //Exits
