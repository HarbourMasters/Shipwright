...
void RegionTable_Init_Kakariko() {
    // clang-format off
    areaTable[RR_KAKARIKO_VILLAGE] = Region("Kakariko Village", SCENE_KAKARIKO_VILLAGE, {RA_KAKARIKO_VILLAGE}, {
        //Events
    ...
    areaTable[RR_KAK_IMPAS_LEDGE] = Region("Kak Impas Ledge", SCENE_KAKARIKO_VILLAGE, {RA_KAKARIKO_VILLAGE}, {}, {}, {
        //Exits
        Entrance(RR_KAK_IMPAS_HOUSE_BACK, []{return true;}),
        Entrance(RR_KAKARIKO_VILLAGE,     []{return true;}),
    });

    areaTable[RR_KAK_IMPAS_ROOFTOP] = Region("Kak Impas Rooftop", SCENE_KAKARIKO_VILLAGE, {RA_KAKARIKO_VILLAGE}, {}, {
        //Locations
    ...
    areaTable[RR_KAK_WATCHTOWER] = Region("Kak Watchtower", SCENE_KAKARIKO_VILLAGE, {RA_KAKARIKO_VILLAGE}, {}, {
        //Locations
    ...
    areaTable[RR_KAK_ROOFTOP] = Region("Kak Rooftop", SCENE_KAKARIKO_VILLAGE, {RA_KAKARIKO_VILLAGE}, {}, {
        //Locations
    ...
    areaTable[RR_KAK_BACKYARD] = Region("Kak Backyard", SCENE_KAKARIKO_VILLAGE, {RA_KAKARIKO_VILLAGE}, {}, {
        //Locations
    ...
    areaTable[RR_KAK_BEHIND_GATE] = Region("Kak Behind Gate", SCENE_KAKARIKO_VILLAGE, {RA_KAKARIKO_VILLAGE}, {}, {}, {
        //Exits
    ...
    areaTable[RR_KAK_WELL] = Region("Kak Well", SCENE_KAKARIKO_VILLAGE, {RA_KAKARIKO_VILLAGE}, {}, {}, {
        //Exits
