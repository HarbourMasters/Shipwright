...
void RegionTable_Init_Kakariko() {
    areaTable[RR_KAKARIKO_VILLAGE] = Region("Kakariko Village", "Kakariko Village", {RA_KAKARIKO_VILLAGE}, NO_DAY_NIGHT_CYCLE, {
        ...
        LOCATION(RC_KAK_NEAR_OPEN_GROTTO_ADULT_CRATE_1,    true),
        LOCATION(RC_KAK_NEAR_OPEN_GROTTO_ADULT_CRATE_2,    true),
        LOCATION(RC_KAK_NEAR_OPEN_GROTTO_ADULT_CRATE_3,    true),
        LOCATION(RC_KAK_NEAR_OPEN_GROTTO_ADULT_CRATE_4,    true),
        LOCATION(RC_KAK_NEAR_POTION_SHOP_ADULT_CRATE,      true),
        LOCATION(RC_KAK_NEAR_SHOOTING_GALLERY_ADULT_CRATE, true),
        LOCATION(RC_KAK_NEAR_BOARDING_HOUSE_ADULT_CRATE_1, true),
        LOCATION(RC_KAK_NEAR_BOARDING_HOUSE_ADULT_CRATE_2, true),
        LOCATION(RC_KAK_NEAR_IMPAS_HOUSE_ADULT_CRATE_1,    true),
        LOCATION(RC_KAK_NEAR_IMPAS_HOUSE_ADULT_CRATE_2,    true),
        LOCATION(RC_KAK_NEAR_BAZAAR_ADULT_CRATE_1,         true),
        LOCATION(RC_KAK_NEAR_BAZAAR_ADULT_CRATE_2,         true),
        LOCATION(RC_KAK_BEHIND_GS_HOUSE_ADULT_CRATE,       true),
        LOCATION(RC_KAK_NEAR_GY_CHILD_CRATE,               true),
        LOCATION(RC_KAK_NEAR_WINDMILL_CHILD_CRATE,         true),
        LOCATION(RC_KAK_NEAR_FENCE_CHILD_CRATE,            true),
        LOCATION(RC_KAK_NEAR_BOARDING_HOUSE_CHILD_CRATE,   true),
        LOCATION(RC_KAK_NEAR_BAZAAR_CHILD_CRATE,           true),
    }, {
        //Exits
