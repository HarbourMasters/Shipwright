...
void RegionTable_Init_KokiriForest() {
    ...
    areaTable[RR_KOKIRI_FOREST] = Region("Kokiri Forest", SCENE_KOKIRI_FOREST, {
        ...
        LOCATION(RC_KF_BEAN_RUPEE_1,                          logic->IsAdult && (logic->BeanPlanted(LOGIC_PLANT_KOKIRI_FOREST_BEAN) || (logic->CanUse(RG_HOVER_BOOTS) && logic->HasItem(RG_ROLL)) || logic->CanUse(RG_BOOMERANG))),
        LOCATION(RC_KF_BEAN_RUPEE_2,                          logic->IsAdult && (logic->BeanPlanted(LOGIC_PLANT_KOKIRI_FOREST_BEAN) || (logic->CanUse(RG_HOVER_BOOTS) && logic->HasItem(RG_ROLL)) || logic->CanUse(RG_BOOMERANG))),
        LOCATION(RC_KF_BEAN_RUPEE_3,                          logic->IsAdult && (logic->BeanPlanted(LOGIC_PLANT_KOKIRI_FOREST_BEAN) || (logic->CanUse(RG_HOVER_BOOTS) && logic->HasItem(RG_ROLL)) || logic->CanUse(RG_BOOMERANG))),
        LOCATION(RC_KF_BEAN_RUPEE_4,                          logic->IsAdult && (logic->BeanPlanted(LOGIC_PLANT_KOKIRI_FOREST_BEAN) || (logic->CanUse(RG_HOVER_BOOTS) && logic->HasItem(RG_ROLL)) || logic->CanUse(RG_BOOMERANG))),
        LOCATION(RC_KF_BEAN_RUPEE_5,                          logic->IsAdult && (logic->BeanPlanted(LOGIC_PLANT_KOKIRI_FOREST_BEAN) || (logic->CanUse(RG_HOVER_BOOTS) && logic->HasItem(RG_ROLL)) || logic->CanUse(RG_BOOMERANG))),
        LOCATION(RC_KF_BEAN_RUPEE_6,                          logic->IsAdult && (logic->BeanPlanted(LOGIC_PLANT_KOKIRI_FOREST_BEAN) || (logic->CanUse(RG_HOVER_BOOTS) && logic->HasItem(RG_ROLL)) || logic->CanUse(RG_BOOMERANG))),
        LOCATION(RC_KF_BEAN_RED_RUPEE,                        logic->IsAdult && (logic->BeanPlanted(LOGIC_PLANT_KOKIRI_FOREST_BEAN) || (logic->CanUse(RG_HOVER_BOOTS) && logic->HasItem(RG_ROLL)) || logic->CanUse(RG_BOOMERANG))),
        ...
        LOCATION(RC_KF_CIRCLE_ROCK_1,                         logic->CanBreakRocks()),
        LOCATION(RC_KF_CIRCLE_ROCK_2,                         logic->CanBreakRocks()),
        LOCATION(RC_KF_CIRCLE_ROCK_3,                         logic->CanBreakRocks()),
        LOCATION(RC_KF_CIRCLE_ROCK_4,                         logic->CanBreakRocks()),
        LOCATION(RC_KF_CIRCLE_ROCK_5,                         logic->CanBreakRocks()),
        LOCATION(RC_KF_CIRCLE_ROCK_6,                         logic->CanBreakRocks()),
        LOCATION(RC_KF_CIRCLE_ROCK_7,                         logic->CanBreakRocks()),
        LOCATION(RC_KF_CIRCLE_ROCK_8,                         logic->CanBreakRocks()),
        LOCATION(RC_KF_ROCK_BY_SARIAS_HOUSE,                  logic->IsChild && logic->CanBreakRocks()),
        LOCATION(RC_KF_ROCK_BEHIND_SARIAS_HOUSE,              logic->IsChild && logic->CanBreakRocks()),
        LOCATION(RC_KF_ROCK_BY_MIDOS_HOUSE,                   logic->IsChild && logic->CanBreakRocks()),
        LOCATION(RC_KF_ROCK_BY_KNOW_IT_ALLS_HOUSE,            logic->IsChild && logic->CanBreakRocks()),
    ...
    areaTable[RR_KF_OUTSIDE_LOST_WOODS] = Region("KF Outside Lost Woods", SCENE_KOKIRI_FOREST, {}, {
        ...
        ENTRANCE(RR_KF_RUPEE_ALCOVE,       logic->IsAdult && (logic->BeanPlanted(LOGIC_PLANT_KOKIRI_FOREST_BEAN) || logic->CanUse(RG_HOVER_BOOTS))),
