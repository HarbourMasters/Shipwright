...
void RegionTable_Init_KokiriForest() {
    ...
    areaTable[RR_KOKIRI_FOREST] = Region("Kokiri Forest", SCENE_KOKIRI_FOREST, {
        ...
        LOCATION(RC_KF_WONDER_ITEM_TRAINING_1,      true),
        LOCATION(RC_KF_WONDER_ITEM_TRAINING_2,      true),
        LOCATION(RC_KF_WONDER_ITEM_TRAINING_3,      true),
        LOCATION(RC_KF_WONDER_ITEM_SHOP,            true),
        LOCATION(RC_KF_WONDER_ITEM_SIGN,            true),
        LOCATION(RC_KF_WONDER_ITEM_PLATFORMS_1,     true),
        LOCATION(RC_KF_WONDER_ITEM_PLATFORMS_2,     true),
        LOCATION(RC_KF_WONDER_ITEM_CRAWL_GRASS_1,   true),
        LOCATION(RC_KF_WONDER_ITEM_CRAWL_GRASS_2,   true),
