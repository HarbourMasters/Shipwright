...
void RegionTable_Init_ZoraRiver() {
    ...
    areaTable[RR_ZR_FRONT] = Region("ZR Front", SCENE_ZORAS_RIVER, {}, {
        //Locations
        LOCATION_NNL(RC_ZR_GS_TREE,  logic->IsChild && logic->CanKillEnemy(RE_GOLD_SKULLTULA, ED_CLOSE) && logic->CanBonkTrees()),
        ...
        LOCATION_NNL(RC_ZR_TREE,     logic->IsChild && logic->CanBonkTrees()),
    }, {
        //Exits
    ...
    areaTable[RR_ZORAS_RIVER] = Region("Zora River", SCENE_ZORAS_RIVER, {
        //Events
        EventAccess(LOGIC_GOSSIP_STONE_FAIRY, []{return logic->CallGossipFairy();}, true),
        ...
        EventAccess(LOGIC_BUG_SHRUB,         []{return logic->CanCutShrubs();}, true),
    }, {
        //Locations
        LOCATION_NNL(RC_ZR_MAGIC_BEAN_SALESMAN,                  logic->IsChild),
