...
void RegionTable_Init_DesertColossus() {
    ...
    areaTable[RR_DESERT_COLOSSUS] = Region("Desert Colossus", SCENE_DESERT_COLOSSUS, {
        ...
        LOCATION(RC_COLOSSUS_GOSSIP_STONE,            logic->CanUse(RG_FAIRY_BOW) || logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_COLOSSUS_WONDER_OASIS_TREE_1,     logic->CanUse(RG_FAIRY_BOW) || logic->CanUse(RG_FAIRY_SLINGSHOT)),
        LOCATION(RC_COLOSSUS_WONDER_OASIS_TREE_2,     logic->CanUse(RG_FAIRY_BOW) || logic->CanUse(RG_FAIRY_SLINGSHOT)),
