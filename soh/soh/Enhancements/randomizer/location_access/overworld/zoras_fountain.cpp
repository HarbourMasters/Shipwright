...
void RegionTable_Init_ZorasFountain() {
    ...
    areaTable[RR_ZORAS_FOUNTAIN] = Region("Zoras Fountain", SCENE_ZORAS_FOUNTAIN, {
        ...
        LOCATION(RC_ZF_WONDER_ROCK,                  	  logic->IsAdult && logic->ReachScarecrow(true, true)),
    }, {
        //Exits
        ...
        ENTRANCE(RR_ZF_ROCK,                   logic->IsAdult && logic->ReachScarecrow(true, true)),
        ...
        ENTRANCE(RR_ZF_HIDDEN_LEDGE,           logic->CanHover(true, true)),
        ENTRANCE(RR_ZF_LEDGE,                  logic->CanHover(true, true)),
    });
