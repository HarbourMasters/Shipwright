...
void RegionTable_Init_LostWoods() {
    // clang-format off
    areaTable[RR_LW_FOREST_EXIT] = Region("LW Forest Exit", SCENE_LOST_WOODS, {RA_THE_LOST_WOODS}, {}, {}, {
        //Exits
        Entrance(RR_KOKIRI_FOREST, []{return true;})
    });

    areaTable[RR_THE_LOST_WOODS] = Region("Lost Woods", SCENE_LOST_WOODS, {RA_THE_LOST_WOODS}, {
        //Events
    ...
    areaTable[RR_LW_BEYOND_MIDO] = Region("LW Beyond Mido", SCENE_LOST_WOODS, {RA_THE_LOST_WOODS}, {
        //Events
    ...
    areaTable[RR_LW_BRIDGE_FROM_FOREST] = Region("LW Bridge From Forest", SCENE_LOST_WOODS, {RA_THE_LOST_WOODS}, {}, {
        //Locations
    ...
    areaTable[RR_LW_BRIDGE] = Region("LW Bridge", SCENE_LOST_WOODS, {RA_THE_LOST_WOODS}, {}, {}, {
        //Exits
        Entrance(RR_KOKIRI_FOREST,  []{return true;}),
