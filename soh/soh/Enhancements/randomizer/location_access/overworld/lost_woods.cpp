...
void RegionTable_Init_LostWoods() {
    // clang-format off
    areaTable[RR_LW_FOREST_EXIT] = Region("LW Forest Exit", SCENE_LOST_WOODS, {RA_THE_LOST_WOODS}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
        Entrance(RR_KOKIRI_FOREST, []{return true;})
    });

    areaTable[RR_THE_LOST_WOODS] = Region("Lost Woods", SCENE_LOST_WOODS, {RA_THE_LOST_WOODS}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_LW_BEYOND_MIDO] = Region("LW Beyond Mido", SCENE_LOST_WOODS, {RA_THE_LOST_WOODS}, NO_DAY_NIGHT_CYCLE, {
        //Events
    ...
    areaTable[RR_LW_NEAR_SHORTCUTS_GROTTO] = Region("LW Near Shortcuts Grotto", SCENE_GROTTOS, {}, NO_DAY_NIGHT_CYCLE, grottoEvents, {
        //Locations
    ...
    areaTable[RR_DEKU_THEATER] = Region("Deku Theater", SCENE_GROTTOS, {}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_LW_SCRUBS_GROTTO] = Region("LW Scrubs Grotto", SCENE_GROTTOS, {}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_LW_BRIDGE_FROM_FOREST] = Region("LW Bridge From Forest", SCENE_LOST_WOODS, {RA_THE_LOST_WOODS}, NO_DAY_NIGHT_CYCLE, {}, {
        //Locations
    ...
    areaTable[RR_LW_BRIDGE] = Region("LW Bridge", SCENE_LOST_WOODS, {RA_THE_LOST_WOODS}, NO_DAY_NIGHT_CYCLE, {}, {}, {
        //Exits
        Entrance(RR_KOKIRI_FOREST,  []{return true;}),
