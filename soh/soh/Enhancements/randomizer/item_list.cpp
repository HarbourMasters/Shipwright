...
void Rando::StaticData::InitItemTable() {
    ...
    // Shop
    AddItem(RG_BUY_DEKU_NUTS_5,          ITEMTYPE_SHOP,          GI_NUTS_5_2,          LOGIC_NUTS,                   RHT_BUY_DEKU_NUTS_5,        ITEM_NUTS_5,           OBJECT_GI_NUTS,          GID_NUTS,             0x34,                        0x0C, CHEST_ANIM_SHORT, ITEM_CATEGORY_JUNK,   MOD_NONE, 15);
    ...
    AddItem(RG_BUY_DEKU_NUTS_10,         ITEMTYPE_SHOP,          GI_NUTS_10,           LOGIC_NUTS,                   RHT_BUY_DEKU_NUTS_10,       ITEM_NUTS_10,          OBJECT_GI_NUTS,          GID_NUTS,             0x34,                        0x0C, CHEST_ANIM_SHORT, ITEM_CATEGORY_JUNK,   MOD_NONE, 30);
    AddItem(RG_BUY_DEKU_STICK_1,         ITEMTYPE_SHOP,          GI_STICKS_1,          LOGIC_STICKS,                 RHT_BUY_DEKU_STICK_1,       ITEM_STICK,            OBJECT_GI_STICK,         GID_STICK,            0x37,                        0x0D, CHEST_ANIM_SHORT, ITEM_CATEGORY_JUNK,   MOD_NONE, 10);
