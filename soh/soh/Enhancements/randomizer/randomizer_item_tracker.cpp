...
std::unordered_map<uint32_t, ItemTrackerItem> actualItemTrackerItemMap = {
    ...
    { ITEM_RUPEE_GREEN,     ITEM_TRACKER_ITEM(ITEM_RUPEE_GREEN, 0, DrawItem) },
    { ITEM_RUPEE_BLUE,      ITEM_TRACKER_ITEM(ITEM_RUPEE_BLUE, 0, DrawItem) },
    { ITEM_RUPEE_RED,       ITEM_TRACKER_ITEM(ITEM_RUPEE_RED, 0, DrawItem) },
    { ITEM_RUPEE_PURPLE,    ITEM_TRACKER_ITEM(ITEM_RUPEE_PURPLE, 0, DrawItem) },
    { ITEM_RUPEE_GOLD,      ITEM_TRACKER_ITEM(ITEM_RUPEE_GOLD, 0, DrawItem) },

    { ITEM_STICK,           ITEM_TRACKER_ITEM(ITEM_STICK, 0, DrawItem) },
    { ITEM_NUT,             ITEM_TRACKER_ITEM(ITEM_NUT, 0, DrawItem) },
    { ITEM_HEART,           ITEM_TRACKER_ITEM(ITEM_HEART, 0, DrawItem) },
    { ITEM_BOMB,            ITEM_TRACKER_ITEM(ITEM_BOMB, 0, DrawItem) },
    { ITEM_BOMBCHU,         ITEM_TRACKER_ITEM(ITEM_BOMBCHU, 0, DrawItem) },
    
    { ITEM_KEY_SMALL,       ITEM_TRACKER_ITEM(ITEM_KEY_SMALL, 0, DrawItem) },
    { ITEM_KEY_BOSS,        ITEM_TRACKER_ITEM(ITEM_KEY_BOSS, 0, DrawItem) },
    { ITEM_DUNGEON_MAP,     ITEM_TRACKER_ITEM(ITEM_DUNGEON_MAP, 0, DrawItem) },
    { ITEM_COMPASS,         ITEM_TRACKER_ITEM(ITEM_COMPASS, 0, DrawItem) },
};
...
void DrawItem(ItemTrackerItem item) {
    ...
    if (IsGameRunning() && (hasItem && item.id != actualItemId && actualItemTrackerItemMap.find(actualItemId) != actualItemTrackerItemMap.end())) {
