...
void DrawEquip(ItemTrackerItem item) {
    ...
    int iconSize = CVarGetInteger(CVAR_TRACKER_ITEM("IconSize"), 36);
    ImGui::Image(ShipDK::Context::GetInstance()->GetWindow()->GetGui()->GetTextureByName(hasEquip && IsValidSaveFile() ? item.name : item.nameFaded),
...
void DrawQuest(ItemTrackerItem item) {
    ...
    int iconSize = CVarGetInteger(CVAR_TRACKER_ITEM("IconSize"), 36);
    ImGui::BeginGroup();
    ImGui::Image(ShipDK::Context::GetInstance()->GetWindow()->GetGui()->GetTextureByName(hasQuestItem && IsValidSaveFile() ? item.name : item.nameFaded),
                 ImVec2(iconSize, iconSize), ImVec2(0, 0), ImVec2(1, 1));
...
void DrawItem(ItemTrackerItem item) {
    ...
    ImGui::Image(ShipDK::Context::GetInstance()->GetWindow()->GetGui()->GetTextureByName(hasItem && IsValidSaveFile() ? item.name : item.nameFaded),
                 ImVec2(iconSize, iconSize), ImVec2(0, 0), ImVec2(1, 1));
...
void DrawDungeonItem(ItemTrackerItem item) {
    ...
    if (itemId == ITEM_KEY_SMALL) {
        ImGui::Image(ShipDK::Context::GetInstance()->GetWindow()->GetGui()->GetTextureByName(hasSmallKey && IsValidSaveFile() ? item.name : item.nameFaded),
                     ImVec2(iconSize, iconSize), ImVec2(0, 0), ImVec2(1, 1));
    }
    else {
        ImGui::Image(ShipDK::Context::GetInstance()->GetWindow()->GetGui()->GetTextureByName(hasItem && IsValidSaveFile() ? item.name : item.nameFaded),
...
void DrawSong(ItemTrackerItem item) {
    ...
    ImGui::Image(ShipDK::Context::GetInstance()->GetWindow()->GetGui()->GetTextureByName(hasSong && IsValidSaveFile() ? item.name : item.nameFaded),
...
void ItemTrackerWindow::DrawElement() {
    ...
    OSContPad* buttonsPressed = ShipDK::Context::GetInstance()->GetControlDeck()->GetPads();
