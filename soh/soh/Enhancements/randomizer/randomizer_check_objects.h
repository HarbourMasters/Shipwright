...
#define RC_OBJECT(rc, rc_v_or_mq, rc_type, rc_area, actor_id, scene_id, actor_params, og_item_id, rc_shortname,  \
                  rc_spoilername)                                                                                \
    {                                                                                                            \
        rc, {                                                                                                    \
            rc, rc_v_or_mq, rc_type, rc_area, actor_id, scene_id, actor_params, og_item_id, false, rc_shortname, \
                rc_spoilername                                                                                   \
        }                                                                                                        \
    }
