...
RANDO_ENUM_ITEM(RG_ABILITY_ISG)
RANDO_ENUM_ITEM(RG_ABILITY_OI)
RANDO_ENUM_ITEM(RG_ABILITY_QPA)
RANDO_ENUM_ITEM(RG_ABILITY_HESS)
RANDO_ENUM_ITEM(RG_ABILITY_SUPERSLIDE)
RANDO_ENUM_ITEM(RG_ABILITY_HOVER)
RANDO_ENUM_ITEM(RG_ABILITY_EQUIP_SWAP)
RANDO_ENUM_ITEM(RG_ABILITY_GROUND_JUMP)
RANDO_ENUM_ITEM(RG_ABILITY_WEIRDSHOT)
