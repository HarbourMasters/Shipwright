...
// Stat Upgrades
RANDO_ENUM_ITEM(RG_QUARTER_HEART)
RANDO_ENUM_ITEM(RG_DEFENSE_UPGRADE)
RANDO_ENUM_ITEM(RG_SPEED_UPGRADE)
RANDO_ENUM_ITEM(RG_POWER_UPGRADE)
RANDO_ENUM_ITEM(RG_MAGIC_STAT_UPGRADE)
RANDO_ENUM_ITEM(RG_CRAWL_SPEED_UPGRADE)
RANDO_ENUM_ITEM(RG_CLIMB_SPEED_UPGRADE)
RANDO_ENUM_ITEM(RG_PUSH_SPEED_UPGRADE)
