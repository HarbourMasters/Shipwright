...
RANDO_ENUM_ITEM(RG_PART_OF_ZELDAS_LULLABY)
RANDO_ENUM_ITEM(RG_PART_OF_EPONAS_SONG)
RANDO_ENUM_ITEM(RG_PART_OF_SARIAS_SONG)
RANDO_ENUM_ITEM(RG_PART_OF_SUNS_SONG)
RANDO_ENUM_ITEM(RG_PART_OF_SONG_OF_TIME)
RANDO_ENUM_ITEM(RG_PART_OF_SONG_OF_STORMS)
RANDO_ENUM_ITEM(RG_PART_OF_MINUET_OF_FOREST)
RANDO_ENUM_ITEM(RG_PART_OF_BOLERO_OF_FIRE)
RANDO_ENUM_ITEM(RG_PART_OF_SERENADE_OF_WATER)
RANDO_ENUM_ITEM(RG_PART_OF_REQUIEM_OF_SPIRIT)
RANDO_ENUM_ITEM(RG_PART_OF_NOCTURNE_OF_SHADOW)
RANDO_ENUM_ITEM(RG_PART_OF_PRELUDE_OF_LIGHT)
