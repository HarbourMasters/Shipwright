...
// 3ds splits hovering into multiple tricks, maybe we should do the same
...
RANDO_ENUM_ITEM(RT_DC_CHILD_LOBBY)
...
RANDO_ENUM_ITEM(RT_DC_EYES_BUNNYHOVERS)
...
RANDO_ENUM_ITEM(RT_WATER_HIGH_EMBLEM_JUMP)
...
RANDO_ENUM_ITEM(RT_GTG_MQ_LAVA_ROOM)
