...
RANDO_ENUM_BEGIN(RandoOptionBlueFireArrows)
RANDO_ENUM_ITEM(RO_BLUE_FIRE_ARROW_NONE)
RANDO_ENUM_ITEM(RO_BLUE_FIRE_ARROW_ICE)
RANDO_ENUM_ITEM(RO_BLUE_FIRE_ARROW_FIRE)
RANDO_ENUM_END(RandoOptionBlueFireArrows)
...
// Shuffle Weird Egg Settings (vanilla, shuffled, skip waking talon)
RANDO_ENUM_BEGIN(RandoOptionShuffleWeirdEgg)
RANDO_ENUM_ITEM(RO_WEIRD_EGG_VANILLA)
RANDO_ENUM_ITEM(RO_WEIRD_EGG_SHUFFLED)
...
// Starting Bottle Settings (off, empty bottle, bottle with big poe, ruto's letter (bottle 1 only))
RANDO_ENUM_BEGIN(RandoOptionStartingBottle)
RANDO_ENUM_ITEM(RO_STARTING_BOTTLE_OFF)
RANDO_ENUM_ITEM(RO_STARTING_BOTTLE_EMPTY)
RANDO_ENUM_ITEM(RO_STARTING_BOTTLE_BIG_POE)
RANDO_ENUM_ITEM(RO_STARTING_BOTTLE_RUTOS_LETTER)
RANDO_ENUM_END(RandoOptionStartingBottle)

// Starting Biggoron's Sword Settings (off, giant's knife, biggoron's sword)
RANDO_ENUM_BEGIN(RandoOptionStartingBiggoronSword)
RANDO_ENUM_ITEM(RO_STARTING_BGS_OFF)
RANDO_ENUM_ITEM(RO_STARTING_BGS_GIANTS_KNIFE)
RANDO_ENUM_ITEM(RO_STARTING_BGS_BIGGORON_SWORD)
RANDO_ENUM_END(RandoOptionStartingBiggoronSword)
...
RANDO_ENUM_ITEM(RO_SHUFFLE_WONDER_ITEMS_OFF)
RANDO_ENUM_ITEM(RO_SHUFFLE_WONDER_ITEMS_DUNGEONS)
RANDO_ENUM_ITEM(RO_SHUFFLE_WONDER_ITEMS_OVERWORLD)
RANDO_ENUM_ITEM(RO_SHUFFLE_WONDER_ITEMS_ALL)
RANDO_ENUM_END(RandoOptionWonderItems)

// Shuffle Silver settings (off, on, wallet, start with)
RANDO_ENUM_BEGIN(RandoOptionSilver)
RANDO_ENUM_ITEM(RO_SHUFFLE_SILVER_OFF)
RANDO_ENUM_ITEM(RO_SHUFFLE_SILVER_ON)
RANDO_ENUM_ITEM(RO_SHUFFLE_SILVER_WALLET)
RANDO_ENUM_ITEM(RO_SHUFFLE_SILVER_STARTWITH)
RANDO_ENUM_END(RandoOptionSilver)
...
RANDO_ENUM_ITEM(RO_SHUFFLE_BOULDERS_OFF)
RANDO_ENUM_ITEM(RO_SHUFFLE_BOULDERS_DUNGEONS)
RANDO_ENUM_ITEM(RO_SHUFFLE_BOULDERS_OVERWORLD)
RANDO_ENUM_ITEM(RO_SHUFFLE_BOULDERS_ALL)
...
RANDO_ENUM_ITEM(RO_TRIFORCE_HUNT_LOCATION_OVERWORLD)
RANDO_ENUM_ITEM(RO_TRIFORCE_HUNT_LOCATION_ANYWHERE)
RANDO_ENUM_END(RandoOptionTriforceHuntLocation)
