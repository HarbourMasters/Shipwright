...
// Starting Hookshot Options
RANDO_ENUM_BEGIN(RandoOptionStartingHookshot)
RANDO_ENUM_ITEM(RO_STARTING_HOOKSHOT_OFF)
RANDO_ENUM_ITEM(RO_STARTING_HOOKSHOT_HOOKSHOT)
RANDO_ENUM_ITEM(RO_STARTING_HOOKSHOT_LONGSHOT)
RANDO_ENUM_END(RandoOptionStartingHookshot)
