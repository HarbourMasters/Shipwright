...
RANDO_ENUM_ITEM(RSG_MENU_SIDEBAR_STAT_UPGRADES)
RANDO_ENUM_ITEM(RSG_MENU_COLUMN_STAT_UPGRADES)
RANDO_ENUM_ITEM(RSG_MENU_SECTION_STAT_UPGRADES)
RANDO_ENUM_ITEM(RSG_MENU_COLUMN_STAT_UPGRADE_SLIDERS)
RANDO_ENUM_ITEM(RSG_MENU_SECTION_STAT_UPGRADE_SLIDERS)
...
/* 0x00 */ RANDO_ENUM_ITEM(RECOIL_SWORD)
/* 0x01 */ RANDO_ENUM_ITEM(RECOIL_SWORD_AND_SHIELD)
/* 0x02 */ RANDO_ENUM_ITEM(RECOIL_HAMMER)
/* 0x03 */ RANDO_ENUM_ITEM(RECOIL_HAMMER_AND_SHIELD)
/* 0x04 */ RANDO_ENUM_ITEM(RECOIL_MAX)
RANDO_ENUM_END(RecoilRequirements)

RANDO_ENUM_BEGIN(TorchRecoilRequirements)
/* 0x00 */ RANDO_ENUM_ITEM(TRECOIL_SHORT)
/* 0x01 */ RANDO_ENUM_ITEM(TRECOIL_MASTER)
/* 0x02 */ RANDO_ENUM_ITEM(TRECOIL_LONG)
/* 0x03 */ RANDO_ENUM_ITEM(TRECOIL_LONG_AND_SHIELD)
/* 0x04 */ RANDO_ENUM_ITEM(TRECOIL_MAX)
RANDO_ENUM_END(TorchRecoilRequirements)
