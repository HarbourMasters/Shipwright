...
RANDO_ENUM_ITEM(RH_TREASURE_GAME_HEART)
...
RANDO_ENUM_ITEM(RH_HOVERS_HINT)
RANDO_ENUM_ITEM(RH_SCALE_HINT)
RANDO_ENUM_ITEM(RH_BOOMERANG_HINT)
RANDO_ENUM_ITEM(RH_HAMMER_HINT)
RANDO_ENUM_ITEM(RH_MIRROR_HINT)
RANDO_ENUM_ITEM(RH_STRENGTH_HINT)
RANDO_ENUM_ITEM(RH_OCARINA_HINT)
RANDO_ENUM_ITEM(RH_LULLABY_HINT)
RANDO_ENUM_ITEM(RH_STORMS_HINT)
RANDO_ENUM_ITEM(RH_EPONAS_HINT)
