...
RANDO_ENUM_BEGIN(DungeonKey)
RANDO_ENUM_ITEM(DEKU_TREE)
RANDO_ENUM_ITEM(DODONGOS_CAVERN)
RANDO_ENUM_ITEM(JABU_JABUS_BELLY)
RANDO_ENUM_ITEM(FOREST_TEMPLE)
RANDO_ENUM_ITEM(FIRE_TEMPLE)
RANDO_ENUM_ITEM(WATER_TEMPLE)
RANDO_ENUM_ITEM(SPIRIT_TEMPLE)
RANDO_ENUM_ITEM(SHADOW_TEMPLE)
RANDO_ENUM_ITEM(BOTTOM_OF_THE_WELL)
RANDO_ENUM_ITEM(ICE_CAVERN)
RANDO_ENUM_ITEM(GERUDO_TRAINING_GROUND)
RANDO_ENUM_ITEM(GANONS_CASTLE)
RANDO_ENUM_END(DungeonKey)
