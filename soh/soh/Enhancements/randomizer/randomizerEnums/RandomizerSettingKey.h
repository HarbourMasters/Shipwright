...
RANDO_ENUM_ITEM(RSK_SHUFFLE_ISG)
RANDO_ENUM_ITEM(RSK_SHUFFLE_OI)
RANDO_ENUM_ITEM(RSK_SHUFFLE_QPA)
RANDO_ENUM_ITEM(RSK_SHUFFLE_HESS)
RANDO_ENUM_ITEM(RSK_SHUFFLE_SUPERSLIDE)
RANDO_ENUM_ITEM(RSK_SHUFFLE_HOVER)
RANDO_ENUM_ITEM(RSK_SHUFFLE_EQUIP_SWAP)
RANDO_ENUM_ITEM(RSK_SHUFFLE_GROUND_JUMP)
RANDO_ENUM_ITEM(RSK_SHUFFLE_WEIRDSHOT)
