...
RANDO_ENUM_ITEM(RSK_QUARTER_HEART)
RANDO_ENUM_ITEM(RSK_DEFENSE_UPGRADE)
RANDO_ENUM_ITEM(RSK_SPEED_UPGRADE)
RANDO_ENUM_ITEM(RSK_POWER_UPGRADE)
RANDO_ENUM_ITEM(RSK_MAGIC_STAT_UPGRADE)
RANDO_ENUM_ITEM(RSK_DEFENSE_UPGRADE_ADJUSTABLE)
RANDO_ENUM_ITEM(RSK_DEFENSE_UPGRADE_TOTAL)
RANDO_ENUM_ITEM(RSK_DEFENSE_UPGRADE_REQUIRED)
RANDO_ENUM_ITEM(RSK_SPEED_UPGRADE_ADJUSTABLE)
RANDO_ENUM_ITEM(RSK_SPEED_UPGRADE_TOTAL)
RANDO_ENUM_ITEM(RSK_SPEED_UPGRADE_REQUIRED)
RANDO_ENUM_ITEM(RSK_POWER_UPGRADE_ADJUSTABLE)
RANDO_ENUM_ITEM(RSK_POWER_UPGRADE_TOTAL)
RANDO_ENUM_ITEM(RSK_POWER_UPGRADE_REQUIRED)
RANDO_ENUM_ITEM(RSK_MAGIC_STAT_UPGRADE_ADJUSTABLE)
RANDO_ENUM_ITEM(RSK_MAGIC_STAT_UPGRADE_TOTAL)
RANDO_ENUM_ITEM(RSK_MAGIC_STAT_UPGRADE_REQUIRED)
RANDO_ENUM_ITEM(RSK_CRAWL_SPEED_UPGRADE)
RANDO_ENUM_ITEM(RSK_CRAWL_SPEED_UPGRADE_ADJUSTABLE)
RANDO_ENUM_ITEM(RSK_CRAWL_SPEED_UPGRADE_TOTAL)
RANDO_ENUM_ITEM(RSK_CRAWL_SPEED_UPGRADE_REQUIRED)
RANDO_ENUM_ITEM(RSK_CLIMB_SPEED_UPGRADE)
RANDO_ENUM_ITEM(RSK_CLIMB_SPEED_UPGRADE_ADJUSTABLE)
RANDO_ENUM_ITEM(RSK_CLIMB_SPEED_UPGRADE_TOTAL)
RANDO_ENUM_ITEM(RSK_CLIMB_SPEED_UPGRADE_REQUIRED)
RANDO_ENUM_ITEM(RSK_PUSH_SPEED_UPGRADE)
RANDO_ENUM_ITEM(RSK_PUSH_SPEED_UPGRADE_ADJUSTABLE)
RANDO_ENUM_ITEM(RSK_PUSH_SPEED_UPGRADE_TOTAL)
RANDO_ENUM_ITEM(RSK_PUSH_SPEED_UPGRADE_REQUIRED)
