...
// Starting Items
RANDO_ENUM_ITEM(RSK_STARTING_DINS)
RANDO_ENUM_ITEM(RSK_STARTING_FARORES)
RANDO_ENUM_ITEM(RSK_STARTING_NAYRUS)
...
RANDO_ENUM_ITEM(RSK_STARTING_FAIRY_BOW)
...
RANDO_ENUM_ITEM(RSK_STARTING_LENS)
RANDO_ENUM_ITEM(RSK_STARTING_HAMMER)
RANDO_ENUM_ITEM(RSK_STARTING_BOTTLE)
...
RANDO_ENUM_ITEM(RSK_STARTING_BGS_SWORD)
...
// Custom Hint Options
RANDO_ENUM_ITEM(RSK_BOOMERANG_HINT)
RANDO_ENUM_ITEM(RSK_HAMMER_HINT)
RANDO_ENUM_ITEM(RSK_MIRROR_HINT)
RANDO_ENUM_ITEM(RSK_HOVERS_HINT)
RANDO_ENUM_ITEM(RSK_STRENGTH_HINT)
RANDO_ENUM_ITEM(RSK_OCARINA_HINT)
RANDO_ENUM_ITEM(RSK_SCALE_HINT)
RANDO_ENUM_ITEM(RSK_LULLABY_HINT)
RANDO_ENUM_ITEM(RSK_STORMS_HINT)
RANDO_ENUM_ITEM(RSK_EPONAS_HINT)
// End
