...
RANDO_ENUM_ITEM(LOGIC_SHADOW_SILVER_BLADES)
RANDO_ENUM_ITEM(LOGIC_SHADOW_SILVER_PIT)
RANDO_ENUM_ITEM(LOGIC_SHADOW_SILVER_SPIKES)
RANDO_ENUM_ITEM(LOGIC_SPIRIT_SILVER_CHILD)
RANDO_ENUM_ITEM(LOGIC_SPIRIT_SILVER_SUN)
RANDO_ENUM_ITEM(LOGIC_SPIRIT_SILVER_BOULDERS)
RANDO_ENUM_ITEM(LOGIC_BOTW_SILVER)
RANDO_ENUM_ITEM(LOGIC_ICE_CAVERN_SILVER_BLADES)
RANDO_ENUM_ITEM(LOGIC_ICE_CAVERN_SILVER_BLOCK)
RANDO_ENUM_ITEM(LOGIC_GTG_SILVER_SLOPE)
RANDO_ENUM_ITEM(LOGIC_GTG_SILVER_LAVA)
RANDO_ENUM_ITEM(LOGIC_GTG_SILVER_WATER)
RANDO_ENUM_ITEM(LOGIC_GANONS_CASTLE_SILVER_LIGHT)
RANDO_ENUM_ITEM(LOGIC_GANONS_CASTLE_SILVER_FOREST)
RANDO_ENUM_ITEM(LOGIC_GANONS_CASTLE_SILVER_FIRE)
RANDO_ENUM_ITEM(LOGIC_GANONS_CASTLE_SILVER_SPIRIT)
RANDO_ENUM_ITEM(LOGIC_DODONGOS_CAVERN_MQ_SILVER)
RANDO_ENUM_ITEM(LOGIC_SHADOW_MQ_SILVER_INVISIBLE_BLADES)
RANDO_ENUM_ITEM(LOGIC_SPIRIT_MQ_SILVER_LOBBY)
RANDO_ENUM_ITEM(LOGIC_SPIRIT_MQ_SILVER_BIG_WALL)
RANDO_ENUM_ITEM(LOGIC_GANONS_CASTLE_MQ_SILVER_WATER)
RANDO_ENUM_ITEM(LOGIC_GANONS_CASTLE_MQ_SILVER_SHADOW)
RANDO_ENUM_ITEM(LOGIC_ROCS_FEATHER)
RANDO_ENUM_ITEM(LOGIC_CAN_BORROW_MASKS)
RANDO_ENUM_ITEM(LOGIC_SOLD_KEATON_MASK)
RANDO_ENUM_ITEM(LOGIC_SOLD_SKULL_MASK)
RANDO_ENUM_ITEM(LOGIC_SOLD_SPOOKY_MASK)
RANDO_ENUM_ITEM(LOGIC_SOLD_BUNNY_HOOD)
...
RANDO_ENUM_ITEM(LOGIC_PLANT_DEATH_MOUNTAIN_CRATER_BEAN)
RANDO_ENUM_ITEM(LOGIC_PLANT_DEATH_MOUNTAIN_TRAIL_BEAN)
RANDO_ENUM_ITEM(LOGIC_PLANT_DESERT_COLOSSUS_BEAN)
RANDO_ENUM_ITEM(LOGIC_PLANT_GERUDO_VALLEY_BEAN)
RANDO_ENUM_ITEM(LOGIC_PLANT_GRAVEYARD_BEAN)
RANDO_ENUM_ITEM(LOGIC_PLANT_KOKIRI_FOREST_BEAN)
RANDO_ENUM_ITEM(LOGIC_PLANT_LAKE_HYLIA_BEAN)
RANDO_ENUM_ITEM(LOGIC_PLANT_LOST_WOODS_BRIDGE_BEAN)
RANDO_ENUM_ITEM(LOGIC_PLANT_LOST_WOODS_THEATER_BEAN)
RANDO_ENUM_ITEM(LOGIC_PLANT_ZORAS_RIVER_BEAN)
...
RANDO_ENUM_ITEM(LOGIC_DC_MQ_TWO_FIRES_BOULDER)
RANDO_ENUM_ITEM(LOGIC_DC_MQ_CLEAR_UPPER_LOBBY_ROCKS)
RANDO_ENUM_ITEM(LOGIC_DC_MQ_CLEAR_BIG_BLOCK_WEB)
RANDO_ENUM_ITEM(LOGIC_DC_MQ_BEHIND_FIRE_SWITCH)
RANDO_ENUM_ITEM(LOGIC_JABU_RUTO_IN_B1)
...
RANDO_ENUM_ITEM(LOGIC_WATER_MQ_BOSS_KEY_CHEST_TORCHES)
...
RANDO_ENUM_ITEM(LOGIC_MET_ZELDA)
RANDO_ENUM_ITEM(LOGIC_MALON_RETURNED_FROM_CASTLE)
RANDO_ENUM_ITEM(LOGIC_TALON_RETURNED_FROM_CASTLE)
...
RANDO_ENUM_ITEM(LOGIC_SHADOW_TRIAL_LATE_CHEST)
RANDO_ENUM_ITEM(LOGIC_SHADOW_TRIAL_RUSTED_SWITCH)
RANDO_ENUM_ITEM(LOGIC_QUARTER_HEART)
RANDO_ENUM_ITEM(LOGIC_DEFENSE_UPGRADE)
RANDO_ENUM_ITEM(LOGIC_SPEED_UPGRADE)
RANDO_ENUM_ITEM(LOGIC_POWER_UPGRADE)
RANDO_ENUM_ITEM(LOGIC_MAGIC_STAT_UPGRADE)
RANDO_ENUM_ITEM(LOGIC_CRAWL_SPEED_UPGRADE)
RANDO_ENUM_ITEM(LOGIC_CLIMB_SPEED_UPGRADE)
RANDO_ENUM_ITEM(LOGIC_PUSH_SPEED_UPGRADE)
