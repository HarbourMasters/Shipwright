...
typedef enum {
    ...
    /* 0xDC */ TIMESTAMP_FOUND_ROLL,
    /* 0xDD */ TIMESTAMP_FOUND_OPEN_CHESTS,
    /* 0xDE */ TIMESTAMP_FOUND_SPEAK_DEKU,
    /* 0xDF */ TIMESTAMP_FOUND_SPEAK_GERUDO,
    /* 0xE0 */ TIMESTAMP_FOUND_SPEAK_GORON,
    /* 0xE1 */ TIMESTAMP_FOUND_SPEAK_HYLIAN,
    /* 0xE2 */ TIMESTAMP_FOUND_SPEAK_KOKIRI,
    /* 0xE3 */ TIMESTAMP_FOUND_SPEAK_ZORA,
    /* 0xE4 */ TIMESTAMP_FOUND_DMC_BEAN_SOUL,
    /* 0xE5 */ TIMESTAMP_FOUND_DMT_BEAN_SOUL,
    /* 0xE6 */ TIMESTAMP_FOUND_COLOSSUS_BEAN_SOUL,
    /* 0xE7 */ TIMESTAMP_FOUND_GV_BEAN_SOUL,
    /* 0xE8 */ TIMESTAMP_FOUND_GY_BEAN_SOUL,
    /* 0xE9 */ TIMESTAMP_FOUND_KF_BEAN_SOUL,
    /* 0xEA */ TIMESTAMP_FOUND_LH_BEAN_SOUL,
    /* 0xEB */ TIMESTAMP_FOUND_LW_BRIDGE_BEAN_SOUL,
    /* 0xEC */ TIMESTAMP_FOUND_LW_MEADOW_BEAN_SOUL,
    /* 0xED */ TIMESTAMP_FOUND_ZR_BEAN_SOUL,
    /* 0xEE */ TIMESTAMP_FOUND_SKELETON_KEY,
    /* 0xEF */ TIMESTAMP_FOUND_ROCS_FEATHER,
    /* 0xF0 */ TIMESTAMP_MAX
