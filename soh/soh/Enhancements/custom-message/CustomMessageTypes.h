...
typedef enum {
    ...
    // TEXT_SPIRIT_TEMPLE_FUTURE_SIGN = 0x0220, // Not used currently
    ...
    TEXT_SHADOW_TEMPLE_TRUTHSPINNER_SIGN = 0x0327,
    ...
    TEXT_DIVING_MINIGAME_SHORTCUT = 0x405b,
    TEXT_BARINADE_INFO = 0x0614,
    TEXT_VOLVAGIA_INFO = 0x0621,
    TEXT_TWINROVA_KOUME_INFO = 0x0632,
    TEXT_TWINROVA_KOTAKE_INFO = 0x0633,
    ...
    TEXT_DARUNIA_WHAT_THE_HECK = 0x301A,
    TEXT_DARUNIA_GORON_PROBLEM = 0x301B,
    TEXT_DARUNIA_DESTROY_MONSTERS = 0x301D,
    TEXT_DARUNIA_PLAY_THAT_TUNE = 0x301E,
    ...
    TEXT_WINDMILL_GUY_GRRR_2 = 0x508E,
    ...
    TEXT_ZELDA_ATTENDANT = 0x703C,
    TEXT_ZELDA_FOUND_IT = 0x703D,
