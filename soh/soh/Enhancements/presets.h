...
const std::vector<const char*> randomizerCvars = {
    CVAR_RANDOMIZER_SETTING_10GS_HINT,
    CVAR_RANDOMIZER_SETTING_20GS_HINT,
    CVAR_RANDOMIZER_SETTING_30GS_HINT,
    CVAR_RANDOMIZER_SETTING_40GS_HINT,
    CVAR_RANDOMIZER_SETTING_50GS_HINT,
    CVAR_RANDOMIZER_SETTING_ALL_LOCATIONS_REACHABLE,
    CVAR_RANDOMIZER_SETTING_ALTAR_HINT,
    CVAR_RANDOMIZER_SETTING_BIG_POE_TARGET_COUNT,
    CVAR_RANDOMIZER_SETTING_BLUE_FIRE_ARROWS,
    CVAR_RANDOMIZER_SETTING_BOMBCHUS_IN_LOGIC,
    CVAR_RANDOMIZER_SETTING_BOSS_KEYSANITY,
    CVAR_RANDOMIZER_SETTING_BRIDGE_REWARD_OPTIONS,
    CVAR_RANDOMIZER_SETTING_COMPLETE_MASK_QUEST,
    CVAR_RANDOMIZER_SETTING_CUCCOS_TO_RETURN,
    CVAR_RANDOMIZER_SETTING_DAMPE_HINT,
    CVAR_RANDOMIZER_SETTING_DECOUPLE_ENTRANCES,
    CVAR_RANDOMIZER_SETTING_DOOR_OF_TIME,
    CVAR_RANDOMIZER_SETTING_DUNGEON_COUNT,
    CVAR_RANDOMIZER_SETTING_ENABLE_BOMBCHU_DROPS,
    CVAR_RANDOMIZER_SETTING_ENABLE_GLITCH_CUTSCENES,
    CVAR_RANDOMIZER_SETTING_ENABLED_GLITCHES,
    CVAR_RANDOMIZER_SETTING_ENABLED_TRICKS,
    CVAR_RANDOMIZER_SETTING_EXCLUDED_LOCATIONS,
    CVAR_RANDOMIZER_SETTING_FOREST,
    CVAR_RANDOMIZER_SETTING_FULL_WALLETS,
    CVAR_RANDOMIZER_SETTING_GANON_TRIAL,
    CVAR_RANDOMIZER_SETTING_GANON_TRIAL_COUNT,
    CVAR_RANDOMIZER_SETTING_GERUDO_FORTRESS,
    CVAR_RANDOMIZER_SETTING_GERUDO_KEYS,
    CVAR_RANDOMIZER_SETTING_GOSSIP_STONE_HINTS,
    CVAR_RANDOMIZER_SETTING_GS_EXPECT_SUNS_SONG,
    CVAR_RANDOMIZER_SETTING_HINT_CLARITY,
    CVAR_RANDOMIZER_SETTING_HINT_DISTRIBUTION,
    CVAR_RANDOMIZER_SETTING_ICE_TRAPS,
    CVAR_RANDOMIZER_SETTING_ITEM_POOL,
    CVAR_RANDOMIZER_SETTING_KAKARIKO_GATE,
    CVAR_RANDOMIZER_SETTING_KEYSANITY,
    CVAR_RANDOMIZER_SETTING_LACS_DUNGEON_COUNT,
    CVAR_RANDOMIZER_SETTING_LACS_MEDALLION_COUNT,
    CVAR_RANDOMIZER_SETTING_LACS_REWARD_COUNT,
    CVAR_RANDOMIZER_SETTING_LACS_REWARD_OPTIONS,
    CVAR_RANDOMIZER_SETTING_LACS_STONE_COUNT,
    CVAR_RANDOMIZER_SETTING_LACS_TOKEN_COUNT,
    CVAR_RANDOMIZER_SETTING_LA_HINT,
    CVAR_RANDOMIZER_SETTING_LINKS_POCKET,
    CVAR_RANDOMIZER_SETTING_LOGIC_RULES,
    CVAR_RANDOMIZER_SETTING_MEDALLION_COUNT,
    CVAR_RANDOMIZER_SETTING_MIX_DUNGEONS,
    CVAR_RANDOMIZER_SETTING_MIXED_ENTRANCES,
    CVAR_RANDOMIZER_SETTING_MIX_GROTTOS,
    CVAR_RANDOMIZER_SETTING_MIX_INTERIORS,
    CVAR_RANDOMIZER_SETTING_MIX_OVERWORLD,
    CVAR_RANDOMIZER_SETTING_MQ_DUNGEON_COUNT,
    CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS,
    CVAR_RANDOMIZER_SETTING_RAINBOW_BRIDGE,
    CVAR_RANDOMIZER_SETTING_REWARD_COUNT,
    CVAR_RANDOMIZER_SETTING_SCRUB_TEXT,
    CVAR_RANDOMIZER_SETTING_SHOPSANITY,
    CVAR_RANDOMIZER_SETTING_SHOPSANITY_PRICES,
    CVAR_RANDOMIZER_SETTING_SHOPSANITY_PRICES_AFFORDABLE,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_ADULT_TRADE,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_BEANS,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_BOSS_ENTRANCES,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_COWS,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_DUNGEON_REWARD,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_DUNGEONS_ENTRANCES,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_FROG_SONG_RUPEES,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_GANON_BOSS_KEY,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_GERUDO_TOKEN,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_GROTTOS_ENTRANCES,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_INTERIORS_ENTRANCES,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_BOTTOM_OF_WELL,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_FIRE_TEMPLE,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_FOREST_TEMPLE,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_GANONS_CASTLE,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_GERUDO_FORTRESS,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_GTG,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_RANDOM_COUNT,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_SHADOW_TEMPLE,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_SPIRIT_TEMPLE,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS_WATER_TEMPLE,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_KOKIRI_SWORD,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_MERCHANTS,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_OCARINAS,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_OVERWORLD_ENTRANCES,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_OVERWORLD_SPAWNS,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_OWL_DROPS,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_SCRUBS,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_SONGS,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_TOKENS,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_WARP_SONGS,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_WEIRD_EGG,
    CVAR_RANDOMIZER_SETTING_SKIP_CHILD_STEALTH,
    CVAR_RANDOMIZER_SETTING_SKIP_CHILD_ZELDA,
    CVAR_RANDOMIZER_SETTING_SKIP_EPONA_RACE,
    CVAR_RANDOMIZER_SETTING_SKIP_SCARECROWS_SONG,
    CVAR_RANDOMIZER_SETTING_SKIP_TOWER_ESCAPE,
    CVAR_RANDOMIZER_SETTING_STARTING_AGE,
    CVAR_RANDOMIZER_SETTING_STARTING_CONSUMABLES,
    CVAR_RANDOMIZER_SETTING_STARTING_BOLERO_OF_FIRE,
    CVAR_RANDOMIZER_SETTING_STARTING_DEKU_SHIELD,
    CVAR_RANDOMIZER_SETTING_STARTING_EPONAS_SONG,
    CVAR_RANDOMIZER_SETTING_STARTING_KOKIRI_SWORD,
    CVAR_RANDOMIZER_SETTING_STARTING_MAPS_COMPASSES,
    CVAR_RANDOMIZER_SETTING_STARTING_MINUET_OF_FOREST,
    CVAR_RANDOMIZER_SETTING_STARTING_NOCTURNE_OF_SHADOW,
    CVAR_RANDOMIZER_SETTING_STARTING_OCARINA,
    CVAR_RANDOMIZER_SETTING_STARTING_PRELUDE_OF_LIGHT,
    CVAR_RANDOMIZER_SETTING_STARTING_REQUIEM_OF_SPIRIT,
    CVAR_RANDOMIZER_SETTING_STARTING_SARIAS_SONG,
    CVAR_RANDOMIZER_SETTING_STARTING_SERENADE_OF_WATER,
    CVAR_RANDOMIZER_SETTING_STARTING_SKULLTULA_TOKEN,
    CVAR_RANDOMIZER_SETTING_STARTING_SONG_OF_STORMS,
    CVAR_RANDOMIZER_SETTING_STARTING_SONG_OF_TIME,
    CVAR_RANDOMIZER_SETTING_STARTING_SUNS_SONG,
    CVAR_RANDOMIZER_SETTING_STARTING_ZELDAS_LULLABY,
    CVAR_RANDOMIZER_SETTING_STONE_COUNT,
    CVAR_RANDOMIZER_SETTING_SUNLIGHT_ARROWS,
    CVAR_RANDOMIZER_SETTING_TOKEN_COUNT,
    CVAR_RANDOMIZER_SETTING_WARP_SONG_TEXT,
    CVAR_RANDOMIZER_SETTING_ZORAS_FOUNTAIN,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_100GS_REWARD,
    CVAR_RANDOMIZER_SETTING_GREG_HINT,
    CVAR_RANDOMIZER_SETTING_MANUAL_SEED_ENTRY,
    CVAR_RANDOMIZER_SETTING_TRIFORCE_HUNT_TOTAL_PIECES,
    CVAR_RANDOMIZER_SETTING_TRIFORCE_HUNT_REQUIRED_PIECES,
    CVAR_RANDOMIZER_SETTING_TRIFORCE_HUNT,
    CVAR_RANDOMIZER_SETTING_SHUFFLE_MASTER_SWORD,
    CVAR_RANDOMIZER_SETTING_SARIA_HINT,
    CVAR_RANDOMIZER_ENHANCEMENT("RandomizeRupeeNames"),
    CVAR_RANDOMIZER_SETTING_FROGS_HINT,
...
const std::vector<PresetEntry> spockRacePresetEntries = {
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_LOGIC_RULES, 0),
    PRESET_ENTRY_S32(CVAR_ENHANCEMENT("TextSpeed"), 5),
    PRESET_ENTRY_S32(CVAR_ENHANCEMENT("MweepSpeed"), 5),
    ...
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_10GS_HINT, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_20GS_HINT, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_30GS_HINT, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_40GS_HINT, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_50GS_HINT, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_ALL_LOCATIONS_REACHABLE, 0),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_BLUE_FIRE_ARROWS, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_BOMBCHUS_IN_LOGIC, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_COMPLETE_MASK_QUEST, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_CUCCOS_TO_RETURN, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_DAMPE_HINT, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_DOOR_OF_TIME, RO_DOOROFTIME_OPEN),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_ENABLE_BOMBCHU_DROPS, 1),
    PRESET_ENTRY_CPP_STRING(CVAR_RANDOMIZER_SETTING_EXCLUDED_LOCATIONS,
                            FormatLocations({ RC_MARKET_10_BIG_POES, RC_KAK_40_GOLD_SKULLTULA_REWARD,
                                              RC_KAK_50_GOLD_SKULLTULA_REWARD, RC_ZR_FROGS_OCARINA_GAME })),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_FOREST, RO_FOREST_OPEN),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_FULL_WALLETS, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_GANON_TRIAL, RO_GANONS_TRIALS_SKIP),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_GERUDO_FORTRESS, RO_GF_FAST),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_GREG_HINT, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_GS_EXPECT_SUNS_SONG, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_KAKARIKO_GATE, RO_KAK_GATE_OPEN),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_LACS_REWARD_COUNT, 5),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_RAINBOW_BRIDGE, RO_BRIDGE_GREG),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SCRUB_TEXT, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHOPSANITY, RO_SHOPSANITY_RANDOM),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_GANON_BOSS_KEY, RO_GANON_BOSS_KEY_LACS_REWARDS),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS, RO_KEYRINGS_COUNT),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_KOKIRI_SWORD, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_OCARINAS, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_SCRUBS, RO_SCRUBS_AFFORDABLE),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SKIP_CHILD_STEALTH, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SKIP_CHILD_ZELDA, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SKIP_EPONA_RACE, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SKIP_SCARECROWS_SONG, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SKIP_TOWER_ESCAPE, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_STARTING_CONSUMABLES, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_STARTING_MAPS_COMPASSES, RO_DUNGEON_ITEM_LOC_STARTWITH),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_STARTING_OCARINA, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SUNLIGHT_ARROWS, 1),
};
...
const std::vector<PresetEntry> spockRaceNoLogicPresetEntries = {
    ...
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_BLUE_FIRE_ARROWS, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_BOMBCHUS_IN_LOGIC, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_BOSS_KEYSANITY, RO_DUNGEON_ITEM_LOC_ANYWHERE),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_COMPLETE_MASK_QUEST, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_CUCCOS_TO_RETURN, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_DAMPE_HINT, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_DOOR_OF_TIME, RO_DOOROFTIME_OPEN),
    ...
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_GANON_TRIAL, RO_GANONS_TRIALS_SKIP),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_GERUDO_FORTRESS, RO_GF_FAST),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_GERUDO_KEYS, RO_GERUDO_KEYS_ANYWHERE),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_GREG_HINT, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_GS_EXPECT_SUNS_SONG, 0),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_KAKARIKO_GATE, RO_KAK_GATE_OPEN),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_KEYSANITY, RO_DUNGEON_ITEM_LOC_ANYWHERE),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_LACS_REWARD_COUNT, 5),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_LOGIC_RULES, RO_LOGIC_NO_LOGIC),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_RAINBOW_BRIDGE, RO_BRIDGE_GREG),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SCRUB_TEXT, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHOPSANITY, RO_SHOPSANITY_RANDOM),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_ADULT_TRADE, 0),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_BEANS, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_GANON_BOSS_KEY, RO_GANON_BOSS_KEY_LACS_REWARDS),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_GERUDO_TOKEN, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS, RO_KEYRINGS_COUNT),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_KOKIRI_SWORD, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_OCARINAS, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_SCRUBS, RO_SCRUBS_AFFORDABLE),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_SONGS, RO_SONG_SHUFFLE_ANYWHERE),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_TOKENS, RO_TOKENSANITY_ALL),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SKIP_CHILD_STEALTH, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SKIP_CHILD_ZELDA, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SKIP_EPONA_RACE, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SKIP_SCARECROWS_SONG, 1),
...
const std::vector<PresetEntry> s6PresetEntries = {
    ...
    PRESET_ENTRY_S32(CVAR_ENHANCEMENT("MMBunnyHood"), BUNNY_HOOD_FAST),
    PRESET_ENTRY_S32(CVAR_ENHANCEMENT("AdultBunnyHood"), 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_BIG_POE_TARGET_COUNT, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_CUCCOS_TO_RETURN, 4),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_DOOR_OF_TIME, RO_DOOROFTIME_OPEN),
    PRESET_ENTRY_CPP_STRING(CVAR_RANDOMIZER_SETTING_EXCLUDED_LOCATIONS, FormatLocations({ RC_DEKU_THEATER_MASK_OF_TRUTH })),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_FOREST, RO_FOREST_CLOSED_DEKU),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_GANON_TRIAL, RO_GANONS_TRIALS_SKIP),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_GERUDO_FORTRESS, RO_GF_FAST),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_ICE_TRAPS, RO_ICE_TRAPS_OFF),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_KAKARIKO_GATE, RO_KAK_GATE_OPEN),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_MEDALLION_COUNT, 6),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS, RO_MQ_DUNGEONS_NONE),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_RAINBOW_BRIDGE, RO_BRIDGE_MEDALLIONS),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_ADULT_TRADE, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_DUNGEON_REWARD, RO_DUNGEON_REWARDS_END_OF_DUNGEON),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_GANON_BOSS_KEY, RO_GANON_BOSS_KEY_STARTWITH),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_KOKIRI_SWORD, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_OVERWORLD_SPAWNS, RO_GENERIC_ON),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SKIP_CHILD_STEALTH, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SKIP_CHILD_ZELDA, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SKIP_EPONA_RACE, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SKIP_TOWER_ESCAPE, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_STARTING_AGE, RO_AGE_RANDOM),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_STARTING_CONSUMABLES, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_STARTING_DEKU_SHIELD, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_STARTING_MAPS_COMPASSES, RO_DUNGEON_ITEM_LOC_STARTWITH),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_STARTING_OCARINA, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_ZORAS_FOUNTAIN, 0),
};
...
const std::vector<PresetEntry> hellModePresetEntries = {
    ...
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_DOOR_OF_TIME, RO_DOOROFTIME_OPEN),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_ENABLE_BOMBCHU_DROPS, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_ENABLE_GLITCH_CUTSCENES, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_FOREST, RO_FOREST_OPEN),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_GANON_TRIAL, RO_GANONS_TRIALS_SET_NUMBER),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_GANON_TRIAL_COUNT, 6),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_GERUDO_KEYS, RO_GERUDO_KEYS_ANYWHERE),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_GS_EXPECT_SUNS_SONG, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_ICE_TRAPS, RO_ICE_TRAPS_ONSLAUGHT),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_ITEM_POOL, RO_ITEM_POOL_MINIMAL),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_KAKARIKO_GATE, RO_KAK_GATE_OPEN),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_KEYSANITY, RO_DUNGEON_ITEM_LOC_ANYWHERE),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_LINKS_POCKET, RO_LINKS_POCKET_NOTHING),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_MQ_DUNGEONS, RO_MQ_DUNGEONS_RANDOM_NUMBER),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_RAINBOW_BRIDGE, RO_BRIDGE_DUNGEON_REWARDS),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHOPSANITY, RO_SHOPSANITY_FOUR_ITEMS),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHOPSANITY_PRICES, RO_SHOPSANITY_PRICE_TYCOON),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_ADULT_TRADE, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_BEANS, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_COWS, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_DUNGEON_REWARD, RO_DUNGEON_REWARDS_ANYWHERE),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_FROG_SONG_RUPEES, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_GANON_BOSS_KEY, RO_GANON_BOSS_KEY_LACS_DUNGEONS),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_GERUDO_TOKEN, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_KEY_RINGS, RO_KEYRINGS_RANDOM),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_KOKIRI_SWORD, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_MASTER_SWORD, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_OCARINAS, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_SCRUBS, RO_SCRUBS_RANDOM),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_SONGS, RO_SONG_SHUFFLE_ANYWHERE),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_TOKENS, RO_TOKENSANITY_ALL),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SHUFFLE_WEIRD_EGG, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SKIP_CHILD_STEALTH, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SKIP_EPONA_RACE, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SKIP_SCARECROWS_SONG, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SKIP_TOWER_ESCAPE, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_STARTING_AGE, RO_AGE_RANDOM),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_STARTING_MAPS_COMPASSES, RO_DUNGEON_ITEM_LOC_ANYWHERE),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_SUNLIGHT_ARROWS, 1),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING_ZORAS_FOUNTAIN, 2),
};
