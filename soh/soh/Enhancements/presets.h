...
const std::vector<const char*> cheatCvars = {
    ...
    CVAR_CHEAT("TimeSync"),
    CVAR_DEVELOPER_TOOLS_DEBUG_ENABLED,
    CVAR_DEVELOPER_TOOLS_DEBUG_ENABLED_SKULLTULA,
    CVAR_DEVELOPER_TOOLS_SKIP_LOGO_TITLE,
    CVAR_DEVELOPER_TOOLS_SAVE_FILE_ID,
    CVAR_CHEAT("EnableBetaQuest"),
    CVAR_DEVELOPER_TOOLS_BETTER_DEBUG_WARP_SCREEN,
    ...
    CVAR_DEVELOPER_TOOLS_REGEDIT_ENABLED,
    "gPreset0",
    "gPreset1",
    CVAR_CHEAT("DekuStick"),
    CVAR_DEVELOPER_TOOLS_DEBUG_WARP_SCREEN_TRANSLATION,
    CVAR_DEVELOPER_TOOLS_DEBUG_SAVE_FILE_MODE,
