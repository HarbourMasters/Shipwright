    ...
    void DrawMiscControlPanel(GameControlEditorWindow* window) {
        ...
        DrawHelpIcon("Hold the assigned button to change the maximum walking or swimming speed\nTo change the assigned button, go into the Ports tabs above");
         if (CVarGetInteger("gEnableWalkModify", 0)) {
            ...
            UIWidgets::PaddedEnhancementSliderFloat("Walk Modifier 1: %d %%", "##WalkMod1", "gWalkModifierOne", 0.0f, 5.0f, "", 1.0f, true, true, false, true);
            UIWidgets::PaddedEnhancementSliderFloat("Walk Modifier 2: %d %%", "##WalkMod2", "gWalkModifierTwo", 0.0f, 5.0f, "", 1.0f, true, true, false, true);
            window->EndGroupPanelPublic(0);
            window->BeginGroupPanelPublic("Swim Modifier", ImGui::GetContentRegionAvail());
            UIWidgets::PaddedEnhancementSliderFloat("Swim Modifier 1: %d %%", "##SwimMod1", "gSwimModifierOne", 0.0f, 5.0f, "", 1.0f, true, true, false, true);
            UIWidgets::PaddedEnhancementSliderFloat("Swim Modifier 2: %d %%", "##SwimMod2", "gSwimModifierTwo", 0.0f, 5.0f, "", 1.0f, true, true, false, true);
            window->EndGroupPanelPublic(0);
            window->EndGroupPanelPublic(0);
        }
        UIWidgets::Spacer(0);
