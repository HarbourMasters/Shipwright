...
namespace GameControlEditor {
    ...
    void Init() {
        LUS::Context::GetInstance()->GetWindow()->GetGui()->AddWindow("Enhancements", "Game Control Editor", DrawUI);
    ...
    void DrawOcarinaControlPanel() {
        ...
        if (CVarGetInteger("gCustomOcarinaControls", 0) == 1) {
            if (ImGui::BeginTable("tableCustomMainOcarinaControls", 2, ImGuiTableFlags_SizingStretchProp)) {
                ...
                LUS::Context::GetInstance()->GetWindow()->GetGui()->EndGroupPanel();
    ...
    void DrawCustomButtons() {
        LUS::GetInputEditorWindow()->DrawControllerSelect(CurrentPort - 1);
        
        LUS::GetInputEditorWindow()->DrawButton("Modifier 1", BTN_MODIFIER1, CurrentPort - 1, &BtnReading);
        LUS::GetInputEditorWindow()->DrawButton("Modifier 2", BTN_MODIFIER2, CurrentPort - 1, &BtnReading);
    }
