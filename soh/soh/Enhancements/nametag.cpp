...
void DrawNameTag(PlayState* play, const NameTag* nameTag) {
    ...
    if (CVarGetInteger(COSMETIC_CVAR("Hud_NameTagActorBackground.Changed"), 0)) {
        textboxColor = CVarGetColor(COSMETIC_CVAR("Hud_NameTagActorBackground.Value"), textboxColor);
    }
    if (CVarGetInteger(COSMETIC_CVAR("Hud_NameTagActorText.Changed"), 0)) {
        textColor = CVarGetColor(COSMETIC_CVAR("Hud_NameTagActorText.Value"), textColor);
    }
