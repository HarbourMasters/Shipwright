...
AudioCollection::AudioCollection() {
    ...
    sequenceMap = {
        ...
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_TAKEN_AWAY, "Adult Link - Taken Away", "NA_SE_VO_LI_TAKEN_AWAY", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_HELD, "Adult Link - Swing Bottle Gasp", "NA_SE_VO_LI_HELD", SEQ_VOICE),
        ...
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_DRINK, "Adult Link - Drinking", "NA_SE_VO_LI_DRINK", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_RELAX, "Adult Link - Yawn", "NA_SE_VO_LI_RELAX", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_SWORD_PUTAWAY, "Adult Link - Yell (Sword Putaway)", "NA_SE_VO_LI_SWORD_PUTAWAY",
                           SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_GROAN, "Young Link - Shiver", "NA_SE_VO_LI_GROAN", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_AUTO_JUMP, "Adult Link - Jump", "NA_SE_VO_LI_AUTOd_JUMP", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_MAGIC_NALE, "Adult Link - Use attack magic", "NA_SE_VO_LI_MAGIC_NALE", SEQ_VOICE),
        ...
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_HOOKSHOT_HANG, "Adult Link - Hookshot hang", "NA_SE_VO_LI_HOOKSHOT_HANG",
                           SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_LAND_DAMAGE_S, "Adult Link - Fall damage", "NA_SE_VO_LI_LAND_DAMAGE_S",
                           SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_NULL_0x1b, "NA_SE_VO_LI_NULL_0x1b", "NA_SE_VO_LI_NULL_0x1b", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_MAGIC_ATTACK, "NA_SE_VO_LI_MAGIC_ATTACK", "NA_SE_VO_LI_MAGIC_ATTACK", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_BL_DOWN, "NA_SE_VO_BL_DOWN", "NA_SE_VO_BL_DOWN", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_DEMO_DAMAGE, "NA_SE_VO_LI_DEMO_DAMAGE", "NA_SE_VO_LI_DEMO_DAMAGE", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_ELECTRIC_SHOCK_LV, "NA_SE_VO_LI_ELECTRIC_SHOCK_LV",
                           "NA_SE_VO_LI_ELECTRIC_SHOCK_LV", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_SWORD_N_KID, "NA_SE_VO_LI_SWORD_N_KID", "NA_SE_VO_LI_SWORD_N_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_ROLLING_CUT_KID, "NA_SE_VO_LI_ROLLING_CUT_KID", "NA_SE_VO_LI_ROLLING_CUT_KID",
                           SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_LASH_KID, "NA_SE_VO_LI_LASH_KID", "NA_SE_VO_LI_LASH_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_HANG_KID, "NA_SE_VO_LI_HANG_KID", "NA_SE_VO_LI_HANG_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_CLIMB_END_KID, "NA_SE_VO_LI_CLIMB_END_KID", "NA_SE_VO_LI_CLIMB_END_KID",
                           SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_DAMAGE_S_KID, "NA_SE_VO_LI_DAMAGE_S_KID", "NA_SE_VO_LI_DAMAGE_S_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_FREEZE_KID, "NA_SE_VO_LI_FREEZE_KID", "NA_SE_VO_LI_FREEZE_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_FALL_S_KID, "NA_SE_VO_LI_FALL_S_KID", "NA_SE_VO_LI_FALL_S_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_FALL_L_KID, "NA_SE_VO_LI_FALL_L_KID", "NA_SE_VO_LI_FALL_L_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_BREATH_REST_KID, "NA_SE_VO_LI_BREATH_REST_KID", "NA_SE_VO_LI_BREATH_REST_KID",
                           SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_BREATH_DRINK_KID, "NA_SE_VO_LI_BREATH_DRINK_KID", "NA_SE_VO_LI_BREATH_DRINK_KID",
                           SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_DOWN_KID, "NA_SE_VO_LI_DOWN_KID", "NA_SE_VO_LI_DOWN_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_TAKEN_AWAY_KID, "NA_SE_VO_LI_TAKEN_AWAY_KID", "NA_SE_VO_LI_TAKEN_AWAY_KID",
                           SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_HELD_KID, "NA_SE_VO_LI_HELD_KID", "NA_SE_VO_LI_HELD_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_SNEEZE_KID, "NA_SE_VO_LI_SNEEZE_KID", "NA_SE_VO_LI_SNEEZE_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_SWEAT_KID, "NA_SE_VO_LI_SWEAT_KID", "NA_SE_VO_LI_SWEAT_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_DRINK_KID, "NA_SE_VO_LI_DRINK_KID", "NA_SE_VO_LI_DRINK_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_RELAX_KID, "NA_SE_VO_LI_RELAX_KID", "NA_SE_VO_LI_RELAX_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_SWORD_PUTAWAY_KID, "NA_SE_VO_LI_SWORD_PUTAWAY_KID",
                           "NA_SE_VO_LI_SWORD_PUTAWAY_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_GROAN_KID, "NA_SE_VO_LI_GROAN_KID", "NA_SE_VO_LI_GROAN_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_AUTO_JUMP_KID, "NA_SE_VO_LI_AUTO_JUMP_KID", "NA_SE_VO_LI_AUTO_JUMP_KID",
                           SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_MAGIC_NALE_KID, "NA_SE_VO_LI_MAGIC_NALE_KID", "NA_SE_VO_LI_MAGIC_NALE_KID",
                           SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_SURPRISE_KID, "NA_SE_VO_LI_SURPRISE_KID", "NA_SE_VO_LI_SURPRISE_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_MAGIC_FROL_KID, "NA_SE_VO_LI_MAGIC_FROL_KID", "NA_SE_VO_LI_MAGIC_FROL_KID",
                           SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_PUSH_KID, "NA_SE_VO_LI_PUSH_KID", "NA_SE_VO_LI_PUSH_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_HOOKSHOT_HANG_KID, "NA_SE_VO_LI_HOOKSHOT_HANG_KID",
                           "NA_SE_VO_LI_HOOKSHOT_HANG_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_LAND_DAMAGE_S_KID, "NA_SE_VO_LI_LAND_DAMAGE_S_KID",
                           "NA_SE_VO_LI_LAND_DAMAGE_S_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_NULL_0x1b_KID, "NA_SE_VO_LI_NULL_0x1b_KID", "NA_SE_VO_LI_NULL_0x1b_KID",
                           SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_MAGIC_ATTACK_KID, "NA_SE_VO_LI_MAGIC_ATTACK_KID", "NA_SE_VO_LI_MAGIC_ATTACK_KID",
                           SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_BL_DOWN_KID, "NA_SE_VO_BL_DOWN_KID", "NA_SE_VO_BL_DOWN_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_DEMO_DAMAGE_KID, "NA_SE_VO_LI_DEMO_DAMAGE_KID", "NA_SE_VO_LI_DEMO_DAMAGE_KID",
                           SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_ELECTRIC_SHOCK_LV_KID, "NA_SE_VO_LI_ELECTRIC_SHOCK_LV_KID",
                           "NA_SE_VO_LI_ELECTRIC_SHOCK_LV_KID", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_NAVY_ENEMY, "NA_SE_VO_NAVY_ENEMY", "NA_SE_VO_NAVY_ENEMY", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_NAVY_HELLO, "NA_SE_VO_NAVY_HELLO", "NA_SE_VO_NAVY_HELLO", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_NAVY_HEAR, "NA_SE_VO_NAVY_HEAR", "NA_SE_VO_NAVY_HEAR", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_NAVY_CALL, "NA_SE_VO_NAVY_CALL", "NA_SE_VO_NAVY_CALL", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_NA_HELLO_3, "NA_SE_VO_NA_HELLO_3", "NA_SE_VO_NA_HELLO_3", SEQ_VOICE),
        ...
        SEQUENCE_MAP_ENTRY(NA_SE_VO_TA_SLEEP, "NA_SE_VO_TA_SLEEP", "NA_SE_VO_TA_SLEEP", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_TA_SURPRISE, "NA_SE_VO_TA_SURPRISE", "NA_SE_VO_TA_SURPRISE", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_TA_CRY_0, "NA_SE_VO_TA_CRY_0", "NA_SE_VO_TA_CRY_0", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_TA_CRY_1, "NA_SE_VO_TA_CRY_1", "NA_SE_VO_TA_CRY_1", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_IN_CRY_0, "NA_SE_VO_IN_CRY_0", "NA_SE_VO_IN_CRY_0", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_IN_LOST, "NA_SE_VO_IN_LOST", "NA_SE_VO_IN_LOST", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_IN_LASH_0, "NA_SE_VO_IN_LASH_0", "NA_SE_VO_IN_LASH_0", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_IN_LASH_1, "NA_SE_VO_IN_LASH_1", "NA_SE_VO_IN_LASH_1", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_FR_LAUGH_0, "NA_SE_VO_FR_LAUGH_0", "NA_SE_VO_FR_LAUGH_0", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_FR_SMILE_0, "NA_SE_VO_FR_SMILE_0", "NA_SE_VO_FR_SMILE_0", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_NB_AGONY, "NA_SE_VO_NB_AGONY", "NA_SE_VO_NB_AGONY", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_NB_CRY_0, "NA_SE_VO_NB_CRY_0", "NA_SE_VO_NB_CRY_0", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_NB_NOTICE, "NA_SE_VO_NB_NOTICE", "NA_SE_VO_NB_NOTICE", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_NA_HELLO_0, "NA_SE_VO_NA_HELLO_0", "NA_SE_VO_NA_HELLO_0", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_NA_HELLO_1, "NA_SE_VO_NA_HELLO_1", "NA_SE_VO_NA_HELLO_1", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_NA_HELLO_2, "NA_SE_VO_NA_HELLO_2", "NA_SE_VO_NA_HELLO_2", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_RT_CRASH, "NA_SE_VO_RT_CRASH", "NA_SE_VO_RT_CRASH", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_RT_DISCOVER, "NA_SE_VO_RT_DISCOVER", "NA_SE_VO_RT_DISCOVER", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_RT_FALL, "NA_SE_VO_RT_FALL", "NA_SE_VO_RT_FALL", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_RT_LAUGH_0, "NA_SE_VO_RT_LAUGH_0", "NA_SE_VO_RT_LAUGH_0", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_RT_LIFT, "NA_SE_VO_RT_LIFT", "NA_SE_VO_RT_LIFT", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_RT_THROW, "NA_SE_VO_RT_THROW", "NA_SE_VO_RT_THROW", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_RT_UNBALLANCE, "NA_SE_VO_RT_UNBALLANCE", "NA_SE_VO_RT_UNBALLANCE", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_ST_DAMAGE, "NA_SE_VO_ST_DAMAGE", "NA_SE_VO_ST_DAMAGE", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_ST_ATTACK, "NA_SE_VO_ST_ATTACK", "NA_SE_VO_ST_ATTACK", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_Z0_HURRY, "NA_SE_VO_Z0_HURRY", "NA_SE_VO_Z0_HURRY", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_Z0_MEET, "NA_SE_VO_Z0_MEET", "NA_SE_VO_Z0_MEET", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_Z0_QUESTION, "NA_SE_VO_Z0_QUESTION", "NA_SE_VO_Z0_QUESTION", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_Z0_SIGH_0, "NA_SE_VO_Z0_SIGH_0", "NA_SE_VO_Z0_SIGH_0", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_Z0_SMILE_0, "NA_SE_VO_Z0_SMILE_0", "NA_SE_VO_Z0_SMILE_0", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_Z0_SURPRISE, "NA_SE_VO_Z0_SURPRISE", "NA_SE_VO_Z0_SURPRISE", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_Z0_THROW, "NA_SE_VO_Z0_THROW", "NA_SE_VO_Z0_THROW", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_SK_CRY_0, "NA_SE_VO_SK_CRY_0", "NA_SE_VO_SK_CRY_0", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_SK_CRY_1, "NA_SE_VO_SK_CRY_1", "NA_SE_VO_SK_CRY_1", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_SK_CRASH, "NA_SE_VO_SK_CRASH", "NA_SE_VO_SK_CRASH", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_SK_LAUGH, "NA_SE_VO_SK_LAUGH", "NA_SE_VO_SK_LAUGH", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_SK_SHOUT, "NA_SE_VO_SK_SHOUT", "NA_SE_VO_SK_SHOUT", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_Z1_CRY_0, "NA_SE_VO_Z1_CRY_0", "NA_SE_VO_Z1_CRY_0", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_Z1_CRY_1, "NA_SE_VO_Z1_CRY_1", "NA_SE_VO_Z1_CRY_1", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_Z1_OPENDOOR, "NA_SE_VO_Z1_OPENDOOR", "NA_SE_VO_Z1_OPENDOOR", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_Z1_SURPRISE, "NA_SE_VO_Z1_SURPRISE", "NA_SE_VO_Z1_SURPRISE", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_Z1_PAIN, "NA_SE_VO_Z1_PAIN", "NA_SE_VO_Z1_PAIN", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_KZ_MOVE, "NA_SE_VO_KZ_MOVE", "NA_SE_VO_KZ_MOVE", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_NB_LAUGH, "NA_SE_VO_NB_LAUGH", "NA_SE_VO_NB_LAUGH", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_IN_LAUGH, "NA_SE_VO_IN_LAUGH", "NA_SE_VO_IN_LAUGH", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_DUMMY_0x7d, "NA_SE_VO_DUMMY_0x7d", "NA_SE_VO_DUMMY_0x7d", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_DUMMY_0x7e, "NA_SE_VO_DUMMY_0x7e", "NA_SE_VO_DUMMY_0x7e", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_DUMMY_0x7f, "NA_SE_VO_DUMMY_0x7f", "NA_SE_VO_DUMMY_0x7f", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_DUMMY_0x80, "NA_SE_VO_DUMMY_0x80", "NA_SE_VO_DUMMY_0x80", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_LI_AUTO_JUMP_DARKLINK, "NA_SE_VO_LI_AUTO_JUMP_DARKLINK",    "NA_SE_VO_LI_AUTO_JUMP_DARKLINK", SEQ_VOICE),
        SEQUENCE_MAP_ENTRY(NA_SE_VO_DUMMY_0x82_YOBI, "NA_SE_VO_DUMMY_0x82_YOBI", "NA_SE_VO_DUMMY_0x82_YOBI", SEQ_VOICE),
