...
const char* enemyCVarList[] = {
    CVAR_ENHANCEMENT("RandomizedEnemyList.Keese"),          CVAR_ENHANCEMENT("RandomizedEnemyList.FireKeese"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.IceKeese"),       CVAR_ENHANCEMENT("RandomizedEnemyList.Stalfos"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.RedTektite"),     CVAR_ENHANCEMENT("RandomizedEnemyList.BlueTektite"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.Wallmaster"),     CVAR_ENHANCEMENT("RandomizedEnemyList.Dodongo"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.FlyingPeahat"),   CVAR_ENHANCEMENT("RandomizedEnemyList.PeahatLarva"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.Lizalfos"),       CVAR_ENHANCEMENT("RandomizedEnemyList.Dinolfos"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.GohmaLarva"),     CVAR_ENHANCEMENT("RandomizedEnemyList.Shabom"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.BabyDodongo"),    CVAR_ENHANCEMENT("RandomizedEnemyList.DarkLink"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.Biri"),           CVAR_ENHANCEMENT("RandomizedEnemyList.Tailparasan"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.Skulltula"),      CVAR_ENHANCEMENT("RandomizedEnemyList.BigSkulltula"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.InvisSkulltula"), CVAR_ENHANCEMENT("RandomizedEnemyList.TorchSlug"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.Stinger"),        CVAR_ENHANCEMENT("RandomizedEnemyList.ClubMoblin"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.SmallBaba"),      CVAR_ENHANCEMENT("RandomizedEnemyList.LargeBaba"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.Armos"),          CVAR_ENHANCEMENT("RandomizedEnemyList.MadScrub"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.Bari"),           CVAR_ENHANCEMENT("RandomizedEnemyList.Bubble"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.FloorTile"),      CVAR_ENHANCEMENT("RandomizedEnemyList.Beamos"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.Floormaster"),    CVAR_ENHANCEMENT("RandomizedEnemyList.Redead"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.Gibdo"),          CVAR_ENHANCEMENT("RandomizedEnemyList.ShellBlade"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.WitheredBaba"),   CVAR_ENHANCEMENT("RandomizedEnemyList.LikeLike"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.Spike"),          CVAR_ENHANCEMENT("RandomizedEnemyList.BlackKnuckle"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.WhiteKnuckle"),   CVAR_ENHANCEMENT("RandomizedEnemyList.FlyingPot"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.Freezard"),       CVAR_ENHANCEMENT("RandomizedEnemyList.Arwing"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.NormalWolfos"),   CVAR_ENHANCEMENT("RandomizedEnemyList.WhiteWolfos"),
    CVAR_ENHANCEMENT("RandomizedEnemyList.SmallStalchild"), CVAR_ENHANCEMENT("RandomizedEnemyList.BigStalchild"),
