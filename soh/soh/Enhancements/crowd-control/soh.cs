...
public class SoH : SimpleTCPPack
{
	...
	public override List<Effect> Effects => new List<Effect>
	{
        ...
        new Effect("Iron Boots", "iron_boots", "link_modifiers") { Duration = 30 },
        new Effect("Hover Boots", "hover_boots", "link_modifiers") { Duration = 30 },
        ...
        new Effect("Take Deku Sticks", "take_dekusticks", new[] { "ammo30" }, "take_item"),
        new Effect("Take Deku Nuts", "take_dekunuts", new[] { "ammo30" }, "take_item"),
