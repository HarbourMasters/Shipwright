...
#define COSMETIC_OPTION(id, label, group, defaultColor, supportsAlpha, supportsRainbow, advancedOption) \
    { id, { \
        COSMETIC_CVAR(id ".Color"), COSMETIC_CVAR(id ".Rainbow"), COSMETIC_CVAR(id ".Locked"), COSMETIC_CVAR(id ".Changed"), label, group, \
        defaultColor, defaultColor, supportsAlpha, supportsRainbow, advancedOption \
    } }
...
/*
    ...
    if (CVarGetInteger(COSMETIC_CVAR("World_Moon.Changed"), 0)) {
        Color_RGB8 moonColor = CVarGetColor24(COSMETIC_CVAR("World_Moon.Value"), (Color_RGB8){ 0, 0, 240 });
...
static std::map<std::string, CosmeticOption> cosmeticOptions = {
    COSMETIC_OPTION("Link_KokiriTunic",              "Kokiri Tunic",         GROUP_LINK,         Color_RGBA8( 30, 105,  27, 255), false, true, false),
    COSMETIC_OPTION("Link_GoronTunic",               "Goron Tunic",          GROUP_LINK,         Color_RGBA8(100,  20,   0, 255), false, true, false),
    COSMETIC_OPTION("Link_ZoraTunic",                "Zora Tunic",           GROUP_LINK,         Color_RGBA8(  0,  60, 100, 255), false, true, false),
    COSMETIC_OPTION("Link_Hair",                     "Hair",                 GROUP_LINK,         Color_RGBA8(255, 173,  27, 255), false, true, true),
    COSMETIC_OPTION("Link_Linen",                    "Linen",                GROUP_LINK,         Color_RGBA8(255, 255, 255, 255), false, true, true),
    COSMETIC_OPTION("Link_Boots",                    "Boots",                GROUP_LINK,         Color_RGBA8( 93,  44,  18, 255), false, true, true),
    
    COSMETIC_OPTION("MirrorShield_Body",             "Body",                 GROUP_MIRRORSHIELD, Color_RGBA8(215,   0,   0, 255), false, true, false),
    COSMETIC_OPTION("MirrorShield_Mirror",           "Mirror",               GROUP_MIRRORSHIELD, Color_RGBA8(255, 255, 255, 255), false, true, true),
    COSMETIC_OPTION("MirrorShield_Emblem",           "Emblem",               GROUP_MIRRORSHIELD, Color_RGBA8(205, 225, 255, 255), false, true, true),

    COSMETIC_OPTION("Swords_KokiriBlade",            "Kokiri Sword Blade",   GROUP_SWORDS,       Color_RGBA8(255, 255, 255, 255), false, true, false),
    // COSMETIC_OPTION("Swords_KokiriHilt",             "Kokiri Sword Hilt",    GROUP_SWORDS,       Color_RGBA8(160, 100,  15, 255), false, true, true), // Todo (Cosmetics): Broken, need a better way to grayscale
    COSMETIC_OPTION("Swords_MasterBlade",            "Master Sword Blade",   GROUP_SWORDS,       Color_RGBA8(255, 255, 255, 255), false, true, false),
    // COSMETIC_OPTION("Swords_MasterHilt",             "Master Sword Hilt",    GROUP_SWORDS,       Color_RGBA8( 80,  80, 168, 255), false, true, true), // Todo (Cosmetics): Broken, need a better way to grayscale
    COSMETIC_OPTION("Swords_BiggoronBlade",          "Biggoron Sword Blade", GROUP_SWORDS,       Color_RGBA8(255, 255, 255, 255), false, true, false),
    // COSMETIC_OPTION("Swords_BiggoronHilt",           "Biggoron Sword Hilt",  GROUP_SWORDS,       Color_RGBA8( 80,  80, 168, 255), false, true, true), // Todo (Cosmetics): Broken, need a better way to grayscale

    COSMETIC_OPTION("Gloves_GoronBracelet",          "Goron Bracelet",       GROUP_GLOVES,       Color_RGBA8(255, 255, 170, 255), false, true, false),
    COSMETIC_OPTION("Gloves_SilverGauntlets",        "Silver Gauntlets",     GROUP_GLOVES,       Color_RGBA8(255, 255, 255, 255), false, true, false),
    COSMETIC_OPTION("Gloves_GoldenGauntlets",        "Golden Gauntlets",     GROUP_GLOVES,       Color_RGBA8(254, 207,  15, 255), false, true, false),
    COSMETIC_OPTION("Gloves_GauntletsGem",           "Gauntlets Gem",        GROUP_GLOVES,       Color_RGBA8(255,  60, 100, 255), false, true, true),
    
    COSMETIC_OPTION("Equipment_BoomerangBody",       "Boomerang Body",       GROUP_EQUIPMENT,    Color_RGBA8(160, 100,   0, 255), false, true, false),
    COSMETIC_OPTION("Equipment_BoomerangGem",        "Boomerang Gem",        GROUP_EQUIPMENT,    Color_RGBA8(255,  50, 150, 255), false, true, true),
    // COSMETIC_OPTION("Equipment_SlingshotBody",       "Slingshot Body",       GROUP_EQUIPMENT,    Color_RGBA8(160, 100,   0, 255), false, true, true), // Todo (Cosmetics): Broken, need a better way to grayscale
    COSMETIC_OPTION("Equipment_SlingshotString",     "Slingshot String",     GROUP_EQUIPMENT,    Color_RGBA8(255, 255, 255, 255), false, true, true),
    COSMETIC_OPTION("Equipment_HammerHead",          "Hammer Head",          GROUP_EQUIPMENT,    Color_RGBA8(155, 192, 201, 255), false, true, false),
    COSMETIC_OPTION("Equipment_HammerHandle",        "Hammer Handle",        GROUP_EQUIPMENT,    Color_RGBA8(110,  60,   0, 255), false, true, true),
    // COSMETIC_OPTION("Equipment_HookshotChain",       "Hookshot Chain",       GROUP_EQUIPMENT,    Color_RGBA8(255, 255, 255, 255), false, true, true), // Todo (Cosmetics): Implement
    // COSMETIC_OPTION("Equipment_HookshotTip",         "Hookshot Tip",         GROUP_EQUIPMENT,    Color_RGBA8(255, 255, 255, 255), false, true, false), // Todo (Cosmetics): Implement
    COSMETIC_OPTION("HookshotReticle_Target",        "Hookshotable Reticle", GROUP_EQUIPMENT,         Color_RGBA8(  0, 255,   0, 255), false, false, false),
    COSMETIC_OPTION("HookshotReticle_NonTarget",     "Non-Hookshotable Reticle", GROUP_EQUIPMENT,     Color_RGBA8(255,   0,   0, 255), false, false, false),
    COSMETIC_OPTION("Equipment_BowTips",             "Bow Tips",             GROUP_EQUIPMENT,    Color_RGBA8(200,   0,   0, 255), false, true, true),
    COSMETIC_OPTION("Equipment_BowString",           "Bow String",           GROUP_EQUIPMENT,    Color_RGBA8(255, 255, 255, 255), false, true, true),
    COSMETIC_OPTION("Equipment_BowBody",             "Bow Body",             GROUP_EQUIPMENT,    Color_RGBA8(140,  90,  10, 255), false, true, false),
    COSMETIC_OPTION("Equipment_BowHandle",           "Bow Handle",           GROUP_EQUIPMENT,    Color_RGBA8( 50, 150, 255, 255), false, true, true),
    COSMETIC_OPTION("Equipment_ChuFace",             "Bombchu Face",         GROUP_EQUIPMENT,    Color_RGBA8(  0, 100, 150, 255), false, true, true),
    COSMETIC_OPTION("Equipment_ChuBody",             "Bombchu Body",         GROUP_EQUIPMENT,    Color_RGBA8(180, 130,  50, 255), false, true, true), 

    COSMETIC_OPTION("Consumable_Hearts",             "Hearts",               GROUP_CONSUMABLE,   Color_RGBA8(255,  70,  50, 255), false, true, false),
    COSMETIC_OPTION("Consumable_HeartBorder",        "Heart Border",         GROUP_CONSUMABLE,   Color_RGBA8( 50,  40,  60, 255), false, true, true),
    COSMETIC_OPTION("Consumable_DDHearts",           "DD Hearts",            GROUP_CONSUMABLE,   Color_RGBA8(200,   0,   0, 255), false, true, false),
    COSMETIC_OPTION("Consumable_DDHeartBorder",      "DD Heart Border",      GROUP_CONSUMABLE,   Color_RGBA8(255, 255, 255, 255), false, true, true),
    COSMETIC_OPTION("Consumable_Magic",              "Magic",                GROUP_CONSUMABLE,   Color_RGBA8(  0, 200,   0, 255), false, true, false),
    COSMETIC_OPTION("Consumable_MagicActive",        "Magic Active",         GROUP_CONSUMABLE,   Color_RGBA8(250, 250,   0, 255), false, true, true),
    COSMETIC_OPTION("Consumable_MagicBorder",        "Magic Border",         GROUP_CONSUMABLE,   Color_RGBA8(255, 255, 255, 255), false, false, true),
    COSMETIC_OPTION("Consumable_MagicBorderActive",  "Magic Border Active",  GROUP_CONSUMABLE,   Color_RGBA8(255, 255, 255, 255), false, false, true),
    COSMETIC_OPTION("Consumable_GreenRupee",         "Green Rupee",          GROUP_CONSUMABLE,   Color_RGBA8( 50, 255,  50, 255), false, true, true),
    COSMETIC_OPTION("Consumable_BlueRupee",          "Blue Rupee",           GROUP_CONSUMABLE,   Color_RGBA8( 50,  50, 255, 255), false, true, true),
    COSMETIC_OPTION("Consumable_RedRupee",           "Red Rupee",            GROUP_CONSUMABLE,   Color_RGBA8(255,  50,  50, 255), false, true, true),
    COSMETIC_OPTION("Consumable_PurpleRupee",        "Purple Rupee",         GROUP_CONSUMABLE,   Color_RGBA8(150,  50, 255, 255), false, true, true),
    COSMETIC_OPTION("Consumable_GoldRupee",          "Gold Rupee",           GROUP_CONSUMABLE,   Color_RGBA8(255, 190,  55, 255), false, true, true),
    COSMETIC_OPTION("Consumable_SilverRupee",        "Silver Rupee",         GROUP_CONSUMABLE,   Color_RGBA8(255, 255, 255, 255), false, true, true),

    COSMETIC_OPTION("Hud_ButtonA",                   "A Button",             GROUP_HUD,          Color_RGBA8( 90,  90, 255, 255), false, true, false),
    COSMETIC_OPTION("Hud_ButtonB",                   "B Button",             GROUP_HUD,          Color_RGBA8(  0, 150,   0, 255), false, true, false),
    COSMETIC_OPTION("Hud_CButtons",                  "C Buttons",            GROUP_HUD,          Color_RGBA8(255, 160,   0, 255), false, true, false),
    COSMETIC_OPTION("Hud_ButtonCUp",                 "C Up Button",          GROUP_HUD,          Color_RGBA8(255, 160,   0, 255), false, true, true),
    COSMETIC_OPTION("Hud_ButtonCDown",               "C Down Button",        GROUP_HUD,          Color_RGBA8(255, 160,   0, 255), false, true, true),
    COSMETIC_OPTION("Hud_ButtonCLeft",               "C Left Button",        GROUP_HUD,          Color_RGBA8(255, 160,   0, 255), false, true, true),
    COSMETIC_OPTION("Hud_ButtonCRight",              "C Right Button",       GROUP_HUD,          Color_RGBA8(255, 160,   0, 255), false, true, true),
    COSMETIC_OPTION("Hud_ButtonStart",               "Start Button",         GROUP_HUD,          Color_RGBA8(200,   0,   0, 255), false, true, false),
    COSMETIC_OPTION("Hud_Dpad",                      "Dpad",                 GROUP_HUD,          Color_RGBA8(255, 255, 255, 255), false, true, false),
    COSMETIC_OPTION("Hud_KeyCount",                  "Key Count",            GROUP_HUD,          Color_RGBA8(200, 230, 255, 255), false, true, true),
    COSMETIC_OPTION("Hud_StoneOfAgony",              "Stone of Agony",       GROUP_HUD,          Color_RGBA8(255, 255, 255, 255), false, true, true),
    COSMETIC_OPTION("Hud_Minimap",                   "Minimap",              GROUP_HUD,          Color_RGBA8(  0, 255, 255, 255), false, true, false),
    COSMETIC_OPTION("Hud_MinimapPosition",           "Minimap Position",     GROUP_HUD,          Color_RGBA8(200, 255,   0, 255), false, true, true),
    COSMETIC_OPTION("Hud_MinimapEntrance",           "Minimap Entrance",     GROUP_HUD,          Color_RGBA8(200,   0,   0, 255), false, true, true),
    COSMETIC_OPTION("Hud_EnemyHealthBar",            "Enemy Health Bar",     GROUP_HUD,          Color_RGBA8(255,   0,   0, 255), true, true, false),
    COSMETIC_OPTION("Hud_EnemyHealthBorder",         "Enemy Health Border",  GROUP_HUD,          Color_RGBA8(255, 255, 255, 255), true, false, true),
    COSMETIC_OPTION("Hud_NameTagActorText",          "Nametag Text",         GROUP_HUD,          Color_RGBA8(255, 255, 255, 255), true, true, false),
    COSMETIC_OPTION("Hud_NameTagActorBackground",    "Nametag Background",   GROUP_HUD,          Color_RGBA8(0,     0,   0,  80), true, false, true),

    COSMETIC_OPTION("Title_FileChoose",              "File Choose",          GROUP_TITLE,        Color_RGBA8(100, 150, 255, 255), false, true, false),
    COSMETIC_OPTION("Title_NintendoLogo",            "Nintendo Logo",        GROUP_TITLE,        Color_RGBA8(  0,   0, 255, 255), false, true, true),
    COSMETIC_OPTION("Title_N64LogoRed",              "N64 Red",              GROUP_TITLE,        Color_RGBA8(150,   0,   0, 255), false, true, true),
    COSMETIC_OPTION("Title_N64LogoBlue",             "N64 Blue",             GROUP_TITLE,        Color_RGBA8(  0,  50, 150, 255), false, true, true),
    COSMETIC_OPTION("Title_N64LogoGreen",            "N64 Green",            GROUP_TITLE,        Color_RGBA8( 50, 100,   0, 255), false, true, true),
    COSMETIC_OPTION("Title_N64LogoYellow",           "N64 Yellow",           GROUP_TITLE,        Color_RGBA8(200, 150,   0, 255), false, true, true),
    // COSMETIC_OPTION("Title_FirePrimary",             "Title Fire Primary",   GROUP_TITLE,        Color_RGBA8(255, 255, 170, 255), false, true, false), // Todo (Cosmetics): Kinda complicated
    // COSMETIC_OPTION("Title_FireSecondary",           "Title Fire Secondary", GROUP_TITLE,        Color_RGBA8(255, 100,   0, 255), false, true, true), // Todo (Cosmetics): Kinda complicated

    COSMETIC_OPTION("Arrows_NormalPrimary",          "Normal Primary",       GROUP_ARROWS,       Color_RGBA8(  0, 150,   0,   0), false, true, false),
    COSMETIC_OPTION("Arrows_NormalSecondary",        "Normal Secondary",     GROUP_ARROWS,       Color_RGBA8(255, 255, 170, 255), false, true, true),
    COSMETIC_OPTION("Arrows_FirePrimary",            "Fire Primary",         GROUP_ARROWS,       Color_RGBA8(255, 200,   0,   0), false, true, false),
    COSMETIC_OPTION("Arrows_FireSecondary",          "Fire Secondary",       GROUP_ARROWS,       Color_RGBA8(255,   0,   0, 255), false, true, true),
    COSMETIC_OPTION("Arrows_IcePrimary",             "Ice Primary",          GROUP_ARROWS,       Color_RGBA8(  0,   0, 255, 255), false, true, false),
    COSMETIC_OPTION("Arrows_IceSecondary",           "Ice Secondary",        GROUP_ARROWS,       Color_RGBA8(255, 255, 255, 255), false, true, true),
    COSMETIC_OPTION("Arrows_LightPrimary",           "Light Primary",        GROUP_ARROWS,       Color_RGBA8(255, 255,   0, 255), false, true, false),
    COSMETIC_OPTION("Arrows_LightSecondary",         "Light Secondary",      GROUP_ARROWS,       Color_RGBA8(255, 255, 170,   0), false, true, true),

    // COSMETIC_OPTION("Magic_DinsPrimary",             "Din's Primary",        GROUP_MAGIC,        Color_RGBA8(255, 255, 255, 255), false, true, false), // Todo (Cosmetics): Replace gDF_Col
    // COSMETIC_OPTION("Magic_DinsSecondary",           "Din's Secondary",      GROUP_MAGIC,        Color_RGBA8(255, 255, 255, 255), false, true, true), // Todo (Cosmetics): Replace gDF_Env
    // COSMETIC_OPTION("Magic_FaroresPrimary",          "Farore's Primary",     GROUP_MAGIC,        Color_RGBA8(255, 255, 255, 255), false, true, false), // Todo (Cosmetics): Implement
    // COSMETIC_OPTION("Magic_FaroresSecondary",        "Farore's Secondary",   GROUP_MAGIC,        Color_RGBA8(255, 255, 255, 255), false, true, true), // Todo (Cosmetics): Implement
    // COSMETIC_OPTION("Magic_NayrusPrimary",           "Nayru's Primary",      GROUP_MAGIC,        Color_RGBA8(255, 255, 255, 255), false, true, false), // Todo (Cosmetics): Replace gNL_Diamond_Col / gNL_Orb_Col
    // COSMETIC_OPTION("Magic_NayrusSecondary",         "Nayru's Secondary",    GROUP_MAGIC,        Color_RGBA8(255, 255, 255, 255), false, true, true), // Todo (Cosmetics): Replace gNL_Diamond_Env / gNL_Orb_Env

    COSMETIC_OPTION("SpinAttack_Level1Primary",      "Level 1 Primary",      GROUP_SPIN_ATTACK,  Color_RGBA8(170, 255, 255, 255), false, true, true),
    COSMETIC_OPTION("SpinAttack_Level1Secondary",    "Level 1 Secondary",    GROUP_SPIN_ATTACK,  Color_RGBA8(  0, 100, 255, 255), false, true, false),
    COSMETIC_OPTION("SpinAttack_Level2Primary",      "Level 2 Primary",      GROUP_SPIN_ATTACK,  Color_RGBA8(255, 255, 170, 255), false, true, true),
    COSMETIC_OPTION("SpinAttack_Level2Secondary",    "Level 2 Secondary",    GROUP_SPIN_ATTACK,  Color_RGBA8(255, 100,   0, 255), false, true, false),

    COSMETIC_OPTION("Trails_Bombchu",                "Bombchu",              GROUP_TRAILS,       Color_RGBA8(250,   0,   0, 255), false, true, true),
    COSMETIC_OPTION("Trails_Boomerang",              "Boomerang",            GROUP_TRAILS,       Color_RGBA8(255, 255, 100, 255), false, true, true),
    COSMETIC_OPTION("Trails_KokiriSword",            "Kokiri Sword",         GROUP_TRAILS,       Color_RGBA8(255, 255, 255, 255), false, true, false),
    COSMETIC_OPTION("Trails_MasterSword",            "Master Sword",         GROUP_TRAILS,       Color_RGBA8(255, 255, 255, 255), false, true, false),
    COSMETIC_OPTION("Trails_BiggoronSword",          "Biggoron Sword",       GROUP_TRAILS,       Color_RGBA8(255, 255, 255, 255), false, true, true),
    COSMETIC_OPTION("Trails_Stick",                  "Stick",                GROUP_TRAILS,       Color_RGBA8(255, 255, 255, 255), false, true, true),
    COSMETIC_OPTION("Trails_Hammer",                 "Hammer",               GROUP_TRAILS,       Color_RGBA8(255, 255, 255, 255), false, true, true),

    COSMETIC_OPTION("World_BlockOfTime",             "Block of Time",        GROUP_WORLD,        Color_RGBA8(255, 255, 255, 255), false, true, true),
    COSMETIC_OPTION("World_Moon",                    "Moon",                 GROUP_WORLD,        Color_RGBA8(240, 255, 180, 255), false, true, true),
    COSMETIC_OPTION("World_GossipStone",             "Gossip Stone",         GROUP_WORLD,        Color_RGBA8(200, 200, 200, 255), false, true, true),
    COSMETIC_OPTION("World_RedIce",                  "Red Ice",              GROUP_WORLD,        Color_RGBA8(255,   0,   0, 255), false, true, false),

    COSMETIC_OPTION("Navi_IdlePrimary",              "Idle Primary",         GROUP_NAVI,         Color_RGBA8(255, 255, 255, 255), false, true, false),
    COSMETIC_OPTION("Navi_IdleSecondary",            "Idle Secondary",       GROUP_NAVI,         Color_RGBA8(  0,   0, 255,   0), false, true, true),
    COSMETIC_OPTION("Navi_NPCPrimary",               "NPC Primary",          GROUP_NAVI,         Color_RGBA8(150, 150, 255, 255), false, true, false),
    COSMETIC_OPTION("Navi_NPCSecondary",             "NPC Secondary",        GROUP_NAVI,         Color_RGBA8(150, 150, 255,   0), false, true, true),
    COSMETIC_OPTION("Navi_EnemyPrimary",             "Enemy Primary",        GROUP_NAVI,         Color_RGBA8(255, 255,   0, 255), false, true, false),
    COSMETIC_OPTION("Navi_EnemySecondary",           "Enemy Secondary",      GROUP_NAVI,         Color_RGBA8(200, 155,   0,   0), false, true, true),
    COSMETIC_OPTION("Navi_PropsPrimary",             "Props Primary",        GROUP_NAVI,         Color_RGBA8(  0, 255,   0, 255), false, true, false),
    COSMETIC_OPTION("Navi_PropsSecondary",           "Props Secondary",      GROUP_NAVI,         Color_RGBA8(  0, 255,   0,   0), false, true, true),

    COSMETIC_OPTION("NPC_FireKeesePrimary",          "Fire Keese Primary",   GROUP_NPC,          Color_RGBA8(255, 255, 255, 255), false, true, false),
    COSMETIC_OPTION("NPC_FireKeeseSecondary",        "Fire Keese Secondary", GROUP_NPC,          Color_RGBA8(255, 255, 255, 255), false, true, true),
    COSMETIC_OPTION("NPC_IceKeesePrimary",           "Ice Keese Primary",    GROUP_NPC,          Color_RGBA8(255, 255, 255, 255), false, true, false),
    COSMETIC_OPTION("NPC_IceKeeseSecondary",         "Ice Keese Secondary",  GROUP_NPC,          Color_RGBA8(255, 255, 255, 255), false, true, true),
    // Todo (Cosmetics): Health fairy
    COSMETIC_OPTION("NPC_Dog1",                      "Dog 1",                GROUP_NPC,          Color_RGBA8(255, 255, 200, 255), false, true, true),
    COSMETIC_OPTION("NPC_Dog2",                      "Dog 2",                GROUP_NPC,          Color_RGBA8(150, 100,  50, 255), false, true, true),
    COSMETIC_OPTION("NPC_GoldenSkulltula",           "Golden Skulltula",     GROUP_NPC,          Color_RGBA8(255, 255, 255, 255), false, true, false),
    COSMETIC_OPTION("NPC_Kokiri",                    "Kokiri",               GROUP_NPC,          Color_RGBA8(  0, 130,  70, 255), false, true, false),
    COSMETIC_OPTION("NPC_Gerudo",                    "Gerudo",               GROUP_NPC,          Color_RGBA8( 90,   0, 140, 255), false, true, false),
    COSMETIC_OPTION("NPC_MetalTrap",                 "Metal Trap",           GROUP_NPC,          Color_RGBA8(255, 255, 255, 255), false, true, true),
    COSMETIC_OPTION("NPC_IronKnuckles",              "Iron Knuckles",        GROUP_NPC,          Color_RGBA8(245, 255, 205, 255), false, true, false),
};

static const char* MarginCvarList[] {
    "Hearts", "MagicBar", "VisualStone", "ButtonB", "ButtonA", "ButtonStart", 
    "ButtonCUp", "ButtonCDown", "ButtonCLeft", "ButtonCRight", "ButtonDpad", "Minimap", 
    "SmallKeys", "Rupees", "Carrots",  "Timers", "Archery", "MapTitleCard", "BossTitleCard", "InGameTimer"
};
static const char* MarginCvarNonAnchor[]{ "Carrots", "Timers", "Archery", "MapTitleCard","BossTitleCard" };
...
void SetMarginAll(const char* ButtonName, bool SetActivated) {
    if (ImGui::Button(ButtonName)) {
        ...
        for (const char* cvarName : MarginCvarList) {
            std::string cvarAnchor = std::string(COSMETIC_CVAR("Hud_")) + cvarName + ".AnchorType";
            std::string cvarNameMargins = std::string(COSMETIC_CVAR("Hud_")) + cvarName + ".UseMargins";
            if (CVarGetInteger(cvarAnchor.c_str(),0) <= 2 && SetActivated) { //Our element is not Hidden or Non anchor
                for (int i = 0; i < arrayLengthNonMargin; i++){
                    if ((strcmp(cvarName, MarginCvarNonAnchor[i]) == 0) && (CVarGetInteger(cvarAnchor.c_str(), 0) == 0)) { //Our element is both in original position and do not have anchor by default so we skip it.
                        CVarSetInteger(cvarNameMargins.c_str(), false); //force set off
                    } 
                    else if ((strcmp(cvarName, MarginCvarNonAnchor[i]) == 0) && (CVarGetInteger(cvarAnchor.c_str(), 0) != 0)) { //Our element is not in original position regarless it has no anchor by default since player made it anchored we can toggle margins
...
void ResetPositionAll() {
    if (ImGui::Button("Reset all positions")) {
        for (auto cvarName : MarginCvarList) {
            std::string cvarAnchor = std::string(COSMETIC_CVAR("Hud_")) + cvarName + ".AnchorType";
            std::string cvarNameMargins = std::string(COSMETIC_CVAR("Hud_")) + cvarName + ".UseMargins";
            CVarClear(cvarAnchor.c_str());
            CVarClear(cvarNameMargins.c_str()); //Turn margin off to everythings as that original position.
        }
    }
}
...
void CosmeticsUpdateTick() {
    int index = 0;
    float rainbowSpeed = CVarGetFloat(COSMETIC_CVAR("RainbowSpeed"), 0.6f);
    for (auto& [id, cosmeticOption] : cosmeticOptions) {
        if (cosmeticOption.supportsRainbow && CVarGetInteger(cosmeticOption.rainbowCvar, 0)) {
            ...
            if (cosmeticOption.supportsAlpha) {
                newColor.a = cosmeticOption.currentColor.a;
            }
            cosmeticOption.currentColor = newColor;
        ...
        if (!CVarGetInteger(COSMETIC_CVAR("RainbowSync"), 0)) {
...
void ApplyOrResetCustomGfxPatches(bool manualChange) {
    ...
    //     Color_RGBA8 color = CVarGetColor(swordsKokiriHilt.cvar, swordsKokiriBlade.defaultColor);
    ...
    if (gPlayState != nullptr) {
        if (CVarGetInteger(COSMETIC_CVAR("Link_BodyScale.Changed"), 0)) {
            static Player* player = GET_PLAYER(gPlayState);
            float scale = CVarGetFloat(COSMETIC_CVAR("Link_BodyScale.Value"), 0.01f);
...
void DrawUseMarginsSlider(const std::string ElementName, const std::string CvarName){
    std::string CvarLabel = COSMETIC_CVAR("Hud_") + CvarName + ".UseMargins";
...
void DrawPositionsRadioBoxes(const std::string CvarName, bool NoAnchorEnabled = true){
    std::string CvarLabel = COSMETIC_CVAR("Hud_") + CvarName + ".AnchorType";
...
void DrawPositionSlider(const std::string CvarName, int MinY, int MaxY, int MinX, int MaxX){
    std::string PosXCvar = COSMETIC_CVAR("Hud_") + CvarName + ".PosX";
    std::string PosYCvar = COSMETIC_CVAR("Hud_") + CvarName + ".PosY";
...
void DrawScaleSlider(const std::string CvarName,float DefaultValue){
    std::string CvarLabel = COSMETIC_CVAR("Hud_") + CvarName + ".Scale";
    std::string InvisibleLabel = "##" + CvarLabel;
...
void Draw_Placements(){
    if (ImGui::BeginTable("tableMargins", 1, FlagsTable)) {
        ...
        Table_InitHeader();
        UIWidgets::EnhancementSliderInt("Top : %dx", "##UIMARGINT", COSMETIC_CVAR("Hud_MarginTop"), (ImGui::GetWindowViewport()->Size.y/2)*-1, 25, "", 0);
        UIWidgets::EnhancementSliderInt("Left: %dx", "##UIMARGINL", COSMETIC_CVAR("Hud_MarginLeft"), -25, ImGui::GetWindowViewport()->Size.x, "", 0);
        UIWidgets::EnhancementSliderInt("Right: %dx", "##UIMARGINR", COSMETIC_CVAR("Hud_MarginRight"), (ImGui::GetWindowViewport()->Size.x)*-1, 25, "", 0);
        UIWidgets::EnhancementSliderInt("Bottom: %dx", "##UIMARGINB", COSMETIC_CVAR("Hud_MarginBottom"), (ImGui::GetWindowViewport()->Size.y/2)*-1, 25, "", 0);
    ...
    if (ImGui::CollapsingHeader("Hearts count position")) {
        if (ImGui::BeginTable("tableHeartsCounts", 1, FlagsTable)) {
            ...
            DrawUseMarginsSlider("Hearts counts", "Hearts");
            DrawPositionsRadioBoxes("Hearts");
            DrawPositionSlider("Hearts",-22,ImGui::GetWindowViewport()->Size.y,-125,ImGui::GetWindowViewport()->Size.x);
            DrawScaleSlider("Hearts",0.7f);
            UIWidgets::EnhancementSliderInt("Heart line length : %d", "##HeartLineLength", COSMETIC_CVAR("Hud_Hearts.LineLength"), 0, 20, "", 10);
    ...
    if (ImGui::CollapsingHeader("Magic Meter position")) {
        if (ImGui::BeginTable("tablemmpos", 1, FlagsTable)) {
            ...
            Table_InitHeader(false);
            DrawUseMarginsSlider("Magic meter", "MagicBar");
            DrawPositionsRadioBoxes("MagicBar");
            UIWidgets::EnhancementRadioButton("Anchor to life bar", COSMETIC_CVAR("Hud_MagicBar.AnchorType"), 5);
            UIWidgets::Tooltip("This will make your elements follow the bottom of the life meter");
            DrawPositionSlider("MagicBar", 0, ImGui::GetWindowViewport()->Size.y/2, -5, ImGui::GetWindowViewport()->Size.x/2);
            DrawScaleSlider("MagicBar",1.0f);
            ImGui::NewLine();
            ImGui::EndTable();
        }
    }
    if (CVarGetInteger("gVisualAgony",0) && ImGui::CollapsingHeader("Visual stone of agony position")) {
        if (ImGui::BeginTable("tabledvisualstoneofagony", 1, FlagsTable)) {
            ...
            Table_InitHeader(false);
            DrawUseMarginsSlider("Visual stone of agony", "VisualStone");
            DrawPositionsRadioBoxes("VisualStone");
            s16 Min_X_VSOA = 0;
            s16 Max_X_VSOA = ImGui::GetWindowViewport()->Size.x/2;
            if(CVarGetInteger(COSMETIC_CVAR("Hud_StoneOfAgony.AnchorType"),0) == 2){
                Max_X_VSOA = 290;
            } else if(CVarGetInteger(COSMETIC_CVAR("Hud_StoneOfAgony.AnchorType"),0) == 4){
                Min_X_VSOA = (ImGui::GetWindowViewport()->Size.x/2)*-1;
            }
            DrawPositionSlider("VisualStone", 0, ImGui::GetWindowViewport()->Size.y/2, Min_X_VSOA, Max_X_VSOA);
            DrawScaleSlider("VisualStone",1.0f);
            ImGui::NewLine();
            ImGui::EndTable();
        }
    }
    if (ImGui::CollapsingHeader("B Button position")) {
        if (ImGui::BeginTable("tablebbtn", 1, FlagsTable)) {
            ...
            Table_InitHeader(false);
            DrawUseMarginsSlider("B Button", "ButtonB");
            DrawPositionsRadioBoxes("ButtonB");
            DrawPositionSlider("ButtonB", 0, ImGui::GetWindowViewport()->Size.y/4+50, -1, ImGui::GetWindowViewport()->Size.x-50);
            DrawScaleSlider("ButtonB",0.95f);
            ImGui::NewLine();
            ImGui::EndTable();
        }
    }
    if (ImGui::CollapsingHeader("A Button position")) {
        if (ImGui::BeginTable("tableabtn", 1, FlagsTable)) {
            ...
            Table_InitHeader(false);
            DrawUseMarginsSlider("A Button", "ButtonA");
            DrawPositionsRadioBoxes("ButtonA");
            DrawPositionSlider("ButtonA", -10, ImGui::GetWindowViewport()->Size.y/4+50, -20, ImGui::GetWindowViewport()->Size.x-50);
            DrawScaleSlider("ButtonA",0.95f);
            ImGui::NewLine();
            ImGui::EndTable();
        }
    }
    if (ImGui::CollapsingHeader("Start Button position")) {
        if (ImGui::BeginTable("tablestartbtn", 1, FlagsTable)) {
            ...
            Table_InitHeader(false);
            DrawUseMarginsSlider("Start Button", "ButtonStart");
            DrawPositionsRadioBoxes("ButtonStart");
            DrawPositionSlider("ButtonStart", 0, ImGui::GetWindowViewport()->Size.y/2, 0, ImGui::GetWindowViewport()->Size.x/2+70);
            DrawScaleSlider("ButtonStart",0.75f);
            ImGui::NewLine();
            ImGui::EndTable();
        }
    }
    if (ImGui::CollapsingHeader("C Button Up position")) {
        if (ImGui::BeginTable("tablecubtn", 1, FlagsTable)) {
            ...
            Table_InitHeader(false);
            DrawUseMarginsSlider("C Button Up", "ButtonCUp");
            DrawPositionsRadioBoxes("ButtonCUp");
            s16 Min_X_CU = 0;
            s16 Max_X_CU = ImGui::GetWindowViewport()->Size.x/2;
            if(CVarGetInteger(COSMETIC_CVAR("Hud_ButtonCUp.AnchorType"),0) == 2){
                Max_X_CU = 294;
            } else if(CVarGetInteger(COSMETIC_CVAR("Hud_ButtonCUp.AnchorType"),0) == 3){
                Max_X_CU = ImGui::GetWindowViewport()->Size.x/2;
            } else if(CVarGetInteger(COSMETIC_CVAR("Hud_ButtonCUp.AnchorType"),0) == 4){
                Min_X_CU = (ImGui::GetWindowViewport()->Size.x/2)*-1;
            }
            DrawPositionSlider("ButtonCUp", 0, ImGui::GetWindowViewport()->Size.y/2, Min_X_CU, Max_X_CU);
            DrawScaleSlider("ButtonCUp",0.5f);
            ImGui::NewLine();
            ImGui::EndTable();
        }
    }
    if (ImGui::CollapsingHeader("C Button Down position")) {
        if (ImGui::BeginTable("tablecdbtn", 1, FlagsTable)) {
            ...
            Table_InitHeader(false);
            DrawUseMarginsSlider("C Button Down", "ButtonCDown");
            DrawPositionsRadioBoxes("ButtonCDown");
            s16 Min_X_CD = 0;
            s16 Max_X_CD = ImGui::GetWindowViewport()->Size.x/2;
            if(CVarGetInteger(COSMETIC_CVAR("Hud_ButtonCDown.AnchorType"),0) == 2){
                Max_X_CD = 294;
            } else if(CVarGetInteger(COSMETIC_CVAR("Hud_ButtonCDown.AnchorType"),0) == 3){
                Max_X_CD = ImGui::GetWindowViewport()->Size.x/2;
            } else if(CVarGetInteger(COSMETIC_CVAR("Hud_ButtonCDown.AnchorType"),0) == 4){
                Min_X_CD = (ImGui::GetWindowViewport()->Size.x/2)*-1;
            }
            DrawPositionSlider("ButtonCDown", 0, ImGui::GetWindowViewport()->Size.y/2, Min_X_CD, Max_X_CD);
            DrawScaleSlider("ButtonCDown",0.87f);
            ImGui::NewLine();
            ImGui::EndTable();
        }
    }
    if (ImGui::CollapsingHeader("C Button Left position")) {
        if (ImGui::BeginTable("tableclbtn", 1, FlagsTable)) {
            ...
            Table_InitHeader(false);
            DrawUseMarginsSlider("C Button Left", "ButtonCLeft");
            DrawPositionsRadioBoxes("ButtonCLeft");
            s16 Min_X_CL = 0;
            s16 Max_X_CL = ImGui::GetWindowViewport()->Size.x/2;
            if(CVarGetInteger(COSMETIC_CVAR("Hud_ButtonCLeft.AnchorType"),0) == 2){
                Max_X_CL = 294;
            } else if(CVarGetInteger(COSMETIC_CVAR("Hud_ButtonCLeft.AnchorType"),0) == 3){
                Max_X_CL = ImGui::GetWindowViewport()->Size.x/2;
            } else if(CVarGetInteger(COSMETIC_CVAR("Hud_ButtonCLeft.AnchorType"),0) == 4){
                Min_X_CL = (ImGui::GetWindowViewport()->Size.x/2)*-1;
            }
            DrawPositionSlider("ButtonCLeft", 0, ImGui::GetWindowViewport()->Size.y/2, Min_X_CL, Max_X_CL);
            DrawScaleSlider("ButtonCLeft",0.87f);
            ImGui::NewLine();
            ImGui::EndTable();
        }
    }
    if (ImGui::CollapsingHeader("C Button Right position")) {
        if (ImGui::BeginTable("tablecrnbtn", 1, FlagsTable)) {
            ...
            Table_InitHeader(false);
            DrawUseMarginsSlider("C Button Right", "ButtonCRight");
            DrawPositionsRadioBoxes("ButtonCRight");
            s16 Min_X_CR = 0;
            s16 Max_X_CR = ImGui::GetWindowViewport()->Size.x/2;
            if(CVarGetInteger(COSMETIC_CVAR("Hud_ButtonCRight.AnchorType"),0) == 2){
                Max_X_CR = 294;
            } else if(CVarGetInteger(COSMETIC_CVAR("Hud_ButtonCRight.AnchorType"),0) == 3){
                Max_X_CR = ImGui::GetWindowViewport()->Size.x/2;
            } else if(CVarGetInteger(COSMETIC_CVAR("Hud_ButtonCRight.AnchorType"),0) == 4){
                Min_X_CR = (ImGui::GetWindowViewport()->Size.x/2)*-1;
            }
            DrawPositionSlider("ButtonCRight", 0, ImGui::GetWindowViewport()->Size.y/2, Min_X_CR, Max_X_CR);
            DrawScaleSlider("ButtonCRight",0.87f);
            ImGui::NewLine();
            ImGui::EndTable();
        }
    }
    if (CVarGetInteger("gDpadEquips",0) && ImGui::CollapsingHeader("DPad items position")) {
        if (ImGui::BeginTable("tabledpaditems", 1, FlagsTable)) {
            ...
            Table_InitHeader(false);
            DrawUseMarginsSlider("DPad items", "Dpad");
            DrawPositionsRadioBoxes("Dpad");
            s16 Min_X_Dpad = 0;
            s16 Max_X_Dpad = ImGui::GetWindowViewport()->Size.x/2;
            if(CVarGetInteger(COSMETIC_CVAR("Hud_Dpad.AnchorType"),0) == 2){
                Max_X_Dpad = 290;
            } else if(CVarGetInteger(COSMETIC_CVAR("Hud_Dpad.AnchorType"),0) == 4){
                Min_X_Dpad = (ImGui::GetWindowViewport()->Size.x/2)*-1;
            }
            DrawPositionSlider("Dpad", 0, ImGui::GetWindowViewport()->Size.y/2, Min_X_Dpad, Max_X_Dpad);
            DrawScaleSlider("Dpad",1.0f);
            ImGui::NewLine();
            ImGui::EndTable();
        }
    }
    if (ImGui::CollapsingHeader("Minimaps position")) {
        if (ImGui::BeginTable("tableminimapspos", 1, FlagsTable)) {
            ...
            Table_InitHeader(false);
            DrawUseMarginsSlider("Minimap", "Minimap");
            DrawPositionsRadioBoxes("Minimap", false);
            DrawPositionSlider("Minimap", (ImGui::GetWindowViewport()->Size.y/3)*-1, ImGui::GetWindowViewport()->Size.y/3, ImGui::GetWindowViewport()->Size.x*-1, ImGui::GetWindowViewport()->Size.x/2);
            DrawScaleSlider("Minimap",1.0f);
            ImGui::NewLine();
            ImGui::EndTable();
        }
    }
    if (ImGui::CollapsingHeader("Small Keys counter position")) {
        if (ImGui::BeginTable("tablesmolekeys", 1, FlagsTable)) {
            ...
            Table_InitHeader(false);
            DrawUseMarginsSlider("Small Keys counter", "SmallKeyCount");
            DrawPositionsRadioBoxes("SmallKeyCount");
            DrawPositionSlider("SmallKeyCount", 0, ImGui::GetWindowViewport()->Size.y/3, -1, ImGui::GetWindowViewport()->Size.x/2);
            DrawScaleSlider("SmallKeyCount",1.0f);
            ImGui::NewLine();
            ImGui::EndTable();
        }
    }
    if (ImGui::CollapsingHeader("Rupee counter position")) {
        if (ImGui::BeginTable("tablerupeecount", 1, FlagsTable)) {
            ...
            Table_InitHeader(false);
            DrawUseMarginsSlider("Rupee counter", "RupeeCount");
            DrawPositionsRadioBoxes("RupeeCount");
            DrawPositionSlider("RupeeCount", -2, ImGui::GetWindowViewport()->Size.y/3, -3, ImGui::GetWindowViewport()->Size.x/2);
            DrawScaleSlider("RupeeCount",1.0f);
            ImGui::NewLine();
            ImGui::EndTable();
        }
    }
    if (ImGui::CollapsingHeader("Carrots position")) {
        if (ImGui::BeginTable("tableCarrots", 1, FlagsTable)) {
            ...
            Table_InitHeader(false);
            DrawUseMarginsSlider("Carrots", "Carrots");
            DrawPositionsRadioBoxes("Carrots");
            DrawPositionSlider("Carrots", 0, ImGui::GetWindowViewport()->Size.y/2, -50, ImGui::GetWindowViewport()->Size.x/2+25);
            DrawScaleSlider("Carrots",1.0f);
            ImGui::NewLine();
            ImGui::EndTable();
        }
    }
    if (ImGui::CollapsingHeader("Timers position")) {
        if (ImGui::BeginTable("tabletimers", 1, FlagsTable)) {
            ...
            Table_InitHeader(false);
            DrawUseMarginsSlider("Timers", "Timers");
            DrawPositionsRadioBoxes("Timers");
            DrawPositionSlider("Timers", 0, ImGui::GetWindowViewport()->Size.y/2, -50, ImGui::GetWindowViewport()->Size.x/2-50);
            DrawScaleSlider("Timers",1.0f);
            ImGui::NewLine();
            ImGui::EndTable();
        }
    }
    if (ImGui::CollapsingHeader("Archery Scores position")) {
        if (ImGui::BeginTable("tablearchery", 1, FlagsTable)) {
            ...
            Table_InitHeader(false);
            DrawUseMarginsSlider("Archery scores", "ArcheryScore");
            DrawPositionsRadioBoxes("ArcheryScore", false);
            DrawPositionSlider("ArcheryScore", 0, ImGui::GetWindowViewport()->Size.y/2, -50, ImGui::GetWindowViewport()->Size.x/2-50);
            DrawScaleSlider("ArcheryScore",1.0f);
            ImGui::NewLine();
            ImGui::EndTable();
        }
    }
    if (ImGui::CollapsingHeader("Title cards (Maps) position")) {
        if (ImGui::BeginTable("tabletcmaps", 1, FlagsTable)) {
            ...
            Table_InitHeader(false);
            DrawUseMarginsSlider("Title cards (overworld)", "TitleCardsMaps");
            DrawPositionsRadioBoxes("TitleCardsMaps");
            DrawPositionSlider("TitleCardsMaps", 0, ImGui::GetWindowViewport()->Size.y/2, -50, ImGui::GetWindowViewport()->Size.x/2+10);
            DrawScaleSlider("TitleCardsMaps",1.0f);
            ImGui::NewLine();
            ImGui::EndTable();
        }
    }
    if (ImGui::CollapsingHeader("Title cards (Bosses) position")) {
        if (ImGui::BeginTable("tabletcbosses", 1, FlagsTable)) {
            ...
            Table_InitHeader(false);
            DrawUseMarginsSlider("Title cards (Bosses)", "TitleCardsBosses");
            DrawPositionsRadioBoxes("TitleCardsBosses");
            DrawPositionSlider("TitleCardsBosses", 0, ImGui::GetWindowViewport()->Size.y/2, -50, ImGui::GetWindowViewport()->Size.x/2+10);
            DrawScaleSlider("TitleCardsBosses",1.0f);
            ImGui::NewLine();
            ImGui::EndTable();
        }
    }
    if (ImGui::CollapsingHeader("In-game Gameplay Timer position")) {
        if (ImGui::BeginTable("tablegameplaytimer", 1, FlagsTable)) {
            ...
            Table_InitHeader(false);
            DrawUseMarginsSlider("In-game Gameplay Timer", "InGameTimer");
            DrawPositionsRadioBoxes("InGameTimer");
            DrawPositionSlider("InGameTimer", 0, ImGui::GetWindowViewport()->Size.y / 2, -50,
                               ImGui::GetWindowViewport()->Size.x / 2 + 10);
            DrawScaleSlider("InGameTimer", 1.0f);
            ImGui::NewLine();
            ImGui::EndTable();
        }
    }
    if (ImGui::CollapsingHeader("Enemy Health Bar position")) {
        if (ImGui::BeginTable("enemyhealthbar", 1, FlagsTable)) {
            ...
            Table_InitHeader(false);
            std::string posTypeCVar = COSMETIC_CVAR("Hud_EnemyHealthBar.AnchorType");
            ...
            DrawPositionSlider(COSMETIC_CVAR("Hud_EnemyHealthBar"), -SCREEN_HEIGHT, SCREEN_HEIGHT, -ImGui::GetWindowViewport()->Size.x / 2, ImGui::GetWindowViewport()->Size.x / 2);
            if (UIWidgets::EnhancementSliderInt("Health Bar Width: %d", "##EnemyHealthBarWidth", COSMETIC_CVAR("Hud_EnemyHealthBar.Width"), 32, 128, "", 64)) {
                CVarSetInteger(COSMETIC_CVAR("Hud_EnemyHealthBarWidth.Changed"), 1);
            }
            UIWidgets::Tooltip("This will change the width of the health bar");
            ImGui::SameLine();
            if (ImGui::Button("Reset##EnemyHealthBarWidth")) {
                CVarClear(COSMETIC_CVAR("Hud_EnemyHealthBar.Width"));
                CVarClear(COSMETIC_CVAR("Hud_EnemyHealthBarWidth.Changed"));
...
void DrawSillyTab() {
    ...
    if (UIWidgets::EnhancementSliderFloat("Link Body Scale: %f", "##Link_BodyScale", COSMETIC_CVAR("Link_BodyScale.Value"), 0.001f, 0.025f, "", 0.01f, true)) {
        CVarSetInteger(COSMETIC_CVAR("Link_BodyScale.Changed"), 1);
    }
    ImGui::SameLine();
    if (ImGui::Button("Reset##Link_BodyScale")) {
        CVarClear(COSMETIC_CVAR("Link_BodyScale.Value"));
        CVarClear(COSMETIC_CVAR("Link_BodyScale.Changed"));
        LUS::Context::GetInstance()->GetWindow()->GetGui()->SaveConsoleVariablesOnNextTick();
        if (gPlayState != nullptr) {
            static Player* player = GET_PLAYER(gPlayState);
    ...
    if (UIWidgets::EnhancementSliderFloat("Link Head Scale: %f", "##Link_HeadScale", COSMETIC_CVAR("Link_HeadScale.Value"), 0.4f, 4.0f, "", 1.0f, false)) {
        CVarSetInteger(COSMETIC_CVAR("Link_HeadScale.Changed"), 1);
    }
    ImGui::SameLine();
    if (ImGui::Button("Reset##Link_HeadScale")) {
        CVarClear(COSMETIC_CVAR("Link_HeadScale.Value"));
        CVarClear(COSMETIC_CVAR("Link_HeadScale.Changed"));
        LUS::Context::GetInstance()->GetWindow()->GetGui()->SaveConsoleVariablesOnNextTick();
    }
    if (UIWidgets::EnhancementSliderFloat("Link Sword Scale: %f", "##Link_SwordScale", COSMETIC_CVAR("Link_SwordScale.Value"), 1.0f, 2.5f, "", 1.0f, false)) {
        CVarSetInteger(COSMETIC_CVAR("Link_SwordScale.Changed"), 1);
    }
    ImGui::SameLine();
    if (ImGui::Button("Reset##Link_SwordScale")) {
        CVarClear(COSMETIC_CVAR("Link_SwordScale.Value"));
        CVarClear(COSMETIC_CVAR("Link_SwordScale.Changed"));
        LUS::Context::GetInstance()->GetWindow()->GetGui()->SaveConsoleVariablesOnNextTick();
    }
    UIWidgets::EnhancementSliderFloat("Bunny Hood Length: %f", "##BunnyHood_EarLength", COSMETIC_CVAR("BunnyHood_EarLength"), -300.0f, 1000.0f, "", 0.0f, false);
    ImGui::SameLine();
    if (ImGui::Button("Reset##BunnyHood_EarLength")) {
        CVarClear(COSMETIC_CVAR("BunnyHood_EarLength"));
        LUS::Context::GetInstance()->GetWindow()->GetGui()->SaveConsoleVariablesOnNextTick();
    }
    UIWidgets::EnhancementSliderFloat("Bunny Hood Spread: %f", "##BunnyHood_EarSpread", COSMETIC_CVAR("BunnyHood_EarSpread"), -300.0f, 500.0f, "", 0.0f, false);
    ImGui::SameLine();
    if (ImGui::Button("Reset##BunnyHood_EarSpread")) {
        CVarClear(COSMETIC_CVAR("BunnyHood_EarSpread"));
        LUS::Context::GetInstance()->GetWindow()->GetGui()->SaveConsoleVariablesOnNextTick();
    }
    UIWidgets::EnhancementSliderFloat("Goron Neck Length: %f", "##Goron_NeckLength", COSMETIC_CVAR("Goron_NeckLength"), 0.0f, 1000.0f, "", 0.0f, false);
    ImGui::SameLine();
    if (ImGui::Button("Reset##Goron_NeckLength")) {
        CVarClear(COSMETIC_CVAR("Goron_NeckLength"));
        LUS::Context::GetInstance()->GetWindow()->GetGui()->SaveConsoleVariablesOnNextTick();
    }
    UIWidgets::EnhancementCheckbox("Unfix Goron Spin", "gUnfixGoronSpin");
    UIWidgets::EnhancementSliderFloat("Fairies Size: %f", "##Fairies_Size", COSMETIC_CVAR("Fairies_Size"), 0.25f, 5.0f, "", 1.0f, false);
    ImGui::SameLine();
    if (ImGui::Button("Reset##Fairies_Size")) {
        CVarClear(COSMETIC_CVAR("Fairies_Size"));
        LUS::Context::GetInstance()->GetWindow()->GetGui()->SaveConsoleVariablesOnNextTick();
    }
    UIWidgets::EnhancementSliderFloat("N64 Logo Spin Speed: %f", "##N64Logo_SpinSpeed", COSMETIC_CVAR("N64Logo_SpinSpeed"), 0.25f, 5.0f, "", 1.0f, false);
    ImGui::SameLine();
    if (ImGui::Button("Reset##N64Logo_SpinSpeed")) {
        CVarClear(COSMETIC_CVAR("N64Logo_SpinSpeed"));
        LUS::Context::GetInstance()->GetWindow()->GetGui()->SaveConsoleVariablesOnNextTick();
    }
    UIWidgets::EnhancementSliderFloat("Moon Size: %f", "##Moon_Size", COSMETIC_CVAR("Moon_Size"), 0.5f, 2.0f, "", 1.0f, false);
    ImGui::SameLine();
    if (ImGui::Button("Reset##Moon_Size")) {
        CVarClear(COSMETIC_CVAR("Moon_Size"));
        LUS::Context::GetInstance()->GetWindow()->GetGui()->SaveConsoleVariablesOnNextTick();
    }
    if (UIWidgets::EnhancementSliderFloat("Kak Windmill Speed: %f", "##Kak_Windmill_Speed", COSMETIC_CVAR("Kak_Windmill_Speed.Value"), 100.0f, 6000.0f, "", 100.0f, false)) {
        CVarSetInteger(COSMETIC_CVAR("Kak_Windmill_Speed.Changed"), 1);
    }
    ImGui::SameLine();
    if (ImGui::Button("Reset##Kak_Windmill_Speed")) {
        CVarClear(COSMETIC_CVAR("Kak_Windmill_Speed.Value"));
        CVarClear(COSMETIC_CVAR("Kak_Windmill_Speed.Changed"));
        LUS::Context::GetInstance()->GetWindow()->GetGui()->SaveConsoleVariablesOnNextTick();
    }
}
...
void CopyMultipliedColor(CosmeticOption& cosmeticOptionSrc, CosmeticOption& cosmeticOptionTarget, float amount = 0.75f) {
    Color_RGBA8 newColor;
    newColor.r = MIN((cosmeticOptionSrc.currentColor.r) * amount, 255);
    newColor.g = MIN((cosmeticOptionSrc.currentColor.g) * amount, 255);
    newColor.b = MIN((cosmeticOptionSrc.currentColor.b) * amount, 255);
    newColor.a = 255;

    cosmeticOptionTarget.currentColor = newColor;
...
void ResetColor(CosmeticOption& cosmeticOption) {
    cosmeticOption.currentColor = cosmeticOption.defaultColor;
...
void DrawCosmeticRow(CosmeticOption& cosmeticOption) {
    bool colorChanged;
    ImVec4 pickerColor = { (float)cosmeticOption.currentColor.r / 255, (float)cosmeticOption.currentColor.g / 255,
                           (float)cosmeticOption.currentColor.b / 255, (float)cosmeticOption.currentColor.a / 255 };
    if (cosmeticOption.supportsAlpha) {
        colorChanged = ImGui::ColorEdit4(cosmeticOption.label.c_str(), (float*)&pickerColor, ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_NoLabel);
    } else {
        colorChanged = ImGui::ColorEdit3(cosmeticOption.label.c_str(), (float*)&pickerColor, ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_NoLabel);
    }
    if (colorChanged) {
        cosmeticOption.currentColor.r = pickerColor.x * 255.0;
        cosmeticOption.currentColor.g = pickerColor.y * 255.0;
        cosmeticOption.currentColor.b = pickerColor.z * 255.0;
        cosmeticOption.currentColor.a = pickerColor.w * 255.0;

        CVarSetColor(cosmeticOption.cvar, cosmeticOption.currentColor);
        CVarSetInteger((cosmeticOption.rainbowCvar), 0);
        CVarSetInteger((cosmeticOption.changedCvar), 1);
...
void DrawCosmeticGroup(CosmeticGroup cosmeticGroup) {
    ...
    if (ImGui::Button(("Random##" + label).c_str())) {
        for (auto& [id, cosmeticOption] : cosmeticOptions) {
            if (cosmeticOption.group == cosmeticGroup && (!cosmeticOption.advancedOption || CVarGetInteger(COSMETIC_CVAR("AdvancedMode"), 0)) && !CVarGetInteger(cosmeticOption.lockedCvar, 0)) {
                RandomizeColor(cosmeticOption);
            }
        }
        ApplyOrResetCustomGfxPatches();
    ...
    for (auto& [id, cosmeticOption] : cosmeticOptions) {
        if (cosmeticOption.group == cosmeticGroup && (!cosmeticOption.advancedOption || CVarGetInteger(COSMETIC_CVAR("AdvancedMode"), 0))) {
...
void CosmeticsEditorWindow::DrawElement() {
    ...
    ImGui::SameLine();
    UIWidgets::EnhancementCombobox(COSMETIC_CVAR("DefaultColorScheme"), colorSchemes, COLORSCHEME_N64);
    UIWidgets::EnhancementCheckbox("Advanced Mode", COSMETIC_CVAR("AdvancedMode"));
    if (CVarGetInteger(COSMETIC_CVAR("AdvancedMode"), 0)) {
    ...
    UIWidgets::EnhancementCheckbox("Sync Rainbow colors", COSMETIC_CVAR("RainbowSync"));
    UIWidgets::EnhancementSliderFloat("Rainbow Speed: %f", "##rainbowSpeed", COSMETIC_CVAR("RainbowSpeed"), 0.03f, 1.0f, "", 0.6f, false);
    if (ImGui::Button("Randomize All", ImVec2(ImGui::GetContentRegionAvail().x / 2, 30.0f))) {
        for (auto& [id, cosmeticOption] : cosmeticOptions) {
            if (!CVarGetInteger(cosmeticOption.lockedCvar, 0) && (!cosmeticOption.advancedOption || CVarGetInteger(COSMETIC_CVAR("AdvancedMode"), 0))) {
                RandomizeColor(cosmeticOption);
            }
        }
        ApplyOrResetCustomGfxPatches();
    ...
    if (ImGui::Button("Lock All", ImVec2(ImGui::GetContentRegionAvail().x / 2, 30.0f))) {
        for (auto& [id, cosmeticOption] : cosmeticOptions) {
            if (!cosmeticOption.advancedOption || CVarGetInteger(COSMETIC_CVAR("AdvancedMode"), 0)) {
                CVarSetInteger(cosmeticOption.lockedCvar, 1);
            }
        }
        LUS::Context::GetInstance()->GetWindow()->GetGui()->SaveConsoleVariablesOnNextTick();
    ...
    if (ImGui::BeginTabBar("CosmeticsContextTabBar", ImGuiTabBarFlags_NoCloseWithMiddleMouseButton)) {
        ...
        if (ImGui::BeginTabItem("Effects")) {
            ...
            if (UIWidgets::EnhancementSliderInt("Trails Duration: %d", "##Trails_Duration", COSMETIC_CVAR("Trails_Duration.Value"), 2, 20, "", 4)) {
                CVarSetInteger(COSMETIC_CVAR("Trails_Duration.Changed"), 1);
            }
            ImGui::SameLine();
            if (ImGui::Button("Reset##Trails_Duration")) {
                CVarClear(COSMETIC_CVAR("Trails_Duration.Value"));
                CVarClear(COSMETIC_CVAR("Trails_Duration.Changed"));
                LUS::Context::GetInstance()->GetWindow()->GetGui()->SaveConsoleVariablesOnNextTick();
            }
            ImGui::EndTabItem();
        }
...
void CosmeticsEditorWindow::InitElement() {
    ...
    //    Color_RGBA8 cvarColor = CVarGetColor(cosmeticOption.cvar, cosmeticOption.defaultColor);
...
void CosmeticsEditor_RandomizeAll() {
    for (auto& [id, cosmeticOption] : cosmeticOptions) {
        if (!CVarGetInteger(cosmeticOption.lockedCvar, 0) &&
            (!cosmeticOption.advancedOption || CVarGetInteger(COSMETIC_CVAR("AdvancedMode"), 0))) {
            RandomizeColor(cosmeticOption);
        }
    }
