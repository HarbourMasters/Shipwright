...
static std::map<std::string, CosmeticOption> cosmeticOptions = {
    COSMETIC_OPTION("Link_KokiriTunic",              "Kokiri Tunic",         GROUP_LINK,         { 30, 105,  27, 255}, false, true, false),
    COSMETIC_OPTION("Link_GoronTunic",               "Goron Tunic",          GROUP_LINK,         {100,  20,   0, 255}, false, true, false),
    COSMETIC_OPTION("Link_ZoraTunic",                "Zora Tunic",           GROUP_LINK,         {  0,  60, 100, 255}, false, true, false),
    COSMETIC_OPTION("Link_Hair",                     "Hair",                 GROUP_LINK,         {255, 173,  27, 255}, false, true, true),
    COSMETIC_OPTION("Link_Linen",                    "Linen",                GROUP_LINK,         {255, 255, 255, 255}, false, true, true),
    COSMETIC_OPTION("Link_Boots",                    "Boots",                GROUP_LINK,         { 93,  44,  18, 255}, false, true, true),
    
    COSMETIC_OPTION("MirrorShield_Body",             "Body",                 GROUP_MIRRORSHIELD, {215,   0,   0, 255}, false, true, false),
    COSMETIC_OPTION("MirrorShield_Mirror",           "Mirror",               GROUP_MIRRORSHIELD, {255, 255, 255, 255}, false, true, true),
    COSMETIC_OPTION("MirrorShield_Emblem",           "Emblem",               GROUP_MIRRORSHIELD, {205, 225, 255, 255}, false, true, true),

    COSMETIC_OPTION("Swords_KokiriBlade",            "Kokiri Sword Blade",   GROUP_SWORDS,       {255, 255, 255, 255}, false, true, false),
    // COSMETIC_OPTION("Swords_KokiriHilt",             "Kokiri Sword Hilt",    GROUP_SWORDS,       {160, 100,  15, 255}, false, true, true), // Todo (Cosmetics): Broken, need a better way to grayscale
    COSMETIC_OPTION("Swords_MasterBlade",            "Master Sword Blade",   GROUP_SWORDS,       {255, 255, 255, 255}, false, true, false),
    // COSMETIC_OPTION("Swords_MasterHilt",             "Master Sword Hilt",    GROUP_SWORDS,       { 80,  80, 168, 255}, false, true, true), // Todo (Cosmetics): Broken, need a better way to grayscale
    COSMETIC_OPTION("Swords_BiggoronBlade",          "Biggoron Sword Blade", GROUP_SWORDS,       {255, 255, 255, 255}, false, true, false),
    // COSMETIC_OPTION("Swords_BiggoronHilt",           "Biggoron Sword Hilt",  GROUP_SWORDS,       { 80,  80, 168, 255}, false, true, true), // Todo (Cosmetics): Broken, need a better way to grayscale

    COSMETIC_OPTION("Gloves_GoronBracelet",          "Goron Bracelet",       GROUP_GLOVES,       {255, 255, 170, 255}, false, true, false),
    COSMETIC_OPTION("Gloves_SilverGauntlets",        "Silver Gauntlets",     GROUP_GLOVES,       {255, 255, 255, 255}, false, true, false),
    COSMETIC_OPTION("Gloves_GoldenGauntlets",        "Golden Gauntlets",     GROUP_GLOVES,       {254, 207,  15, 255}, false, true, false),
    COSMETIC_OPTION("Gloves_GauntletsGem",           "Gauntlets Gem",        GROUP_GLOVES,       {255,  60, 100, 255}, false, true, true),
    
    COSMETIC_OPTION("Equipment_BoomerangBody",       "Boomerang Body",       GROUP_EQUIPMENT,    {160, 100,   0, 255}, false, true, false),
    COSMETIC_OPTION("Equipment_BoomerangGem",        "Boomerang Gem",        GROUP_EQUIPMENT,    {255,  50, 150, 255}, false, true, true),
    // COSMETIC_OPTION("Equipment_SlingshotBody",       "Slingshot Body",       GROUP_EQUIPMENT,    {160, 100,   0, 255}, false, true, true), // Todo (Cosmetics): Broken, need a better way to grayscale
    COSMETIC_OPTION("Equipment_SlingshotString",     "Slingshot String",     GROUP_EQUIPMENT,    {255, 255, 255, 255}, false, true, true),
    COSMETIC_OPTION("Equipment_HammerHead",          "Hammer Head",          GROUP_EQUIPMENT,    {155, 192, 201, 255}, false, true, false),
    COSMETIC_OPTION("Equipment_HammerHandle",        "Hammer Handle",        GROUP_EQUIPMENT,    {110,  60,   0, 255}, false, true, true),
    // COSMETIC_OPTION("Equipment_HookshotChain",       "Hookshot Chain",       GROUP_EQUIPMENT,    {255, 255, 255, 255}, false, true, true), // Todo (Cosmetics): Implement
    // COSMETIC_OPTION("Equipment_HookshotTip",         "Hookshot Tip",         GROUP_EQUIPMENT,    {255, 255, 255, 255}, false, true, false), // Todo (Cosmetics): Implement
    COSMETIC_OPTION("HookshotReticle_Target",        "Hookshotable Reticle", GROUP_EQUIPMENT,         {  0, 255,   0, 255}, false, false, false),
    COSMETIC_OPTION("HookshotReticle_NonTarget",     "Non-Hookshotable Reticle", GROUP_EQUIPMENT,     {255,   0,   0, 255}, false, false, false),
    COSMETIC_OPTION("Equipment_BowTips",             "Bow Tips",             GROUP_EQUIPMENT,    {200,   0,   0, 255}, false, true, true),
    COSMETIC_OPTION("Equipment_BowString",           "Bow String",           GROUP_EQUIPMENT,    {255, 255, 255, 255}, false, true, true),
    COSMETIC_OPTION("Equipment_BowBody",             "Bow Body",             GROUP_EQUIPMENT,    {140,  90,  10, 255}, false, true, false),
    COSMETIC_OPTION("Equipment_BowHandle",           "Bow Handle",           GROUP_EQUIPMENT,    { 50, 150, 255, 255}, false, true, true),
    COSMETIC_OPTION("Equipment_ChuFace",             "Bombchu Face",         GROUP_EQUIPMENT,    {  0, 100, 150, 255}, false, true, true),
    COSMETIC_OPTION("Equipment_ChuBody",             "Bombchu Body",         GROUP_EQUIPMENT,    {180, 130,  50, 255}, false, true, true), 

    COSMETIC_OPTION("Consumable_Hearts",             "Hearts",               GROUP_CONSUMABLE,   {255,  70,  50, 255}, false, true, false),
    COSMETIC_OPTION("Consumable_HeartBorder",        "Heart Border",         GROUP_CONSUMABLE,   { 50,  40,  60, 255}, false, true, true),
    COSMETIC_OPTION("Consumable_DDHearts",           "DD Hearts",            GROUP_CONSUMABLE,   {200,   0,   0, 255}, false, true, false),
    COSMETIC_OPTION("Consumable_DDHeartBorder",      "DD Heart Border",      GROUP_CONSUMABLE,   {255, 255, 255, 255}, false, true, true),
    COSMETIC_OPTION("Consumable_Magic",              "Magic",                GROUP_CONSUMABLE,   {  0, 200,   0, 255}, false, true, false),
    COSMETIC_OPTION("Consumable_MagicActive",        "Magic Active",         GROUP_CONSUMABLE,   {250, 250,   0, 255}, false, true, true),
    COSMETIC_OPTION("Consumable_MagicBorder",        "Magic Border",         GROUP_CONSUMABLE,   {255, 255, 255, 255}, false, false, true),
    COSMETIC_OPTION("Consumable_MagicBorderActive",  "Magic Border Active",  GROUP_CONSUMABLE,   {255, 255, 255, 255}, false, false, true),
    COSMETIC_OPTION("Consumable_GreenRupee",         "Green Rupee",          GROUP_CONSUMABLE,   { 50, 255,  50, 255}, false, true, true),
    COSMETIC_OPTION("Consumable_BlueRupee",          "Blue Rupee",           GROUP_CONSUMABLE,   { 50,  50, 255, 255}, false, true, true),
    COSMETIC_OPTION("Consumable_RedRupee",           "Red Rupee",            GROUP_CONSUMABLE,   {255,  50,  50, 255}, false, true, true),
    COSMETIC_OPTION("Consumable_PurpleRupee",        "Purple Rupee",         GROUP_CONSUMABLE,   {150,  50, 255, 255}, false, true, true),
    COSMETIC_OPTION("Consumable_GoldRupee",          "Gold Rupee",           GROUP_CONSUMABLE,   {255, 190,  55, 255}, false, true, true),
    COSMETIC_OPTION("Consumable_SilverRupee",        "Silver Rupee",         GROUP_CONSUMABLE,   {255, 255, 255, 255}, false, true, true),

    COSMETIC_OPTION("Hud_ButtonA",                   "A Button",             GROUP_HUD,          { 90,  90, 255, 255}, false, true, false),
    COSMETIC_OPTION("Hud_ButtonB",                   "B Button",             GROUP_HUD,          {  0, 150,   0, 255}, false, true, false),
    COSMETIC_OPTION("Hud_CButtons",                  "C Buttons",            GROUP_HUD,          {255, 160,   0, 255}, false, true, false),
    COSMETIC_OPTION("Hud_ButtonCUp",                 "C Up Button",          GROUP_HUD,          {255, 160,   0, 255}, false, true, true),
    COSMETIC_OPTION("Hud_ButtonCDown",               "C Down Button",        GROUP_HUD,          {255, 160,   0, 255}, false, true, true),
    COSMETIC_OPTION("Hud_ButtonCLeft",               "C Left Button",        GROUP_HUD,          {255, 160,   0, 255}, false, true, true),
    COSMETIC_OPTION("Hud_ButtonCRight",              "C Right Button",       GROUP_HUD,          {255, 160,   0, 255}, false, true, true),
    COSMETIC_OPTION("Hud_ButtonStart",               "Start Button",         GROUP_HUD,          {200,   0,   0, 255}, false, true, false),
    COSMETIC_OPTION("Hud_Dpad",                      "Dpad",                 GROUP_HUD,          {255, 255, 255, 255}, false, true, false),
    COSMETIC_OPTION("Hud_KeyCount",                  "Key Count",            GROUP_HUD,          {200, 230, 255, 255}, false, true, true),
    COSMETIC_OPTION("Hud_StoneOfAgony",              "Stone of Agony",       GROUP_HUD,          {255, 255, 255, 255}, false, true, true),
    COSMETIC_OPTION("Hud_Minimap",                   "Minimap",              GROUP_HUD,          {  0, 255, 255, 255}, false, true, false),
    COSMETIC_OPTION("Hud_MinimapPosition",           "Minimap Position",     GROUP_HUD,          {200, 255,   0, 255}, false, true, true),
    COSMETIC_OPTION("Hud_MinimapEntrance",           "Minimap Entrance",     GROUP_HUD,          {200,   0,   0, 255}, false, true, true),
    COSMETIC_OPTION("Hud_EnemyHealthBar",            "Enemy Health Bar",     GROUP_HUD,          {255,   0,   0, 255}, true, true, false),
    COSMETIC_OPTION("Hud_EnemyHealthBorder",         "Enemy Health Border",  GROUP_HUD,          {255, 255, 255, 255}, true, false, true),
    COSMETIC_OPTION("Hud_NameTagActorText",          "Nametag Text",         GROUP_HUD,          {255, 255, 255, 255}, true, true, false),
    COSMETIC_OPTION("Hud_NameTagActorBackground",    "Nametag Background",   GROUP_HUD,          {0,     0,   0,  80}, true, false, true),

    COSMETIC_OPTION("Title_FileChoose",              "File Choose",          GROUP_TITLE,        {100, 150, 255, 255}, false, true, false),
    COSMETIC_OPTION("Title_NintendoLogo",            "Nintendo Logo",        GROUP_TITLE,        {  0,   0, 255, 255}, false, true, true),
    COSMETIC_OPTION("Title_N64LogoRed",              "N64 Red",              GROUP_TITLE,        {150,   0,   0, 255}, false, true, true),
    COSMETIC_OPTION("Title_N64LogoBlue",             "N64 Blue",             GROUP_TITLE,        {  0,  50, 150, 255}, false, true, true),
    COSMETIC_OPTION("Title_N64LogoGreen",            "N64 Green",            GROUP_TITLE,        { 50, 100,   0, 255}, false, true, true),
    COSMETIC_OPTION("Title_N64LogoYellow",           "N64 Yellow",           GROUP_TITLE,        {200, 150,   0, 255}, false, true, true),
    // COSMETIC_OPTION("Title_FirePrimary",             "Title Fire Primary",   GROUP_TITLE,        {255, 255, 170, 255}, false, true, false), // Todo (Cosmetics): Kinda complicated
    // COSMETIC_OPTION("Title_FireSecondary",           "Title Fire Secondary", GROUP_TITLE,        {255, 100,   0, 255}, false, true, true), // Todo (Cosmetics): Kinda complicated

    COSMETIC_OPTION("Arrows_NormalPrimary",          "Normal Primary",       GROUP_ARROWS,       {  0, 150,   0,   0}, false, true, false),
    COSMETIC_OPTION("Arrows_NormalSecondary",        "Normal Secondary",     GROUP_ARROWS,       {255, 255, 170, 255}, false, true, true),
    COSMETIC_OPTION("Arrows_FirePrimary",            "Fire Primary",         GROUP_ARROWS,       {255, 200,   0,   0}, false, true, false),
    COSMETIC_OPTION("Arrows_FireSecondary",          "Fire Secondary",       GROUP_ARROWS,       {255,   0,   0, 255}, false, true, true),
    COSMETIC_OPTION("Arrows_IcePrimary",             "Ice Primary",          GROUP_ARROWS,       {  0,   0, 255, 255}, false, true, false),
    COSMETIC_OPTION("Arrows_IceSecondary",           "Ice Secondary",        GROUP_ARROWS,       {255, 255, 255, 255}, false, true, true),
    COSMETIC_OPTION("Arrows_LightPrimary",           "Light Primary",        GROUP_ARROWS,       {255, 255,   0, 255}, false, true, false),
    COSMETIC_OPTION("Arrows_LightSecondary",         "Light Secondary",      GROUP_ARROWS,       {255, 255, 170,   0}, false, true, true),

    // COSMETIC_OPTION("Magic_DinsPrimary",             "Din's Primary",        GROUP_MAGIC,        {255, 255, 255, 255}, false, true, false), // Todo (Cosmetics): Replace gDF_Col
    // COSMETIC_OPTION("Magic_DinsSecondary",           "Din's Secondary",      GROUP_MAGIC,        {255, 255, 255, 255}, false, true, true), // Todo (Cosmetics): Replace gDF_Env
    // COSMETIC_OPTION("Magic_FaroresPrimary",          "Farore's Primary",     GROUP_MAGIC,        {255, 255, 255, 255}, false, true, false), // Todo (Cosmetics): Implement
    // COSMETIC_OPTION("Magic_FaroresSecondary",        "Farore's Secondary",   GROUP_MAGIC,        {255, 255, 255, 255}, false, true, true), // Todo (Cosmetics): Implement
    // COSMETIC_OPTION("Magic_NayrusPrimary",           "Nayru's Primary",      GROUP_MAGIC,        {255, 255, 255, 255}, false, true, false), // Todo (Cosmetics): Replace gNL_Diamond_Col / gNL_Orb_Col
    // COSMETIC_OPTION("Magic_NayrusSecondary",         "Nayru's Secondary",    GROUP_MAGIC,        {255, 255, 255, 255}, false, true, true), // Todo (Cosmetics): Replace gNL_Diamond_Env / gNL_Orb_Env

    COSMETIC_OPTION("SpinAttack_Level1Primary",      "Level 1 Primary",      GROUP_SPIN_ATTACK,  {170, 255, 255, 255}, false, true, true),
    COSMETIC_OPTION("SpinAttack_Level1Secondary",    "Level 1 Secondary",    GROUP_SPIN_ATTACK,  {  0, 100, 255, 255}, false, true, false),
    COSMETIC_OPTION("SpinAttack_Level2Primary",      "Level 2 Primary",      GROUP_SPIN_ATTACK,  {255, 255, 170, 255}, false, true, true),
    COSMETIC_OPTION("SpinAttack_Level2Secondary",    "Level 2 Secondary",    GROUP_SPIN_ATTACK,  {255, 100,   0, 255}, false, true, false),

    COSMETIC_OPTION("Trails_Bombchu",                "Bombchu",              GROUP_TRAILS,       {250,   0,   0, 255}, false, true, true),
    COSMETIC_OPTION("Trails_Boomerang",              "Boomerang",            GROUP_TRAILS,       {255, 255, 100, 255}, false, true, true),
    COSMETIC_OPTION("Trails_KokiriSword",            "Kokiri Sword",         GROUP_TRAILS,       {255, 255, 255, 255}, false, true, false),
    COSMETIC_OPTION("Trails_MasterSword",            "Master Sword",         GROUP_TRAILS,       {255, 255, 255, 255}, false, true, false),
    COSMETIC_OPTION("Trails_BiggoronSword",          "Biggoron Sword",       GROUP_TRAILS,       {255, 255, 255, 255}, false, true, true),
    COSMETIC_OPTION("Trails_Stick",                  "Stick",                GROUP_TRAILS,       {255, 255, 255, 255}, false, true, true),
    COSMETIC_OPTION("Trails_Hammer",                 "Hammer",               GROUP_TRAILS,       {255, 255, 255, 255}, false, true, true),

    COSMETIC_OPTION("World_BlockOfTime",             "Block of Time",        GROUP_WORLD,        {255, 255, 255, 255}, false, true, true),
    COSMETIC_OPTION("World_Moon",                    "Moon",                 GROUP_WORLD,        {240, 255, 180, 255}, false, true, true),
    COSMETIC_OPTION("World_GossipStone",             "Gossip Stone",         GROUP_WORLD,        {200, 200, 200, 255}, false, true, true),
    COSMETIC_OPTION("World_RedIce",                  "Red Ice",              GROUP_WORLD,        {255,   0,   0, 255}, false, true, false),

    COSMETIC_OPTION("Navi_IdlePrimary",              "Idle Primary",         GROUP_NAVI,         {255, 255, 255, 255}, false, true, false),
    COSMETIC_OPTION("Navi_IdleSecondary",            "Idle Secondary",       GROUP_NAVI,         {  0,   0, 255,   0}, false, true, true),
    COSMETIC_OPTION("Navi_NPCPrimary",               "NPC Primary",          GROUP_NAVI,         {150, 150, 255, 255}, false, true, false),
    COSMETIC_OPTION("Navi_NPCSecondary",             "NPC Secondary",        GROUP_NAVI,         {150, 150, 255,   0}, false, true, true),
    COSMETIC_OPTION("Navi_EnemyPrimary",             "Enemy Primary",        GROUP_NAVI,         {255, 255,   0, 255}, false, true, false),
    COSMETIC_OPTION("Navi_EnemySecondary",           "Enemy Secondary",      GROUP_NAVI,         {200, 155,   0,   0}, false, true, true),
    COSMETIC_OPTION("Navi_PropsPrimary",             "Props Primary",        GROUP_NAVI,         {  0, 255,   0, 255}, false, true, false),
    COSMETIC_OPTION("Navi_PropsSecondary",           "Props Secondary",      GROUP_NAVI,         {  0, 255,   0,   0}, false, true, true),

    COSMETIC_OPTION("NPC_FireKeesePrimary",          "Fire Keese Primary",   GROUP_NPC,          {255, 255, 255, 255}, false, true, false),
    COSMETIC_OPTION("NPC_FireKeeseSecondary",        "Fire Keese Secondary", GROUP_NPC,          {255, 255, 255, 255}, false, true, true),
    COSMETIC_OPTION("NPC_IceKeesePrimary",           "Ice Keese Primary",    GROUP_NPC,          {255, 255, 255, 255}, false, true, false),
    COSMETIC_OPTION("NPC_IceKeeseSecondary",         "Ice Keese Secondary",  GROUP_NPC,          {255, 255, 255, 255}, false, true, true),
    // Todo (Cosmetics): Health fairy
    COSMETIC_OPTION("NPC_Dog1",                      "Dog 1",                GROUP_NPC,          {255, 255, 200, 255}, false, true, true),
    COSMETIC_OPTION("NPC_Dog2",                      "Dog 2",                GROUP_NPC,          {150, 100,  50, 255}, false, true, true),
    COSMETIC_OPTION("NPC_GoldenSkulltula",           "Golden Skulltula",     GROUP_NPC,          {255, 255, 255, 255}, false, true, false),
    COSMETIC_OPTION("NPC_Kokiri",                    "Kokiri",               GROUP_NPC,          {  0, 130,  70, 255}, false, true, false),
    COSMETIC_OPTION("NPC_Gerudo",                    "Gerudo",               GROUP_NPC,          { 90,   0, 140, 255}, false, true, false),
    COSMETIC_OPTION("NPC_MetalTrap",                 "Metal Trap",           GROUP_NPC,          {255, 255, 255, 255}, false, true, true),
    COSMETIC_OPTION("NPC_IronKnuckles",              "Iron Knuckles",        GROUP_NPC,          {245, 255, 205, 255}, false, true, false),
};
