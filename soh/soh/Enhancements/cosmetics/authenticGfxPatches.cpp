...
static DListPatchInfo ironKnuckleDListPatchInfos[] = {
    { object_ik_DL_01BE98, 39 }, { object_ik_DL_01BE98, 59 },

    { object_ik_DL_01C130, 38 },

    { object_ik_DL_01C2B8, 39 }, { object_ik_DL_01C2B8, 59 },

    { object_ik_DL_01C550, 38 },

    { object_ik_DL_01C7B8, 8 },  { object_ik_DL_01C7B8, 28 },

    { object_ik_DL_01CB58, 8 },  { object_ik_DL_01CB58, 31 },

    { object_ik_DL_01CCA0, 15 }, { object_ik_DL_01CCA0, 37 }, { object_ik_DL_01CCA0, 52 },  { object_ik_DL_01CCA0, 68 },

    { object_ik_DL_01CEE0, 27 }, { object_ik_DL_01CEE0, 46 }, { object_ik_DL_01CEE0, 125 },

    { object_ik_DL_01D2B0, 8 },  { object_ik_DL_01D2B0, 32 },

    { object_ik_DL_01D3F8, 15 }, { object_ik_DL_01D3F8, 37 }, { object_ik_DL_01D3F8, 52 },  { object_ik_DL_01D3F8, 68 },

    { object_ik_DL_01D638, 23 }, { object_ik_DL_01D638, 42 }, { object_ik_DL_01D638, 110 },
};
...
void PatchDekuStickTextureOverflow() {
    ...
    Gfx gDekuStickTexFix[] = { gsDPLoadTextureBlock(gDekuStickTex, G_IM_FMT_I, G_IM_SIZ_8b, 8, 8, 0,
                                                    G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, 4, 4,
...
void PatchFreezardTextureOverflow() {
    ...
    Gfx gEffUnknown12TexFix[] = { gsDPLoadTextureBlock(gEffUnknown12Tex, G_IM_FMT_I, G_IM_SIZ_8b, 32, 32, 0,
...
void PatchIronKnuckleTextureOverflow() {
    ...
    Gfx gIronKnuckleMetalTexFix[] = { gsDPLoadTextureBlock(object_ik_Tex_00F7A0, G_IM_FMT_I, G_IM_SIZ_4b, 32, 64, 0,
                                                           G_TX_MIRROR | G_TX_WRAP, G_TX_MIRROR | G_TX_WRAP, 5, 6,
                                                           G_TX_NOLOD, G_TX_NOLOD) };
...
void PatchMirroredSunSongEtching() {
    ...
    static const char gMqRoyalGraveBackRoomSongVtx[] =
        "__OTR__scenes/mq/hakaana_ouke_scene/hakaana_ouke_room_2Vtx_004F80";
    static const char gNonMqRoyalGraveBackRoomSongVtx[] =
        "__OTR__scenes/nonmq/hakaana_ouke_scene/hakaana_ouke_room_2Vtx_004F80";

    static Vtx* mirroredSunSongVtx;

    // Using a dummy texture here, but will be ignoring the texture command itself
    // Only need to patch over the two SetTile commands to get the MIRROR effect
    Gfx mirroredSunSongTex[] = { gsDPLoadTextureBlock("", G_IM_FMT_IA, G_IM_SIZ_8b, 128, 32, 0, G_TX_MIRROR | G_TX_WRAP,
    ...
    if (CVarGetInteger("gMirroredWorld", 0)) {
        ...
        ResourceMgr_PatchGfxByName(royalGraveBackRoomDL, "RoyalGraveSunSongTextureCords_1", 24,
