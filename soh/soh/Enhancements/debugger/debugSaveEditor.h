...
const std::vector<FlagTable> flagTables = {
    ...
    { "Randomizer Inf Flags", RANDOMIZER_INF, (RAND_INF_MAX + 15) / 16, {
        ...
        { RAND_INF_WASTELAND_CARPET_MERCHANT  , "RAND_INF_WASTELAND_CARPET_MERCHANT" },
        { RAND_INF_WASTELAND_NW_POT           , "RAND_INF_WASTELAND_NW_POT" },
        { RAND_INF_WASTELAND_NE_POT           , "RAND_INF_WASTELAND_NE_POT" },
        { RAND_INF_WASTELAND_SW_POT           , "RAND_INF_WASTELAND_SW_POT" },
        { RAND_INF_WASTELAND_SE_POT           , "RAND_INF_WASTELAND_SE_POT" },

        { RAND_INF_BOTW_ENTRYWAY_WEST_POT     , "RAND_INF_BOTW_ENTRYWAY_WEST_POT" },
        { RAND_INF_BOTW_ENTRYWAY_EAST_POT     , "RAND_INF_BOTW_ENTRYWAY_EAST_POT" },
        { RAND_INF_BOTW_SUNKEN_POT            , "RAND_INF_BOTW_SUNKEN_POT" },
        { RAND_INF_BOTW_FAKE_WALL_SOUTH_POT   , "RAND_INF_BOTW_FAKE_WALL_SOUTH_POT" },
        { RAND_INF_BOTW_FAKE_WALL_CENTRAL_POT , "RAND_INF_BOTW_FAKE_WALL_CENTRAL_POT" },
        { RAND_INF_BOTW_FAKE_WALL_NORTH_POT   , "RAND_INF_BOTW_FAKE_WALL_NORTH_POT" },
        { RAND_INF_BOTW_3_HIDDEN_PITS_POT     , "RAND_INF_BOTW_3_HIDDEN_PITS_POT" },
        { RAND_INF_BOTW_OPEN_COFFIN_HEART     , "RAND_INF_BOTW_OPEN_COFFIN_HEART" },
        { RAND_INF_BOTW_SE_COFFIN_HEART       , "RAND_INF_BOTW_SE_COFFIN_HEART" },
        { RAND_INF_BOTW_B3_WEST_CENTER_POT    , "RAND_INF_BOTW_B3_WEST_CENTER_POT" },
        { RAND_INF_BOTW_B3_EAST_CENTER_POT    , "RAND_INF_BOTW_B3_EAST_CENTER_POT" },
        { RAND_INF_BOTW_B3_WEST_V_N_POT       , "RAND_INF_BOTW_B3_WEST_V_N_POT" },
        { RAND_INF_BOTW_B3_WEST_V_NW_POT      , "RAND_INF_BOTW_B3_WEST_V_NW_POT" },
        { RAND_INF_BOTW_B3_WEST_V_W_POT       , "RAND_INF_BOTW_B3_WEST_V_W_POT" },
        { RAND_INF_BOTW_B3_WEST_V_SW_POT      , "RAND_INF_BOTW_B3_WEST_V_SW_POT" },
        { RAND_INF_BOTW_B3_WEST_V_S_POT       , "RAND_INF_BOTW_B3_WEST_V_S_POT" },
        { RAND_INF_BOTW_B3_EAST_V_N_POT       , "RAND_INF_BOTW_B3_EAST_V_N_POT" },
        { RAND_INF_BOTW_B3_EAST_V_NW_POT      , "RAND_INF_BOTW_B3_EAST_V_NW_POT" },
        { RAND_INF_BOTW_B3_EAST_V_W_POT       , "RAND_INF_BOTW_B3_EAST_V_W_POT" },
        { RAND_INF_BOTW_B3_EAST_V_SW_POT      , "RAND_INF_BOTW_B3_EAST_V_SW_POT" },
        { RAND_INF_BOTW_B3_EAST_V_S_POT       , "RAND_INF_BOTW_B3_EAST_V_S_POT" },
        { RAND_INF_BOTW_B3_SUN_FAIRY          , "RAND_INF_BOTW_B3_SUN_FAIRY" },
        { RAND_INF_BOTW_B3_PLATFORM_N_RUPEE   , "RAND_INF_BOTW_B3_PLATFORM_N_RUPEE" },
        { RAND_INF_BOTW_B3_PLATFORM_NW_RUPEE  , "RAND_INF_BOTW_B3_PLATFORM_NW_RUPEE" },
        { RAND_INF_BOTW_B3_PLATFORM_NE_RUPEE  , "RAND_INF_BOTW_B3_PLATFORM_NE_RUPEE" },
        { RAND_INF_BOTW_B3_PLATFORM_W_RUPEE   , "RAND_INF_BOTW_B3_PLATFORM_W_RUPEE" },
        { RAND_INF_BOTW_B3_PLATFORM_E_RUPEE   , "RAND_INF_BOTW_B3_PLATFORM_E_RUPEE" },
        { RAND_INF_BOTW_MQ_CAGED_POT          , "RAND_INF_BOTW_MQ_CAGED_POT" },
        { RAND_INF_BOTW_MQ_N_BURIED_HEART     , "RAND_INF_BOTW_MQ_N_BURIED_HEART" },
        { RAND_INF_BOTW_MQ_S_BURIED_HEART     , "RAND_INF_BOTW_MQ_S_BURIED_HEART" },
        { RAND_INF_BOTW_MQ_NE_COFFIN_HEART    , "RAND_INF_BOTW_MQ_NE_COFFIN_HEART" },
        { RAND_INF_BOTW_MQ_S_COFFIN_HEART     , "RAND_INF_BOTW_MQ_S_COFFIN_HEART" },
        { RAND_INF_BOTW_MQ_WOODEN_X_ROOM_W_POT, "RAND_INF_BOTW_MQ_WOODEN_X_ROOM_W_POT" },
        { RAND_INF_BOTW_MQ_WOODEN_X_ROOM_C_POT, "RAND_INF_BOTW_MQ_WOODEN_X_ROOM_C_POT" },
        { RAND_INF_BOTW_MQ_NEAR_POTS_SUN_FAIRY, "RAND_INF_BOTW_MQ_NEAR_POTS_SUN_FAIRY" },
        { RAND_INF_BOTW_MQ_WOODEN_X_ROOM_E_POT, "RAND_INF_BOTW_MQ_WOODEN_X_ROOM_E_POT" },
        { RAND_INF_BOTW_MQ_UNSEEN_LEDGE_NW_POT, "RAND_INF_BOTW_MQ_UNSEEN_LEDGE_NW_POT" },
        { RAND_INF_BOTW_MQ_UNSEEN_LEDGE_NE_POT, "RAND_INF_BOTW_MQ_UNSEEN_LEDGE_NE_POT" },
        { RAND_INF_BOTW_MQ_UNSEEN_LEDGE_S_POT , "RAND_INF_BOTW_MQ_UNSEEN_LEDGE_S_POT" },
        { RAND_INF_BOTW_MQ_B3_S_HEART         , "RAND_INF_BOTW_MQ_B3_S_HEART" },
        { RAND_INF_BOTW_MQ_B3_NW_HEART        , "RAND_INF_BOTW_MQ_B3_NW_HEART" },
        { RAND_INF_BOTW_MQ_B3_NE_HEART        , "RAND_INF_BOTW_MQ_B3_NE_HEART" },
        { RAND_INF_BOTW_MQ_B3_SUN_FAIRY       , "RAND_INF_BOTW_MQ_B3_SUN_FAIRY" },
    } },
};
