...
const std::vector<std::string> state1 = { "Loading",
                                          "Swinging Bottle",
...
const std::vector<std::string> state2 = { "Grab",
                                          "Speak/Check",
                                          "Climb",
                                          "Footstep",
                                          "Moving Dynapoly",
...
const std::vector<std::string> state3 = { "Ignore ceiling for Floor and Water",
                                          "Midair",
                                          "Pause Action Func",
                                          "Finished Attacking",
