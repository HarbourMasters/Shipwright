...
const std::vector<FlagTable> flagTables = {
   ...
   { "Randomizer Inf Flags", RANDOMIZER_INF, 0x09, {
        ...
        { RAND_INF_USED_SPIRIT_TEMPLE_BLUE_WARP, "RAND_INF_USED_SPIRIT_TEMPLE_BLUE_WARP" },
        { RAND_INF_USED_SHADOW_TEMPLE_BLUE_WARP, "RAND_INF_USED_SHADOW_TEMPLE_BLUE_WARP" },
        { RAND_INF_RECEIVED_LIGHT_MEDALLION, "RAND_INF_RECEIVED_LIGHT_MEDALLION" },
        ...
        { RAND_INF_RECEIVED_ZELDAS_LULLABY, "RAND_INF_RECEIVED_ZELDAS_LULLABY" },
        { RAND_INF_RECEIVED_REQUIEM_OF_SPIRIT, "RAND_INF_RECEIVED_REQUIEM_OF_SPIRIT" },
        { RAND_INF_RECEIVED_FAIRY_OCARINA, "RAND_INF_RECEIVED_FAIRY_OCARINA" },
        { RAND_INF_RECEIVED_LIGHT_ARROWS, "RAND_INF_RECEIVED_LIGHT_ARROWS" },
    } },
};
