...
extern "C" int CustomMessage_RetrieveIfExists(PlayState* play) {
    ...
    if (gSaveContext.n64ddFlag) {
        ...
        } else if (CVar_GetS32("gRandoMarketSneak", 0) && textId == TEXT_MARKET_GUARD_NIGHT && play->sceneNum != SCENE_MARKET_NIGHT) {
            messageEntry = CustomMessageManager::Instance->RetrieveMessage(Randomizer::merchantMessageTableID, TEXT_MARKET_GUARD_NIGHT);
