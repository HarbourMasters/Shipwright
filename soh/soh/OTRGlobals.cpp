...
extern "C" int CustomMessage_RetrieveIfExists(PlayState* play) {
    ...
    if (textId == TEXT_MARKET_GUARD_NIGHT && (CVarGetInteger(CVAR_ENHANCEMENT("MarketSneak"), 0) || CVarGetInteger(CVAR_ENHANCEMENT("BridgeOpenAtNight"), 0)) && play->sceneNum == SCENE_MARKET_ENTRANCE_NIGHT) {
