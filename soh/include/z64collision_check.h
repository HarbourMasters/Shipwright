...
// These flags are not to be used in code until we figure out how we want to format them. They are only here for
// reference
...
#define DMG_ARROW                                                                                            \
    (DMG_ARROW_NORMAL | DMG_ARROW_FIRE | DMG_ARROW_ICE | DMG_ARROW_LIGHT | DMG_ARROW_UNK1 | DMG_ARROW_UNK2 | \
     DMG_ARROW_UNK3)
