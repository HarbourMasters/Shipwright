...
#define ACTOR_FLAG_TARGETABLE (1 << 0) //ACTOR_FLAG_TARGETABLE
#define ACTOR_FLAG_HOSTILE (1 << 2) //ACTOR_FLAG_HOSTILE
#define ACTOR_FLAG_FRIENDLY (1 << 3) //ACTOR_FLAG_FRIENDLY
#define ACTOR_FLAG_UPDATE_WHILE_CULLED (1 << 4) //ACTOR_FLAG_UPDATE_WHILE_CULLED
#define ACTOR_FLAG_DRAW_WHILE_CULLED (1 << 5) //ACTOR_FLAG_DRAW_WHILE_CULLED
#define ACTOR_FLAG_ACTIVE (1 << 6) //ACTOR_FLAG_ACTIVE
#define ACTOR_FLAG_LENS (1 << 7) //ACTOR_FLAG_LENS
#define ACTOR_FLAG_PLAYER_TALKED_TO (1 << 8) //ACTOR_FLAG_PLAYER_TALKED_TO
#define ACTOR_FLAG_HOOKSHOT_DRAGS (1 << 9) //ACTOR_FLAG_HOOKSHOT_DRAGS
#define ACTOR_FLAG_DRAGGED_BY_HOOKSHOT (1 << 10) //ACTOR_FLAG_DRAGGED_BY_HOOKSHOT
#define ACTOR_FLAG_ENKUSA_CUT (1 << 11)
#define ACTOR_FLAG_IGNORE_QUAKE (1 << 12) //ACTOR_FLAG_IGNORE_QUAKE
#define ACTOR_FLAG_HOOKSHOT_ATTACHED (1 << 13) //ACTOR_FLAG_HOOKSHOT_ATTACHED
#define ACTOR_FLAG_ARROW_DRAGGABLE (1 << 14) //ACTOR_FLAG_ARROW_DRAGGABLE
#define ACTOR_FLAG_DRAGGED_BY_ARROW (1 << 15) //ACTOR_FLAG_DRAGGED_BY_ARROW
#define ACTOR_FLAG_WILL_TALK (1 << 16) //ACTOR_FLAG_WILL_TALK
#define ACTOR_FLAG_PILLAR_PICKUP (1 << 17) //ACTOR_FLAG_PILLAR_PICKUP
#define ACTOR_FLAG_NAVI_HAS_INFO (1 << 18) //ACTOR_FLAG_NAVI_HAS_INFO
#define ACTOR_FLAG_SFX_AT_POS (1 << 19) //ACTOR_FLAG_SFX_AT_POS
#define ACTOR_FLAG_SFX_AT_CENTER (1 << 20) //ACTOR_FLAG_SFX_AT_CENTER
#define ACTOR_FLAG_SFX_AT_CENTER2 (1 << 21) //ACTOR_FLAG_SFX_AT_CENTER2
#define ACTOR_FLAG_IGNORE_POINTLIGHTS (1 << 22) //ACTOR_FLAG_IGNORE_POINTLIGHTS
#define ACTOR_FLAG_ALWAYS_THROWN (1 << 23) //ACTOR_FLAG_ALWAYS_THROWN
#define ACTOR_FLAG_PLAY_HIT_SFX (1 << 24) //ACTOR_FLAG_PLAY_HIT_SFX
#define ACTOR_FLAG_NO_FREEZE_OCARINA (1 << 25) //ACTOR_FLAG_NO_FREEZE_OCARINA
#define ACTOR_FLAG_CAN_PRESS_SWITCH (1 << 26) //ACTOR_FLAG_CAN_PRESS_SWITCH
#define ACTOR_FLAG_NO_LOCKON (1 << 27) //ACTOR_FLAG_NO_LOCKON
#define ACTOR_FLAG_SFX_AS_TIMER (1 << 28) //ACTOR_FLAG_SFX_AS_TIMER
