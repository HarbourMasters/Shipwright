...
#define CAM_FUNCDATA_DATA4(yOffset, fov, flags) \
    { yOffset, CAM_DATA_Y_OFFSET }, { fov, CAM_DATA_FOV }, { flags, CAM_DATA_FLAGS }
...
#define CAM_FUNCDATA_UNIQ2(yOffset, eyeDist, fov, flags) \
    { yOffset, CAM_DATA_Y_OFFSET }, { eyeDist, CAM_DATA_EYE_DIST }, { fov, CAM_DATA_FOV }, { flags, CAM_DATA_FLAGS }
...
#define CAM_FUNCDATA_UNIQ7(fov, flags) \
    { fov, CAM_DATA_FOV }, { flags, CAM_DATA_FLAGS }
...
#define CAM_FUNCDATA_SPEC0(yawUpdateRateTarget, flags) \
    { yawUpdateRateTarget, CAM_DATA_YAW_UPDATE_RATE_TARGET }, { flags, CAM_DATA_FLAGS }
