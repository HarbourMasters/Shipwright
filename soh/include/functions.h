...
void Player_SetLeftHandModels(Player* player, s32 modelGroup);
void Player_SetRightHandModels(Player* player, s32 modelGroup);
void Player_SetSheathModels(Player* player, s32 modelGroup);
void Player_SetWaistModels(Player* player, s32 modelGroup);
