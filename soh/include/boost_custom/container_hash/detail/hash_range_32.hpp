...
hash_range_32(uint32_t seed, It first, It last) {
    ...
    for (; n >= 4; first += 4, n -= 4) {
        ...
        boost::uint32_t w = static_cast<boost::uint32_t>(static_cast<unsigned char>(first[0])) |
...

    {
        ...
        switch (n) {
            case 1:
                ...
                w = static_cast<boost::uint32_t>(static_cast<unsigned char>(first[0])) | 0x0100u;

                break;

            case 2:

                w = static_cast<boost::uint32_t>(static_cast<unsigned char>(first[0])) |
                    static_cast<boost::uint32_t>(static_cast<unsigned char>(first[1])) << 8 | 0x010000u;
            ...
            case 3:
                ...
                w = static_cast<boost::uint32_t>(static_cast<unsigned char>(first[0])) |
                    static_cast<boost::uint32_t>(static_cast<unsigned char>(first[1])) << 8 |
                    static_cast<boost::uint32_t>(static_cast<unsigned char>(first[2])) << 16 | 0x01000000u;
