...
#define PLAYER_STATE2_0 (1 << 0) //PLAYER_STATE2_DO_ACTION_GRAB
#define PLAYER_STATE2_1 (1 << 1) //PLAYER_STATE2_SPEAK_OR_CHECK
#define PLAYER_STATE2_2 (1 << 2) //PLAYER_STATE2_DO_ACTION_CLIMB
#define PLAYER_STATE2_3 (1 << 3) //PLAYER_STATE2_FOOTSTEP
#define PLAYER_STATE2_4 (1 << 4) //PLAYER_STATE2_MOVING_DYNAPOLY
#define PLAYER_STATE2_5 (1 << 5) //PLAYER_STATE2_DISABLE_ROTATION_Z_TARGET
#define PLAYER_STATE2_6 (1 << 6) //PLAYER_STATE2_DISABLE_ROTATION_ALWAYS
#define PLAYER_STATE2_7 (1 << 7) //PLAYER_STATE2_GRABBED_BY_ENEMY
#define PLAYER_STATE2_8 (1 << 8) //PLAYER_STATE2_GRABBING_DYNAPOLY
#define PLAYER_STATE2_9 (1 << 9) //PLAYER_STATE2_SPAWN_DUST_FOR
#define PLAYER_STATE2_10 (1 << 10) //PLAYER_STATE2_UNDERWATER
#define PLAYER_STATE2_11 (1 << 11) //PLAYER_STATE2_DIVING
#define PLAYER_STATE2_12 (1 << 12) //PLAYER_STATE2_STATIONARY_LADDER
#define PLAYER_STATE2_13 (1 << 13) //PLAYER_STATE2_SWITCH_TARGETING
#define PLAYER_STATE2_14 (1 << 14) //PLAYER_STATE2_FROZEN
#define PLAYER_STATE2_15 (1 << 15) //PLAYER_STATE2_PAUSE_MOST_UPDATING
#define PLAYER_STATE2_DO_ACTION_ENTER (1 << 16) // Turns on the "Enter On A" DoAction
#define PLAYER_STATE2_17 (1 << 17) //PLAYER_STATE2_SPIN_ATTACKING //w/o magic
#define PLAYER_STATE2_CRAWLING (1 << 18) // Crawling through a crawlspace
#define PLAYER_STATE2_19 (1 << 19) //PLAYER_STATE2_HOPPING //Sidehop/backflip
#define PLAYER_STATE2_20 (1 << 20) //PLAYER_STATE2_NAVI_OUT
#define PLAYER_STATE2_21 (1 << 21) //PLAYER_STATE2_NAVI_ALERT
#define PLAYER_STATE2_22 (1 << 22) //PLAYER_STATE2_DO_ACTION_DOWN
#define PLAYER_STATE2_23 (1 << 23) //PLAYER_STATE2_NEAR_OCARINA_ACTOR
#define PLAYER_STATE2_24 (1 << 24) //PLAYER_STATE2_ATTEMPT_PLAY_FOR_ACTOR
#define PLAYER_STATE2_25 (1 << 25) //PLAYER_STATE2_PLAY_FOR_ACTOR
#define PLAYER_STATE2_26 (1 << 26) //PLAYER_STATE2_REFLECTION //Handles Dark Link's Reflection
#define PLAYER_STATE2_27 (1 << 27) //PLAYER_STATE2_OCARINA_PLAYING
#define PLAYER_STATE2_28 (1 << 28) //PLAYER_STATE2_IDLING
#define PLAYER_STATE2_29 (1 << 29) //PLAYER_STATE2_DISABLE
#define PLAYER_STATE2_30 (1 << 30) //PLAYER_STATE2_SWORD_LUNGE
#define PLAYER_STATE2_31 (1 << 31) //PLAYER_STATE2_FORCED_VOID_OUT
