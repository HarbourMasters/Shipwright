...
EXTERN_C void IrqMgr_Init(IrqMgr* this, void* stack, OSPri pri, u8 retraceCount);
EXTERN_C void IrqMgr_AddClient(IrqMgr* this, IrqMgrClient* c, OSMesgQueue* msgQ);
EXTERN_C void IrqMgr_RemoveClient(IrqMgr* this, IrqMgrClient* c);
