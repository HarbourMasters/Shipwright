...
#define CHECK_MODDED_ITEM_AGE(modId, itemId) (CVarGetInteger("gTimelessEquipment", 0) || (ModdedItems_GetItemAgeRequirement(modId, itemId) == 9) || (ModdedItems_GetItemAgeRequirement(modId, itemId) == gSaveContext.linkAge))
