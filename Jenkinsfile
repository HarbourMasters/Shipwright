                ...
                stage ('Build macOS') {
                    ...
                    steps {
                        ...
                        catchError(buildResult: 'FAILURE', stageResult: 'FAILURE') {
                            ...
                            cp ../../ZELOOTD.z64 OTRExporter/baserom_non_mq.z64
                            cd soh
                            make setup -j4 OPTFLAGS=-O2 DEBUG=0 CC="clang -arch arm64 -arch x86_64" CXX="clang++ -arch arm64 -arch x86_64" LD="ld"
                            make -j4 DEBUG=0 OPTFLAGS=-O2 CC="clang -arch arm64 -arch x86_64" CXX="clang++ -arch arm64 -arch x86_64" LD="ld"
                            make -j4 appbundle
                            mv ../README.md readme.txt
