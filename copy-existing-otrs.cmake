...
if(EXISTS ${SOURCE_DIR}/OTRExporter/custom-music.otr)
    execute_process(COMMAND ${CMAKE_COMMAND} -E copy custom-music.otr ${SOURCE_DIR})
    execute_process(COMMAND ${CMAKE_COMMAND} -E copy custom-music.otr ${BINARY_DIR}/soh/mods/)
endif()
