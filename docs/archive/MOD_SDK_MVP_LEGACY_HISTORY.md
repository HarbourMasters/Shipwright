# MOD SDK MVP Legacy History (Archived)

This file preserves the previous long-form historical content from `docs/MOD_SDK_MVP.md`.

- Archived on: 2026-02-25
- Reason: keep `MOD_SDK_MVP.md` concise and operational for the current `apiVersion: 3` baseline.
