#include "resource/importer/PlayerAnimationFactory.h"
#include "resource/type/PlayerAnimation.h"
#include "spdlog/spdlog.h"

namespace Ship {
std::shared_ptr<Resource> PlayerAnimationFactory::ReadResource(std::shared_ptr<BinaryReader> reader)
{
                                                     ...
                                                     std::shared_ptr<Resource> resource)
{
	...
	ResourceFile::ParseFileBinary(reader, playerAnimation);
