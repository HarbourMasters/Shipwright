#include "resource/importer/AudioSampleFactory.h"
#include "resource/type/AudioSample.h"
#include "spdlog/spdlog.h"

namespace Ship {
std::shared_ptr<Resource> AudioSampleFactory::ReadResource(std::shared_ptr<BinaryReader> reader)
{
                                                 ...
                                                 std::shared_ptr<Resource> resource)
{
	...
	ResourceFile::ParseFileBinary(reader, audioSample);
