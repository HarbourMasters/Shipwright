#include "resource/importer/CutsceneFactory.h"
#include "resource/type/Cutscene.h"
#include "spdlog/spdlog.h"

namespace Ship {
std::shared_ptr<Resource> CutsceneFactory::ReadResource(std::shared_ptr<BinaryReader> reader)
{
                                              ...
                                              std::shared_ptr<Resource> resource)
{
	...
	ResourceFile::ParseFileBinary(reader, cutscene);
